...
abstract public class ClientCountFilterRequestDMW extends Request {
    ...
    private ClientCountFilterRequestDMO mycore;
    ...
    public ClientCountFilterRequestDMW() {
        ...
        mycore = (ClientCountFilterRequestDMO) core;
    ...
    public void setDmcObject(DmcObject obj) {
        mycore = (ClientCountFilterRequestDMO) obj;
        mycore.setContainer(this);
     ...
     */
    // org.dmd.dmg.generators.DMWGenerator.formatSV(DMWGenerator.java:964)
    public ClientCountFilter getClientCountFilter(){
        ClientCountFilterDMO dmo = mycore.getClientCountFilter();
        if (dmo == null)
            return(null);
    ...
    public void setClientCountFilter(ClientCountFilter value) {
        mycore.setClientCountFilter(value.getDMO());
    }
    ...
    public int getRequestIDSize(){
        DmcAttribute<?> attr = mycore.get(ClientCountFilterRequestDMO.__requestID);
        if (attr == null)
            return(0);
