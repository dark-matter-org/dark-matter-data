...
// Called from: org.dmd.dms.util.GenUtility.dumpExtendedReferenceTypeDmcType(GenUtility.java:3039)
import org.dmd.dmc.DmcAttributeInfo;                            // Standard attribute interface - (GenUtility.java:3027)
import org.dmd.dmc.DmcInputStreamIF;                            // Serialization support - (GenUtility.java:3024)
import org.dmd.dmc.DmcOutputStreamIF;                           // Serialization support - (GenUtility.java:3025)
import org.dmd.dmc.DmcValueException;                           // Value exceptions - (GenUtility.java:3028)
import org.dmd.dmc.types.DmcTypeNamedObjectREF;                 // The class we extend - (GenUtility.java:3029)
import org.dmd.dmc.types.StringName;                            // Name type - (GenUtility.java:3033)
import org.dmd.dmt.shared.generated.dmo.ObjWithRefsDMO;         // The class we refer to - (GenUtility.java:3031)
 ...
 * Generated from: org.dmd.dms.util.GenUtility.dumpExtendedReferenceTypeDmcType(GenUtility.java:3062)
