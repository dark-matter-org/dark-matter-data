...
public class TestMultiLevelSubpackageDMO  extends DmwWrapperDMO  implements DmcNamedObjectIF, Serializable  {
    ...
    public TestMultiLevelSubpackageDMO getModificationRecorder(){
        TestMultiLevelSubpackageDMO rc = new TestMultiLevelSubpackageDMO(new DmcTypeModifierMV());
        rc.setName(getName());
        return(rc);
    }

    // org.dmd.dms.util.DmoFormatter.getAccessFunctions(DmoFormatter.java:664)
