...
import org.dmd.mvw.tools.mvwgenerator.generated.dmo.WebApplicationDMO; // primitive type
...
public class WebApplicationREF extends DmcNamedObjectNontransportableREF<WebApplicationDMO> {
    ...
    public final static DmcAttributeInfo __appName = new DmcAttributeInfo("appName",833,"CamelCaseName",ValueTypeEnum.SINGLE,false);
    
    DmcTypeCamelCaseNameSV myName;    
    
    public WebApplicationREF(){
    }

    public WebApplicationREF(WebApplicationDMO o){
         object = o;
    ...
    public WebApplicationREF(WebApplicationREF original){
     ...
     */
    public WebApplicationREF cloneMe(){
