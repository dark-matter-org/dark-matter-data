...
import org.dmd.mvw.tools.mvwgenerator.generated.dmo.FieldEditorDMO; // primitive type
...
public class FieldEditorREF extends DmcNamedObjectNontransportableREF<FieldEditorDMO> {
    ...
    public FieldEditorREF(){
    }

    public FieldEditorREF(FieldEditorDMO o){
         object = o;
         myName = (DmcTypeCamelCaseNameSV)o.getObjectNameAttribute();
    }

    public FieldEditorREF(CamelCaseName n) throws DmcValueException {
         object = null;
         myName = new DmcTypeCamelCaseNameSV(__editorName);
         myName.set(n);
    }

    public FieldEditorREF(String n) throws DmcValueException {
         object = null;
         myName = new DmcTypeCamelCaseNameSV(__editorName);
         myName.set(n);
    }

    public FieldEditorREF(FieldEditorREF original){
        myName = original.myName;
        object = original.object;
    }

    public void setObject(FieldEditorDMO o){
         object = o;
         myName = (DmcTypeCamelCaseNameSV)o.getObjectNameAttribute();
    }
