...
import org.dmd.mvw.tools.mvwgenerator.generated.types.DmcTypeMethodWithArgsSV;

@SuppressWarnings("serial")
// org.dmd.dms.util.AdapterFormatter.dumpAdapter(AdapterFormatter.java:50)
// Called from: org.dmd.dms.util.AdapterFormatter.dumpAdapterSV(AdapterFormatter.java:12)
public class MethodWithArgsSVAdapter extends DmcTypeMethodWithArgsSV implements DmcAdapterIF {

    DmcTypeMethodWithArgsSV existingValue;
    ...
    public void setExisting(DmcAttribute<?> attr) {
    	existingValue = (DmcTypeMethodWithArgsSV) attr;
    	if (existingValue != null)
    		value = existingValue.getSVCopy();
    }
