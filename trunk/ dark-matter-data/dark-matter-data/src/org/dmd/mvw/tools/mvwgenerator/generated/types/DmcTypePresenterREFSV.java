...
public class DmcTypePresenterREFSV extends DmcTypePresenterREF implements Serializable {
    ...
    public DmcTypePresenterREFSV(){
    
    }
    
    public DmcTypePresenterREFSV(DmcAttributeInfo ai){
        super(ai);
    }
    
    public DmcTypePresenterREFSV getNew(){
        return(new DmcTypePresenterREFSV(attrInfo));
    }
    
    public DmcTypePresenterREFSV getNew(DmcAttributeInfo ai){
        return(new DmcTypePresenterREFSV(ai));
    }
