...
import org.dmd.mvw.tools.mvwgenerator.generated.types.DmcTypeMenuItemREFSV;

@SuppressWarnings("serial")
// org.dmd.dms.util.AdapterFormatter.dumpAdapter(AdapterFormatter.java:50)
// Called from: org.dmd.dms.util.AdapterFormatter.dumpAdapterSV(AdapterFormatter.java:12)
public class MenuItemREFSVAdapter extends DmcTypeMenuItemREFSV implements DmcAdapterIF {

    DmcTypeMenuItemREFSV existingValue;
    ...
    public void setExisting(DmcAttribute<?> attr) {
    	existingValue = (DmcTypeMenuItemREFSV) attr;
    	if (existingValue != null)
    		value = existingValue.getSVCopy();
    }
