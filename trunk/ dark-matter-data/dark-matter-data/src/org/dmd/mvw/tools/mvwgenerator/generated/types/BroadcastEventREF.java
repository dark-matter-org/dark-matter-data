...
import org.dmd.mvw.tools.mvwgenerator.generated.dmo.BroadcastEventDMO; // primitive type
...
public class BroadcastEventREF extends DmcNamedObjectNontransportableREF<BroadcastEventDMO> {
    ...
    public BroadcastEventREF(){
    }

    public BroadcastEventREF(BroadcastEventDMO o){
         object = o;
         myName = (DmcTypeCamelCaseNameSV)o.getObjectNameAttribute();
    }

    public BroadcastEventREF(CamelCaseName n) throws DmcValueException {
         object = null;
         myName = new DmcTypeCamelCaseNameSV();
         myName.set(n);
    }

    public BroadcastEventREF(String n) throws DmcValueException {
         object = null;
         myName = new DmcTypeCamelCaseNameSV();
         myName.set(n);
    }

    public BroadcastEventREF(BroadcastEventREF original){
        myName = original.myName;
        object = original.object;
    }

    public void setObject(BroadcastEventDMO o){
         object = o;
         myName = (DmcTypeCamelCaseNameSV)o.getObjectNameAttribute();
    }
     ...
     */
    public BroadcastEventREF cloneMe(){
