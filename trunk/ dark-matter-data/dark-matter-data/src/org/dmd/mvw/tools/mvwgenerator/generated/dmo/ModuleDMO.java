...
public class ModuleDMO  extends MvwDefinitionDMO  implements DmcNamedObjectIF, Serializable  {
    ...
    public final static DmcAttributeInfo __dependsOnModule = new DmcAttributeInfo("dependsOnModule",805,"String",ValueTypeEnum.MULTI,DataTypeEnum.PERSISTENT,false);
    ...
    public Iterator<String> getDependsOnModule(){
        DmcTypeStringMV attr = (DmcTypeStringMV) get(__dependsOnModule);
        if (attr == null)
    ...
    public DmcAttribute<?> addDependsOnModule(String value) {
        ...
        if (attr == null)
            attr = new DmcTypeStringMV(__dependsOnModule);
    ...
    public DmcAttribute<?> delDependsOnModule(Object value) throws DmcValueException {
        ...
        if ( (attr == null) && (getModifier()!= null))
            delFromEmptyAttribute(new DmcTypeStringMV(__dependsOnModule), value);
        else
