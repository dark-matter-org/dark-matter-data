...
import org.dmd.mvw.tools.mvwgenerator.extended.Event;                                   // Is reference type aux - (BaseDMWGeneratorNewest.java:823)
import org.dmd.mvw.tools.mvwgenerator.extended.MvwDefinition;                           // Derived class - (BaseDMWGeneratorNewest.java:943)
import org.dmd.mvw.tools.mvwgenerator.extended.RunContextItem;                          // Is reference type aux - (BaseDMWGeneratorNewest.java:823)
import org.dmd.mvw.tools.mvwgenerator.extended.View;                                    // Required for getModificationRecorder() - (BaseDMWGeneratorNewest.java:801)
import org.dmd.mvw.tools.mvwgenerator.generated.dmo.EventDMO;                           // For multi-valued adds of Event - (BaseDMWGeneratorNewest.java:1430)
import org.dmd.mvw.tools.mvwgenerator.generated.dmo.MvwDMSAG;                           // Attribute from mvw schema - (BaseDMWGeneratorNewest.java:717)
import org.dmd.mvw.tools.mvwgenerator.generated.dmo.RunContextItemDMO;                  // For multi-valued adds of RunContextItem - (BaseDMWGeneratorNewest.java:1430)
import org.dmd.mvw.tools.mvwgenerator.generated.dmo.ViewDMO;                            // Class not auxiliary or abstract - (BaseDMWGeneratorNewest.java:947)
import org.dmd.mvw.tools.mvwgenerator.generated.dmw.DisplayDataSpecIterableDMW;         // For multi-valued DisplayDataSpec - (BaseDMWGeneratorNewest.java:1727)
import org.dmd.mvw.tools.mvwgenerator.generated.dmw.EventIterableDMW;                   // For multi-valued Event - (BaseDMWGeneratorNewest.java:1382)
import org.dmd.mvw.tools.mvwgenerator.generated.dmw.EventSpecIterableDMW;               // For multi-valued EventSpec - (BaseDMWGeneratorNewest.java:1727)
import org.dmd.mvw.tools.mvwgenerator.generated.dmw.MethodWithArgsIterableDMW;          // For multi-valued MethodWithArgs - (BaseDMWGeneratorNewest.java:1727)
import org.dmd.mvw.tools.mvwgenerator.generated.dmw.OperationSpecIterableDMW;           // For multi-valued OperationSpec - (BaseDMWGeneratorNewest.java:1727)
import org.dmd.mvw.tools.mvwgenerator.generated.dmw.RunContextItemIterableDMW;          // For multi-valued RunContextItem - (BaseDMWGeneratorNewest.java:1382)
import org.dmd.mvw.tools.mvwgenerator.generated.types.DisplayDataSpec;                  // Primitive type - (BaseDMWGeneratorNewest.java:864)
import org.dmd.mvw.tools.mvwgenerator.generated.types.EventSpec;                        // Primitive type - (BaseDMWGeneratorNewest.java:864)
import org.dmd.mvw.tools.mvwgenerator.generated.types.OperationSpec;                    // Primitive type - (BaseDMWGeneratorNewest.java:864)
import org.dmd.mvw.tools.mvwgenerator.types.MethodWithArgs;                             // Primitive type - (BaseDMWGeneratorNewest.java:864)
