...
public class DmcTypeFieldEditorREFSET extends DmcTypeFieldEditorREF implements Serializable {
    
    Set<FieldEditorREF> value;
    
    public DmcTypeFieldEditorREFSET(){
        value = null;
    }
    
    public DmcTypeFieldEditorREFSET(DmcAttributeInfo ai){
        super(ai);
        initValue();
    }
    ...
    void initValue(){
        if (attrInfo.valueType == ValueTypeEnum.HASHSET)
            value = new HashSet<FieldEditorREF>();
        else
            value = new TreeSet<FieldEditorREF>();
    }
    
    @Override
    public DmcTypeFieldEditorREFSET getNew(){
        return(new DmcTypeFieldEditorREFSET(attrInfo));
    }
    ...
    public Iterator<FieldEditorREF> getMV(){
        synchronized(this){
            ...
            if (attrInfo.valueType == ValueTypeEnum.HASHSET)
                clone = new HashSet<FieldEditorREF>(value);
            else
                clone = new TreeSet<FieldEditorREF>(value);
