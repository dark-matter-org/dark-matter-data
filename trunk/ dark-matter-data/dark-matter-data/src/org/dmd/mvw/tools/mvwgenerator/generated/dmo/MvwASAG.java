...
public class MvwASAG implements DmcAttributeSchemaIF {
    ...
    public final static DmcAttributeInfo __broadcastEvent = new DmcAttributeInfo("broadcastEvent", 815, "String", ValueTypeEnum.SINGLE, DataTypeEnum.PERSISTENT, true);
    ...
    public final static DmcAttributeInfo __displayData = new DmcAttributeInfo("displayData", 816, "DisplayDataSpec", ValueTypeEnum.SINGLE, DataTypeEnum.PERSISTENT, true);
    ...
    static {
        ...
        _SmAp.put(__broadcastEvent.id,__broadcastEvent);
        ...
        _SmAp.put(__displayData.id,__displayData);
