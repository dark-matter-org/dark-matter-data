...
import org.dmd.mvw.tools.mvwgenerator.generated.types.DmcTypeEventWithArgsMV;           // Required type
...
import org.dmd.mvw.tools.mvwgenerator.types.EventWithArgs;                              // Primitive type and !auxiliary class
...
public class ViewDMO  extends MvwDefinitionDMO  implements DmcNamedObjectIF, Serializable  {
    ...
    public final static DmcAttributeInfo __broadcast = new DmcAttributeInfo("broadcast",822,"EventWithArgs",ValueTypeEnum.MULTI,DataTypeEnum.PERSISTENT,false);
    public final static DmcAttributeInfo __broadcastOnly = new DmcAttributeInfo("broadcastOnly",823,"EventWithArgs",ValueTypeEnum.MULTI,DataTypeEnum.PERSISTENT,false);
    ...
    public final static DmcAttributeInfo __displayDMO = new DmcAttributeInfo("displayDMO",816,"DisplayDataSpec",ValueTypeEnum.SINGLE,DataTypeEnum.PERSISTENT,false);
    ...
    @SuppressWarnings("unchecked")
    // org.dmd.dms.util.GenUtility.formatMV(GenUtility.java:802)
    public Iterator<EventWithArgs> getBroadcast(){
        DmcTypeEventWithArgsMV attr = (DmcTypeEventWithArgsMV) get(__broadcast);
        if (attr == null)
            return( ((List<EventWithArgs>) Collections.EMPTY_LIST).iterator());

        return(attr.getMV());
    }

    /**
     * @return The nth EventWithArgs value.
     */
    // org.dmd.dms.util.GenUtility.formatMV(GenUtility.java:814)
    public EventWithArgs getNthBroadcast(int i){
        DmcTypeEventWithArgsMV attr = (DmcTypeEventWithArgsMV) get(__broadcast);
        if (attr == null)
            return(null);
     ...
     * @param value EventWithArgs
     */
    // org.dmd.dms.util.GenUtility.formatMV(GenUtility.java:827)
    public DmcAttribute<?> addBroadcast(EventWithArgs value) {
        DmcAttribute<?> attr = get(__broadcast);
        if (attr == null)
            attr = new DmcTypeEventWithArgsMV(__broadcast);
    ...
    /**
     * Returns true if we contain a valued keyed by the specified EventWithArgs.
     * @param value EventWithArgs
     */
    // org.dmd.dms.util.GenUtility.formatMV(GenUtility.java:869)
     ...
     */
    // org.dmd.dms.util.GenUtility.formatMV(GenUtility.java:960)
    public DmcAttribute<?> delBroadcast(Object value) throws DmcValueException {
        DmcAttribute<?> attr = get(__broadcast);
        
        if ( (attr == null) && (getModifier()!= null))
            delFromEmptyAttribute(new DmcTypeEventWithArgsMV(__broadcast), value);
        else
            attr = del(__broadcast, value);
        
        return(attr);
    }

    /**
     * Deletes a broadcast from the specified value.
     * @param value EventWithArgs
     */
    // org.dmd.dms.util.GenUtility.formatMV(GenUtility.java:976)
    public DmcAttribute<?> delBroadcast(EventWithArgs value) {
        DmcAttribute<?> attr = get(__broadcast);
    ...
    @SuppressWarnings("unchecked")
    // org.dmd.dms.util.GenUtility.formatMV(GenUtility.java:802)
    public Iterator<EventWithArgs> getBroadcastOnly(){
        DmcTypeEventWithArgsMV attr = (DmcTypeEventWithArgsMV) get(__broadcastOnly);
        if (attr == null)
            return( ((List<EventWithArgs>) Collections.EMPTY_LIST).iterator());
     ...
     */
    // org.dmd.dms.util.GenUtility.formatMV(GenUtility.java:814)
    public EventWithArgs getNthBroadcastOnly(int i){
        DmcTypeEventWithArgsMV attr = (DmcTypeEventWithArgsMV) get(__broadcastOnly);
        if (attr == null)
            return(null);
     ...
     */
    // org.dmd.dms.util.GenUtility.formatMV(GenUtility.java:827)
    public DmcAttribute<?> addBroadcastOnly(EventWithArgs value) {
        DmcAttribute<?> attr = get(__broadcastOnly);
        if (attr == null)
            attr = new DmcTypeEventWithArgsMV(__broadcastOnly);
     ...
     */
    // org.dmd.dms.util.GenUtility.formatMV(GenUtility.java:960)
    public DmcAttribute<?> delBroadcastOnly(Object value) throws DmcValueException {
        DmcAttribute<?> attr = get(__broadcastOnly);
        
        if ( (attr == null) && (getModifier()!= null))
            delFromEmptyAttribute(new DmcTypeEventWithArgsMV(__broadcastOnly), value);
        else
            attr = del(__broadcastOnly, value);
        
        return(attr);
    }

    /**
     * Deletes a broadcastOnly from the specified value.
     * @param value EventWithArgs
     */
    // org.dmd.dms.util.GenUtility.formatMV(GenUtility.java:976)
    public DmcAttribute<?> delBroadcastOnly(EventWithArgs value) {
        DmcAttribute<?> attr = get(__broadcastOnly);
    ...
    public DisplayDataSpec getDisplayDMO(){
        DmcTypeDisplayDataSpecSV attr = (DmcTypeDisplayDataSpecSV) get(__displayDMO);
        if (attr == null)
            return(null);
    ...
    public void setDisplayDMO(DisplayDataSpec value) {
        ...
        if (attr == null)
            attr = new DmcTypeDisplayDataSpecSV(__displayDMO);
        
        try{
            attr.set(value);
            set(__displayDMO,attr);
        }
        catch(DmcValueException ex){
            throw(new IllegalStateException("The type specific set() method shouldn't throw exceptions!",ex));
        }
