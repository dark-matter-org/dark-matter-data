...
import org.dmd.mvw.tools.mvwgenerator.generated.dmo.MultipleDMOSelectedEventDMO; // primitive type
...
public class MultipleDMOSelectedEventREF extends DmcNamedObjectNontransportableREF<MultipleDMOSelectedEventDMO> {
    ...
    public MultipleDMOSelectedEventREF(){
    }

    public MultipleDMOSelectedEventREF(MultipleDMOSelectedEventDMO o){
         object = o;
         myName = (DmcTypeCamelCaseNameSV)o.getObjectNameAttribute();
    }

    public MultipleDMOSelectedEventREF(CamelCaseName n) throws DmcValueException {
         object = null;
         myName = new DmcTypeCamelCaseNameSV();
         myName.set(n);
    }

    public MultipleDMOSelectedEventREF(String n) throws DmcValueException {
         object = null;
         myName = new DmcTypeCamelCaseNameSV();
         myName.set(n);
    }

    public MultipleDMOSelectedEventREF(MultipleDMOSelectedEventREF original){
        myName = original.myName;
        object = original.object;
    }

    public void setObject(MultipleDMOSelectedEventDMO o){
         object = o;
         myName = (DmcTypeCamelCaseNameSV)o.getObjectNameAttribute();
    }
     ...
     */
    public MultipleDMOSelectedEventREF cloneMe(){
