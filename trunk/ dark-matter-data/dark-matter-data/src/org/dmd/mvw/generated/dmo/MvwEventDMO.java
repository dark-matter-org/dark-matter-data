...
public class MvwEventDMO  extends MvwDefinitionDMO  implements DmcNamedObjectIF, Serializable  {
    ...
    @Override
    public MvwEventDMO getNew(){
        MvwEventDMO rc = new MvwEventDMO();
        return(rc);
    }

    @Override
    public MvwEventDMO getSlice(DmcSliceInfo info){
        MvwEventDMO rc = new MvwEventDMO();
        populateSlice(rc,info);
        return(rc);
    }

    public MvwEventDMO(DmcTypeModifierMV mods) {
        super("MvwEvent");
        modrec(true);
        setModifier(mods);
    }

    public MvwEventDMO getModificationRecorder(){
        MvwEventDMO rc = new MvwEventDMO(new DmcTypeModifierMV());
