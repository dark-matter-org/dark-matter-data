...
import org.dmd.mvw.generated.dmo.EventChannelDMO;                    // Type specific set/add
import org.dmd.mvw.generated.dmo.MvwEventDMO;                        // Base class
import org.dmd.mvw.generated.types.DmcTypeEventChannelREFSV;         // Reference type
import org.dmd.mvw.generated.types.EventChannelREF;                  // Helper class
...
public class BroadcastEventDMO  extends MvwEventDMO  implements DmcNamedObjectIF, Serializable  {

    public final static String constructionClassName = "BroadcastEvent";
    ...
    public final static DmcAttributeInfo __channel = new DmcAttributeInfo("channel",806,"EventChannel",ValueTypeEnum.SINGLE,DataTypeEnum.PERSISTENT,false);
    ...
    static {
        ...
        _ImAp.put(__channel.id,__channel);
        ...
        _SmAp.put(__channel.name,__channel);
    ...
    public BroadcastEventDMO() {
        super("BroadcastEvent");
    }

    protected BroadcastEventDMO(String oc) {
        super(oc);
    }
    ...
    @Override
    public BroadcastEventDMO getNew(){
        BroadcastEventDMO rc = new BroadcastEventDMO();
        return(rc);
    }

    @Override
    public BroadcastEventDMO getSlice(DmcSliceInfo info){
        BroadcastEventDMO rc = new BroadcastEventDMO();
        populateSlice(rc,info);
        return(rc);
    }

    public BroadcastEventDMO(DmcTypeModifierMV mods) {
        super("BroadcastEvent");
        modrec(true);
        setModifier(mods);
    }
    ...
    public boolean equals(Object obj){
        if (obj instanceof BroadcastEventDMO){
            return( getObjectName().equals( ((BroadcastEventDMO) obj).getObjectName()) );
        }
        return(false);
    }
    ...
    public EventChannelREF getChannel(){
        DmcTypeEventChannelREFSV attr = (DmcTypeEventChannelREFSV) get(__channel);
        if (attr == null)
            return(null);
    ...
    /**
     * Returns the reference to EventChannel without attempting lazy resolution (if turned on).
     */
    public EventChannelREF getChannelREF(){
        DmcTypeEventChannelREFSV attr = (DmcTypeEventChannelREFSV) get(__channel);
        if (attr == null)
            return(null);
    ...
    /**
     * Sets channel to the specified value.
     * @param value EventChannelDMO
     */
    //  org.dmd.dms.util.GenUtility.formatSV(GenUtility.java:566)
    public void setChannel(EventChannelDMO value) {
        DmcAttribute<?> attr = get(__channel);
        if (attr == null)
            attr = new DmcTypeEventChannelREFSV(__channel);
    ...
    /**
     * Sets channel to the specified value.
     * @param value A value compatible with DmcTypeEventChannelREFSV
     */
    //  org.dmd.dms.util.GenUtility.formatSV(GenUtility.java:668)
    public void setChannel(Object value) throws DmcValueException {
        DmcAttribute<?> attr = get(__channel);
        if (attr == null)
            attr = new DmcTypeEventChannelREFSV(__channel);
