...
import org.dmd.mvw.generated.dmo.MvwEventDMO;                 // Class not auxiliary or abstract

/**
 * The MvwEvent is an autonomous definition of some kind of event that is
 * fired and handled by components ina Model-View-Whatever application.
...
abstract public class MvwEventDMW extends MvwDefinition implements DmcNamedObjectIF {
    ...
    public MvwEventDMW() {
        super(new MvwEventDMO(), org.dmd.mvw.generated.MvwSchemaAG._MvwEvent);
    }

    public MvwEventDMW(DmcTypeModifierMV mods) {
        super(new MvwEventDMO(mods), org.dmd.mvw.generated.MvwSchemaAG._MvwEvent);
    }

    public MvwEvent getModificationRecorder(){
        MvwEvent rc = new MvwEvent();
        rc.setCamelCaseName(getCamelCaseName());
        rc.setModifier(new DmcTypeModifierMV());
        return(rc);
    }

    public MvwEventDMW(MvwEventDMO obj) {
        super(obj, org.dmd.mvw.generated.MvwSchemaAG._MvwEvent);
    }
