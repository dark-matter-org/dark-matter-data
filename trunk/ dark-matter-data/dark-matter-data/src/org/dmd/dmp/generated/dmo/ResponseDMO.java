...
public class ResponseDMO  extends DmcObject  {
     ...
     */
    public void setResponseText(Object value){
        try{
            set(_responseText, DmcTypeString.class, value);
        }
        catch(Exception ex){
            ex.printStackTrace();
        }
     ...
     */
    public void setResponseCategory(Object value){
        try{
            set(_responseCategory, DmcTypeResponseCategoryEnum.class, value);
        }
        catch(Exception ex){
            ex.printStackTrace();
        }
     ...
     */
    public void setLastResponse(Object value){
        try{
            set(_lastResponse, DmcTypeBoolean.class, value);
        }
        catch(Exception ex){
            ex.printStackTrace();
        }
     ...
     */
    public void setResponseType(Object value){
        try{
            set(_responseType, DmcTypeResponseTypeEnum.class, value);
        }
        catch(Exception ex){
            ex.printStackTrace();
        }
