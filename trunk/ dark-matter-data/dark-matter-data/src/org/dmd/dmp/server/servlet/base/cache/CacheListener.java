...
abstract public class CacheListener {
    ...
    protected final CacheRegistration	registration;
    
    protected CacheListener(CacheRegistration reg){
    	registration = reg;
    	listenerId = registration.getCache().getNextListenerID();
    }
    ...
    public void processCacheEvent(DMPEvent event){
        ...
        if ( (event.getOriginatorID() == registration.getID()) && (!event.isNotifyOriginator()) ){
    ...
    /**
     * This method is called once an event has passed through processCacheEvent method.
     * @param event the event ot be handled.
     */
    abstract void handleEvent(DMPEvent event);
