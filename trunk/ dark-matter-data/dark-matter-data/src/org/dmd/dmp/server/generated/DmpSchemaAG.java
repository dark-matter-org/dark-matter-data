...
public class DmpSchemaAG extends SchemaDefinition {
    ...
    private DmpSchemaAG() throws DmcValueException {
        SchemaDefinitionDMO me = (SchemaDefinitionDMO) this.getDmcObject();
        me.setName("dmp");
        me.setSchemaPackage("org.dmd.dmp.shared");
        me.setDmwPackage("org.dmd.dmp.server");
        me.setFile("F:/AASoftDev/workspace/dark-matter-data/src/org/dmd/dmp/shared/schema/v0dot1/dmp.dms");
    ...
    public static DmpSchemaAG getInstance() throws DmcValueException{
    	   if (instance == null)
    		   instance = new DmpSchemaAG();
    	   return(instance);
    }
}
