...
/**
 * The ResponseIteratorDMW will cast from an underlying ResponseREF class to 
 * the associated wrapper class: Response when accessing object references in a wrapper context.
 * <P>
 ...
 */
public class ResponseIterableDMW extends DmwContainerIterator<Response,ResponseREF> {
    ...
    public ResponseIterableDMW(Iterator<ResponseREF> it){
        super(it);
    }
