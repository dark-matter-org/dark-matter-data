...
public class NotifyResponseDMO  extends ResponseDMO  implements DmcNamedObjectIF, Serializable  {
    ...
    public NotifyResponseDMO getModificationRecorder(){
        NotifyResponseDMO rc = new NotifyResponseDMO(new DmcTypeModifierMV());
