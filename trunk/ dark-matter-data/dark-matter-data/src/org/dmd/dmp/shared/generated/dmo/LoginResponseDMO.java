...
public class LoginResponseDMO  extends ResponseDMO  implements DmcNamedObjectIF, Serializable  {
    ...
    public LoginResponseDMO getModificationRecorder(){
        LoginResponseDMO rc = new LoginResponseDMO(new DmcTypeModifierMV());
