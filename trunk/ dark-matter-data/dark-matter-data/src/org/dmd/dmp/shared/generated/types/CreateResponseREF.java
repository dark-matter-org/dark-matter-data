...
public class CreateResponseREF extends DmcNamedObjectNontransportableREF<CreateResponseDMO> {
    ...
    public CreateResponseREF(){
    }

    public CreateResponseREF(CreateResponseDMO o){
         object = o;
         myName = (DmcTypeIntegerNameSV)o.getObjectNameAttribute();
    }

    public CreateResponseREF(String n) throws DmcValueException {
         object = null;
         myName = new DmcTypeIntegerNameSV();
         myName.set(n);
    }

    public CreateResponseREF(CreateResponseREF original){
        myName = original.myName;
        object = original.object;
    }

    public void setObject(CreateResponseDMO o){
         object = o;
         myName = (DmcTypeIntegerNameSV)o.getObjectNameAttribute();
    }
     ...
     */
    public CreateResponseREF cloneMe(){
