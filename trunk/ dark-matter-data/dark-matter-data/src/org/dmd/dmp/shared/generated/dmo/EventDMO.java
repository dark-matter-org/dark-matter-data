...
public class EventDMO  extends DMPMessageDMO  implements DmcNamedObjectIF,de.novanic.eventservice.client.event.Event  {
    ...
    public EventDMO getOneOfMe() {
        EventDMO rc = new EventDMO(constructionClassName);
        return(rc);
    }
