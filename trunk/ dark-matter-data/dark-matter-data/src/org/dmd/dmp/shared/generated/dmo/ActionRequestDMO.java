...
public class ActionRequestDMO  extends RequestDMO  {
    ...
    public final static String _actionTrigger = "actionTrigger";
    ...
    public DmcObject getActionTrigger(){
        DmcTypeDmcObject attr = (DmcTypeDmcObject) get(_actionTrigger);
        if (attr == null)
            return(null);
    ...
    public void setActionTrigger(Object value) throws DmcValueException {
        DmcAttribute attr = get(_actionTrigger);
        if (attr == null)
            attr = new DmcTypeDmcObject();
        
        attr.set(value);
        set(_actionTrigger,attr);
    }
