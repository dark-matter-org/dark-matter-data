...
public class DmcTypeDMPMessageREFSET extends DmcTypeDMPMessageREF implements Serializable {
    ...
    public Iterator<DMPMessageREF> getMV(){
        Set<DMPMessageREF> clone = null;
        if (attrInfo.valueType == ValueTypeEnum.HASHSET)
            clone = new HashSet<DMPMessageREF>(value);
        else
            clone = new TreeSet<DMPMessageREF>(value);
        return(clone.iterator());
    }
    
    public Set<DMPMessageREF> getMVCopy(){
        Set<DMPMessageREF> clone = null;
        if (attrInfo.valueType == ValueTypeEnum.HASHSET)
            clone = new HashSet<DMPMessageREF>(value);
        else
