...
public class DmcTypeSetRequestREF extends DmcTypeNamedObjectREF<SetRequestREF, IntegerName> {
     ...
     */
    public DmcTypeSetRequestREF cloneMe(){
        DmcTypeSetRequestREF rc = new DmcTypeSetRequestREF();
        if (mv == null){
            rc.sv = sv.cloneMe();
        }
        else{
            rc.mv = new ArrayList<SetRequestREF>();
            for(SetRequestREF val : mv){
     ...
     */
    public DmcTypeSetRequestREF getOneOfMe(){
        DmcTypeSetRequestREF rc = new DmcTypeSetRequestREF();
        return(rc);
    }
     ...
     */
    public SetRequestREF cloneValue(SetRequestREF val){
        SetRequestREF rc = new SetRequestREF(val);
        return(rc);
    }
