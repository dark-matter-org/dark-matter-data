...
public class DmcTypeResponseREF extends DmcTypeNamedObjectREF<ResponseREF, IntegerName> {
     ...
     */
    public DmcTypeResponseREF cloneMe(){
        DmcTypeResponseREF rc = new DmcTypeResponseREF();
        if (mv == null){
            rc.sv = sv.cloneMe();
        }
        else{
            rc.mv = new ArrayList<ResponseREF>();
            for(ResponseREF val : mv){
     ...
     */
    public DmcTypeResponseREF getOneOfMe(){
        DmcTypeResponseREF rc = new DmcTypeResponseREF();
        return(rc);
    }
     ...
     */
    public ResponseREF cloneValue(ResponseREF val){
        ResponseREF rc = new ResponseREF(val);
        return(rc);
    }
