...
public class DmcTypeNotifyRequestREF extends DmcTypeNamedObjectREF<NotifyRequestREF, IntegerName> {
     ...
     */
    public DmcTypeNotifyRequestREF cloneMe(){
        DmcTypeNotifyRequestREF rc = new DmcTypeNotifyRequestREF();
        if (mv == null){
            rc.sv = sv.cloneMe();
        }
        else{
            rc.mv = new ArrayList<NotifyRequestREF>();
            for(NotifyRequestREF val : mv){
     ...
     */
    public DmcTypeNotifyRequestREF getOneOfMe(){
        DmcTypeNotifyRequestREF rc = new DmcTypeNotifyRequestREF();
        return(rc);
    }
     ...
     */
    public NotifyRequestREF cloneValue(NotifyRequestREF val){
        NotifyRequestREF rc = new NotifyRequestREF(val);
        return(rc);
    }
