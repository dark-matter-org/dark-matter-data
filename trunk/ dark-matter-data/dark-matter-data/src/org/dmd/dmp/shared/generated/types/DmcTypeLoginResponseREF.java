...
public class DmcTypeLoginResponseREF extends DmcTypeNamedObjectREF<LoginResponseREF, IntegerName> {
     ...
     */
    public DmcTypeLoginResponseREF cloneMe(){
        DmcTypeLoginResponseREF rc = new DmcTypeLoginResponseREF();
        if (mv == null){
            rc.sv = sv.cloneMe();
        }
        else{
            rc.mv = new ArrayList<LoginResponseREF>();
            for(LoginResponseREF val : mv){
     ...
     */
    public LoginResponseREF cloneValue(LoginResponseREF val){
        LoginResponseREF rc = new LoginResponseREF(val);
        return(rc);
    }
