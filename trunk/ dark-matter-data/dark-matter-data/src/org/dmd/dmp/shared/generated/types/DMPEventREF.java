...
public class DMPEventREF extends DmcNamedObjectNontransportableREF<DMPEventDMO> {
    ...
    public DMPEventREF(DMPEventDMO o){
         object = o;
         myName = (DmcTypeIntegerNameSV)o.getObjectNameAttribute();
    }

    public DMPEventREF(String n) throws DmcValueException {
         object = null;
         myName = new DmcTypeIntegerNameSV();
         myName.set(n);
    }

    public DMPEventREF(DMPEventREF original){
        myName = original.myName;
        object = original.object;
    }

    public void setObject(DMPEventDMO o){
         object = o;
         myName = (DmcTypeIntegerNameSV)o.getObjectNameAttribute();
    }
