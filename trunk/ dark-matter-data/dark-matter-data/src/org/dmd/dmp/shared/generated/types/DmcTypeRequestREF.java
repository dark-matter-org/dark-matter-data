...
public class DmcTypeRequestREF extends DmcTypeNamedObjectREF<RequestREF, IntegerName> {
     ...
     */
    public DmcTypeRequestREF cloneMe(){
        DmcTypeRequestREF rc = new DmcTypeRequestREF();
        if (mv == null){
            rc.sv = sv.cloneMe();
        }
        else{
            rc.mv = new ArrayList<RequestREF>();
            for(RequestREF val : mv){
     ...
     */
    public RequestREF cloneValue(RequestREF val){
        RequestREF rc = new RequestREF(val);
        return(rc);
    }
