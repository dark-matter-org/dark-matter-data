...
public class DmcTypeRequestREF extends DmcAttribute<RequestDMO> {

    public DmcTypeRequestREF(){
    }

    protected RequestDMO typeCheck(Object value) throws DmcValueException {
        RequestDMO rc = null;
        ...
        if (value instanceof RequestDMO){
            ...
            throw(new DmcValueException("Object of class: " + value.getClass().getName() + " passed where object compatible with RequestDMO expected."));
        }
        return(rc);
    }
     ...
     */
    public DmcTypeRequestREF getOneOfMe(){
        DmcTypeRequestREF rc = new DmcTypeRequestREF();
        return(rc);
    }
     ...
     */
    public RequestDMO cloneValue(RequestDMO val){
        return(null);
    }
