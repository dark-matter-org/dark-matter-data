...
import org.dmd.dmp.shared.generated.types.DmcTypeFileModeEnumSV;

@SuppressWarnings("serial")
// org.dmd.dms.util.AdapterFormatter.dumpAdapter(AdapterFormatter.java:50)
// Called from: org.dmd.dms.util.AdapterFormatter.dumpAdapterSV(AdapterFormatter.java:12)
public class FileModeEnumSVAdapter extends DmcTypeFileModeEnumSV implements DmcAdapterIF {

    DmcTypeFileModeEnumSV existingValue;
    ...
    public void setExisting(DmcAttribute<?> attr) {
    	existingValue = (DmcTypeFileModeEnumSV) attr;
    	if (existingValue != null)
    		value = existingValue.getSVCopy();
    }
