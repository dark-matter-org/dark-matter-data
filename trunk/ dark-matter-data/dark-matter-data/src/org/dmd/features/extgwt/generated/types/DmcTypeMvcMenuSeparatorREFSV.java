...
public class DmcTypeMvcMenuSeparatorREFSV extends DmcTypeMvcMenuSeparatorREF implements Serializable {
    ...
    public DmcTypeMvcMenuSeparatorREFSV getNew(DmcAttributeInfo ai){
        return(new DmcTypeMvcMenuSeparatorREFSV(ai));
    }
