...
import org.dmd.features.extgwt.generated.dmo.MvcViewDMO; // primitive type
...
public class MvcViewREF extends DmcNamedObjectNontransportableREF<MvcViewDMO> {
    ...
    public MvcViewREF(MvcViewDMO o){
         object = o;
         myName = (DmcTypeStringNameSV)o.getObjectNameAttribute();
    }

    public MvcViewREF(StringName n) throws DmcValueException {
         object = null;
         myName = new DmcTypeStringNameSV(__name);
         myName.set(n);
    }

    public MvcViewREF(String n) throws DmcValueException {
         object = null;
         myName = new DmcTypeStringNameSV(__name);
         myName.set(n);
    }
