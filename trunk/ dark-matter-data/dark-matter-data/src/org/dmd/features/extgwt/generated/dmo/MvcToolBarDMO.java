...
public class MvcToolBarDMO  extends MvcMenuDMO  implements DmcNamedObjectIF, Serializable  {
    ...
    public MvcToolBarDMO getModificationRecorder(){
        MvcToolBarDMO rc = new MvcToolBarDMO(new DmcTypeModifierMV());
        rc.setName(getName());
        return(rc);
    }
