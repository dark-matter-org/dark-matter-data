...
public class DmcTypeMvcApplicationREFSV extends DmcTypeMvcApplicationREF implements Serializable {
    ...
    public DmcTypeMvcApplicationREFSV getNew(DmcAttributeInfo ai){
        return(new DmcTypeMvcApplicationREFSV(ai));
    }
