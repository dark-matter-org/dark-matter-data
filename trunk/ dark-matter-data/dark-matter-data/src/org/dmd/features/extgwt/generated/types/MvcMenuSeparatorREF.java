...
import org.dmd.features.extgwt.generated.dmo.MvcMenuSeparatorDMO; // primitive type
...
public class MvcMenuSeparatorREF extends DmcNamedObjectNontransportableREF<MvcMenuSeparatorDMO> {
    ...
    public MvcMenuSeparatorREF(MvcMenuSeparatorDMO o){
         object = o;
         myName = (DmcTypeStringNameSV)o.getObjectNameAttribute();
    }

    public MvcMenuSeparatorREF(StringName n) throws DmcValueException {
         object = null;
         myName = new DmcTypeStringNameSV(__name);
         myName.set(n);
    }

    public MvcMenuSeparatorREF(String n) throws DmcValueException {
         object = null;
         myName = new DmcTypeStringNameSV(__name);
         myName.set(n);
    }
