...
public class DmcTypeUserREFMV extends DmcTypeUserREF implements Serializable {
    ...
    protected ArrayList<UserREF> value;
    ...
    public UserREF getMVnth(int index){
        synchronized(this){
            if (value == null)
                return(null);
    ...
    public UserREF setMVnth(int index, Object v) throws DmcValueException {
        synchronized(this){
            if (attrInfo.indexSize == 0)
            ...
            if (value == null){
                value = new ArrayList<UserREF>(attrInfo.indexSize);
