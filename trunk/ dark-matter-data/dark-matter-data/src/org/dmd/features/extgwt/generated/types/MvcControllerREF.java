...
import org.dmd.features.extgwt.generated.dmo.MvcControllerDMO; // primitive type
...
public class MvcControllerREF extends DmcNamedObjectNontransportableREF<MvcControllerDMO> {
    ...
    public MvcControllerREF(MvcControllerDMO o){
         object = o;
         myName = (DmcTypeStringNameSV)o.getObjectNameAttribute();
    }

    public MvcControllerREF(StringName n) throws DmcValueException {
         object = null;
         myName = new DmcTypeStringNameSV(__name);
         myName.set(n);
    }

    public MvcControllerREF(String n) throws DmcValueException {
         object = null;
         myName = new DmcTypeStringNameSV(__name);
         myName.set(n);
    }
