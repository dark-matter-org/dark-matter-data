...
public class DmcTypeMvcMultiViewREFSET extends DmcTypeMvcMultiViewREF implements Serializable {
    ...
    Set<MvcMultiViewREF> value;
    
    public DmcTypeMvcMultiViewREFSET(){
        value = null;
    }
    
    public DmcTypeMvcMultiViewREFSET(DmcAttributeInfo ai){
        super(ai);
        initValue();
    }
    ...
    void initValue(){
        if (attrInfo.valueType == ValueTypeEnum.HASHSET)
            value = new HashSet<MvcMultiViewREF>();
        else
            value = new TreeSet<MvcMultiViewREF>();
    }
    
    @Override
    public DmcTypeMvcMultiViewREFSET getNew(){
        return(new DmcTypeMvcMultiViewREFSET(attrInfo));
    }
    
    @Override
    public DmcAttribute<MvcMultiViewREF> cloneIt(){
        DmcTypeMvcMultiViewREFSET rc = getNew();
