...
public class MvcServerEventDMO  extends MvcDefinitionDMO  implements DmcNamedObjectIF  {
    ...
    public MvcServerEventDMO() {
        super("MvcServerEvent",_ImAp,_SmAp);
    }
    ...
    public MvcServerEventDMO(String oc, Map<Integer,DmcAttributeInfo> im, Map<String,DmcAttributeInfo> sm){
        super(oc,im,sm);
    }

    public MvcServerEventDMO(MvcServerEventDMO original) {
        super(original.getConstructionClassName());
        System.out.println("Full object cloning not implemented...");
    }

    @Override
    public MvcServerEventDMO getOneOfMe() {
        MvcServerEventDMO rc = new MvcServerEventDMO(this.getConstructionClassName());
        return(rc);
    }
    ...
    public String getEventDataType(){
        DmcTypeString attr = (DmcTypeString) get(__eventDataType);
        if (attr == null)
            return(null);
    ...
    public void setEventDataType(String value) {
        ...
        if (attr == null)
            attr = new DmcTypeString(__eventDataType);
