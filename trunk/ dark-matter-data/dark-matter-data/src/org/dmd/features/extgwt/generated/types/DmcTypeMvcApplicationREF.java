...
public class DmcTypeMvcApplicationREF extends DmcTypeNamedObjectREF<MvcApplicationREF> {
     ...
     */
    public DmcTypeMvcApplicationREF cloneMe(){
        DmcTypeMvcApplicationREF rc = new DmcTypeMvcApplicationREF();
        if (mv == null){
            rc.sv = sv.cloneMe();
        }
        else{
            rc.mv = new ArrayList<MvcApplicationREF>();
            for(MvcApplicationREF val : mv){
     ...
     */
    public DmcTypeMvcApplicationREF getOneOfMe(){
        DmcTypeMvcApplicationREF rc = new DmcTypeMvcApplicationREF();
        return(rc);
    }
     ...
     */
    public MvcApplicationREF cloneValue(MvcApplicationREF val){
        MvcApplicationREF rc = new MvcApplicationREF(val);
        return(rc);
    }
