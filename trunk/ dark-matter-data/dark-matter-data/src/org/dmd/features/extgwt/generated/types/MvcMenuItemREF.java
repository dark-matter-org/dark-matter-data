...
import org.dmd.features.extgwt.generated.dmo.MvcMenuItemDMO; // primitive type
...
public class MvcMenuItemREF extends DmcNamedObjectNontransportableREF<MvcMenuItemDMO> {
    ...
    public MvcMenuItemREF(){
    }

    public MvcMenuItemREF(MvcMenuItemDMO o){
         object = o;
         myName = (DmcTypeStringNameSV)o.getObjectNameAttribute();
    }

    public MvcMenuItemREF(StringName n) throws DmcValueException {
         object = null;
         myName = new DmcTypeStringNameSV(__name);
         myName.set(n);
    }

    public MvcMenuItemREF(String n) throws DmcValueException {
         object = null;
         myName = new DmcTypeStringNameSV(__name);
         myName.set(n);
    }

    public MvcMenuItemREF(MvcMenuItemREF original){
        myName = original.myName;
        object = original.object;
    }

    public void setObject(MvcMenuItemDMO o){
         object = o;
         myName = (DmcTypeStringNameSV)o.getObjectNameAttribute();
    }
