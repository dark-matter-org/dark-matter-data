...
public class DmcTypeMvcRegistryItemREFSET extends DmcTypeMvcRegistryItemREF implements Serializable {
    ...
    public Iterator<MvcRegistryItemREF> getMV(){
        Set<MvcRegistryItemREF> clone = null;
        if (attrInfo.valueType == ValueTypeEnum.HASHSET)
            clone = new HashSet<MvcRegistryItemREF>(value);
        else
            clone = new TreeSet<MvcRegistryItemREF>(value);
        return(clone.iterator());
    }
    
    public Set<MvcRegistryItemREF> getMVCopy(){
        Set<MvcRegistryItemREF> clone = null;
        if (attrInfo.valueType == ValueTypeEnum.HASHSET)
            clone = new HashSet<MvcRegistryItemREF>(value);
        else
