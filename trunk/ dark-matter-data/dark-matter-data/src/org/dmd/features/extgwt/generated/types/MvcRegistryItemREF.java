...
import org.dmd.features.extgwt.generated.dmo.MvcRegistryItemDMO; // primitive type
...
public class MvcRegistryItemREF extends DmcNamedObjectNontransportableREF<MvcRegistryItemDMO> {
    ...
    public MvcRegistryItemREF(MvcRegistryItemDMO o){
         object = o;
         myName = (DmcTypeStringNameSV)o.getObjectNameAttribute();
    }

    public MvcRegistryItemREF(StringName n) throws DmcValueException {
         object = null;
         myName = new DmcTypeStringNameSV(__name);
         myName.set(n);
    }

    public MvcRegistryItemREF(String n) throws DmcValueException {
         object = null;
         myName = new DmcTypeStringNameSV(__name);
         myName.set(n);
    }
