...
public class DmcTypeMvcServerEventREF extends DmcTypeNamedObjectREF<MvcServerEventREF> {
     ...
     */
    public DmcTypeMvcServerEventREF cloneMe(){
        DmcTypeMvcServerEventREF rc = new DmcTypeMvcServerEventREF();
        if (mv == null){
            rc.sv = sv.cloneMe();
        }
        else{
            rc.mv = new ArrayList<MvcServerEventREF>();
            for(MvcServerEventREF val : mv){
     ...
     */
    public DmcTypeMvcServerEventREF getOneOfMe(){
        DmcTypeMvcServerEventREF rc = new DmcTypeMvcServerEventREF();
        return(rc);
    }
     ...
     */
    public MvcServerEventREF cloneValue(MvcServerEventREF val){
        MvcServerEventREF rc = new MvcServerEventREF(val);
        return(rc);
    }
