...
import org.dmd.features.extgwt.generated.dmo.MvcConfigDMO; // primitive type
...
public class MvcConfigREF extends DmcNamedObjectNontransportableREF<MvcConfigDMO> {
    ...
    public MvcConfigREF(MvcConfigDMO o){
         object = o;
         myName = (DmcTypeStringNameSV)o.getObjectNameAttribute();
    }

    public MvcConfigREF(StringName n) throws DmcValueException {
         object = null;
         myName = new DmcTypeStringNameSV(__name);
         myName.set(n);
    }

    public MvcConfigREF(String n) throws DmcValueException {
         object = null;
         myName = new DmcTypeStringNameSV(__name);
         myName.set(n);
    }
