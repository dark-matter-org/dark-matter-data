...
import org.dmd.features.extgwt.generated.dmo.MvcSubMenuDMO; // primitive type
...
public class MvcSubMenuREF extends DmcNamedObjectNontransportableREF<MvcSubMenuDMO> {
    ...
    public MvcSubMenuREF(MvcSubMenuDMO o){
         object = o;
         myName = (DmcTypeStringNameSV)o.getObjectNameAttribute();
    }

    public MvcSubMenuREF(StringName n) throws DmcValueException {
         object = null;
         myName = new DmcTypeStringNameSV(__name);
         myName.set(n);
    }

    public MvcSubMenuREF(String n) throws DmcValueException {
         object = null;
         myName = new DmcTypeStringNameSV(__name);
         myName.set(n);
    }
