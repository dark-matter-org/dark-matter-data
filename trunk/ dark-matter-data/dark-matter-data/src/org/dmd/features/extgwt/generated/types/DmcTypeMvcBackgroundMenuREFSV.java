...
public class DmcTypeMvcBackgroundMenuREFSV extends DmcTypeMvcBackgroundMenuREF {
    
    MvcBackgroundMenuREF value;
    
    public DmcTypeMvcBackgroundMenuREFSV(){
    
    }
    
    public DmcTypeMvcBackgroundMenuREFSV(DmcAttributeInfo ai){
        super(ai);
    }
    ...
    @Override
    public MvcBackgroundMenuREF getSV(){
        return(value);
    }
