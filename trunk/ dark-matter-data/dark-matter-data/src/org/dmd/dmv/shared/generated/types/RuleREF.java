...
import org.dmd.dmv.shared.generated.dmo.RuleDMO; // primitive type
...
public class RuleREF extends DmcNamedObjectNontransportableREF<RuleDMO> {
    ...
    public RuleREF(RuleDMO o){
         object = o;
         myName = (DmcTypeStringNameSV)o.getObjectNameAttribute();
    }

    public RuleREF(StringName n) throws DmcValueException {
         object = null;
         myName = new DmcTypeStringNameSV(__name);
         myName.set(n);
    }

    public RuleREF(String n) throws DmcValueException {
         object = null;
         myName = new DmcTypeStringNameSV(__name);
         myName.set(n);
    }
