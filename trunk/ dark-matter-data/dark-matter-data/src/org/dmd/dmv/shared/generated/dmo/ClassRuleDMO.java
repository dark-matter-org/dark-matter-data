...
abstract public class ClassRuleDMO  extends RuleDMO  {
    ...
    public final static String _applyToClass = "applyToClass";
    ...
    public ClassDefinitionREF getApplyToClass(){
        DmcTypeClassDefinitionREF attr = (DmcTypeClassDefinitionREF) get(_applyToClass);
        if (attr == null)
            return(null);
    ...
    public void setApplyToClass(Object value) throws DmcValueException {
        DmcAttribute attr = get(_applyToClass);
        if (attr == null)
            attr = new DmcTypeClassDefinitionREF();
        
        attr.set(value);
        set(_applyToClass,attr);
    }
