...
public class DmgConfigDMO  extends DmwWrapperDMO  {
    ...
    public DmcAttribute delConfigSuffix(Object value) throws DmcValueException {
        DmcAttribute attr = del(_configSuffix, value);
        if (attr == null){
            DmcTypeModifier mods = getModifier();
            if (mods != null){
                attr = new DmcTypeString();
                attr.setName(_configSuffix);
                attr.add(value);
    ...
    public Iterator<Generator> getGenerator(){
        ...
        if (attr == null)
            return(Collections.<Generator> emptyList().iterator());
    ...
    public DmcAttribute delGenerator(Object value) throws DmcValueException {
        DmcAttribute attr = del(_generator, value);
        if (attr == null){
            DmcTypeModifier mods = getModifier();
            if (mods != null){
                attr = new DmcTypeGenerator();
                attr.setName(_generator);
                attr.add(value);
                mods.add(new Modification(ModifyTypeEnum.DEL, attr));
            }
        }
