...
abstract public class DmcTypeNamedObjectREFNEW<DMO, HELPER extends DmcNamedObjectREF> extends DmcAttribute<HELPER> {
		
	/**
	 * Constructs a new object reference attribute. 
	 */
	public DmcTypeNamedObjectREFNEW(){
	}
...
//            throw(new DmcValueException("Object of class: " + value.getClass().getName() + " passed where object compatible with " + dmoClass.getClass().getName() + " or String expected."));			
		}
