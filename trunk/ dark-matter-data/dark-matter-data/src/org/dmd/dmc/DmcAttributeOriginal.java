...
abstract public class DmcAttributeOriginal<E> implements Cloneable, Serializable, Comparable<String> {
	 ...
	 * Constructs a new attribute value holder.
	 */
	public DmcAttributeOriginal(DmcAttributeInfo ai){
		ID			= ai.id;
		attrInfo	= ai;
		name		= ai.name;
	 ...
	 */
	abstract protected DmcAttributeOriginal<?> getOneOfMe();
...
//		return(mv.contains(obj));
	...
	public DmcAttributeOriginal clone(){
    	DmcAttributeOriginal rc = this.getOneOfMe();
...
//        }
	 ...
	 * @param sb       The buffer where we're building the output.
	 */
	private void addJSONNameWithPadding(DmcAttributeOriginal<?> attr, StringBuffer sb, int padding){
