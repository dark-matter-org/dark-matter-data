 ...
 * Generated from: org.dmd.dmg.generators.DMWGenerator.getAuxClassHeader(DMWGenerator.java:854)
 */
public class LDAPClassAUX {
     ...
     */
    @SuppressWarnings("unchecked")
    static public AttributeDefinitionDMW getNamingAttribute(DmwWrapperBase corew){
     ...
     */
    @SuppressWarnings("unchecked")
    static public void setNamingAttribute(DmwWrapperBase corew, AttributeDefinitionDMW value) throws DmcValueException {
        DmcAttribute attr = corew.getDmcObject().get(_namingAttribute);
        if (attr == null)
