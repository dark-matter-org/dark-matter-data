...
import org.dmd.dms.generated.types.DmcTypeDebugEnumSV;

@SuppressWarnings("serial")
public class DebugEnumSVAdapter extends DmcTypeDebugEnumSV implements DmcAdapterIF {

    DmcTypeDebugEnumSV existingValue;
    ...
    public void setExisting(DmcAttribute<?> attr) {
    	existingValue = (DmcTypeDebugEnumSV) attr;
    	if (existingValue != null)
    		value = existingValue.getSVCopy();
    }
