...
abstract public class DmcTypeSchemaDefinitionREF extends DmcTypeNamedObjectREF<SchemaDefinitionREF, StringName> {
    ...
    public SchemaDefinitionREF typeCheck(Object value) throws DmcValueException {
        ...
        if (value instanceof SchemaDefinitionREF)
            ...
            throw(new DmcValueException("Object of class:" + value.getClass().getName() + " passed where a SchemaDefinitionREF/DMO or DmcObjectNameIF expected."));
        return(rc);
    }
