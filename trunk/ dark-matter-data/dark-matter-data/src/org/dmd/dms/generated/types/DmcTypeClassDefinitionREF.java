...
public class DmcTypeClassDefinitionREF extends DmcTypeNamedObjectREF<ClassDefinitionREF, StringName> {
    ...
    public DmcTypeClassDefinitionREF cloneMe(){
        DmcTypeClassDefinitionREF rc = new DmcTypeClassDefinitionREF();
        if (mv == null){
            rc.sv = sv.cloneMe();
        }
        else{
            rc.mv = new ArrayList<ClassDefinitionREF>();
            for(ClassDefinitionREF val : mv){
     ...
     */
    public DmcTypeClassDefinitionREF getOneOfMe(){
        DmcTypeClassDefinitionREF rc = new DmcTypeClassDefinitionREF();
        return(rc);
    }
