...
abstract public class DmcTypeClassDefinitionREF extends DmcTypeNamedObjectREF<ClassDefinitionREF, StringName> implements Serializable {
    ...
    public ClassDefinitionREF typeCheck(Object value) throws DmcValueException {
        ...
        if (value instanceof ClassDefinitionREF)
            ...
            throw(new DmcValueException("Object of class:" + value.getClass().getName() + " passed where a ClassDefinitionREF/DMO or DmcObjectNameIF expected."));
        return(rc);
    }
