...
public class DmcTypeDataTypeEnum extends DmcAttribute<DataTypeEnum>{
     ...
     */
    public DmcTypeDataTypeEnum getOneOfMe(){
        DmcTypeDataTypeEnum rc = new DmcTypeDataTypeEnum();
        return(rc);
    }
    ...
    public void deserializeSV(DmcInputStreamIF dis) throws Exception {
        sv = DataTypeEnum.get(dis.readShort());
    }
    
    @Override
    public void deserializeMV(DmcInputStreamIF dis) throws Exception {
        if (mv == null)
            mv = new ArrayList<DataTypeEnum>();
        
        mv.add(DataTypeEnum.get(dis.readShort()));
    }
