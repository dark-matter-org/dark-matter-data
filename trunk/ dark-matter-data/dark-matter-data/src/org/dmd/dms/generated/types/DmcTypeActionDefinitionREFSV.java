...
public class DmcTypeActionDefinitionREFSV extends DmcTypeActionDefinitionREF {
    ...
    public ActionDefinitionREF add(Object v){
    ...
    public ActionDefinitionREF getMVnth(){
