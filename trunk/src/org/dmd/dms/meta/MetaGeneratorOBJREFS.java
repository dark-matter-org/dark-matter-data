 ...
 */
public class MetaGeneratorOBJREFS implements DmcUncheckedOIFHandlerIF {
...
//				typeDef.addValue("name", cn + "REF");
				...
				typeDef.addValue("helperClassName", 	"org.dmd.dms.generated.types." + cn + "REF");
				typeDef.addValue("primitiveType", 		"org.dmd.dms.generated.dmo." + cn + "DMO");
				typeDef.addValue("wrapperClassName", 	classDef.getSV("javaClass"));
				typeDef.addValue("internallyGenerated", "true");
				typeDef.addValue("isRefType", 			"true");
//				typeDef.addValue("isEnumType", 			"false");
				...
				classDef.addValue("internalTypeRef", tn);
	...
	void dumpMetaSchema(String od) throws IOException, ResultException {
		...
		setAttributeValues(out, typeDefs, pf, true);
	...
	private void setAttributeValues(BufferedWriter out, TreeMap<String, DmcUncheckedObject> objects, PrintfFormat pf) throws IOException, ResultException {
		setAttributeValues(out, objects, pf, false);
	}

	private void setAttributeValues(BufferedWriter out, TreeMap<String, DmcUncheckedObject> objects, PrintfFormat pf, boolean typedefs) throws IOException, ResultException {
		...
		while (it.hasNext()) {
			...
			if (typedefs){
				if (obj.getSV("internallyGenerated") != null){
					if (obj.getSV("isRefType") != null)
						objName = objName + "REF";
				}
			}
