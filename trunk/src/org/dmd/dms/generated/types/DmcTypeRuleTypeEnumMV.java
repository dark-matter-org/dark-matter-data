 ...
 *    Called from: org.dmd.dms.meta.MetaGenerator.dumpDerivedTypes(MetaGenerator.java:525)
 */
...
public class DmcTypeRuleTypeEnumMV extends DmcTypeRuleTypeEnum implements Serializable {
    ...
    public DmcTypeRuleTypeEnumMV getNew(){
        return(new DmcTypeRuleTypeEnumMV(attrInfo));
    }
    ...
    public RuleTypeEnum setMVnth(int index, Object v) throws DmcValueException {
        synchronized(this){
            ...
            if (value == null){
                value = new ArrayList<RuleTypeEnum>(attrInfo.indexSize);
