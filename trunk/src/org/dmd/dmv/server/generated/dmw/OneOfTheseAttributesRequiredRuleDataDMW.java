 ...
 */
public class OneOfTheseAttributesRequiredRuleDataDMW extends RuleData {
    ...
    public OneOfTheseAttributesRequiredRuleDataDMW getModificationRecorder(){
        OneOfTheseAttributesRequiredRuleDataDMW rc = new OneOfTheseAttributesRequiredRuleDataDMW(new DmcTypeModifierMV(MetaDMSAG.__modify));
        return(rc);
    }
