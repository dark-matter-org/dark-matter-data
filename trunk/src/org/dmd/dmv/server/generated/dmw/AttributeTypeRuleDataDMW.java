 ...
 */
public class AttributeTypeRuleDataDMW extends RuleData implements DmcNamedObjectIF {
    ...
    public AttributeTypeRuleDataDMW getModificationRecorder(){
        AttributeTypeRuleDataDMW rc = new AttributeTypeRuleDataDMW();
    ...
    public DmcAttribute<?> getObjectNameAttribute(){
        return(((AttributeTypeRuleDataDMO) core).getObjectNameAttribute());
    }

    public boolean equals(Object obj){
        if (obj instanceof AttributeTypeRuleDataDMW){
            return( getObjectName().equals( ((AttributeTypeRuleDataDMW) obj).getObjectName()) );
        }
        return(false);
    }
