...
abstract public class AppViewMVC extends View {
    ...
    public void handleEvent(AppEvent event) {
        ...
        if (type == AppEventsMVC.MailappLogin) {
            handleMailappLoginEvent(event);
        }
    ...
    /**
     * The derived class must overload this method to handle the mailapp.login event.
     * <P>
     * The login event is injected when the system is ready to start the login
     * process. It isn't emitted by any controller/view.
     */
    abstract protected void handleMailappLoginEvent(AppEvent event);
