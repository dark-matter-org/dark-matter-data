...
public class ContainsMVAdapter extends DmcTypeContainsMV implements DmcAdapterIF {

    transient DmcTypeContainsMV existingValue;

    public ContainsMVAdapter(DmcAttributeInfo ai){
    	   super(ai);
    }
    ...
    public void setExisting(DmcAttribute<?> attr) {
    	existingValue = (DmcTypeContainsMV) attr;
    	if (existingValue != null)
    		value = existingValue.getMVCopy();
    }
