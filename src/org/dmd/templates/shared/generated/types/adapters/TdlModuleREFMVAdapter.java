...
public class TdlModuleREFMVAdapter extends DmcTypeTdlModuleREFMV implements DmcAdapterIF {

    transient DmcTypeTdlModuleREFMV existingValue;

    public TdlModuleREFMVAdapter(DmcAttributeInfo ai){
    	   super(ai);
    }
    ...
    public void setExisting(DmcAttribute<?> attr) {
    	existingValue = (DmcTypeTdlModuleREFMV) attr;
    	if (existingValue != null)
    		value = existingValue.getMVCopy();
    }
