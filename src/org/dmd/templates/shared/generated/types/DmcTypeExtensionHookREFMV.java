...
public class DmcTypeExtensionHookREFMV extends DmcTypeExtensionHookREF implements Serializable {
    
    private final static Iterator<ExtensionHookREF> emptyList = (new ArrayList<ExtensionHookREF>()).iterator();
    
    protected ArrayList<ExtensionHookREF> value;
    
    public DmcTypeExtensionHookREFMV(){
    
    }
    
    public DmcTypeExtensionHookREFMV(DmcAttributeInfo ai){
        super(ai);
    }
    
    @Override
    public DmcTypeExtensionHookREFMV getNew(){
        return(new DmcTypeExtensionHookREFMV(getAttributeInfo()));
    }
    ...
    public DmcAttribute<ExtensionHookREF> cloneIt(){
        synchronized(this){
            DmcTypeExtensionHookREFMV rc = getNew();
    
            if (value == null)
                return(rc);
    
            if (getAttributeInfo().indexSize == 0){
                for(ExtensionHookREF val: value)
                try {
                    rc.add(val);
    ...
    public ExtensionHookREF add(Object v) throws DmcValueException {
        synchronized(this){
            ...
            if (value == null)
                value = new ArrayList<ExtensionHookREF>();
            value.add(rc);
            return(rc);
        }
    }
    ...
    public Iterator<ExtensionHookREF> getMV(){
        synchronized(this){
            ...
            ArrayList<ExtensionHookREF> clone = new ArrayList<ExtensionHookREF>(value);
            return(clone.iterator());
        }
    }
    
    // org.dmd.dms.util.GenUtility.dumpMVType(GenUtility.java:2618)
    public ArrayList<ExtensionHookREF> getMVCopy(){
        synchronized(this){
            if (value == null)
                return(new ArrayList<ExtensionHookREF>());
            else 
                return(new ArrayList<ExtensionHookREF>(value));
        }
    }
    ...
    public ExtensionHookREF getMVnth(int index){
        synchronized(this){
            if (value == null)
                return(null);
    ...
    public ExtensionHookREF setMVnth(int index, Object v) throws DmcValueException {
        synchronized(this){
            if (getAttributeInfo().indexSize == 0)
            ...
            if (value == null){
                value = new ArrayList<ExtensionHookREF>(getAttributeInfo().indexSize);
