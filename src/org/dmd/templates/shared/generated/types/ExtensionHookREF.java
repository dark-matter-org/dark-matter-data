...
import org.dmd.templates.shared.generated.dmo.ExtensionHookDMO; // primitive type
...
public class ExtensionHookREF extends DmcNamedObjectNontransportableREF<ExtensionHookDMO> {
    ...
    public ExtensionHookREF(){
    }

    public ExtensionHookREF(ExtensionHookDMO o){
         object = o;
         myName = (DmcTypeDefinitionNameSV)o.getObjectNameAttribute();
    }

    public ExtensionHookREF(DefinitionName n) throws DmcValueException {
         object = null;
         myName = new DmcTypeDefinitionNameSV(__name);
         myName.set(n);
    }

    public ExtensionHookREF(String n) throws DmcValueException {
         object = null;
         myName = new DmcTypeDefinitionNameSV(__name);
         myName.set(n);
    }

    public ExtensionHookREF(ExtensionHookREF original){
        myName = original.myName;
        object = original.object;
    }

    public void setObject(ExtensionHookDMO o){
         object = o;
         if (object != null)
             myName = (DmcTypeDefinitionNameSV)o.getObjectNameAttribute();
    }
     ...
     */
    public ExtensionHookREF cloneMe(){
