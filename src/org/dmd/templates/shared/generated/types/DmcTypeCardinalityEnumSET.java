...
public class DmcTypeCardinalityEnumSET extends DmcTypeCardinalityEnum implements Serializable {
    
     private final static Iterator<CardinalityEnum> emptyList =  (new HashSet<CardinalityEnum>()).iterator();
    ...
    void initValue(){
        if (getAttributeInfo().valueType == ValueTypeEnum.HASHSET)
            value = new HashSet<CardinalityEnum>();
        else
            value = new TreeSet<CardinalityEnum>();
    }
    
    @Override
    public DmcTypeCardinalityEnumSET getNew(){
        return(new DmcTypeCardinalityEnumSET(getAttributeInfo()));
    }
    ...
    public DmcAttribute<CardinalityEnum> cloneIt(){
        synchronized(this){
            DmcTypeCardinalityEnumSET rc = getNew();
    ...
    public Iterator<CardinalityEnum> getMV(){
        synchronized(this){
            ...
            if (getAttributeInfo().valueType == ValueTypeEnum.HASHSET)
                return( (new HashSet<CardinalityEnum>(value)).iterator() );
            else
                return( (new TreeSet<CardinalityEnum>(value)).iterator() );
        }
    }
        ...
        synchronized(this){
            if (getAttributeInfo().valueType == ValueTypeEnum.HASHSET){
                if (value == null)
                    ...
                    return(new HashSet<CardinalityEnum>(value));
            }
            else{
                if (value == null)
                    return(new TreeSet<CardinalityEnum>(value));
                else
                    return(new TreeSet<CardinalityEnum>(value));
            }
        }
