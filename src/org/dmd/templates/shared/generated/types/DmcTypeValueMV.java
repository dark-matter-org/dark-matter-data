...
import org.dmd.templates.shared.generated.types.DmcTypeValue;    // DmcType import
/**
...
public class DmcTypeValueMV extends DmcTypeValue implements Serializable {
    
    private final static Iterator<Value> emptyList = (new ArrayList<Value>()).iterator();
    
    protected ArrayList<Value> value;
    
    public DmcTypeValueMV(){
    
    }
    
    public DmcTypeValueMV(DmcAttributeInfo ai){
        super(ai);
    }
    
    @Override
    public DmcTypeValueMV getNew(){
        return(new DmcTypeValueMV(getAttributeInfo()));
    }
    ...
    public Iterator<Value> getMV(){
        synchronized(this){
            ...
            ArrayList<Value> clone = new ArrayList<Value>(value);
            return(clone.iterator());
        }
    }
    
    // org.dmd.dms.util.GenUtility.dumpMVType(GenUtility.java:2618)
    public ArrayList<Value> getMVCopy(){
        synchronized(this){
            if (value == null)
    ...
    public Value setMVnth(int index, Object v) throws DmcValueException {
        synchronized(this){
            if (getAttributeInfo().indexSize == 0)
            ...
            if (value == null){
                value = new ArrayList<Value>(getAttributeInfo().indexSize);
