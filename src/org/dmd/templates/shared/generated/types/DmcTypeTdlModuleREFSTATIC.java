...
/**
 * The DmcTypeTdlModuleREFSTATIC provides static access to functions used to manage values of type TdlModuleREF
...
public class DmcTypeTdlModuleREFSTATIC {
    ...
    public static DmcTypeTdlModuleREFSTATIC instance;
    static DmcTypeTdlModuleREFSV typeHelper;
    
    static {
        instance = new DmcTypeTdlModuleREFSTATIC();
    }
    ...
    public TdlModuleREF typeCheck(Object value) throws DmcValueException {
    	   return(typeHelper.typeCheck(value));
    }
    
    public TdlModuleREF cloneValue(TdlModuleREF value) throws DmcValueException {
