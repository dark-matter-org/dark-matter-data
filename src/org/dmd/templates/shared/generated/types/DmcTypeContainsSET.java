...
public class DmcTypeContainsSET extends DmcTypeContains implements Serializable {
    
     private final static Iterator<Contains> emptyList =  (new HashSet<Contains>()).iterator();
    ...
    void initValue(){
        if (getAttributeInfo().valueType == ValueTypeEnum.HASHSET)
            value = new HashSet<Contains>();
        else
            value = new TreeSet<Contains>();
    }
    
    @Override
    public DmcTypeContainsSET getNew(){
        return(new DmcTypeContainsSET(getAttributeInfo()));
    }
    ...
    public Iterator<Contains> getMV(){
        synchronized(this){
            ...
            if (getAttributeInfo().valueType == ValueTypeEnum.HASHSET)
                return( (new HashSet<Contains>(value)).iterator() );
            else
                return( (new TreeSet<Contains>(value)).iterator() );
        }
    }
        ...
        synchronized(this){
            if (getAttributeInfo().valueType == ValueTypeEnum.HASHSET){
                if (value == null)
                    ...
                    return(new HashSet<Contains>(value));
            }
            else{
                if (value == null)
                    return(new TreeSet<Contains>(value));
                else
                    return(new TreeSet<Contains>(value));
            }
        }
