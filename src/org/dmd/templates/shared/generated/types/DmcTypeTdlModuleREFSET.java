...
public class DmcTypeTdlModuleREFSET extends DmcTypeTdlModuleREF implements Serializable {
    
     private final static Iterator<TdlModuleREF> emptyList =  (new HashSet<TdlModuleREF>()).iterator();
    ...
    void initValue(){
        if (getAttributeInfo().valueType == ValueTypeEnum.HASHSET)
            value = new HashSet<TdlModuleREF>();
        else
            value = new TreeSet<TdlModuleREF>();
    }
    
    @Override
    public DmcTypeTdlModuleREFSET getNew(){
        return(new DmcTypeTdlModuleREFSET(getAttributeInfo()));
    }
    ...
    public DmcAttribute<TdlModuleREF> cloneIt(){
        synchronized(this){
            DmcTypeTdlModuleREFSET rc = getNew();
    ...
    public Iterator<TdlModuleREF> getMV(){
        synchronized(this){
            ...
            if (getAttributeInfo().valueType == ValueTypeEnum.HASHSET)
                return( (new HashSet<TdlModuleREF>(value)).iterator() );
            else
                return( (new TreeSet<TdlModuleREF>(value)).iterator() );
        }
    }
        ...
        synchronized(this){
            if (getAttributeInfo().valueType == ValueTypeEnum.HASHSET){
                if (value == null)
                    ...
                    return(new HashSet<TdlModuleREF>(value));
            }
            else{
                if (value == null)
                    return(new TreeSet<TdlModuleREF>(value));
                else
                    return(new TreeSet<TdlModuleREF>(value));
            }
        }
