...
public class DmcTypeCardinalityEnumMV extends DmcTypeCardinalityEnum implements Serializable {
    
    private final static Iterator<CardinalityEnum> emptyList = (new ArrayList<CardinalityEnum>()).iterator();
    
    protected ArrayList<CardinalityEnum> value;
    
    public DmcTypeCardinalityEnumMV(){
    
    }
    
    public DmcTypeCardinalityEnumMV(DmcAttributeInfo ai){
        super(ai);
    }
    
    @Override
    public DmcTypeCardinalityEnumMV getNew(){
        return(new DmcTypeCardinalityEnumMV(getAttributeInfo()));
    }
    ...
    public CardinalityEnum add(Object v) throws DmcValueException {
        synchronized(this){
            ...
            if (value == null)
                value = new ArrayList<CardinalityEnum>();
            value.add(rc);
            return(rc);
        }
    }
    ...
    public Iterator<CardinalityEnum> getMV(){
        synchronized(this){
            ...
            ArrayList<CardinalityEnum> clone = new ArrayList<CardinalityEnum>(value);
    ...
    public ArrayList<CardinalityEnum> getMVCopy(){
        synchronized(this){
            if (value == null)
                return(new ArrayList<CardinalityEnum>());
            else 
                return(new ArrayList<CardinalityEnum>(value));
        }
    }
    ...
    public CardinalityEnum setMVnth(int index, Object v) throws DmcValueException {
        synchronized(this){
            ...
            if (value == null){
                value = new ArrayList<CardinalityEnum>(getAttributeInfo().indexSize);
    ...
    public boolean contains(Object v){
        synchronized(this){
            ...
            try {
                CardinalityEnum val = typeCheck(v);
