...
public class DmcTypeValueSV extends DmcTypeValue implements Serializable {
    ...
    public DmcTypeValueSV getNew(){
        return(new DmcTypeValueSV(getAttributeInfo()));
    }
    
    public DmcTypeValueSV getNew(DmcAttributeInfo ai){
        return(new DmcTypeValueSV(ai));
    }
    
    @Override
    // org.dmd.dms.util.GenUtility.dumpSVType(GenUtility.java:2183)
    public DmcAttribute<Value> cloneIt(){
        DmcTypeValueSV rc = getNew();
        rc.value = value;
        return(rc);
    }
    
    // org.dmd.dms.util.GenUtility.dumpSVType(GenUtility.java:2194)
    public Value getSVCopy(){
        if (value == null)
            return(null);
