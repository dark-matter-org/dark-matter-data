...
public class DmcTypeValueSET extends DmcTypeValue implements Serializable {
    
     private final static Iterator<Value> emptyList =  (new HashSet<Value>()).iterator();
    ...
    public DmcTypeValueSET getNew(){
        return(new DmcTypeValueSET(getAttributeInfo()));
    }
    ...
    public Iterator<Value> getMV(){
        synchronized(this){
            ...
            if (getAttributeInfo().valueType == ValueTypeEnum.HASHSET)
                return( (new HashSet<Value>(value)).iterator() );
            else
                return( (new TreeSet<Value>(value)).iterator() );
        }
    }
    ...
    public Set<Value> getMVCopy(){
        synchronized(this){
            if (getAttributeInfo().valueType == ValueTypeEnum.HASHSET){
                ...
                if (value == null)
                    return(new TreeSet<Value>(value));
                else
                    return(new TreeSet<Value>(value));
            }
        }
