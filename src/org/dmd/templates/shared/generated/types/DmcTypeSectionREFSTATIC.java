...
/**
 * The DmcTypeSectionREFSTATIC provides static access to functions used to manage values of type SectionREF
...
public class DmcTypeSectionREFSTATIC {
    ...
    public static DmcTypeSectionREFSTATIC instance;
    static DmcTypeSectionREFSV typeHelper;
    
    static {
        instance = new DmcTypeSectionREFSTATIC();
    }
    ...
    public SectionREF typeCheck(Object value) throws DmcValueException {
    	   return(typeHelper.typeCheck(value));
    }
    
    public SectionREF cloneValue(SectionREF value) throws DmcValueException {
