...
public class DmcTypeSectionREFMV extends DmcTypeSectionREF implements Serializable {
    
    private final static Iterator<SectionREF> emptyList = (new ArrayList<SectionREF>()).iterator();
    
    protected ArrayList<SectionREF> value;
    
    public DmcTypeSectionREFMV(){
    
    }
    
    public DmcTypeSectionREFMV(DmcAttributeInfo ai){
        super(ai);
    }
    
    @Override
    public DmcTypeSectionREFMV getNew(){
        return(new DmcTypeSectionREFMV(getAttributeInfo()));
    }
    ...
    public DmcAttribute<SectionREF> cloneIt(){
        synchronized(this){
            DmcTypeSectionREFMV rc = getNew();
    
            if (value == null)
                return(rc);
    
            if (getAttributeInfo().indexSize == 0){
                for(SectionREF val: value)
                try {
                    rc.add(val);
    ...
    public SectionREF add(Object v) throws DmcValueException {
        synchronized(this){
            ...
            if (value == null)
                value = new ArrayList<SectionREF>();
            value.add(rc);
            return(rc);
        }
    }
    ...
    public Iterator<SectionREF> getMV(){
        synchronized(this){
            ...
            ArrayList<SectionREF> clone = new ArrayList<SectionREF>(value);
            return(clone.iterator());
        }
    }
    
    // org.dmd.dms.util.GenUtility.dumpMVType(GenUtility.java:2618)
    public ArrayList<SectionREF> getMVCopy(){
        synchronized(this){
            if (value == null)
                return(new ArrayList<SectionREF>());
            else 
                return(new ArrayList<SectionREF>(value));
        }
    }
    ...
    public SectionREF getMVnth(int index){
        synchronized(this){
            if (value == null)
                return(null);
    ...
    public SectionREF setMVnth(int index, Object v) throws DmcValueException {
        synchronized(this){
            if (getAttributeInfo().indexSize == 0)
            ...
            if (value == null){
                value = new ArrayList<SectionREF>(getAttributeInfo().indexSize);
