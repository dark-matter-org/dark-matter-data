...
public class DmcTypeContainedElementREFSV extends DmcTypeContainedElementREF implements Serializable {
    ...
    public DmcTypeContainedElementREFSV(DmcAttributeInfo ai){
        super(ai);
    }
    ...
    public DmcTypeContainedElementREFSV getNew(DmcAttributeInfo ai){
        return(new DmcTypeContainedElementREFSV(ai));
    }
    
    @Override
    // org.dmd.dms.util.GenUtility.dumpSVType(GenUtility.java:2203)
    public DmcAttribute<ContainedElementREF> cloneIt(){
        DmcTypeContainedElementREFSV rc = getNew();
        rc.value = value;
        return(rc);
    }
    ...
    public ContainedElementREF set(Object v) throws DmcValueException {
