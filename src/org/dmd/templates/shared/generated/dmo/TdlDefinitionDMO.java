...
import org.dmd.templates.shared.generated.types.DmcTypeTdlModuleREFSV;         // Reference type - (GenUtility.java:311)
...
abstract public class TdlDefinitionDMO  extends DSDefinitionDMO  implements DmcNamedObjectIF, Serializable  {

    public final static String constructionClassName = "TdlDefinition";
    ...
    public boolean equals(Object obj){
        if (obj instanceof TdlDefinitionDMO){
            return( getObjectName().equals( ((TdlDefinitionDMO) obj).getObjectName()) );
        }
        return(false);
    }
    ...
    /**
     * @return the TdlModuleREF
     */
    public TdlModuleREF getDefinedInTdlModule(){
        DmcTypeTdlModuleREFSV attr = (DmcTypeTdlModuleREFSV) get(DmtdlDMSAG.__definedInTdlModule);
        if (attr == null)
            return(null);
    ...
    /**
     * @return the reference to TdlModule without attempting lazy resolution (if turned on).
     */
     ...
     * @param value TdlModuleDMO
     */
    // org.dmd.dms.util.GenUtility.formatSV(GenUtility.java:723)
    public void setDefinedInTdlModule(TdlModuleDMO value) {
        DmcAttribute<?> attr = get(DmtdlDMSAG.__definedInTdlModule);
        if (attr == null)
            attr = new DmcTypeTdlModuleREFSV(DmtdlDMSAG.__definedInTdlModule);
        else
            ((DmcTypeTdlModuleREFSV)attr).removeBackReferences();
        
        try{
            attr.set(value);
            set(DmtdlDMSAG.__definedInTdlModule,attr);
        }
        catch(DmcValueException ex){
            throw(new IllegalStateException("The type specific set() method shouldn't throw exceptions!",ex));
        }
    ...
    /**
     * Sets definedInTdlModule to the specified value.
     * @param value A value compatible with DmcTypeTdlModuleREFSV
     * @throws DmcValueException if value is not correct
     */
    // org.dmd.dms.util.GenUtility.formatSV(GenUtility.java:892)
    ...
    public void remDefinedInTdlModule(){
         rem(DmtdlDMSAG.__definedInTdlModule);
    }
