...
public class DmtdlDMSAGAMAP {
    ...
    static protected void initSmAp(HashMap<Integer, DmcAttributeInfo> _SmAp){
        ...
        _SmAp.put(DmtdlDMSAG.__endsWithText.id,DmtdlDMSAG.__endsWithText);
        _SmAp.put(DmtdlDMSAG.__format.id,DmtdlDMSAG.__format);
        _SmAp.put(DmtdlDMSAG.__hasTemplate.id,DmtdlDMSAG.__hasTemplate);
