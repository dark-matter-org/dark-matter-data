...
public class DmcTypeGenerationContextREFSV extends DmcTypeGenerationContextREF implements Serializable {
    
    protected GenerationContextREF value;
    
    public DmcTypeGenerationContextREFSV(){
    
    }
    
    public DmcTypeGenerationContextREFSV(DmcAttributeInfo ai){
        super(ai);
    }
    ...
    public GenerationContextREF set(Object v) throws DmcValueException {
    ...
    @Override
    public GenerationContextREF getSV(){
        return(value);
    }
