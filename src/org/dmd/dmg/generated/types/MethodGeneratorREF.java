...
import org.dmd.dmg.generated.dmo.MethodGeneratorDMO; // primitive type
...
public class MethodGeneratorREF extends DmcNamedObjectNontransportableREF<MethodGeneratorDMO> {
    ...
    public final static DmcAttributeInfo __name = new DmcAttributeInfo("name",-999998,"StringName",ValueTypeEnum.SINGLE,DataTypeEnum.PERSISTENT);
    ...
    public MethodGeneratorREF(MethodGeneratorDMO o){
         object = o;
         myName = (DmcTypeStringNameSV)o.getObjectNameAttribute();
    }

    public MethodGeneratorREF(StringName n) throws DmcValueException {
         object = null;
         myName = new DmcTypeStringNameSV(__name);
         myName.set(n);
    }

    public MethodGeneratorREF(String n) throws DmcValueException {
         object = null;
         myName = new DmcTypeStringNameSV(__name);
         myName.set(n);
    }

    public MethodGeneratorREF(MethodGeneratorREF original){
        myName = original.myName;
        object = original.object;
    }

    public void setObject(MethodGeneratorDMO o){
         object = o;
         if (object != null)
             myName = (DmcTypeStringNameSV)o.getObjectNameAttribute();
    }
