...
public class GenerationContextREFSVAdapter extends DmcTypeGenerationContextREFSV implements DmcAdapterIF {
    ...
    transient DmcTypeGenerationContextREFSV existingValue;

    public GenerationContextREFSVAdapter(DmcAttributeInfo ai){
    	   super(ai);
    }
    ...
    public void setExisting(DmcAttribute<?> attr) {
    	existingValue = (DmcTypeGenerationContextREFSV) attr;
    	if (existingValue != null)
    		value = existingValue.getSVCopy();
    }
