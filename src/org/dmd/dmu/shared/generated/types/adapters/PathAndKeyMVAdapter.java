...
public class PathAndKeyMVAdapter extends DmcTypePathAndKeyMV implements DmcAdapterIF {

    transient DmcTypePathAndKeyMV existingValue;

    public PathAndKeyMVAdapter(DmcAttributeInfo ai){
    	   super(ai);
    }
    ...
    public void setExisting(DmcAttribute<?> attr) {
    	existingValue = (DmcTypePathAndKeyMV) attr;
    	if (existingValue != null)
    		value = existingValue.getMVCopy();
    }
