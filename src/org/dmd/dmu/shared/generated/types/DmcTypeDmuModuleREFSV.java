...
public class DmcTypeDmuModuleREFSV extends DmcTypeDmuModuleREF implements Serializable {
    
    protected DmuModuleREF value;
    
    public DmcTypeDmuModuleREFSV(){
    
    }
    
    public DmcTypeDmuModuleREFSV(DmcAttributeInfo ai){
        super(ai);
    }
    
    public DmcTypeDmuModuleREFSV getNew(){
        return(new DmcTypeDmuModuleREFSV(getAttributeInfo()));
    }
    
    public DmcTypeDmuModuleREFSV getNew(DmcAttributeInfo ai){
        return(new DmcTypeDmuModuleREFSV(ai));
    }
    
    @Override
    // org.dmd.dms.util.GenUtility.dumpSVType(GenUtility.java:2203)
    public DmcAttribute<DmuModuleREF> cloneIt(){
        DmcTypeDmuModuleREFSV rc = getNew();
        rc.value = value;
        return(rc);
    }
    
    // org.dmd.dms.util.GenUtility.dumpSVType(GenUtility.java:2214)
    public DmuModuleREF getSVCopy(){
        if (value == null)
            return(null);
    ...
    public DmuModuleREF set(Object v) throws DmcValueException {
