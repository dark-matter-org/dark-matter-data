...
public class DmcTypeDmuDefinitionREFMV extends DmcTypeDmuDefinitionREF implements Serializable {
    
    private final static Iterator<DmuDefinitionREF> emptyList = (new ArrayList<DmuDefinitionREF>()).iterator();
    
    protected ArrayList<DmuDefinitionREF> value;
    
    public DmcTypeDmuDefinitionREFMV(){
    
    }
    
    public DmcTypeDmuDefinitionREFMV(DmcAttributeInfo ai){
        super(ai);
    }
    
    @Override
    public DmcTypeDmuDefinitionREFMV getNew(){
        return(new DmcTypeDmuDefinitionREFMV(getAttributeInfo()));
    }
    ...
    public DmcAttribute<DmuDefinitionREF> cloneIt(){
        synchronized(this){
            DmcTypeDmuDefinitionREFMV rc = getNew();
    
            if (value == null)
                return(rc);
    
            if (getAttributeInfo().indexSize == 0){
                for(DmuDefinitionREF val: value)
                try {
                    rc.add(val);
    ...
    public DmuDefinitionREF add(Object v) throws DmcValueException {
        synchronized(this){
            ...
            if (value == null)
                value = new ArrayList<DmuDefinitionREF>();
            value.add(rc);
            return(rc);
        }
    }
    ...
    public Iterator<DmuDefinitionREF> getMV(){
        synchronized(this){
            ...
            ArrayList<DmuDefinitionREF> clone = new ArrayList<DmuDefinitionREF>(value);
            return(clone.iterator());
        }
    }
    
    // org.dmd.dms.util.GenUtility.dumpMVType(GenUtility.java:2638)
    public ArrayList<DmuDefinitionREF> getMVCopy(){
        synchronized(this){
            if (value == null)
                return(new ArrayList<DmuDefinitionREF>());
            else 
                return(new ArrayList<DmuDefinitionREF>(value));
        }
    }
    ...
    public DmuDefinitionREF getMVnth(int index){
        synchronized(this){
            if (value == null)
                return(null);
    ...
    public DmuDefinitionREF setMVnth(int index, Object v) throws DmcValueException {
        synchronized(this){
            if (getAttributeInfo().indexSize == 0)
            ...
            if (value == null){
                value = new ArrayList<DmuDefinitionREF>(getAttributeInfo().indexSize);
