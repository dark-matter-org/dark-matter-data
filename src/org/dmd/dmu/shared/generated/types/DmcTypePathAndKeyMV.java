...
public class DmcTypePathAndKeyMV extends DmcTypePathAndKey implements Serializable {
    
    private final static Iterator<PathAndKey> emptyList = (new ArrayList<PathAndKey>()).iterator();
    ...
    public DmcTypePathAndKeyMV getNew(){
        return(new DmcTypePathAndKeyMV(getAttributeInfo()));
    }
    ...
    public PathAndKey add(Object v) throws DmcValueException {
        synchronized(this){
            ...
            if (value == null)
                value = new ArrayList<PathAndKey>();
            value.add(rc);
            return(rc);
        }
    }
    ...
    public Iterator<PathAndKey> getMV(){
        synchronized(this){
            ...
            ArrayList<PathAndKey> clone = new ArrayList<PathAndKey>(value);
    ...
    public ArrayList<PathAndKey> getMVCopy(){
        synchronized(this){
            if (value == null)
                ...
                return(new ArrayList<PathAndKey>(value));
        }
    }
    ...
    public PathAndKey setMVnth(int index, Object v) throws DmcValueException {
        synchronized(this){
            ...
            if (value == null){
                value = new ArrayList<PathAndKey>(getAttributeInfo().indexSize);
