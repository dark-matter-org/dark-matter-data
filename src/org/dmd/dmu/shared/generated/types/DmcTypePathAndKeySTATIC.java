...
/**
 * The DmcTypePathAndKeySTATIC provides static access to functions used to manage values of type PathAndKey
...
public class DmcTypePathAndKeySTATIC {
    ...
    public static DmcTypePathAndKeySTATIC instance;
    static DmcTypePathAndKeySV typeHelper;
    
    static {
        instance = new DmcTypePathAndKeySTATIC();
    }
    ...
    public PathAndKey cloneValue(PathAndKey value) throws DmcValueException {
