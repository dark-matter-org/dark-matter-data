...
public class DmcTypeDmuModuleREFSET extends DmcTypeDmuModuleREF implements Serializable {
    
     private final static Iterator<DmuModuleREF> emptyList =  (new HashSet<DmuModuleREF>()).iterator();
    ...
    void initValue(){
        if (getAttributeInfo().valueType == ValueTypeEnum.HASHSET)
            value = new HashSet<DmuModuleREF>();
        else
            value = new TreeSet<DmuModuleREF>();
    }
    
    @Override
    public DmcTypeDmuModuleREFSET getNew(){
        return(new DmcTypeDmuModuleREFSET(getAttributeInfo()));
    }
    ...
    public DmcAttribute<DmuModuleREF> cloneIt(){
        synchronized(this){
            DmcTypeDmuModuleREFSET rc = getNew();
    ...
    public Iterator<DmuModuleREF> getMV(){
        synchronized(this){
            ...
            if (getAttributeInfo().valueType == ValueTypeEnum.HASHSET)
                return( (new HashSet<DmuModuleREF>(value)).iterator() );
            else
                return( (new TreeSet<DmuModuleREF>(value)).iterator() );
        }
    }
        ...
        synchronized(this){
            if (getAttributeInfo().valueType == ValueTypeEnum.HASHSET){
                if (value == null)
                    ...
                    return(new HashSet<DmuModuleREF>(value));
            }
            else{
                if (value == null)
                    return(new TreeSet<DmuModuleREF>(value));
                else
                    return(new TreeSet<DmuModuleREF>(value));
            }
        }
