...
import org.dmd.dmu.shared.generated.types.DmcTypeDmuModuleREFSV;         // Reference type - (GenUtility.java:311)
...
abstract public class DmuDefinitionDMO  extends DSDefinitionDMO  implements DmcNamedObjectIF, Serializable  {

    public final static String constructionClassName = "DmuDefinition";


    static {
    }

    public DmuDefinitionDMO() {
        super("DmuDefinition");
    }

    protected DmuDefinitionDMO(String oc) {
        super(oc);
    }
    ...
    public boolean equals(Object obj){
        if (obj instanceof DmuDefinitionDMO){
            return( getObjectName().equals( ((DmuDefinitionDMO) obj).getObjectName()) );
        }
        return(false);
    }
    ...
    /**
     * @return the DmuModuleREF
     */
    public DmuModuleREF getDefinedInDmuModule(){
        DmcTypeDmuModuleREFSV attr = (DmcTypeDmuModuleREFSV) get(DmuDMSAG.__definedInDmuModule);
        if (attr == null)
            return(null);
    ...
    /**
     * @return the reference to DmuModule without attempting lazy resolution (if turned on).
     */
    public DmuModuleREF getDefinedInDmuModuleREF(){
        DmcTypeDmuModuleREFSV attr = (DmcTypeDmuModuleREFSV) get(DmuDMSAG.__definedInDmuModule);
        if (attr == null)
            return(null);
     ...
     * @param value DmuModuleDMO
     */
    // org.dmd.dms.util.GenUtility.formatSV(GenUtility.java:723)
    public void setDefinedInDmuModule(DmuModuleDMO value) {
        DmcAttribute<?> attr = get(DmuDMSAG.__definedInDmuModule);
        if (attr == null)
            attr = new DmcTypeDmuModuleREFSV(DmuDMSAG.__definedInDmuModule);
        else
            ((DmcTypeDmuModuleREFSV)attr).removeBackReferences();
        
        try{
            attr.set(value);
            set(DmuDMSAG.__definedInDmuModule,attr);
        }
        catch(DmcValueException ex){
            throw(new IllegalStateException("The type specific set() method shouldn't throw exceptions!",ex));
        }
    ...
    /**
     * Sets definedInDmuModule to the specified value.
     * @param value A value compatible with DmcTypeDmuModuleREFSV
     * @throws DmcValueException if value is not correct
     */
    // org.dmd.dms.util.GenUtility.formatSV(GenUtility.java:892)
    ...
    public void remDefinedInDmuModule(){
         rem(DmuDMSAG.__definedInDmuModule);
    }
