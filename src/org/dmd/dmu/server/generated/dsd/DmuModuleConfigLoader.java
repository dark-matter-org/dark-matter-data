...
import org.dmd.dmu.server.extended.DmuDefinition;                       // One of our base definition types - (InitializationInterfaceManager.java:109)
import org.dmd.dmu.server.extended.DmuModule;                           // The module type we load - (InitializationInterfaceManager.java:69)
import org.dmd.dmu.server.generated.dsd.DmuModuleDefinitionsIF;         // Interface for DmuModule definitions - (InitializationInterfaceManager.java:101)
...
public class DmuModuleConfigLoader extends DmuModuleGenUtility {
    ...
    private void initializeDefinitions() throws ResultException {
        Iterator<DmuDefinition> DmuDefinitionIT = definitionManager.getAllDmuDefinition();
        while(DmuDefinitionIT.hasNext()) {
            DmuDefinition def = DmuDefinitionIT.next();
            def.initialize((DmuModuleDefinitionsIF)definitionManager);
        }
    }
}
