...
import org.dmd.dmc.types.FullyQualifiedName;                      // Primitive type - (BaseDMWGenerator.java:1074)
import org.dmd.dmp.server.extended.ActionRequest;                 // Required for getModificationRecorder() - (BaseDMWGenerator.java:1000)
import org.dmd.dmp.server.extended.Request;                       // Derived class - (BaseDMWGenerator.java:1172)
import org.dmd.dmp.shared.generated.dmo.ActionRequestDMO;         // Class not auxiliary or abstract - (BaseDMWGenerator.java:1176)
