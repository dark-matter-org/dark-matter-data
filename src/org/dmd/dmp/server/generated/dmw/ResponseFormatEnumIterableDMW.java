...
import org.dmd.dmp.shared.generated.enums.ResponseFormatEnum;         // This is the type we're iterating - (GenUtility.java:1908)
import org.dmd.dmw.DmwMVIterator;                                     // The base multi-value iterator - (GenUtility.java:1905)


/**
 * The ResponseFormatEnumIterableDMW wraps an Iterator for a particular type and makes 
 * it Iterable.
 * <P>
...
public class ResponseFormatEnumIterableDMW extends DmwMVIterator<ResponseFormatEnum> {
    ...
    public final static ResponseFormatEnumIterableDMW emptyList = new ResponseFormatEnumIterableDMW();

    protected ResponseFormatEnumIterableDMW(){
        super();
    }

    public ResponseFormatEnumIterableDMW(Iterator<ResponseFormatEnum> it){
        super(it);
    }
