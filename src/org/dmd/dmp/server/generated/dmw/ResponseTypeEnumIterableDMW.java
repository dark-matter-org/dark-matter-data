...
import org.dmd.dmp.shared.generated.enums.ResponseTypeEnum;         // This is the type we're iterating - (GenUtility.java:1925)
import org.dmd.dmw.DmwMVIterator;                                   // The base multi-value iterator - (GenUtility.java:1922)


/**
 * The ResponseTypeEnumIterableDMW wraps an Iterator for a particular type and makes 
 * it Iterable.
 * <P>
...
public class ResponseTypeEnumIterableDMW extends DmwMVIterator<ResponseTypeEnum> {
    ...
    public final static ResponseTypeEnumIterableDMW emptyList = new ResponseTypeEnumIterableDMW();
