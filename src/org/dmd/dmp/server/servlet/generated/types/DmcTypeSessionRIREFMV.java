...
/**
 * The DmcTypeSessionRIREFMV provides storage for a multi-valued SessionRIREF
 * <P>
...
public class DmcTypeSessionRIREFMV extends DmcTypeSessionRIREF implements Serializable {
    ...
    public DmcTypeSessionRIREFMV(DmcAttributeInfo ai){
        super(ai);
    }
    
    @Override
    public DmcTypeSessionRIREFMV getNew(){
        return(new DmcTypeSessionRIREFMV(attrInfo));
    }
    ...
    public SessionRIREF add(Object v) throws DmcValueException {
        synchronized(this){
            ...
            if (value == null)
                value = new ArrayList<SessionRIREF>();
            value.add(rc);
            return(rc);
        }
    }
    ...
    public ArrayList<SessionRIREF> getMVCopy(){
        synchronized(this){
            if (value == null)
                ...
                ArrayList<SessionRIREF> rc = new  ArrayList<SessionRIREF>(value.size());
                if (attrInfo.indexSize == 0){
                    for(SessionRIREF val: value)
                        rc.add(val);
                }
    ...
    public SessionRIREF setMVnth(int index, Object v) throws DmcValueException {
        synchronized(this){
            ...
            if (value == null){
                value = new ArrayList<SessionRIREF>(attrInfo.indexSize);
                for(int i=0;i<attrInfo.indexSize;i++)
                    value.add(null);
            }
