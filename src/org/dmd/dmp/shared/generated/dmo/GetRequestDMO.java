...
import org.dmd.dmc.types.ClassFilter;                                   // Primitive type - (GenUtility.java:282)
...
import org.dmd.dms.generated.types.DmcTypeClassFilterSV;                // Required type - (GenUtility.java:339)
...
public class GetRequestDMO  extends RequestDMO  implements Serializable  {
    ...
    /**
     * @return the reference to ClassDefinition without attempting lazy resolution (if turned on).
     */
    ...
    /**
     * @return the number of values in attributeSelector
     */
    // org.dmd.dms.util.GenUtility.formatMV(GenUtility.java:1441)
