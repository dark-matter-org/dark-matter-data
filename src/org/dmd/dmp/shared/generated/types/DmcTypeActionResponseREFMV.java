...
import org.dmd.dmp.shared.generated.dmo.ActionResponseDMO;         // DmcType import - (MVTypeFormatter.java:63)
...
public class DmcTypeActionResponseREFMV extends DmcTypeActionResponseREF implements Serializable {
    ...
    private final static Iterator<ActionResponseDMO> emptyList = (new ArrayList<ActionResponseDMO>()).iterator();
    
    protected ArrayList<ActionResponseDMO> value;
    ...
    public DmcTypeActionResponseREFMV getNew(){
        return(new DmcTypeActionResponseREFMV(getAttributeInfo()));
    }
    ...
    public ArrayList<ActionResponseDMO> getMVCopy(){
        synchronized(this){
            if (value == null)
                return(new ArrayList<ActionResponseDMO>());
            else 
                return(new ArrayList<ActionResponseDMO>(value));
        }
    }
    ...
    public ActionResponseDMO getMVnth(int index){
        synchronized(this){
            if (value == null)
                return(null);
    ...
    public ActionResponseDMO setMVnth(int index, Object v) throws DMFeedbackSet {
        synchronized(this){
            if (getAttributeInfo().indexSize == 0)
            ...
            if (value == null){
                value = new ArrayList<ActionResponseDMO>(getAttributeInfo().indexSize);
