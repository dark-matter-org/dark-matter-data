...
import org.dmd.dmp.shared.generated.dmo.SetRequestDMO;         // DmcType import - (MVTypeFormatter.java:63)
...
public class DmcTypeSetRequestREFMV extends DmcTypeSetRequestREF implements Serializable {
    ...
    private final static Iterator<SetRequestDMO> emptyList = (new ArrayList<SetRequestDMO>()).iterator();
    
    protected ArrayList<SetRequestDMO> value;
    ...
    public DmcTypeSetRequestREFMV getNew(){
        return(new DmcTypeSetRequestREFMV(getAttributeInfo()));
    }
    ...
    public SetRequestDMO add(Object v) throws DMFeedbackSet {
        synchronized(this){
    ...
    public ArrayList<SetRequestDMO> getMVCopy(){
        synchronized(this){
            if (value == null)
                return(new ArrayList<SetRequestDMO>());
            else 
                return(new ArrayList<SetRequestDMO>(value));
        }
    }
    ...
    public SetRequestDMO setMVnth(int index, Object v) throws DMFeedbackSet {
        synchronized(this){
            if (getAttributeInfo().indexSize == 0)
            ...
            if (value == null){
                value = new ArrayList<SetRequestDMO>(getAttributeInfo().indexSize);
