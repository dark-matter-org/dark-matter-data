...
import org.dmd.dmp.shared.generated.types.DmcTypeDenotifyRequestREFSV;         //  - (AdapterFormatter.java:60)
...
public class DenotifyRequestSVAdapter extends DmcTypeDenotifyRequestREFSV implements DmcAdapterIF {

    transient DmcTypeDenotifyRequestREFSV existingValue;

    public DenotifyRequestSVAdapter(DmcAttributeInfo ai){
    	   super(ai);
    }
    ...
    public void setExisting(DmcAttribute<?> attr) {
    	existingValue = (DmcTypeDenotifyRequestREFSV) attr;
    	if (existingValue != null)
    		value = existingValue.getSVCopy();
    }
