...
import org.dmd.dmp.shared.generated.types.DmcTypeNotifyResponseREFSV;         //  - (AdapterFormatter.java:60)
...
public class NotifyResponseSVAdapter extends DmcTypeNotifyResponseREFSV implements DmcAdapterIF {
    ...
    public void setExisting(DmcAttribute<?> attr) {
    	existingValue = (DmcTypeNotifyResponseREFSV) attr;
    	if (existingValue != null)
    		value = existingValue.getSVCopy();
    }
