...
import org.dmd.dmp.shared.generated.types.DmcTypeLoginRequestREFSET;         //  - (AdapterFormatter.java:60)
...
public class LoginRequestSETAdapter extends DmcTypeLoginRequestREFSET implements DmcAdapterIF {
    ...
    public void setExisting(DmcAttribute<?> attr) {
    	existingValue = (DmcTypeLoginRequestREFSET) attr;
    	if (existingValue != null)
    		value = existingValue.getMVCopy();
    }
