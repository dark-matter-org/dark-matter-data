...
import org.dmd.dmp.shared.generated.types.DmcTypeGetResponseREFSET;         //  - (AdapterFormatter.java:60)
...
public class GetResponseSETAdapter extends DmcTypeGetResponseREFSET implements DmcAdapterIF {

    transient DmcTypeGetResponseREFSET existingValue;

    public GetResponseSETAdapter(DmcAttributeInfo ai){
    	   super(ai);
    }
    ...
    public void setExisting(DmcAttribute<?> attr) {
    	existingValue = (DmcTypeGetResponseREFSET) attr;
    	if (existingValue != null)
    		value = existingValue.getMVCopy();
    }
