...
import org.dmd.dmp.shared.generated.types.DmcTypeLogoutRequestREFSET;         //  - (AdapterFormatter.java:60)
...
public class LogoutRequestSETAdapter extends DmcTypeLogoutRequestREFSET implements DmcAdapterIF {
    ...
    public void setExisting(DmcAttribute<?> attr) {
    	existingValue = (DmcTypeLogoutRequestREFSET) attr;
    	if (existingValue != null)
    		value = existingValue.getMVCopy();
    }
