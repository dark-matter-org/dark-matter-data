...
import org.dmd.dmp.shared.generated.types.DmcTypeLogoutRequestREFMV;         //  - (AdapterFormatter.java:60)
...
public class LogoutRequestMVAdapter extends DmcTypeLogoutRequestREFMV implements DmcAdapterIF {
    ...
    public void setExisting(DmcAttribute<?> attr) {
    	existingValue = (DmcTypeLogoutRequestREFMV) attr;
    	if (existingValue != null)
    		value = existingValue.getMVCopy();
    }
