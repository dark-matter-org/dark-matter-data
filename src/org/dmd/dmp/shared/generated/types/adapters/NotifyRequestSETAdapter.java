...
import org.dmd.dmp.shared.generated.types.DmcTypeNotifyRequestREFSET;         //  - (AdapterFormatter.java:60)
...
public class NotifyRequestSETAdapter extends DmcTypeNotifyRequestREFSET implements DmcAdapterIF {

    transient DmcTypeNotifyRequestREFSET existingValue;

    public NotifyRequestSETAdapter(DmcAttributeInfo ai){
    	   super(ai);
    }
    ...
    public void setExisting(DmcAttribute<?> attr) {
    	existingValue = (DmcTypeNotifyRequestREFSET) attr;
    	if (existingValue != null)
    		value = existingValue.getMVCopy();
    }
