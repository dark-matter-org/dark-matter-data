...
import org.dmd.dmp.shared.generated.types.DmcTypeCreateRequestREFSV;         //  - (AdapterFormatter.java:60)
...
public class CreateRequestSVAdapter extends DmcTypeCreateRequestREFSV implements DmcAdapterIF {
    ...
    public void setExisting(DmcAttribute<?> attr) {
    	existingValue = (DmcTypeCreateRequestREFSV) attr;
    	if (existingValue != null)
    		value = existingValue.getSVCopy();
    }
