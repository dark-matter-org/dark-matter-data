...
import org.dmd.dmp.shared.generated.types.DmcTypeDeleteRequestREFSV;         //  - (AdapterFormatter.java:60)
...
public class DeleteRequestSVAdapter extends DmcTypeDeleteRequestREFSV implements DmcAdapterIF {

    transient DmcTypeDeleteRequestREFSV existingValue;

    public DeleteRequestSVAdapter(DmcAttributeInfo ai){
    	   super(ai);
    }
    ...
    public void setExisting(DmcAttribute<?> attr) {
    	existingValue = (DmcTypeDeleteRequestREFSV) attr;
    	if (existingValue != null)
    		value = existingValue.getSVCopy();
    }
