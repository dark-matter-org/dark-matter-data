...
import org.dmd.dmp.shared.generated.types.DmcTypeLogoutResponseREFSET;         //  - (AdapterFormatter.java:60)
...
public class LogoutResponseSETAdapter extends DmcTypeLogoutResponseREFSET implements DmcAdapterIF {
    ...
    public void setExisting(DmcAttribute<?> attr) {
    	existingValue = (DmcTypeLogoutResponseREFSET) attr;
    	if (existingValue != null)
    		value = existingValue.getMVCopy();
    }
