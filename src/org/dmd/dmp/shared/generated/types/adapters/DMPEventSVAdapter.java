...
import org.dmd.dmp.shared.generated.types.DmcTypeDMPEventREFSV;         //  - (AdapterFormatter.java:60)
...
public class DMPEventSVAdapter extends DmcTypeDMPEventREFSV implements DmcAdapterIF {

    transient DmcTypeDMPEventREFSV existingValue;

    public DMPEventSVAdapter(DmcAttributeInfo ai){
    	   super(ai);
    }
    ...
    public void setExisting(DmcAttribute<?> attr) {
    	existingValue = (DmcTypeDMPEventREFSV) attr;
    	if (existingValue != null)
    		value = existingValue.getSVCopy();
    }
