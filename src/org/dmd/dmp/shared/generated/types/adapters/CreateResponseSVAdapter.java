...
import org.dmd.dmp.shared.generated.types.DmcTypeCreateResponseREFSV;         //  - (AdapterFormatter.java:60)
...
public class CreateResponseSVAdapter extends DmcTypeCreateResponseREFSV implements DmcAdapterIF {

    transient DmcTypeCreateResponseREFSV existingValue;

    public CreateResponseSVAdapter(DmcAttributeInfo ai){
    	   super(ai);
    }
    ...
    public void setExisting(DmcAttribute<?> attr) {
    	existingValue = (DmcTypeCreateResponseREFSV) attr;
    	if (existingValue != null)
    		value = existingValue.getSVCopy();
    }
