...
import org.dmd.dmp.shared.generated.types.DmcTypePreAuthResponseREFSET;         //  - (AdapterFormatter.java:60)
...
public class PreAuthResponseSETAdapter extends DmcTypePreAuthResponseREFSET implements DmcAdapterIF {
    ...
    public void setExisting(DmcAttribute<?> attr) {
    	existingValue = (DmcTypePreAuthResponseREFSET) attr;
    	if (existingValue != null)
    		value = existingValue.getMVCopy();
    }
