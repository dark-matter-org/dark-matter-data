...
import org.dmd.dmp.shared.generated.types.DmcTypeLoginResponseREFSV;         //  - (AdapterFormatter.java:60)
...
public class LoginResponseSVAdapter extends DmcTypeLoginResponseREFSV implements DmcAdapterIF {
    ...
    public void setExisting(DmcAttribute<?> attr) {
    	existingValue = (DmcTypeLoginResponseREFSV) attr;
    	if (existingValue != null)
    		value = existingValue.getSVCopy();
    }
