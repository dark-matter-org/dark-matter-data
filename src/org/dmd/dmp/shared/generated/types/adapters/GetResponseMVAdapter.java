...
import org.dmd.dmp.shared.generated.types.DmcTypeGetResponseREFMV;         //  - (AdapterFormatter.java:60)
...
public class GetResponseMVAdapter extends DmcTypeGetResponseREFMV implements DmcAdapterIF {

    transient DmcTypeGetResponseREFMV existingValue;

    public GetResponseMVAdapter(DmcAttributeInfo ai){
    	   super(ai);
    }
    ...
    public void setExisting(DmcAttribute<?> attr) {
    	existingValue = (DmcTypeGetResponseREFMV) attr;
    	if (existingValue != null)
    		value = existingValue.getMVCopy();
    }
