...
import org.dmd.dmp.shared.generated.types.DmcTypeActionResponseREFSV;         //  - (AdapterFormatter.java:60)
...
public class ActionResponseSVAdapter extends DmcTypeActionResponseREFSV implements DmcAdapterIF {

    transient DmcTypeActionResponseREFSV existingValue;

    public ActionResponseSVAdapter(DmcAttributeInfo ai){
    	   super(ai);
    }
    ...
    public void setExisting(DmcAttribute<?> attr) {
    	existingValue = (DmcTypeActionResponseREFSV) attr;
    	if (existingValue != null)
    		value = existingValue.getSVCopy();
    }
