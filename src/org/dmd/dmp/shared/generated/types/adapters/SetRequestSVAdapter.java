...
import org.dmd.dmp.shared.generated.types.DmcTypeSetRequestREFSV;         //  - (AdapterFormatter.java:60)
...
public class SetRequestSVAdapter extends DmcTypeSetRequestREFSV implements DmcAdapterIF {

    transient DmcTypeSetRequestREFSV existingValue;

    public SetRequestSVAdapter(DmcAttributeInfo ai){
    	   super(ai);
    }
    ...
    public void setExisting(DmcAttribute<?> attr) {
    	existingValue = (DmcTypeSetRequestREFSV) attr;
    	if (existingValue != null)
    		value = existingValue.getSVCopy();
    }
