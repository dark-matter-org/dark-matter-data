...
import org.dmd.dmp.shared.generated.types.DmcTypeActionResponseREFSET;         //  - (AdapterFormatter.java:60)
...
public class ActionResponseSETAdapter extends DmcTypeActionResponseREFSET implements DmcAdapterIF {
    ...
    public void setExisting(DmcAttribute<?> attr) {
    	existingValue = (DmcTypeActionResponseREFSET) attr;
    	if (existingValue != null)
    		value = existingValue.getMVCopy();
    }
