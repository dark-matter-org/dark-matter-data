...
import org.dmd.dmp.shared.generated.types.DmcTypePreAuthRequestREFMV;         //  - (AdapterFormatter.java:60)
...
public class PreAuthRequestMVAdapter extends DmcTypePreAuthRequestREFMV implements DmcAdapterIF {

    transient DmcTypePreAuthRequestREFMV existingValue;

    public PreAuthRequestMVAdapter(DmcAttributeInfo ai){
    	   super(ai);
    }
    ...
    public void setExisting(DmcAttribute<?> attr) {
    	existingValue = (DmcTypePreAuthRequestREFMV) attr;
    	if (existingValue != null)
    		value = existingValue.getMVCopy();
    }
