...
import org.dmd.dmp.shared.generated.types.DmcTypeGetRequestREFSET;         //  - (AdapterFormatter.java:60)
...
public class GetRequestSETAdapter extends DmcTypeGetRequestREFSET implements DmcAdapterIF {
    ...
    public void setExisting(DmcAttribute<?> attr) {
    	existingValue = (DmcTypeGetRequestREFSET) attr;
    	if (existingValue != null)
    		value = existingValue.getMVCopy();
    }
