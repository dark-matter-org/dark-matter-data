...
import org.dmd.dmp.shared.generated.types.DmcTypeNotifyRequestREFMV;         //  - (AdapterFormatter.java:60)
...
public class NotifyRequestMVAdapter extends DmcTypeNotifyRequestREFMV implements DmcAdapterIF {
    ...
    public void setExisting(DmcAttribute<?> attr) {
    	existingValue = (DmcTypeNotifyRequestREFMV) attr;
    	if (existingValue != null)
    		value = existingValue.getMVCopy();
    }
