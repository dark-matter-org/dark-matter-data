...
import org.dmd.dmp.shared.generated.types.DmcTypePreAuthRequestREFSV;         //  - (AdapterFormatter.java:60)
...
public class PreAuthRequestSVAdapter extends DmcTypePreAuthRequestREFSV implements DmcAdapterIF {

    transient DmcTypePreAuthRequestREFSV existingValue;

    public PreAuthRequestSVAdapter(DmcAttributeInfo ai){
    	   super(ai);
    }
    ...
    public void setExisting(DmcAttribute<?> attr) {
    	existingValue = (DmcTypePreAuthRequestREFSV) attr;
    	if (existingValue != null)
    		value = existingValue.getSVCopy();
    }
