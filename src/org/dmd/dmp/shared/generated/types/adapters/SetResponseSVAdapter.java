...
import org.dmd.dmp.shared.generated.types.DmcTypeSetResponseREFSV;         //  - (AdapterFormatter.java:60)
...
public class SetResponseSVAdapter extends DmcTypeSetResponseREFSV implements DmcAdapterIF {

    transient DmcTypeSetResponseREFSV existingValue;

    public SetResponseSVAdapter(DmcAttributeInfo ai){
    	   super(ai);
    }
    ...
    public void setExisting(DmcAttribute<?> attr) {
    	existingValue = (DmcTypeSetResponseREFSV) attr;
    	if (existingValue != null)
    		value = existingValue.getSVCopy();
    }
