...
import org.dmd.dmp.shared.generated.types.DmcTypeGetRequestREFMV;         //  - (AdapterFormatter.java:60)
...
public class GetRequestMVAdapter extends DmcTypeGetRequestREFMV implements DmcAdapterIF {

    transient DmcTypeGetRequestREFMV existingValue;

    public GetRequestMVAdapter(DmcAttributeInfo ai){
    	   super(ai);
    }
    ...
    public void setExisting(DmcAttribute<?> attr) {
    	existingValue = (DmcTypeGetRequestREFMV) attr;
    	if (existingValue != null)
    		value = existingValue.getMVCopy();
    }
