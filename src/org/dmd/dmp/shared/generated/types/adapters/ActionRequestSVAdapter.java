...
import org.dmd.dmp.shared.generated.types.DmcTypeActionRequestREFSV;         //  - (AdapterFormatter.java:60)
...
public class ActionRequestSVAdapter extends DmcTypeActionRequestREFSV implements DmcAdapterIF {
    ...
    public void setExisting(DmcAttribute<?> attr) {
    	existingValue = (DmcTypeActionRequestREFSV) attr;
    	if (existingValue != null)
    		value = existingValue.getSVCopy();
    }
