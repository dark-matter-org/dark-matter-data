...
import org.dmd.dmp.shared.generated.types.DmcTypeDeleteResponseREFMV;         //  - (AdapterFormatter.java:60)
...
public class DeleteResponseMVAdapter extends DmcTypeDeleteResponseREFMV implements DmcAdapterIF {

    transient DmcTypeDeleteResponseREFMV existingValue;

    public DeleteResponseMVAdapter(DmcAttributeInfo ai){
    	   super(ai);
    }
    ...
    public void setExisting(DmcAttribute<?> attr) {
    	existingValue = (DmcTypeDeleteResponseREFMV) attr;
    	if (existingValue != null)
    		value = existingValue.getMVCopy();
    }
