...
import org.dmd.dmp.shared.generated.dmo.DenotifyResponseDMO;         //  - (DmoTypeFormatter.java:194)
...
abstract public class DmcTypeDenotifyResponseREF extends DmcAttribute<DenotifyResponseDMO> implements Serializable {

    public DmcTypeDenotifyResponseREF(){
    }

    public DmcTypeDenotifyResponseREF(DmcAttributeInfo ai){
        super(ai);
    }

    protected DenotifyResponseDMO typeCheck(Object value) throws DMFeedbackSet {
        if (value instanceof DenotifyResponseDMO)
            return((DenotifyResponseDMO)value);
        
        throw(new DMFeedbackSet("Object of class: " + value.getClass().getName() + " passed where object compatible with DenotifyResponseDMO expected."));
    }

    @Override
    public void serializeValue(DmcOutputStreamIF dos, DenotifyResponseDMO value) throws Exception {
        value.serializeIt(dos);
    }

    @Override
    public DenotifyResponseDMO deserializeValue(DmcInputStreamIF dis) throws Exception {
        DenotifyResponseDMO rc = (DenotifyResponseDMO)dis.getDMOInstance(dis);
        rc.deserializeIt(dis);
        return(rc);
    }

    @Override
    public DenotifyResponseDMO cloneValue(DenotifyResponseDMO value){
        return((DenotifyResponseDMO)value.cloneIt());
    }
