...
import org.dmd.dmp.shared.generated.dmo.GetResponseDMO;         // DmcType import - (SVTypeFormatter.java:65)
...
public class DmcTypeGetResponseREFSV extends DmcTypeGetResponseREF implements Serializable {
    ...
    public DmcTypeGetResponseREFSV getNew(){
        return(new DmcTypeGetResponseREFSV(getAttributeInfo()));
    }
    ...
    public GetResponseDMO set(Object v) throws DMFeedbackSet {
