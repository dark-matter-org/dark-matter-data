...
import org.dmd.dmp.shared.generated.enums.DMPEventTypeEnum;         // DmcType import - (SETTypeFormatter.java:59)
...
public class DmcTypeDMPEventTypeEnumSET extends DmcTypeDMPEventTypeEnum implements Serializable {
     ...
     private final static Iterator<DMPEventTypeEnum> emptyList =  (new HashSet<DMPEventTypeEnum>()).iterator();
