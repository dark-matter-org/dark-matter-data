...
import org.dmd.dmp.shared.generated.dmo.PreAuthResponseDMO;         //  - (DmoTypeFormatter.java:194)
...
abstract public class DmcTypePreAuthResponseREF extends DmcAttribute<PreAuthResponseDMO> implements Serializable {

    public DmcTypePreAuthResponseREF(){
    }

    public DmcTypePreAuthResponseREF(DmcAttributeInfo ai){
        super(ai);
    }

    protected PreAuthResponseDMO typeCheck(Object value) throws DMFeedbackSet {
        if (value instanceof PreAuthResponseDMO)
            return((PreAuthResponseDMO)value);
        
        throw(new DMFeedbackSet("Object of class: " + value.getClass().getName() + " passed where object compatible with PreAuthResponseDMO expected."));
    }

    @Override
    public void serializeValue(DmcOutputStreamIF dos, PreAuthResponseDMO value) throws Exception {
        value.serializeIt(dos);
    }

    @Override
    public PreAuthResponseDMO deserializeValue(DmcInputStreamIF dis) throws Exception {
        PreAuthResponseDMO rc = (PreAuthResponseDMO)dis.getDMOInstance(dis);
        rc.deserializeIt(dis);
        return(rc);
    }

    @Override
    public PreAuthResponseDMO cloneValue(PreAuthResponseDMO value){
        return((PreAuthResponseDMO)value.cloneIt());
    }
