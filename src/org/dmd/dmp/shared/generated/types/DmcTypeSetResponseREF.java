...
import org.dmd.dmp.shared.generated.dmo.SetResponseDMO;         //  - (DmoTypeFormatter.java:194)
...
abstract public class DmcTypeSetResponseREF extends DmcAttribute<SetResponseDMO> implements Serializable {
    ...
    protected SetResponseDMO typeCheck(Object value) throws DMFeedbackSet {
        if (value instanceof SetResponseDMO)
            return((SetResponseDMO)value);
        
        throw(new DMFeedbackSet("Object of class: " + value.getClass().getName() + " passed where object compatible with SetResponseDMO expected."));
    }
