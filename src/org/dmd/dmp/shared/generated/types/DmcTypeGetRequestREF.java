...
import org.dmd.dmp.shared.generated.dmo.GetRequestDMO;         //  - (DmoTypeFormatter.java:194)
...
abstract public class DmcTypeGetRequestREF extends DmcAttribute<GetRequestDMO> implements Serializable {
    ...
    protected GetRequestDMO typeCheck(Object value) throws DMFeedbackSet {
        if (value instanceof GetRequestDMO)
            return((GetRequestDMO)value);
        
        throw(new DMFeedbackSet("Object of class: " + value.getClass().getName() + " passed where object compatible with GetRequestDMO expected."));
    }

    @Override
    public void serializeValue(DmcOutputStreamIF dos, GetRequestDMO value) throws Exception {
        value.serializeIt(dos);
    }

    @Override
    public GetRequestDMO deserializeValue(DmcInputStreamIF dis) throws Exception {
        GetRequestDMO rc = (GetRequestDMO)dis.getDMOInstance(dis);
        rc.deserializeIt(dis);
        return(rc);
    }

    @Override
    public GetRequestDMO cloneValue(GetRequestDMO value){
        return((GetRequestDMO)value.cloneIt());
    }
