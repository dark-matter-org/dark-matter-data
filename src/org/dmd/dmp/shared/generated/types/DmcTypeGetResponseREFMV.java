...
import org.dmd.dmp.shared.generated.dmo.GetResponseDMO;         // DmcType import - (MVTypeFormatter.java:63)
...
public class DmcTypeGetResponseREFMV extends DmcTypeGetResponseREF implements Serializable {
    ...
    private final static Iterator<GetResponseDMO> emptyList = (new ArrayList<GetResponseDMO>()).iterator();
    
    protected ArrayList<GetResponseDMO> value;
    ...
    public DmcTypeGetResponseREFMV getNew(){
        return(new DmcTypeGetResponseREFMV(getAttributeInfo()));
    }
    ...
    public GetResponseDMO add(Object v) throws DMFeedbackSet {
        synchronized(this){
            GetResponseDMO rc = typeCheck(v);
            if (value == null)
                value = new ArrayList<GetResponseDMO>();
            value.add(rc);
            return(rc);
        }
    }
    ...
    public Iterator<GetResponseDMO> getMV(){
        synchronized(this){
            ...
            ArrayList<GetResponseDMO> clone = new ArrayList<GetResponseDMO>(value);
            return(clone.iterator());
        }
    }
    
    // org.dmd.dms.tools.util.MVTypeFormatter.dumpMVType(MVTypeFormatter.java:188)
    public ArrayList<GetResponseDMO> getMVCopy(){
        synchronized(this){
            if (value == null)
                return(new ArrayList<GetResponseDMO>());
            else 
                return(new ArrayList<GetResponseDMO>(value));
        }
    }
    ...
    public GetResponseDMO getMVnth(int index){
        synchronized(this){
            if (value == null)
                return(null);
    ...
    public GetResponseDMO setMVnth(int index, Object v) throws DMFeedbackSet {
        synchronized(this){
            if (getAttributeInfo().indexSize == 0)
            ...
            if (value == null){
                value = new ArrayList<GetResponseDMO>(getAttributeInfo().indexSize);
