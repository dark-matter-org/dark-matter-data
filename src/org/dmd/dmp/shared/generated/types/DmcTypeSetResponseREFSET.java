...
import org.dmd.dmp.shared.generated.dmo.SetResponseDMO;          // DmcType import - (SETTypeFormatter.java:59)
...
public class DmcTypeSetResponseREFSET extends DmcTypeSetResponseREF implements Serializable {
     ...
     private final static Iterator<SetResponseDMO> emptyList =  (new HashSet<SetResponseDMO>()).iterator();
    ...
    public DmcTypeSetResponseREFSET getNew(){
        return(new DmcTypeSetResponseREFSET(getAttributeInfo()));
    }
    ...
    public SetResponseDMO add(Object v) throws DMFeedbackSet {
        synchronized(this){
    ...
    public Iterator<SetResponseDMO> getMV(){
        synchronized(this){
            ...
            if (getAttributeInfo().valueType == ValueTypeEnum.HASHSET)
                return( (new HashSet<SetResponseDMO>(value)).iterator() );
            else
                return( (new TreeSet<SetResponseDMO>(value)).iterator() );
        }
    }
        ...
        synchronized(this){
            if (getAttributeInfo().valueType == ValueTypeEnum.HASHSET){
                if (value == null)
                    ...
                    return(new HashSet<SetResponseDMO>(value));
            }
            else{
                if (value == null)
                    return(new TreeSet<SetResponseDMO>(value));
                else
                    return(new TreeSet<SetResponseDMO>(value));
            }
        }
