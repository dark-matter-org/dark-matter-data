...
import org.dmd.dmp.shared.generated.enums.ResponseTypeEnum;         // DmcType import - (SETTypeFormatter.java:59)
...
public class DmcTypeResponseTypeEnumSET extends DmcTypeResponseTypeEnum implements Serializable {
    ...
    public DmcTypeResponseTypeEnumSET getNew(){
        return(new DmcTypeResponseTypeEnumSET(getAttributeInfo()));
    }
