...
import org.dmd.dmp.shared.generated.dmo.CreateResponseDMO;         // DmcType import - (MVTypeFormatter.java:63)
...
public class DmcTypeCreateResponseREFMV extends DmcTypeCreateResponseREF implements Serializable {
    ...
    private final static Iterator<CreateResponseDMO> emptyList = (new ArrayList<CreateResponseDMO>()).iterator();
    
    protected ArrayList<CreateResponseDMO> value;
    ...
    public DmcTypeCreateResponseREFMV getNew(){
        return(new DmcTypeCreateResponseREFMV(getAttributeInfo()));
    }
    ...
    public CreateResponseDMO add(Object v) throws DMFeedbackSet {
        synchronized(this){
    ...
    public ArrayList<CreateResponseDMO> getMVCopy(){
        synchronized(this){
            if (value == null)
                return(new ArrayList<CreateResponseDMO>());
            else 
                return(new ArrayList<CreateResponseDMO>(value));
        }
    }
    ...
    public CreateResponseDMO setMVnth(int index, Object v) throws DMFeedbackSet {
        synchronized(this){
            if (getAttributeInfo().indexSize == 0)
            ...
            if (value == null){
                value = new ArrayList<CreateResponseDMO>(getAttributeInfo().indexSize);
