...
import org.dmd.dmp.shared.generated.dmo.LoginRequestDMO;         // DmcType import - (MVTypeFormatter.java:63)
...
public class DmcTypeLoginRequestREFMV extends DmcTypeLoginRequestREF implements Serializable {
    ...
    private final static Iterator<LoginRequestDMO> emptyList = (new ArrayList<LoginRequestDMO>()).iterator();
    
    protected ArrayList<LoginRequestDMO> value;
    ...
    public DmcTypeLoginRequestREFMV getNew(){
        return(new DmcTypeLoginRequestREFMV(getAttributeInfo()));
    }
    ...
    public LoginRequestDMO add(Object v) throws DMFeedbackSet {
        synchronized(this){
    ...
    public ArrayList<LoginRequestDMO> getMVCopy(){
        synchronized(this){
            if (value == null)
                return(new ArrayList<LoginRequestDMO>());
            else 
                return(new ArrayList<LoginRequestDMO>(value));
        }
    }
    ...
    public LoginRequestDMO setMVnth(int index, Object v) throws DMFeedbackSet {
        synchronized(this){
            if (getAttributeInfo().indexSize == 0)
            ...
            if (value == null){
                value = new ArrayList<LoginRequestDMO>(getAttributeInfo().indexSize);
