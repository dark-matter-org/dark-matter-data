...
import org.dmd.dmp.shared.generated.dmo.DeleteResponseDMO;         //  - (DmoTypeFormatter.java:194)
...
abstract public class DmcTypeDeleteResponseREF extends DmcAttribute<DeleteResponseDMO> implements Serializable {
    ...
    protected DeleteResponseDMO typeCheck(Object value) throws DMFeedbackSet {
        if (value instanceof DeleteResponseDMO)
            return((DeleteResponseDMO)value);
        
        throw(new DMFeedbackSet("Object of class: " + value.getClass().getName() + " passed where object compatible with DeleteResponseDMO expected."));
    }
