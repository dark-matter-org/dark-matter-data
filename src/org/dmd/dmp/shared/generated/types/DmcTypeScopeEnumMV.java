...
import org.dmd.dmp.shared.generated.enums.ScopeEnum;         // DmcType import - (MVTypeFormatter.java:63)
...
public class DmcTypeScopeEnumMV extends DmcTypeScopeEnum implements Serializable {
    ...
    private final static Iterator<ScopeEnum> emptyList = (new ArrayList<ScopeEnum>()).iterator();
    
    protected ArrayList<ScopeEnum> value;
    ...
    public DmcTypeScopeEnumMV getNew(){
        return(new DmcTypeScopeEnumMV(getAttributeInfo()));
    }
    ...
    public ArrayList<ScopeEnum> getMVCopy(){
        synchronized(this){
            if (value == null)
                return(new ArrayList<ScopeEnum>());
            else 
                return(new ArrayList<ScopeEnum>(value));
        }
    }
    ...
    public ScopeEnum setMVnth(int index, Object v) throws DMFeedbackSet {
        synchronized(this){
            if (getAttributeInfo().indexSize == 0)
            ...
            if (value == null){
                value = new ArrayList<ScopeEnum>(getAttributeInfo().indexSize);
