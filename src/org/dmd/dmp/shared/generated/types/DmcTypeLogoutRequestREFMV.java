...
import org.dmd.dmp.shared.generated.dmo.LogoutRequestDMO;         // DmcType import - (MVTypeFormatter.java:63)
...
public class DmcTypeLogoutRequestREFMV extends DmcTypeLogoutRequestREF implements Serializable {
    ...
    public LogoutRequestDMO setMVnth(int index, Object v) throws DMFeedbackSet {
        synchronized(this){
            if (getAttributeInfo().indexSize == 0)
