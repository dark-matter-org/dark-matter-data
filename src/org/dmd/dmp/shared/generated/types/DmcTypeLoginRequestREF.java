...
import org.dmd.dmp.shared.generated.dmo.LoginRequestDMO;         //  - (DmoTypeFormatter.java:194)
...
abstract public class DmcTypeLoginRequestREF extends DmcAttribute<LoginRequestDMO> implements Serializable {
    ...
    protected LoginRequestDMO typeCheck(Object value) throws DMFeedbackSet {
        if (value instanceof LoginRequestDMO)
            return((LoginRequestDMO)value);
        
        throw(new DMFeedbackSet("Object of class: " + value.getClass().getName() + " passed where object compatible with LoginRequestDMO expected."));
    }
