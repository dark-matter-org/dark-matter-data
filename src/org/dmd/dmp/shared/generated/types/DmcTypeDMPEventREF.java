...
import org.dmd.dmp.shared.generated.dmo.DMPEventDMO;         //  - (DmoTypeFormatter.java:194)
...
abstract public class DmcTypeDMPEventREF extends DmcAttribute<DMPEventDMO> implements Serializable {
    ...
    protected DMPEventDMO typeCheck(Object value) throws DMFeedbackSet {
        if (value instanceof DMPEventDMO)
            return((DMPEventDMO)value);
        
        throw(new DMFeedbackSet("Object of class: " + value.getClass().getName() + " passed where object compatible with DMPEventDMO expected."));
    }

    @Override
    public void serializeValue(DmcOutputStreamIF dos, DMPEventDMO value) throws Exception {
        value.serializeIt(dos);
    }

    @Override
    public DMPEventDMO deserializeValue(DmcInputStreamIF dis) throws Exception {
        DMPEventDMO rc = (DMPEventDMO)dis.getDMOInstance(dis);
        rc.deserializeIt(dis);
        return(rc);
    }

    @Override
    public DMPEventDMO cloneValue(DMPEventDMO value){
        return((DMPEventDMO)value.cloneIt());
    }
