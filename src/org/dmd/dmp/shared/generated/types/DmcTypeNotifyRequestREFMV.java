...
import org.dmd.dmp.shared.generated.dmo.NotifyRequestDMO;         // DmcType import - (MVTypeFormatter.java:63)
...
public class DmcTypeNotifyRequestREFMV extends DmcTypeNotifyRequestREF implements Serializable {
    ...
    private final static Iterator<NotifyRequestDMO> emptyList = (new ArrayList<NotifyRequestDMO>()).iterator();
    
    protected ArrayList<NotifyRequestDMO> value;
    ...
    public DmcTypeNotifyRequestREFMV getNew(){
        return(new DmcTypeNotifyRequestREFMV(getAttributeInfo()));
    }
    ...
    public ArrayList<NotifyRequestDMO> getMVCopy(){
        synchronized(this){
            if (value == null)
                return(new ArrayList<NotifyRequestDMO>());
            else 
                return(new ArrayList<NotifyRequestDMO>(value));
        }
    }
    ...
    public NotifyRequestDMO setMVnth(int index, Object v) throws DMFeedbackSet {
        synchronized(this){
            if (getAttributeInfo().indexSize == 0)
            ...
            if (value == null){
                value = new ArrayList<NotifyRequestDMO>(getAttributeInfo().indexSize);
