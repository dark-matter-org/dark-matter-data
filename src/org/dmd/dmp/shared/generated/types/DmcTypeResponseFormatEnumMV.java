...
import org.dmd.dmp.shared.generated.enums.ResponseFormatEnum;         // DmcType import - (MVTypeFormatter.java:63)
 ...
 *    Called from: org.dmd.dms.tools.generation.dmogen.DmoTypeFormatter.dumpEnumType(DmoTypeFormatter.java:346)
 */
@SuppressWarnings("serial")
public class DmcTypeResponseFormatEnumMV extends DmcTypeResponseFormatEnum implements Serializable {
    
    private final static Iterator<ResponseFormatEnum> emptyList = (new ArrayList<ResponseFormatEnum>()).iterator();
    ...
    public DmcTypeResponseFormatEnumMV getNew(){
        return(new DmcTypeResponseFormatEnumMV(getAttributeInfo()));
    }
    ...
    public ResponseFormatEnum add(Object v) throws DMFeedbackSet {
        synchronized(this){
    ...
    public ResponseFormatEnum setMVnth(int index, Object v) throws DMFeedbackSet {
        synchronized(this){
            if (getAttributeInfo().indexSize == 0)
            ...
            if (value == null){
                value = new ArrayList<ResponseFormatEnum>(getAttributeInfo().indexSize);
