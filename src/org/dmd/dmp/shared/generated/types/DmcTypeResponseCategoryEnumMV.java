...
import org.dmd.dmp.shared.generated.enums.ResponseCategoryEnum;         // DmcType import - (MVTypeFormatter.java:63)
...
public class DmcTypeResponseCategoryEnumMV extends DmcTypeResponseCategoryEnum implements Serializable {
    ...
    public ResponseCategoryEnum setMVnth(int index, Object v) throws DMFeedbackSet {
        synchronized(this){
            if (getAttributeInfo().indexSize == 0)
