...
import org.dmd.dmp.shared.generated.dmo.ActionResponseDMO;         //  - (DmoTypeFormatter.java:194)
...
abstract public class DmcTypeActionResponseREF extends DmcAttribute<ActionResponseDMO> implements Serializable {
    ...
    protected ActionResponseDMO typeCheck(Object value) throws DMFeedbackSet {
        if (value instanceof ActionResponseDMO)
            return((ActionResponseDMO)value);
        
        throw(new DMFeedbackSet("Object of class: " + value.getClass().getName() + " passed where object compatible with ActionResponseDMO expected."));
    }
