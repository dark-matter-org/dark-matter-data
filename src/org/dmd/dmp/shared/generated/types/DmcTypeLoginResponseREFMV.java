...
import org.dmd.dmp.shared.generated.dmo.LoginResponseDMO;         // DmcType import - (MVTypeFormatter.java:63)
...
public class DmcTypeLoginResponseREFMV extends DmcTypeLoginResponseREF implements Serializable {
    ...
    public DmcTypeLoginResponseREFMV getNew(){
        return(new DmcTypeLoginResponseREFMV(getAttributeInfo()));
    }
    ...
    public LoginResponseDMO setMVnth(int index, Object v) throws DMFeedbackSet {
        synchronized(this){
            if (getAttributeInfo().indexSize == 0)
            ...
            if (value == null){
                value = new ArrayList<LoginResponseDMO>(getAttributeInfo().indexSize);
