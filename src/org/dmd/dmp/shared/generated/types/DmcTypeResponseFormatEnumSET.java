...
import org.dmd.dmp.shared.generated.enums.ResponseFormatEnum;         // DmcType import - (SETTypeFormatter.java:59)
 ...
 *    Called from: org.dmd.dms.tools.dmogen.DmoTypeFormatter.dumpEnumType(DmoTypeFormatter.java:347)
 */
@SuppressWarnings("serial")
public class DmcTypeResponseFormatEnumSET extends DmcTypeResponseFormatEnum implements Serializable {
    
     private final static Iterator<ResponseFormatEnum> emptyList =  (new HashSet<ResponseFormatEnum>()).iterator();
    ...
    public Set<ResponseFormatEnum> getMVCopy(){
        synchronized(this){
            if (getAttributeInfo().valueType == ValueTypeEnum.HASHSET){
                if (value == null)
                    return(new HashSet<ResponseFormatEnum>());
                else
