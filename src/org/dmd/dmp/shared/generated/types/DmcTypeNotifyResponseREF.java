...
import org.dmd.dmp.shared.generated.dmo.NotifyResponseDMO;         //  - (DmoTypeFormatter.java:194)
...
abstract public class DmcTypeNotifyResponseREF extends DmcAttribute<NotifyResponseDMO> implements Serializable {
    ...
    protected NotifyResponseDMO typeCheck(Object value) throws DMFeedbackSet {
        if (value instanceof NotifyResponseDMO)
            return((NotifyResponseDMO)value);
        
        throw(new DMFeedbackSet("Object of class: " + value.getClass().getName() + " passed where object compatible with NotifyResponseDMO expected."));
    }
