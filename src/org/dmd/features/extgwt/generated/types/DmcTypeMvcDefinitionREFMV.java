...
public class DmcTypeMvcDefinitionREFMV extends DmcTypeMvcDefinitionREF implements Serializable {
    ...
    protected ArrayList<MvcDefinitionREF> value;
    ...
    public MvcDefinitionREF getMVnth(int index){
        synchronized(this){
            if (value == null)
                return(null);
    ...
    public MvcDefinitionREF setMVnth(int index, Object v) throws DmcValueException {
        synchronized(this){
            if (attrInfo.indexSize == 0)
            ...
            if (value == null){
                value = new ArrayList<MvcDefinitionREF>(attrInfo.indexSize);
