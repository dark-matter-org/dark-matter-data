...
public class DmcTypeMvcMenuREFMV extends DmcTypeMvcMenuREF implements Serializable {
    ...
    protected ArrayList<MvcMenuREF> value;
    ...
    public MvcMenuREF getMVnth(int index){
        synchronized(this){
            if (value == null)
                return(null);
    ...
    public MvcMenuREF setMVnth(int index, Object v) throws DmcValueException {
        synchronized(this){
            if (attrInfo.indexSize == 0)
            ...
            if (value == null){
                value = new ArrayList<MvcMenuREF>(attrInfo.indexSize);
