...
public class DmcTypeMvcMultiViewREFMV extends DmcTypeMvcMultiViewREF implements Serializable {
    ...
    protected ArrayList<MvcMultiViewREF> value;
    ...
    public MvcMultiViewREF getMVnth(int index){
        synchronized(this){
            if (value == null)
                return(null);
    ...
    public MvcMultiViewREF setMVnth(int index, Object v) throws DmcValueException {
        synchronized(this){
            if (attrInfo.indexSize == 0)
            ...
            if (value == null){
                value = new ArrayList<MvcMultiViewREF>(attrInfo.indexSize);
