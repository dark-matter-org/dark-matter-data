...
public class DmcTypeMvcApplicationREFMV extends DmcTypeMvcApplicationREF implements Serializable {
    ...
    protected ArrayList<MvcApplicationREF> value;
    ...
    public MvcApplicationREF getMVnth(int index){
        synchronized(this){
            if (value == null)
                return(null);
    ...
    public MvcApplicationREF setMVnth(int index, Object v) throws DmcValueException {
        synchronized(this){
            if (attrInfo.indexSize == 0)
            ...
            if (value == null){
                value = new ArrayList<MvcApplicationREF>(attrInfo.indexSize);
