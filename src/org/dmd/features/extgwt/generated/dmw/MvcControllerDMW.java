...
abstract public class MvcControllerDMW extends MvcDefinition implements DmcNamedObjectIF {
    ...
    public int getControlsViewSize(){
        DmcAttribute<?> attr = core.get(ExtgwtDMSAG.__controlsView);
        if (attr == null)
            return(0);
    ...
    public MvcViewIterableDMW getControlsViewIterable(){
        DmcAttribute attr = ((MvcControllerDMO) core).get(ExtgwtDMSAG.__controlsView);
        if (attr == null)
    ...
    public int getControlsMultiViewSize(){
        DmcAttribute<?> attr = core.get(ExtgwtDMSAG.__controlsMultiView);
        if (attr == null)
            return(0);
    ...
    public MvcMultiViewIterableDMW getControlsMultiViewIterable(){
        DmcAttribute attr = ((MvcControllerDMO) core).get(ExtgwtDMSAG.__controlsMultiView);
        if (attr == null)
    ...
    public MvcEventIterableDMW getHandlesEventIterable(){
        DmcAttribute attr = ((MvcControllerDMO) core).get(ExtgwtDMSAG.__handlesEvent);
        if (attr == null)
    ...
    public MvcServerEventIterableDMW getHandlesServerEventIterable(){
        DmcAttribute attr = ((MvcControllerDMO) core).get(ExtgwtDMSAG.__handlesServerEvent);
        if (attr == null)
    ...
    public MvcEventIterableDMW getDispatchesEventIterable(){
        DmcAttribute attr = ((MvcControllerDMO) core).get(ExtgwtDMSAG.__dispatchesEvent);
        if (attr == null)
            return(MvcEventIterableDMW.emptyList);
    ...
    public MvcRegistryItemIterableDMW getUsesRegistryItemIterable(){
        DmcAttribute attr = ((MvcControllerDMO) core).get(ExtgwtDMSAG.__usesRegistryItem);
        if (attr == null)
    ...
    public MvcRegistryItemIterableDMW getCreatesRegistryItemIterable(){
        DmcAttribute attr = ((MvcControllerDMO) core).get(ExtgwtDMSAG.__createsRegistryItem);
        if (attr == null)
            return(MvcRegistryItemIterableDMW.emptyList);
    ...
    public int getDefinesActionSize(){
        DmcAttribute<?> attr = core.get(ExtgwtDMSAG.__definesAction);
        if (attr == null)
            return(0);
    ...
    public MvcActionIterableDMW getDefinesActionIterable(){
        DmcAttribute attr = ((MvcControllerDMO) core).get(ExtgwtDMSAG.__definesAction);
        if (attr == null)
    ...
    public int getDefinesMenuSize(){
        DmcAttribute<?> attr = core.get(ExtgwtDMSAG.__definesMenu);
        if (attr == null)
            return(0);
    ...
    public MvcMenuIterableDMW getDefinesMenuIterable(){
        DmcAttribute attr = ((MvcControllerDMO) core).get(ExtgwtDMSAG.__definesMenu);
        if (attr == null)
    ...
    public int getDefinesMenuItemSize(){
        DmcAttribute<?> attr = core.get(ExtgwtDMSAG.__definesMenuItem);
        if (attr == null)
            return(0);
    ...
    public MvcMenuItemIterableDMW getDefinesMenuItemIterable(){
        DmcAttribute attr = ((MvcControllerDMO) core).get(ExtgwtDMSAG.__definesMenuItem);
        if (attr == null)
    ...
    public int getDefinesMenuSeparatorSize(){
        DmcAttribute<?> attr = core.get(ExtgwtDMSAG.__definesMenuSeparator);
        if (attr == null)
            return(0);
    ...
    public MvcMenuSeparatorIterableDMW getDefinesMenuSeparatorIterable(){
        DmcAttribute attr = ((MvcControllerDMO) core).get(ExtgwtDMSAG.__definesMenuSeparator);
        if (attr == null)
