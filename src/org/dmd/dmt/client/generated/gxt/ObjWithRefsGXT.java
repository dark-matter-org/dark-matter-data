...
import org.dmd.dmt.client.generated.gxt.BaseObjGXT;                      // Derived class - (BaseDMWGeneratorNewest.java:1115)
import org.dmd.dmt.shared.generated.dmo.ClientCountFilterDMO;            // DMO reference - (BaseDMWGeneratorNewest.java:1009)
import org.dmd.dmt.shared.generated.dmo.DmtDMSAG;                        // Attribute attrIDs from the dmt schema - (BaseDMWGeneratorNewest.java:784)
...
public class ObjWithRefsGXT extends BaseObjGXT implements DmcNamedObjectIF {
    ...
    static final int anotherSVStringID = 10148;
    static final int enabledDisabledID = 10920;
    static final int nameID = 2;
    static final int objRefID = 10903;
    static final int onOffID = 10919;
    static final int someRelationSVID = 10921;
    static final int svBooleanID = 10000;
    static final int svStringID = 10141;
    static final int svTestEnumID = 10918;
    ...
    public <X> X set(String property, X value) {
        DmcAttributeInfo ai = core.getAttributeInfo(property);
			...
			try {
				...
				case anotherSVStringID:
				    ((ObjWithRefsDMO) core).setAnotherSVString(value);
				    break;
				case enabledDisabledID:
				    ((ObjWithRefsDMO) core).setEnabledDisabled(value);
				    break;
				case nameID:
				    ((ObjWithRefsDMO) core).setName(value);
