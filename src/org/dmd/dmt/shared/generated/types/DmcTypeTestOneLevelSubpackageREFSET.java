...
public class DmcTypeTestOneLevelSubpackageREFSET extends DmcTypeTestOneLevelSubpackageREF implements Serializable {
     ...
     private final static Iterator<TestOneLevelSubpackageREF> emptyList =  (new HashSet<TestOneLevelSubpackageREF>()).iterator();
    ...
    public Set<TestOneLevelSubpackageREF> getMVCopy(){
        synchronized(this){
            if (getAttributeInfo().valueType == ValueTypeEnum.HASHSET){
                if (value == null)
                    return(new HashSet<TestOneLevelSubpackageREF>());
                else
