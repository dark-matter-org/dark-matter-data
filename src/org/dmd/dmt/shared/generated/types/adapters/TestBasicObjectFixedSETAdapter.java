...
public class TestBasicObjectFixedSETAdapter extends DmcTypeTestBasicObjectFixedREFSET implements DmcAdapterIF {
    ...
    public void setExisting(DmcAttribute<?> attr) {
    	existingValue = (DmcTypeTestBasicObjectFixedREFSET) attr;
    	if (existingValue != null)
    		value = existingValue.getMVCopy();
    }
