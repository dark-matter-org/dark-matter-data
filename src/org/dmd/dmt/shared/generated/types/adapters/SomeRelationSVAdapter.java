...
public class SomeRelationSVAdapter extends DmcTypeSomeRelationSV implements DmcAdapterIF {

    transient DmcTypeSomeRelationSV existingValue;

    public SomeRelationSVAdapter(DmcAttributeInfo ai){
    	   attrInfo = ai;
    }
    ...
    public void setExisting(DmcAttribute<?> attr) {
    	existingValue = (DmcTypeSomeRelationSV) attr;
    	if (existingValue != null)
    		value = existingValue.getSVCopy();
    }
