...
import org.dmd.dmt.shared.generated.types.DmcTypeExtendedRefSVREFSV;

@SuppressWarnings("serial")
// org.dmd.dms.util.AdapterFormatter.dumpAdapter(AdapterFormatter.java:59)
// Called from: org.dmd.dms.util.AdapterFormatter.dumpAdapterSV(AdapterFormatter.java:12)
public class ExtendedRefSVSVAdapter extends DmcTypeExtendedRefSVREFSV implements DmcAdapterIF {
    ...
    public void setExisting(DmcAttribute<?> attr) {
    	existingValue = (DmcTypeExtendedRefSVREFSV) attr;
    	if (existingValue != null)
    		value = existingValue.getSVCopy();
    }
