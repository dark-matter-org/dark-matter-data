...
import org.dmd.dmt.shared.generated.types.DmcTypeClientCountFilterRequestREFSV;

@SuppressWarnings("serial")
// org.dmd.dms.util.AdapterFormatter.dumpAdapter(AdapterFormatter.java:59)
// Called from: org.dmd.dms.util.AdapterFormatter.dumpAdapterSV(AdapterFormatter.java:12)
public class ClientCountFilterRequestSVAdapter extends DmcTypeClientCountFilterRequestREFSV implements DmcAdapterIF {
    ...
    public void setExisting(DmcAttribute<?> attr) {
    	existingValue = (DmcTypeClientCountFilterRequestREFSV) attr;
    	if (existingValue != null)
    		value = existingValue.getSVCopy();
    }
