...
import org.dmd.dmt.shared.generated.types.DmcTypeExtendedRefHSREFSET;

@SuppressWarnings("serial")
// org.dmd.dms.util.AdapterFormatter.dumpAdapter(AdapterFormatter.java:59)
// Called from: org.dmd.dms.util.AdapterFormatter.dumpAdapterSET(AdapterFormatter.java:20)
public class ExtendedRefHSSETAdapter extends DmcTypeExtendedRefHSREFSET implements DmcAdapterIF {
    ...
    public void setExisting(DmcAttribute<?> attr) {
    	existingValue = (DmcTypeExtendedRefHSREFSET) attr;
    	if (existingValue != null)
    		value = existingValue.getMVCopy();
    }
