...
public class SomeRelationSETAdapter extends DmcTypeSomeRelationSET implements DmcAdapterIF {

    transient DmcTypeSomeRelationSET existingValue;

    public SomeRelationSETAdapter(DmcAttributeInfo ai){
    	   super(ai);
    }
    ...
    public void setExisting(DmcAttribute<?> attr) {
    	existingValue = (DmcTypeSomeRelationSET) attr;
    	if (existingValue != null)
    		value = existingValue.getMVCopy();
    }
