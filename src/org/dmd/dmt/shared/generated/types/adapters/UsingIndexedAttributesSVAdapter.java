...
import org.dmd.dmt.shared.generated.types.DmcTypeUsingIndexedAttributesREFSV;

@SuppressWarnings("serial")
// org.dmd.dms.util.AdapterFormatter.dumpAdapter(AdapterFormatter.java:59)
// Called from: org.dmd.dms.util.AdapterFormatter.dumpAdapterSV(AdapterFormatter.java:12)
public class UsingIndexedAttributesSVAdapter extends DmcTypeUsingIndexedAttributesREFSV implements DmcAdapterIF {
    ...
    public void setExisting(DmcAttribute<?> attr) {
    	existingValue = (DmcTypeUsingIndexedAttributesREFSV) attr;
    	if (existingValue != null)
    		value = existingValue.getSVCopy();
    }
