...
import org.dmd.dmt.shared.generated.types.DmcTypeUsingIndexedAttributesREFSET;

@SuppressWarnings("serial")
// org.dmd.dms.util.AdapterFormatter.dumpAdapter(AdapterFormatter.java:59)
// Called from: org.dmd.dms.util.AdapterFormatter.dumpAdapterSET(AdapterFormatter.java:20)
public class UsingIndexedAttributesSETAdapter extends DmcTypeUsingIndexedAttributesREFSET implements DmcAdapterIF {
    ...
    public void setExisting(DmcAttribute<?> attr) {
    	existingValue = (DmcTypeUsingIndexedAttributesREFSET) attr;
    	if (existingValue != null)
    		value = existingValue.getMVCopy();
    }
