...
public class ClientCountFilterSVAdapter extends DmcTypeClientCountFilterREFSV implements DmcAdapterIF {

    transient DmcTypeClientCountFilterREFSV existingValue;

    public ClientCountFilterSVAdapter(DmcAttributeInfo ai){
    	   super(ai);
    }
    ...
    public void setExisting(DmcAttribute<?> attr) {
    	existingValue = (DmcTypeClientCountFilterREFSV) attr;
    	if (existingValue != null)
    		value = existingValue.getSVCopy();
    }
