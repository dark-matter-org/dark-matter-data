...
import org.dmd.dmt.shared.generated.dmo.ComplexTypeTestDMO;    // DmcType import
/**
...
public class DmcTypeComplexTypeTestREFMV extends DmcTypeComplexTypeTestREF implements Serializable {
    
    private final static Iterator<ComplexTypeTestDMO> emptyList = (new ArrayList<ComplexTypeTestDMO>()).iterator();
    
    protected ArrayList<ComplexTypeTestDMO> value;
    
    public DmcTypeComplexTypeTestREFMV(){
    
    }
    
    public DmcTypeComplexTypeTestREFMV(DmcAttributeInfo ai){
        super(ai);
    }
    
    @Override
    public DmcTypeComplexTypeTestREFMV getNew(){
        return(new DmcTypeComplexTypeTestREFMV(getAttributeInfo()));
    }
    ...
    public DmcAttribute<ComplexTypeTestDMO> cloneIt(){
        synchronized(this){
            ...
            if (getAttributeInfo().indexSize == 0){
                for(ComplexTypeTestDMO val: value)
                try {
                    rc.add(val);
    ...
    public ComplexTypeTestDMO add(Object v) throws DmcValueException {
        synchronized(this){
            ...
            if (value == null)
                value = new ArrayList<ComplexTypeTestDMO>();
            value.add(rc);
            return(rc);
        }
    }
    ...
    public Iterator<ComplexTypeTestDMO> getMV(){
        synchronized(this){
            ...
            ArrayList<ComplexTypeTestDMO> clone = new ArrayList<ComplexTypeTestDMO>(value);
    ...
    public ArrayList<ComplexTypeTestDMO> getMVCopy(){
        synchronized(this){
            if (value == null)
                return(new ArrayList<ComplexTypeTestDMO>());
            else 
                return(new ArrayList<ComplexTypeTestDMO>(value));
        }
    }
    ...
    public ComplexTypeTestDMO setMVnth(int index, Object v) throws DmcValueException {
        synchronized(this){
            ...
            if (value == null){
                value = new ArrayList<ComplexTypeTestDMO>(getAttributeInfo().indexSize);
    ...
    public boolean contains(Object v){
        synchronized(this){
            ...
            try {
                ComplexTypeTestDMO val = typeCheck(v);
