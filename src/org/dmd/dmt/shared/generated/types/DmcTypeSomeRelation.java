...
// Called from: org.dmd.dms.util.GenUtility.dumpExtendedReferenceTypeDmcType(GenUtility.java:3250)
import org.dmd.dmc.DmcAttributeInfo;                            // Standard attribute interface - (GenUtility.java:3238)
import org.dmd.dmc.DmcInputStreamIF;                            // Serialization support - (GenUtility.java:3235)
import org.dmd.dmc.DmcOutputStreamIF;                           // Serialization support - (GenUtility.java:3236)
import org.dmd.dmc.DmcValueException;                           // Value exceptions - (GenUtility.java:3239)
import org.dmd.dmc.types.DefinitionName;                        // Name type - (GenUtility.java:3244)
import org.dmd.dmc.types.DmcTypeNamedObjectREF;                 // The class we extend - (GenUtility.java:3240)
import org.dmd.dmt.shared.generated.dmo.ObjWithRefsDMO;         // The class we refer to - (GenUtility.java:3242)
 ...
 * Generated from: org.dmd.dms.util.GenUtility.dumpExtendedReferenceTypeDmcType(GenUtility.java:3273)
