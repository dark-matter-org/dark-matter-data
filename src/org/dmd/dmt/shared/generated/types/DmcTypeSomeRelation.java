...
// Called from: org.dmd.dms.util.GenUtility.dumpExtendedReferenceTypeDmcType(GenUtility.java:3141)
import org.dmd.dmc.DmcAttributeInfo;                            // Standard attribute interface - (GenUtility.java:3129)
import org.dmd.dmc.DmcInputStreamIF;                            // Serialization support - (GenUtility.java:3126)
import org.dmd.dmc.DmcOutputStreamIF;                           // Serialization support - (GenUtility.java:3127)
import org.dmd.dmc.DmcValueException;                           // Value exceptions - (GenUtility.java:3130)
import org.dmd.dmc.types.DmcTypeNamedObjectREF;                 // The class we extend - (GenUtility.java:3131)
import org.dmd.dmc.types.StringName;                            // Name type - (GenUtility.java:3135)
import org.dmd.dmt.shared.generated.dmo.ObjWithRefsDMO;         // The class we refer to - (GenUtility.java:3133)
 ...
 * Generated from: org.dmd.dms.util.GenUtility.dumpExtendedReferenceTypeDmcType(GenUtility.java:3164)
