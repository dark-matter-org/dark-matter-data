...
// Called from: org.dmd.dms.util.GenUtility.dumpExtendedReferenceTypeDmcType(GenUtility.java:3457)
import org.dmd.dmc.DmcAttributeInfo;                            // Standard attribute interface - (GenUtility.java:3445)
import org.dmd.dmc.DmcInputStreamIF;                            // Serialization support - (GenUtility.java:3442)
import org.dmd.dmc.DmcOutputStreamIF;                           // Serialization support - (GenUtility.java:3443)
import org.dmd.dmc.DmcValueException;                           // Value exceptions - (GenUtility.java:3446)
import org.dmd.dmc.types.DefinitionName;                        // Name type - (GenUtility.java:3451)
import org.dmd.dmc.types.DmcTypeNamedObjectREF;                 // The class we extend - (GenUtility.java:3447)
import org.dmd.dmt.shared.generated.dmo.ObjWithRefsDMO;         // The class we refer to - (GenUtility.java:3449)
 ...
 * Generated from: org.dmd.dms.util.GenUtility.dumpExtendedReferenceTypeDmcType(GenUtility.java:3480)
