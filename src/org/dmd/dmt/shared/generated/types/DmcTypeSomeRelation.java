...
// Called from: org.dmd.dms.util.GenUtility.dumpExtendedReferenceTypeDmcType(GenUtility.java:3100)
import org.dmd.dmc.DmcAttributeInfo;                            // Standard attribute interface - (GenUtility.java:3088)
import org.dmd.dmc.DmcInputStreamIF;                            // Serialization support - (GenUtility.java:3085)
import org.dmd.dmc.DmcOutputStreamIF;                           // Serialization support - (GenUtility.java:3086)
import org.dmd.dmc.DmcValueException;                           // Value exceptions - (GenUtility.java:3089)
import org.dmd.dmc.types.DmcTypeNamedObjectREF;                 // The class we extend - (GenUtility.java:3090)
import org.dmd.dmc.types.StringName;                            // Name type - (GenUtility.java:3094)
import org.dmd.dmt.shared.generated.dmo.ObjWithRefsDMO;         // The class we refer to - (GenUtility.java:3092)
 ...
 * Generated from: org.dmd.dms.util.GenUtility.dumpExtendedReferenceTypeDmcType(GenUtility.java:3123)
