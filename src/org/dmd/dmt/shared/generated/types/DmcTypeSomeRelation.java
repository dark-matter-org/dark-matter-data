...
// Called from: org.dmd.dms.util.GenUtility.dumpExtendedReferenceTypeDmcType(GenUtility.java:3106)
import org.dmd.dmc.DmcAttributeInfo;                            // Standard attribute interface - (GenUtility.java:3094)
import org.dmd.dmc.DmcInputStreamIF;                            // Serialization support - (GenUtility.java:3091)
import org.dmd.dmc.DmcOutputStreamIF;                           // Serialization support - (GenUtility.java:3092)
import org.dmd.dmc.DmcValueException;                           // Value exceptions - (GenUtility.java:3095)
import org.dmd.dmc.types.DmcTypeNamedObjectREF;                 // The class we extend - (GenUtility.java:3096)
import org.dmd.dmc.types.StringName;                            // Name type - (GenUtility.java:3100)
import org.dmd.dmt.shared.generated.dmo.ObjWithRefsDMO;         // The class we refer to - (GenUtility.java:3098)
 ...
 * Generated from: org.dmd.dms.util.GenUtility.dumpExtendedReferenceTypeDmcType(GenUtility.java:3129)
