...
// Called from: org.dmd.dms.util.GenUtility.dumpExtendedReferenceTypeDmcType(GenUtility.java:3267)
import org.dmd.dmc.DmcAttributeInfo;                            // Standard attribute interface - (GenUtility.java:3255)
import org.dmd.dmc.DmcInputStreamIF;                            // Serialization support - (GenUtility.java:3252)
import org.dmd.dmc.DmcOutputStreamIF;                           // Serialization support - (GenUtility.java:3253)
import org.dmd.dmc.DmcValueException;                           // Value exceptions - (GenUtility.java:3256)
import org.dmd.dmc.types.DefinitionName;                        // Name type - (GenUtility.java:3261)
import org.dmd.dmc.types.DmcTypeNamedObjectREF;                 // The class we extend - (GenUtility.java:3257)
import org.dmd.dmt.shared.generated.dmo.ObjWithRefsDMO;         // The class we refer to - (GenUtility.java:3259)
 ...
 * Generated from: org.dmd.dms.util.GenUtility.dumpExtendedReferenceTypeDmcType(GenUtility.java:3290)
