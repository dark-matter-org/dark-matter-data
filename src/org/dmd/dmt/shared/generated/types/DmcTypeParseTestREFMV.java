...
public class DmcTypeParseTestREFMV extends DmcTypeParseTestREF implements Serializable {
    
    private final static Iterator<ParseTestDMO> emptyList = (new ArrayList<ParseTestDMO>()).iterator();
    
    protected ArrayList<ParseTestDMO> value;
    
    public DmcTypeParseTestREFMV(){
    
    }
    
    public DmcTypeParseTestREFMV(DmcAttributeInfo ai){
        super(ai);
    }
    
    @Override
    public DmcTypeParseTestREFMV getNew(){
        return(new DmcTypeParseTestREFMV(getAttributeInfo()));
    }
    ...
    public DmcAttribute<ParseTestDMO> cloneIt(){
        synchronized(this){
            DmcTypeParseTestREFMV rc = getNew();
    ...
    public ParseTestDMO add(Object v) throws DmcValueException {
        synchronized(this){
            ...
            if (value == null)
                value = new ArrayList<ParseTestDMO>();
            value.add(rc);
            return(rc);
        }
    }
    ...
    public Iterator<ParseTestDMO> getMV(){
        synchronized(this){
            ...
            ArrayList<ParseTestDMO> clone = new ArrayList<ParseTestDMO>(value);
            return(clone.iterator());
        }
    }
    
    // org.dmd.dms.util.GenUtility.dumpMVType(GenUtility.java:2433)
    public ArrayList<ParseTestDMO> getMVCopy(){
        synchronized(this){
            if (value == null)
                return(new ArrayList<ParseTestDMO>());
            else 
                return(new ArrayList<ParseTestDMO>(value));
        }
    }
    ...
    public ParseTestDMO getMVnth(int index){
        synchronized(this){
            if (value == null)
                return(null);
    ...
    public ParseTestDMO setMVnth(int index, Object v) throws DmcValueException {
        synchronized(this){
            if (getAttributeInfo().indexSize == 0)
            ...
            if (value == null){
                value = new ArrayList<ParseTestDMO>(getAttributeInfo().indexSize);
