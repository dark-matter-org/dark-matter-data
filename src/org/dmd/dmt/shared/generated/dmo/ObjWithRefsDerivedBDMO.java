...
import org.dmd.dmt.shared.generated.dmo.ObjWithRefsDMO;             // Base class - (GenUtility.java:364)
...
public class ObjWithRefsDerivedBDMO  extends ObjWithRefsDMO  implements DmcNamedObjectIF, Serializable  {

    public final static String constructionClassName = "ObjWithRefsDerivedB";


    static {
    }

    public ObjWithRefsDerivedBDMO() {
        super("ObjWithRefsDerivedB");
    }

    protected ObjWithRefsDerivedBDMO(String oc) {
        super(oc);
    }

    @Override
    public ObjWithRefsDerivedBDMO getNew(){
        ObjWithRefsDerivedBDMO rc = new ObjWithRefsDerivedBDMO();
        return(rc);
    }

    @Override
    public ObjWithRefsDerivedBDMO getSlice(DmcSliceInfo info){
        ObjWithRefsDerivedBDMO rc = new ObjWithRefsDerivedBDMO();
        populateSlice(rc,info);
        return(rc);
    }

    public ObjWithRefsDerivedBDMO(DmcTypeModifierMV mods) {
        super("ObjWithRefsDerivedB");
        modrec(true);
        setModifier(mods);
    }

    public ObjWithRefsDerivedBDMO getModificationRecorder(){
        ObjWithRefsDerivedBDMO rc = new ObjWithRefsDerivedBDMO();
        rc.setName(getName());
    ...
    public boolean equals(Object obj){
        if (obj instanceof ObjWithRefsDerivedBDMO){
            return( getObjectName().equals( ((ObjWithRefsDerivedBDMO) obj).getObjectName()) );
        }
        return(false);
    }
