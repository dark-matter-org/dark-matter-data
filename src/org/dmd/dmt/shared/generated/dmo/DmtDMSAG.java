...
import org.dmd.dmp.shared.generated.dmo.DmpDMSAG;                              // Base class from DmpDMSAG - (DmoCompactSchemaFormatter.java:1190)
...
import org.dmd.dms.generated.types.DmcTypeIntegerSV;                           // Support for addition of svInteger values to the extensible InitRuleData class - (ClassDefinition.java:970)
import org.dmd.dms.generated.types.DmcTypeStringMV;                            // Support for addition of mvString values to the extensible InitRuleData class - (ClassDefinition.java:970)
import org.dmd.dms.generated.types.DmcTypeStringSV;                            // Support for addition of svString values to the extensible InitRuleData class - (ClassDefinition.java:970)
import org.dmd.dmt.shared.generated.types.DmcTypeDmtTestEnumSET;               // Support for addition of hsTestEnum values to the extensible InitRuleData class - (ClassDefinition.java:970)
import org.dmd.dmv.shared.extended.rulesdmo.CardinalityRule;                   // To instantiate rules of this type - (DmoCompactSchemaFormatter.java:1231)
import org.dmd.dmv.shared.extended.rulesdmo.InitRule;                          // To instantiate rules of this type - (DmoCompactSchemaFormatter.java:1231)
import org.dmd.dmv.shared.extended.rulesdmo.NumericRangeRule;                  // To instantiate rules of this type - (DmoCompactSchemaFormatter.java:1231)
import org.dmd.dmv.shared.extended.rulesdmo.RestrictReferencesRule;            // To instantiate rules of this type - (DmoCompactSchemaFormatter.java:1231)
import org.dmd.dmv.shared.extended.rulesdmo.StringSetRule;                     // To instantiate rules of this type - (DmoCompactSchemaFormatter.java:1231)
import org.dmd.dmv.shared.generated.dmo.CardinalityRuleDataDMO;                // To instantiate CardinalityRuleData rule data - (DmoCompactSchemaFormatter.java:1230)
import org.dmd.dmv.shared.generated.dmo.InitRuleDataDMO;                       // To instantiate InitRuleData rule data - (DmoCompactSchemaFormatter.java:1230)
...
import org.dmd.dmv.shared.generated.dmo.RestrictReferencesRuleDataDMO;         // To instantiate RestrictReferencesRuleData rule data - (DmoCompactSchemaFormatter.java:1230)
import org.dmd.dmv.shared.generated.dmo.StringSetRuleDataDMO;                  // To instantiate StringSetRuleData rule data - (DmoCompactSchemaFormatter.java:1230)
