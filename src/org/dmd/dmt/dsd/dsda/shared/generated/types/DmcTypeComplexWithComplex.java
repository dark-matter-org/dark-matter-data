...
/**
 * The DmcTypeComplexWithComplex class.
 ...
 */
abstract public class DmcTypeComplexWithComplex extends DmcTypeComplexTypeWithRefs<ComplexWithComplex> implements Serializable {
    ...
    protected void formatValueAsJSON(StringBuffer sb, int padding, String indent) {
        if (getMVSize() == 0){
            ...
            Iterator<ComplexWithComplex> it = getMV();
            while(it.hasNext()){
                ComplexWithComplex value = it.next();
    ...
    protected ComplexWithComplex typeCheck(Object value) throws DmcValueException {
        ComplexWithComplex rc = null;

        if (value instanceof ComplexWithComplex){
            rc = (ComplexWithComplex)value;
        }
        else if (value instanceof String){
            rc = new ComplexWithComplex((String)value);
        }
        else{
            throw(new DmcValueException("Object of class: " + value.getClass().getName() + " passed where object compatible with ComplexWithComplex expected."));
        }
        return(rc);
    }
     ...
     */
    public ComplexWithComplex cloneValue(ComplexWithComplex val){
        return(new ComplexWithComplex(val));
    }
    ...
    public ComplexWithComplex deserializeValue(DmcInputStreamIF dis) throws Exception {
        ComplexWithComplex rc = new ComplexWithComplex();
     ...
     */
    @Override
    public void resolveValue(DmcNameResolverIF resolver, ComplexWithComplex value, String attrName) throws DmcValueException {
     ...
     */
    @Override
    public void resolveValue(DmcNameResolverWithClashSupportIF resolver, ComplexWithComplex value, DmcObject object, DmcNameClashResolverIF ncr, DmcAttributeInfo ai) throws DmcValueException, DmcValueExceptionSet {
     ...
     */
    public void removeBackRefsFromValue(ComplexWithComplex value){
