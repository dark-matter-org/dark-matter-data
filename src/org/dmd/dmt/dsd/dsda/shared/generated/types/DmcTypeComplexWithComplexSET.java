...
public class DmcTypeComplexWithComplexSET extends DmcTypeComplexWithComplex implements Serializable {
    
     private final static Iterator<ComplexWithComplex> emptyList =  (new HashSet<ComplexWithComplex>()).iterator();
    ...
    void initValue(){
        if (getAttributeInfo().valueType == ValueTypeEnum.HASHSET)
            value = new HashSet<ComplexWithComplex>();
        else
            value = new TreeSet<ComplexWithComplex>();
    }
    
    @Override
    public DmcTypeComplexWithComplexSET getNew(){
        return(new DmcTypeComplexWithComplexSET(getAttributeInfo()));
    }
    ...
    public DmcAttribute<ComplexWithComplex> cloneIt(){
        synchronized(this){
            DmcTypeComplexWithComplexSET rc = getNew();
    ...
    public Iterator<ComplexWithComplex> getMV(){
        synchronized(this){
            ...
            if (getAttributeInfo().valueType == ValueTypeEnum.HASHSET)
                return( (new HashSet<ComplexWithComplex>(value)).iterator() );
            else
                return( (new TreeSet<ComplexWithComplex>(value)).iterator() );
        }
    }
        ...
        synchronized(this){
            if (getAttributeInfo().valueType == ValueTypeEnum.HASHSET){
                if (value == null)
                    ...
                    return(new HashSet<ComplexWithComplex>(value));
            }
            else{
                if (value == null)
                    return(new TreeSet<ComplexWithComplex>(value));
                else
                    return(new TreeSet<ComplexWithComplex>(value));
            }
        }
