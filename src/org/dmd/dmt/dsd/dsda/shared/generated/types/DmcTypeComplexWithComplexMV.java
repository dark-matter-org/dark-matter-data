...
import org.dmd.dmt.dsd.dsda.shared.generated.types.DmcTypeComplexWithComplex;    // DmcType import
/**
...
public class DmcTypeComplexWithComplexMV extends DmcTypeComplexWithComplex implements Serializable {
    
    private final static Iterator<ComplexWithComplex> emptyList = (new ArrayList<ComplexWithComplex>()).iterator();
    
    protected ArrayList<ComplexWithComplex> value;
    
    public DmcTypeComplexWithComplexMV(){
    
    }
    
    public DmcTypeComplexWithComplexMV(DmcAttributeInfo ai){
        super(ai);
    }
    
    @Override
    public DmcTypeComplexWithComplexMV getNew(){
        return(new DmcTypeComplexWithComplexMV(getAttributeInfo()));
    }
    ...
    public DmcAttribute<ComplexWithComplex> cloneIt(){
        synchronized(this){
            DmcTypeComplexWithComplexMV rc = getNew();
    
            if (value == null)
                return(rc);
    
            if (getAttributeInfo().indexSize == 0){
                for(ComplexWithComplex val: value)
                try {
                    rc.add(val);
    ...
    public ComplexWithComplex add(Object v) throws DmcValueException {
        synchronized(this){
            ComplexWithComplex rc = typeCheck(v);
            if (value == null)
                value = new ArrayList<ComplexWithComplex>();
            value.add(rc);
            return(rc);
        }
    }
    ...
    public Iterator<ComplexWithComplex> getMV(){
        synchronized(this){
            ...
            ArrayList<ComplexWithComplex> clone = new ArrayList<ComplexWithComplex>(value);
            return(clone.iterator());
        }
    }
    
    // org.dmd.dms.util.GenUtility.dumpMVType(GenUtility.java:2638)
    public ArrayList<ComplexWithComplex> getMVCopy(){
        synchronized(this){
            if (value == null)
                return(new ArrayList<ComplexWithComplex>());
            else 
                return(new ArrayList<ComplexWithComplex>(value));
        }
    }
    ...
    public ComplexWithComplex getMVnth(int index){
        synchronized(this){
            if (value == null)
                return(null);
    ...
    public ComplexWithComplex setMVnth(int index, Object v) throws DmcValueException {
        synchronized(this){
            if (getAttributeInfo().indexSize == 0)
            ...
            if (value == null){
                value = new ArrayList<ComplexWithComplex>(getAttributeInfo().indexSize);
    ...
    public boolean contains(Object v){
        synchronized(this){
            ...
            try {
                ComplexWithComplex val = typeCheck(v);
