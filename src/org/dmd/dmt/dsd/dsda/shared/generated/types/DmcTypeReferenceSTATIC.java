...
/**
 * The DmcTypeReferenceSTATIC provides static access to functions used to manage values of type Reference
...
public class DmcTypeReferenceSTATIC {
    ...
    public static DmcTypeReferenceSTATIC instance;
    static DmcTypeReferenceSV typeHelper;
    
    static {
        instance = new DmcTypeReferenceSTATIC();
    }
    ...
    public Reference typeCheck(Object value) throws DmcValueException {
    	   return(typeHelper.typeCheck(value));
    }
    
    public Reference cloneValue(Reference value) throws DmcValueException {
