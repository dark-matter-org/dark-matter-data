...
public class DmcTypeModuleAREFSET extends DmcTypeModuleAREF implements Serializable {
    
     private final static Iterator<ModuleAREF> emptyList =  (new HashSet<ModuleAREF>()).iterator();
    ...
    void initValue(){
        if (getAttributeInfo().valueType == ValueTypeEnum.HASHSET)
            value = new HashSet<ModuleAREF>();
        else
            value = new TreeSet<ModuleAREF>();
    }
    
    @Override
    public DmcTypeModuleAREFSET getNew(){
        return(new DmcTypeModuleAREFSET(getAttributeInfo()));
    }
    ...
    public DmcAttribute<ModuleAREF> cloneIt(){
        synchronized(this){
            DmcTypeModuleAREFSET rc = getNew();
    ...
    public Iterator<ModuleAREF> getMV(){
        synchronized(this){
            ...
            if (getAttributeInfo().valueType == ValueTypeEnum.HASHSET)
                return( (new HashSet<ModuleAREF>(value)).iterator() );
            else
                return( (new TreeSet<ModuleAREF>(value)).iterator() );
        }
    }
        ...
        synchronized(this){
            if (getAttributeInfo().valueType == ValueTypeEnum.HASHSET){
                if (value == null)
                    ...
                    return(new HashSet<ModuleAREF>(value));
            }
            else{
                if (value == null)
                    return(new TreeSet<ModuleAREF>(value));
                else
                    return(new TreeSet<ModuleAREF>(value));
            }
        }
