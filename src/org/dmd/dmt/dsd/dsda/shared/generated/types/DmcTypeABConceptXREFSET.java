...
public class DmcTypeABConceptXREFSET extends DmcTypeABConceptXREF implements Serializable {
    
     private final static Iterator<ABConceptXREF> emptyList =  (new HashSet<ABConceptXREF>()).iterator();
    ...
    void initValue(){
        if (getAttributeInfo().valueType == ValueTypeEnum.HASHSET)
            value = new HashSet<ABConceptXREF>();
        else
            value = new TreeSet<ABConceptXREF>();
    }
    
    @Override
    public DmcTypeABConceptXREFSET getNew(){
        return(new DmcTypeABConceptXREFSET(getAttributeInfo()));
    }
    ...
    public Iterator<ABConceptXREF> getMV(){
        synchronized(this){
            ...
            if (getAttributeInfo().valueType == ValueTypeEnum.HASHSET)
                return( (new HashSet<ABConceptXREF>(value)).iterator() );
            else
                return( (new TreeSet<ABConceptXREF>(value)).iterator() );
        }
    }
        ...
        synchronized(this){
            if (getAttributeInfo().valueType == ValueTypeEnum.HASHSET){
                if (value == null)
                    ...
                    return(new HashSet<ABConceptXREF>(value));
            }
            else{
                if (value == null)
                    return(new TreeSet<ABConceptXREF>(value));
                else
                    return(new TreeSet<ABConceptXREF>(value));
            }
        }
