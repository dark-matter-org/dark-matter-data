...
public class DmcTypeTypeAndAttributeMV extends DmcTypeTypeAndAttribute implements Serializable {
    
    private final static Iterator<TypeAndAttribute> emptyList = (new ArrayList<TypeAndAttribute>()).iterator();
    
    protected ArrayList<TypeAndAttribute> value;
    
    public DmcTypeTypeAndAttributeMV(){
    
    }
    
    public DmcTypeTypeAndAttributeMV(DmcAttributeInfo ai){
        super(ai);
    }
    
    @Override
    public DmcTypeTypeAndAttributeMV getNew(){
        return(new DmcTypeTypeAndAttributeMV(getAttributeInfo()));
    }
    ...
    public DmcAttribute<TypeAndAttribute> cloneIt(){
        synchronized(this){
            DmcTypeTypeAndAttributeMV rc = getNew();
    
            if (value == null)
                return(rc);
    
            if (getAttributeInfo().indexSize == 0){
                for(TypeAndAttribute val: value)
                try {
                    rc.add(val);
    ...
    public TypeAndAttribute add(Object v) throws DmcValueException {
        synchronized(this){
            ...
            if (value == null)
                value = new ArrayList<TypeAndAttribute>();
            value.add(rc);
            return(rc);
        }
    }
    ...
    public Iterator<TypeAndAttribute> getMV(){
        synchronized(this){
            ...
            ArrayList<TypeAndAttribute> clone = new ArrayList<TypeAndAttribute>(value);
            return(clone.iterator());
        }
    }
    
    // org.dmd.dms.util.GenUtility.dumpMVType(GenUtility.java:2638)
    public ArrayList<TypeAndAttribute> getMVCopy(){
        synchronized(this){
            if (value == null)
                return(new ArrayList<TypeAndAttribute>());
            else 
                return(new ArrayList<TypeAndAttribute>(value));
        }
    }
    ...
    public TypeAndAttribute getMVnth(int index){
        synchronized(this){
            if (value == null)
                return(null);
    ...
    public TypeAndAttribute setMVnth(int index, Object v) throws DmcValueException {
        synchronized(this){
            if (getAttributeInfo().indexSize == 0)
            ...
            if (value == null){
                value = new ArrayList<TypeAndAttribute>(getAttributeInfo().indexSize);
    ...
    public boolean contains(Object v){
        synchronized(this){
            ...
            try {
                TypeAndAttribute val = typeCheck(v);
