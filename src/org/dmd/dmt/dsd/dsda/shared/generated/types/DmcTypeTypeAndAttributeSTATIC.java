...
/**
 * The DmcTypeTypeAndAttributeSTATIC provides static access to functions used to manage values of type TypeAndAttribute
...
public class DmcTypeTypeAndAttributeSTATIC {
    ...
    public static DmcTypeTypeAndAttributeSTATIC instance;
    static DmcTypeTypeAndAttributeSV typeHelper;
    
    static {
        instance = new DmcTypeTypeAndAttributeSTATIC();
    }
    ...
    public TypeAndAttribute cloneValue(TypeAndAttribute value) throws DmcValueException {
