...
/**
 * The DmcTypeABConceptXREFSTATIC provides static access to functions used to manage values of type ABConceptXREF
...
public class DmcTypeABConceptXREFSTATIC {
    ...
    public static DmcTypeABConceptXREFSTATIC instance;
    static DmcTypeABConceptXREFSV typeHelper;
    
    static {
        instance = new DmcTypeABConceptXREFSTATIC();
    }
    ...
    public ABConceptXREF typeCheck(Object value) throws DmcValueException {
    	   return(typeHelper.typeCheck(value));
    }
    
    public ABConceptXREF cloneValue(ABConceptXREF value) throws DmcValueException {
