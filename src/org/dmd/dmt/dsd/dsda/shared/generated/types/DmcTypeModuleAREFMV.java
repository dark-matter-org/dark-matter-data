...
public class DmcTypeModuleAREFMV extends DmcTypeModuleAREF implements Serializable {
    
    private final static Iterator<ModuleAREF> emptyList = (new ArrayList<ModuleAREF>()).iterator();
    
    protected ArrayList<ModuleAREF> value;
    
    public DmcTypeModuleAREFMV(){
    
    }
    
    public DmcTypeModuleAREFMV(DmcAttributeInfo ai){
        super(ai);
    }
    
    @Override
    public DmcTypeModuleAREFMV getNew(){
        return(new DmcTypeModuleAREFMV(getAttributeInfo()));
    }
    ...
    public DmcAttribute<ModuleAREF> cloneIt(){
        synchronized(this){
            DmcTypeModuleAREFMV rc = getNew();
    
            if (value == null)
                return(rc);
    
            if (getAttributeInfo().indexSize == 0){
                for(ModuleAREF val: value)
                try {
                    rc.add(val);
    ...
    public ModuleAREF add(Object v) throws DmcValueException {
        synchronized(this){
            ModuleAREF rc = typeCheck(v);
            if (value == null)
                value = new ArrayList<ModuleAREF>();
            value.add(rc);
            return(rc);
        }
    }
    ...
    public Iterator<ModuleAREF> getMV(){
        synchronized(this){
            ...
            ArrayList<ModuleAREF> clone = new ArrayList<ModuleAREF>(value);
            return(clone.iterator());
        }
    }
    
    // org.dmd.dms.util.GenUtility.dumpMVType(GenUtility.java:2461)
    public ArrayList<ModuleAREF> getMVCopy(){
        synchronized(this){
            if (value == null)
                return(new ArrayList<ModuleAREF>());
            else 
                return(new ArrayList<ModuleAREF>(value));
        }
    }
    ...
    public ModuleAREF getMVnth(int index){
        synchronized(this){
            if (value == null)
                return(null);
    ...
    public ModuleAREF setMVnth(int index, Object v) throws DmcValueException {
        synchronized(this){
            if (getAttributeInfo().indexSize == 0)
            ...
            if (value == null){
                value = new ArrayList<ModuleAREF>(getAttributeInfo().indexSize);
