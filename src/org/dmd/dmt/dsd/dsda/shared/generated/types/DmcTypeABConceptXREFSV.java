...
public class DmcTypeABConceptXREFSV extends DmcTypeABConceptXREF implements Serializable {
    
    protected ABConceptXREF value;
    
    public DmcTypeABConceptXREFSV(){
    
    }
    
    public DmcTypeABConceptXREFSV(DmcAttributeInfo ai){
        super(ai);
    }
    
    public DmcTypeABConceptXREFSV getNew(){
        return(new DmcTypeABConceptXREFSV(getAttributeInfo()));
    }
    
    public DmcTypeABConceptXREFSV getNew(DmcAttributeInfo ai){
        return(new DmcTypeABConceptXREFSV(ai));
    }
    
    @Override
    // org.dmd.dms.util.GenUtility.dumpSVType(GenUtility.java:2203)
    public DmcAttribute<ABConceptXREF> cloneIt(){
        DmcTypeABConceptXREFSV rc = getNew();
        rc.value = value;
        return(rc);
    }
    
    // org.dmd.dms.util.GenUtility.dumpSVType(GenUtility.java:2214)
    public ABConceptXREF getSVCopy(){
        if (value == null)
            return(null);
    ...
    public ABConceptXREF set(Object v) throws DmcValueException {
