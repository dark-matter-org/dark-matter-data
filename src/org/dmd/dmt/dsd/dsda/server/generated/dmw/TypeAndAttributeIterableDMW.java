...
import org.dmd.dmt.dsd.dsda.shared.generated.types.TypeAndAttribute;         // This is the type we're iterating - (GenUtility.java:1928)
import org.dmd.dmw.DmwMVIterator;                                            // The base multi-value iterator - (GenUtility.java:1925)


/**
 * The TypeAndAttributeIterableDMW wraps an Iterator for a particular type and makes 
 * it Iterable.
 * <P>
...
public class TypeAndAttributeIterableDMW extends DmwMVIterator<TypeAndAttribute> {
    ...
    public final static TypeAndAttributeIterableDMW emptyList = new TypeAndAttributeIterableDMW();
