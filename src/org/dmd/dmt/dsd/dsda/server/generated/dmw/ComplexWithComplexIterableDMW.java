...
import org.dmd.dmt.dsd.dsda.shared.generated.types.ComplexWithComplex;         // This is the type we're iterating - (GenUtility.java:1928)
import org.dmd.dmw.DmwMVIterator;                                              // The base multi-value iterator - (GenUtility.java:1925)


/**
 * The ComplexWithComplexIterableDMW wraps an Iterator for a particular type and makes 
 * it Iterable.
 * <P>
...
public class ComplexWithComplexIterableDMW extends DmwMVIterator<ComplexWithComplex> {
    ...
    public final static ComplexWithComplexIterableDMW emptyList = new ComplexWithComplexIterableDMW();
