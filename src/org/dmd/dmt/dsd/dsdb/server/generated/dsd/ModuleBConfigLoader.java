...
import org.dmd.dmt.dsd.dsdb.server.extended.ModuleB;                           // The module type we load - (InitializationInterfaceManager.java:69)
...
public class ModuleBConfigLoader extends ModuleBGenUtility {
    private ModuleBDefinitionManager definitionManager;
    
    public ModuleBConfigLoader() {
    ...
    public ModuleBDefinitionManager definitionManager() {
    ...
    @Override
    public void generate(ModuleB module, ConfigLocation location, ModuleBDefinitionManager definitions) throws ResultException, IOException {
        initializeDefinitions();
    }

    @Override
    public void generate(ModuleBDefinitionManager definitions) throws ResultException, IOException {
        initializeDefinitions();
    }
