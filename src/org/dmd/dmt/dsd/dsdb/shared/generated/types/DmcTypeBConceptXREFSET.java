...
public class DmcTypeBConceptXREFSET extends DmcTypeBConceptXREF implements Serializable {
    
     private final static Iterator<BConceptXREF> emptyList =  (new HashSet<BConceptXREF>()).iterator();
    ...
    void initValue(){
        if (getAttributeInfo().valueType == ValueTypeEnum.HASHSET)
            value = new HashSet<BConceptXREF>();
        else
            value = new TreeSet<BConceptXREF>();
    }
    
    @Override
    public DmcTypeBConceptXREFSET getNew(){
        return(new DmcTypeBConceptXREFSET(getAttributeInfo()));
    }
    ...
    public DmcAttribute<BConceptXREF> cloneIt(){
        synchronized(this){
            DmcTypeBConceptXREFSET rc = getNew();
    ...
    public Iterator<BConceptXREF> getMV(){
        synchronized(this){
            ...
            if (getAttributeInfo().valueType == ValueTypeEnum.HASHSET)
                return( (new HashSet<BConceptXREF>(value)).iterator() );
            else
                return( (new TreeSet<BConceptXREF>(value)).iterator() );
        }
    }
        ...
        synchronized(this){
            if (getAttributeInfo().valueType == ValueTypeEnum.HASHSET){
                if (value == null)
                    ...
                    return(new HashSet<BConceptXREF>(value));
            }
            else{
                if (value == null)
                    return(new TreeSet<BConceptXREF>(value));
                else
                    return(new TreeSet<BConceptXREF>(value));
            }
        }
