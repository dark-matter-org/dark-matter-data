...
public class DmcTypeBConceptBaseREFMV extends DmcTypeBConceptBaseREF implements Serializable {
    
    private final static Iterator<BConceptBaseREF> emptyList = (new ArrayList<BConceptBaseREF>()).iterator();
    
    protected ArrayList<BConceptBaseREF> value;
    
    public DmcTypeBConceptBaseREFMV(){
    
    }
    
    public DmcTypeBConceptBaseREFMV(DmcAttributeInfo ai){
        super(ai);
    }
    
    @Override
    public DmcTypeBConceptBaseREFMV getNew(){
        return(new DmcTypeBConceptBaseREFMV(getAttributeInfo()));
    }
    ...
    public DmcAttribute<BConceptBaseREF> cloneIt(){
        synchronized(this){
            DmcTypeBConceptBaseREFMV rc = getNew();
    
            if (value == null)
                return(rc);
    
            if (getAttributeInfo().indexSize == 0){
                for(BConceptBaseREF val: value)
                try {
                    rc.add(val);
    ...
    public BConceptBaseREF add(Object v) throws DmcValueException {
        synchronized(this){
            ...
            if (value == null)
                value = new ArrayList<BConceptBaseREF>();
            value.add(rc);
            return(rc);
        }
    }
    ...
    public BConceptBaseREF del(Object v){
        synchronized(this){
            if (value == null)
                return(null);
    
            BConceptBaseREF key = null;
    ...
    public Iterator<BConceptBaseREF> getMV(){
        synchronized(this){
            ...
            ArrayList<BConceptBaseREF> clone = new ArrayList<BConceptBaseREF>(value);
            return(clone.iterator());
        }
    }
    
    // org.dmd.dms.util.GenUtility.dumpMVType(GenUtility.java:2464)
    public ArrayList<BConceptBaseREF> getMVCopy(){
        synchronized(this){
            if (value == null)
                return(new ArrayList<BConceptBaseREF>());
            else 
                return(new ArrayList<BConceptBaseREF>(value));
        }
    }
    ...
    public BConceptBaseREF getMVnth(int index){
        synchronized(this){
            if (value == null)
                return(null);
    ...
    public BConceptBaseREF setMVnth(int index, Object v) throws DmcValueException {
        synchronized(this){
            if (getAttributeInfo().indexSize == 0)
            ...
            if (value == null){
                value = new ArrayList<BConceptBaseREF>(getAttributeInfo().indexSize);
