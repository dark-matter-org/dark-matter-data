...
public class DmcTypeCConceptXREFMV extends DmcTypeCConceptXREF implements Serializable {
    
    private final static Iterator<CConceptXREF> emptyList = (new ArrayList<CConceptXREF>()).iterator();
    
    protected ArrayList<CConceptXREF> value;
    
    public DmcTypeCConceptXREFMV(){
    
    }
    
    public DmcTypeCConceptXREFMV(DmcAttributeInfo ai){
        super(ai);
    }
    
    @Override
    public DmcTypeCConceptXREFMV getNew(){
        return(new DmcTypeCConceptXREFMV(getAttributeInfo()));
    }
    ...
    public CConceptXREF add(Object v) throws DmcValueException {
        synchronized(this){
            ...
            if (value == null)
                value = new ArrayList<CConceptXREF>();
            value.add(rc);
            return(rc);
        }
    }
    ...
    public Iterator<CConceptXREF> getMV(){
        synchronized(this){
            ...
            ArrayList<CConceptXREF> clone = new ArrayList<CConceptXREF>(value);
    ...
    public ArrayList<CConceptXREF> getMVCopy(){
        synchronized(this){
            if (value == null)
                return(new ArrayList<CConceptXREF>());
            else 
                return(new ArrayList<CConceptXREF>(value));
        }
    }
    ...
    public CConceptXREF setMVnth(int index, Object v) throws DmcValueException {
        synchronized(this){
            ...
            if (value == null){
                value = new ArrayList<CConceptXREF>(getAttributeInfo().indexSize);
