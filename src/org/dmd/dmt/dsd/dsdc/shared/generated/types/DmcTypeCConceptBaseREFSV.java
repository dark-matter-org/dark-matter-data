...
public class DmcTypeCConceptBaseREFSV extends DmcTypeCConceptBaseREF implements Serializable {
    ...
    public DmcTypeCConceptBaseREFSV(DmcAttributeInfo ai){
        super(ai);
    }
    ...
    public DmcTypeCConceptBaseREFSV getNew(DmcAttributeInfo ai){
        return(new DmcTypeCConceptBaseREFSV(ai));
    }
    
    @Override
    // org.dmd.dms.util.GenUtility.dumpSVType(GenUtility.java:2183)
    public DmcAttribute<CConceptBaseREF> cloneIt(){
        DmcTypeCConceptBaseREFSV rc = getNew();
        rc.value = value;
        return(rc);
    }
    ...
    public CConceptBaseREF set(Object v) throws DmcValueException {
