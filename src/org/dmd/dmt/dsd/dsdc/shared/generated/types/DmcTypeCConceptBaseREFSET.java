...
public class DmcTypeCConceptBaseREFSET extends DmcTypeCConceptBaseREF implements Serializable {
    
     private final static Iterator<CConceptBaseREF> emptyList =  (new HashSet<CConceptBaseREF>()).iterator();
    ...
    void initValue(){
        if (getAttributeInfo().valueType == ValueTypeEnum.HASHSET)
            value = new HashSet<CConceptBaseREF>();
        else
            value = new TreeSet<CConceptBaseREF>();
    }
    
    @Override
    public DmcTypeCConceptBaseREFSET getNew(){
        return(new DmcTypeCConceptBaseREFSET(getAttributeInfo()));
    }
    ...
    public DmcAttribute<CConceptBaseREF> cloneIt(){
        synchronized(this){
            DmcTypeCConceptBaseREFSET rc = getNew();
    ...
    public Iterator<CConceptBaseREF> getMV(){
        synchronized(this){
            ...
            if (getAttributeInfo().valueType == ValueTypeEnum.HASHSET)
                return( (new HashSet<CConceptBaseREF>(value)).iterator() );
            else
                return( (new TreeSet<CConceptBaseREF>(value)).iterator() );
        }
    }
        ...
        synchronized(this){
            if (getAttributeInfo().valueType == ValueTypeEnum.HASHSET){
                if (value == null)
                    ...
                    return(new HashSet<CConceptBaseREF>(value));
            }
            else{
                if (value == null)
                    return(new TreeSet<CConceptBaseREF>(value));
                else
                    return(new TreeSet<CConceptBaseREF>(value));
            }
        }
