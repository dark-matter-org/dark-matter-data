...
import org.dmd.dmt.dsd.dsdc.shared.generated.dmo.CConceptBaseDMO; // primitive type
...
public class CConceptBaseREF extends DmcNamedObjectNontransportableREF<CConceptBaseDMO> {
    ...
    public CConceptBaseREF(){
    }

    public CConceptBaseREF(CConceptBaseDMO o){
         object = o;
         myName = (DmcTypeDefinitionNameSV)o.getObjectNameAttribute();
    }

    public CConceptBaseREF(DefinitionName n) throws DmcValueException {
         object = null;
         myName = new DmcTypeDefinitionNameSV(__name);
         myName.set(n);
    }

    public CConceptBaseREF(String n) throws DmcValueException {
         object = null;
         myName = new DmcTypeDefinitionNameSV(__name);
         myName.set(n);
    }

    public CConceptBaseREF(CConceptBaseREF original){
        myName = original.myName;
        object = original.object;
    }

    public void setObject(CConceptBaseDMO o){
         object = o;
         if (object != null)
             myName = (DmcTypeDefinitionNameSV)o.getObjectNameAttribute();
    }
     ...
     */
    public CConceptBaseREF cloneMe(){
