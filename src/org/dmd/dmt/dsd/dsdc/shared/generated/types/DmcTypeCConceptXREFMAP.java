...
// public class DmcTypeCConceptXREFMAP extends DmcTypeCConceptXREF<CConceptXREF,DefinitionName> {
public class DmcTypeCConceptXREFMAP extends DmcTypeCConceptXREF implements Serializable {
    
    private final static Iterator<CConceptXREF> emptyList = (new HashMap<DefinitionName,CConceptXREF>()).values().iterator();
    ...
    void initValue(){
        if (getAttributeInfo().valueType == ValueTypeEnum.HASHMAPPED)
            value = new HashMap<DefinitionName,CConceptXREF>();
        else
            value = new TreeMap<DefinitionName,CConceptXREF>();
    }
    ...
    public DefinitionName firstKey(){
        if (getAttributeInfo().valueType == ValueTypeEnum.TREEMAPPED){
            if (value == null)
                return(null);
            TreeMap<DefinitionName,CConceptXREF> map = (TreeMap<DefinitionName,CConceptXREF>)value;
            return(map.firstKey());
        }
    ...
    public DmcTypeCConceptXREFMAP getNew(){
        return(new DmcTypeCConceptXREFMAP(getAttributeInfo()));
    }
    ...
    public DmcAttribute<CConceptXREF> cloneIt(){
        synchronized(this){
            DmcTypeCConceptXREFMAP rc = getNew();
    
            if (value == null)
                return(rc);
    
            for(CConceptXREF val: value.values())
            try {
                rc.add(val);
    ...
    public CConceptXREF add(Object v) throws DmcValueException {
        synchronized(this){
            CConceptXREF newval = typeCheck(v);
            if (value == null)
                initValue();
            DefinitionName key = (DefinitionName)((DmcMappedAttributeIF)newval).getKey();
            CConceptXREF oldval = value.put(key,newval);
    ...
    public Iterator<CConceptXREF> getMV(){
        synchronized(this){
            ...
            Map<DefinitionName,CConceptXREF> clone = null;
            if (getAttributeInfo().valueType == ValueTypeEnum.HASHMAPPED)
                clone = new HashMap<DefinitionName,CConceptXREF>(value);
            else
                clone = new TreeMap<DefinitionName,CConceptXREF>(value);
    ...
    public Map<DefinitionName,CConceptXREF> getMVCopy(){
        synchronized(this){
            ...
            if (getAttributeInfo().valueType == ValueTypeEnum.HASHMAPPED){
                if (value == null)
                    clone = new HashMap<DefinitionName,CConceptXREF>();
                else
                    clone = new HashMap<DefinitionName,CConceptXREF>(value);
            }
            else{
                if (value == null)
                    clone = new TreeMap<DefinitionName,CConceptXREF>();
                else
                    clone = new TreeMap<DefinitionName,CConceptXREF>(value);
            }
            return(clone);
