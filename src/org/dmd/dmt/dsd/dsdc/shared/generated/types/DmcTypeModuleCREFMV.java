...
public class DmcTypeModuleCREFMV extends DmcTypeModuleCREF implements Serializable {
    
    private final static Iterator<ModuleCREF> emptyList = (new ArrayList<ModuleCREF>()).iterator();
    
    protected ArrayList<ModuleCREF> value;
    
    public DmcTypeModuleCREFMV(){
    
    }
    
    public DmcTypeModuleCREFMV(DmcAttributeInfo ai){
        super(ai);
    }
    
    @Override
    public DmcTypeModuleCREFMV getNew(){
        return(new DmcTypeModuleCREFMV(getAttributeInfo()));
    }
    ...
    public ModuleCREF add(Object v) throws DmcValueException {
        synchronized(this){
            ...
            if (value == null)
                value = new ArrayList<ModuleCREF>();
            value.add(rc);
            return(rc);
        }
    }
    ...
    public Iterator<ModuleCREF> getMV(){
        synchronized(this){
            ...
            ArrayList<ModuleCREF> clone = new ArrayList<ModuleCREF>(value);
            return(clone.iterator());
        }
    }
    
    // org.dmd.dms.util.GenUtility.dumpMVType(GenUtility.java:2638)
    public ArrayList<ModuleCREF> getMVCopy(){
        synchronized(this){
            if (value == null)
                return(new ArrayList<ModuleCREF>());
            else 
                return(new ArrayList<ModuleCREF>(value));
        }
    }
    ...
    public ModuleCREF getMVnth(int index){
        synchronized(this){
            if (value == null)
                return(null);
    ...
    public ModuleCREF setMVnth(int index, Object v) throws DmcValueException {
        synchronized(this){
            if (getAttributeInfo().indexSize == 0)
            ...
            if (value == null){
                value = new ArrayList<ModuleCREF>(getAttributeInfo().indexSize);
