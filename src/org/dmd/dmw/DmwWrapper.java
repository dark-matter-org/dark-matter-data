...
public abstract class DmwWrapper extends DmcContainer {
	 ...
	 * @throws DmcValueException
	 */
	public void addAux(ClassDefinition cd) throws DMFeedbackSet {
	...
	DmcNamedObjectIF resolve(SchemaManager sm, DmcNameResolverIF rx, AttributeDefinition ad, DmcNamedObjectREF obj) throws DMFeedbackSet {
		...
		if (resolved == null){
			DMFeedbackSet	dve = new DMFeedbackSet("Reference to object of type " + ad.getType().getObjectName() + " via attribute: " + ad.getName().getNameString() + " can't be found: " + obj.getObjectName());
			throw(dve);
		}
