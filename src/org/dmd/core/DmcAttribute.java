...
import org.dmd.core.presentation.DmcAdapterIF;
...
abstract public class DmcAttribute<VALUE> implements Cloneable, Serializable, Comparable<String> {
	 ...
	 */
	abstract protected VALUE typeCheck(Object value) throws DMFeedbackSet;
	 ...
	 * @throws DMFeedbackSet if the value is not compatible with the underlying type.
	 */
	public VALUE set(Object value) throws DMFeedbackSet {
	 ...
	 * @throws DMFeedbackSet if the value is not compatible with the underlying type.
	 */
	public VALUE add(Object value) throws DMFeedbackSet {
	 ...
	 * @return E
	 */
	public VALUE setMVnth(int index, Object value) throws DMFeedbackSet {
