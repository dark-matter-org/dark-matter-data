...
//		DebugInfo.debug("GET INFO [" + info.size() + "] " + ((DmcNamedObjectIF)this).getObjectName() + " " + index + " " + System.identityHashCode(this));
     ...
     */
    public void addAux(String cd) throws DMFeedbackSet {
    	DmcTypeClassDefinitionREFMV ocl = (DmcTypeClassDefinitionREFMV) get(__objectClass.id);
     ...
     * @throws DMFeedbackSet  
     */
    public void addAux(ClassDefinitionREF cd) throws DMFeedbackSet {
    	DmcTypeClassDefinitionREFMV ocl = (DmcTypeClassDefinitionREFMV) get(__objectClass.id);
	 ...
	 * @throws DMFeedbackSet 
	 */
	public <T extends DmcAttribute<?>> T set(String attrName, DmcAttribute<?> attr) throws DMFeedbackSet {
		DmcAttributeInfo ai = getAttributeInfo(attrName);
		
		if (ai == null){
			DMFeedbackSet dve = new DMFeedbackSet("Invalid attribute: " + attrName + " for class: " + this.getClass().getName());
			throw(dve);
		}
	...
	public <T extends DmcAttribute<?>> T set(DmcAttributeInfo ai, DmcAttribute<?> attr) throws DMFeedbackSet {		
		synchronized (attributes) {
...
//		}
	 ...
	 * @throws DMFeedbackSet 
	 */
	public <T extends DmcAttribute<?>> T add(String attrName, DmcAttribute<?> attr) throws DMFeedbackSet {
		DmcAttributeInfo ai = getAttributeInfo(attrName);
	 ...
	 */
	@SuppressWarnings("unchecked")
	public <T extends DmcAttribute<?>> T add(DmcAttributeInfo ai, DmcAttribute<?> attr) throws DMFeedbackSet {
		synchronized (attributes) {
...
//	 */
//	@SuppressWarnings("unchecked")
//	public <T extends DmcAttribute> T nth(String attrName, int index, DmcAttribute attr) throws DMFeedbackSet {
//		DmcAttributeInfo ai = getAttributeInfo(attrName);
//		
//		if (ai == null){
//			DMFeedbackSet dve = new DMFeedbackSet("Invalid attribute: " + attrName + " for class: " + this.getClass().getName());
...
//	}
	 ...
	 */
	@SuppressWarnings("unchecked")
	protected <T extends DmcAttribute<?>> T nth(DmcAttributeInfo ai, int index, DmcAttribute<?> attr, Object previous) throws DMFeedbackSet {
		synchronized (attributes) {
			DmcAttribute<?> existing = (DmcAttribute<?>) attributes.get(ai.id);
...
//        sb.append("\n" + indentPlus + "}");
	 ...
	 * @throws DMFeedbackSet
	 */
	public void resolveReferencesExceptClass(DmcNameResolverIF rx) throws DMFeedbackSet {
	 ...
	 * @throws DMFeedbackSet
	 */
	public void resolveReferences(DmcNameResolverWithClashSupportIF rx, DmcNameClashResolverIF ncr) throws DMFeedbackSet {
	...
	protected void resolveReferences(DmcNameResolverIF rx, boolean skipClass, DmcNameClashResolverIF ncr) throws DMFeedbackSet {
		synchronized (attributes) {
			DMFeedbackSet	errors = null;
...
//	 */
//	@SuppressWarnings("unchecked")
//	public void resolveReferencesWithBackrefs(DmcNameResolverIF rx, boolean skipClass) throws DMFeedbackSet {
//		synchronized (attributes) {
//			DMFeedbackSet	errors = null;
//	
//			for(DmcAttribute attr : attributes.values()){
...
//	}
	...
	protected void populateSlice(DmcObject sliceContainer, DmcSliceInfo info){
		synchronized (attributes) {
			...
			Iterator<Integer> attrIDs = info.getAttrIDs();
			while(attrIDs.hasNext()){
				Integer id = attrIDs.next();
	 ...
	 */
	@SuppressWarnings("unchecked")
	public boolean applyModifier(DmcTypeModifier mods) throws DMFeedbackSet {
		synchronized (attributes) {
