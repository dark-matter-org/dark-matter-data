...
import org.dmd.mvw.tools.mvwgenerator.generated.dmo.MenuBarDMO; // primitive type
...
public class MenuBarREF extends DmcNamedObjectNontransportableREF<MenuBarDMO> {
    ...
    public MenuBarREF(MenuBarDMO o){
         object = o;
         myName = (DmcTypeCamelCaseNameSV)o.getObjectNameAttribute();
    }

    public MenuBarREF(CamelCaseName n) throws DmcValueException {
         object = null;
         myName = new DmcTypeCamelCaseNameSV(__elementName);
         myName.set(n);
    }

    public MenuBarREF(String n) throws DmcValueException {
         object = null;
         myName = new DmcTypeCamelCaseNameSV(__elementName);
         myName.set(n);
    }

    public MenuBarREF(MenuBarREF original){
