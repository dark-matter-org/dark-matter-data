...
import org.dmd.mvw.tools.mvwgenerator.generated.dmo.SeparatorDMO; // primitive type
...
/**
 * This is the generated DmcAttribute derivative for values of type Separator
 * <P>
...
public class SeparatorREF extends DmcNamedObjectNontransportableREF<SeparatorDMO> {
    ...
    public SeparatorREF(SeparatorDMO o){
         object = o;
         myName = (DmcTypeCamelCaseNameSV)o.getObjectNameAttribute();
    }

    public SeparatorREF(CamelCaseName n) throws DmcValueException {
         object = null;
         myName = new DmcTypeCamelCaseNameSV(__elementName);
         myName.set(n);
    }

    public SeparatorREF(String n) throws DmcValueException {
         object = null;
         myName = new DmcTypeCamelCaseNameSV(__elementName);
         myName.set(n);
    }

    public SeparatorREF(SeparatorREF original){
