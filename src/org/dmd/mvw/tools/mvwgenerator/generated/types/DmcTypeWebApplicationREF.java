...
import org.dmd.mvw.tools.mvwgenerator.generated.types.WebApplicationREF;

import org.dmd.mvw.tools.mvwgenerator.generated.dmo.WebApplicationDMO;

/**
 * This is the generated DmcAttribute derivative for values of type WebApplication
 * <P>
...
abstract public class DmcTypeWebApplicationREF extends DmcTypeNamedObjectREF<WebApplicationREF, CamelCaseName> {

    public DmcTypeWebApplicationREF(){
    
    }

    public DmcTypeWebApplicationREF(DmcAttributeInfo ai){
        super(ai);
    }
    ...
    protected String getDMOClassName(){
        return( WebApplicationDMO.class.getName());
    }

    @Override
    protected boolean isDMO(Object value){
        if (value instanceof WebApplicationDMO)
            return(true);
        return(false);
    }
