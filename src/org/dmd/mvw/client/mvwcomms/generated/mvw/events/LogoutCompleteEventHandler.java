...
// Called from: org.dmd.mvw.tools.mvwgenerator.util.GwtEventFormatter.dumpHandler(GwtEventFormatter.java:167)
...
public interface LogoutCompleteEventHandler extends EventHandler {

    void handleLogoutCompleteEvent(LogoutCompleteEvent event);
