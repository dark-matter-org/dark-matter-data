...
public class DmcTypePartCheckerRuleDataREFSET extends DmcTypePartCheckerRuleDataREF implements Serializable {
    
     private final static Iterator<PartCheckerRuleDataREF> emptyList =  (new HashSet<PartCheckerRuleDataREF>()).iterator();
    ...
    void initValue(){
        if (getAttributeInfo().valueType == ValueTypeEnum.HASHSET)
            value = new HashSet<PartCheckerRuleDataREF>();
        else
            value = new TreeSet<PartCheckerRuleDataREF>();
    }
    
    @Override
    public DmcTypePartCheckerRuleDataREFSET getNew(){
        return(new DmcTypePartCheckerRuleDataREFSET(getAttributeInfo()));
    }
    ...
    public DmcAttribute<PartCheckerRuleDataREF> cloneIt(){
        synchronized(this){
            DmcTypePartCheckerRuleDataREFSET rc = getNew();
    ...
    public Iterator<PartCheckerRuleDataREF> getMV(){
        synchronized(this){
            ...
            if (getAttributeInfo().valueType == ValueTypeEnum.HASHSET)
                return( (new HashSet<PartCheckerRuleDataREF>(value)).iterator() );
            else
                return( (new TreeSet<PartCheckerRuleDataREF>(value)).iterator() );
        }
    }
        ...
        synchronized(this){
            if (getAttributeInfo().valueType == ValueTypeEnum.HASHSET){
                if (value == null)
                    ...
                    return(new HashSet<PartCheckerRuleDataREF>(value));
            }
            else{
                if (value == null)
                    return(new TreeSet<PartCheckerRuleDataREF>(value));
                else
                    return(new TreeSet<PartCheckerRuleDataREF>(value));
            }
        }
