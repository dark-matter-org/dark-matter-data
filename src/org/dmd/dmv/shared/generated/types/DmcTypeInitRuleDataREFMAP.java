...
// public class DmcTypeInitRuleDataREFMAP extends DmcTypeInitRuleDataREF<InitRuleDataREF,RuleName> {
public class DmcTypeInitRuleDataREFMAP extends DmcTypeInitRuleDataREF implements Serializable {
    
    private final static Iterator<InitRuleDataREF> emptyList = (new HashMap<RuleName,InitRuleDataREF>()).values().iterator();
    
    protected Map<RuleName,InitRuleDataREF> value;
    
    public DmcTypeInitRuleDataREFMAP(){
        value = null;
    }
    
    public DmcTypeInitRuleDataREFMAP(DmcAttributeInfo ai){
        super(ai);
        initValue();
    }
    ...
    void initValue(){
        if (getAttributeInfo().valueType == ValueTypeEnum.HASHMAPPED)
            value = new HashMap<RuleName,InitRuleDataREF>();
        else
            value = new TreeMap<RuleName,InitRuleDataREF>();
    }
    ...
    public RuleName firstKey(){
        if (getAttributeInfo().valueType == ValueTypeEnum.TREEMAPPED){
            if (value == null)
                return(null);
            TreeMap<RuleName,InitRuleDataREF> map = (TreeMap<RuleName,InitRuleDataREF>)value;
            return(map.firstKey());
        }
    ...
    @Override
    public DmcTypeInitRuleDataREFMAP getNew(){
        return(new DmcTypeInitRuleDataREFMAP(getAttributeInfo()));
    }
    ...
    public DmcAttribute<InitRuleDataREF> cloneIt(){
        synchronized(this){
            DmcTypeInitRuleDataREFMAP rc = getNew();
    
            if (value == null)
                return(rc);
    
            for(InitRuleDataREF val: value.values())
            try {
                rc.add(val);
    ...
    public InitRuleDataREF del(Object key){
        synchronized(this){
    ...
    public Iterator<InitRuleDataREF> getMV(){
        synchronized(this){
            ...
            Map<RuleName,InitRuleDataREF> clone = null;
            if (getAttributeInfo().valueType == ValueTypeEnum.HASHMAPPED)
                clone = new HashMap<RuleName,InitRuleDataREF>(value);
            else
                clone = new TreeMap<RuleName,InitRuleDataREF>(value);
            return(clone.values().iterator());
        }
    }
    
    // org.dmd.dms.util.GenUtility.dumpMAPType(GenUtility.java:3155)
    public Map<RuleName,InitRuleDataREF> getMVCopy(){
        synchronized(this){
            Map<RuleName,InitRuleDataREF> clone = null;
            if (getAttributeInfo().valueType == ValueTypeEnum.HASHMAPPED){
                if (value == null)
                    clone = new HashMap<RuleName,InitRuleDataREF>();
                else
                    clone = new HashMap<RuleName,InitRuleDataREF>(value);
            }
            else{
                if (value == null)
                    clone = new TreeMap<RuleName,InitRuleDataREF>();
                else
                    clone = new TreeMap<RuleName,InitRuleDataREF>(value);
            }
            return(clone);
    ...
    public InitRuleDataREF getByKey(Object key){
        synchronized(this){
           if (value == null)
               return(null);
