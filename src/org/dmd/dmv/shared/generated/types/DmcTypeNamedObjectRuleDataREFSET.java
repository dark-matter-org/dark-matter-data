...
public class DmcTypeNamedObjectRuleDataREFSET extends DmcTypeNamedObjectRuleDataREF implements Serializable {
    
     private final static Iterator<NamedObjectRuleDataREF> emptyList =  (new HashSet<NamedObjectRuleDataREF>()).iterator();
    ...
    void initValue(){
        if (getAttributeInfo().valueType == ValueTypeEnum.HASHSET)
            value = new HashSet<NamedObjectRuleDataREF>();
        else
            value = new TreeSet<NamedObjectRuleDataREF>();
    }
    
    @Override
    public DmcTypeNamedObjectRuleDataREFSET getNew(){
        return(new DmcTypeNamedObjectRuleDataREFSET(getAttributeInfo()));
    }
    ...
    public DmcAttribute<NamedObjectRuleDataREF> cloneIt(){
        synchronized(this){
            DmcTypeNamedObjectRuleDataREFSET rc = getNew();
    ...
    public Iterator<NamedObjectRuleDataREF> getMV(){
        synchronized(this){
            ...
            if (getAttributeInfo().valueType == ValueTypeEnum.HASHSET)
                return( (new HashSet<NamedObjectRuleDataREF>(value)).iterator() );
            else
                return( (new TreeSet<NamedObjectRuleDataREF>(value)).iterator() );
        }
    }
        ...
        synchronized(this){
            if (getAttributeInfo().valueType == ValueTypeEnum.HASHSET){
                if (value == null)
                    ...
                    return(new HashSet<NamedObjectRuleDataREF>(value));
            }
            else{
                if (value == null)
                    return(new TreeSet<NamedObjectRuleDataREF>(value));
                else
                    return(new TreeSet<NamedObjectRuleDataREF>(value));
            }
        }
