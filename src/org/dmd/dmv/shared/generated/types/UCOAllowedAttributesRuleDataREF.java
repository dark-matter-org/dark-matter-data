...
import org.dmd.dmv.shared.generated.dmo.UCOAllowedAttributesRuleDataDMO; // primitive type
...
public class UCOAllowedAttributesRuleDataREF extends DmcNamedObjectNontransportableREF<UCOAllowedAttributesRuleDataDMO> {
    ...
    public UCOAllowedAttributesRuleDataREF(){
    }

    // Generated from: org.dmd.dms.util.DmoTypeFormatter.dumpNamedREF(DmoTypeFormatter.java:441)
    public UCOAllowedAttributesRuleDataREF(UCOAllowedAttributesRuleDataDMO o){
         object = o;
    ...
    public UCOAllowedAttributesRuleDataREF(RuleName n) throws DmcValueException {
         object = null;
    ...
    public UCOAllowedAttributesRuleDataREF(String n) throws DmcValueException {
         object = null;
         myName = new DmcTypeRuleNameSV(__ruleName);
         myName.set(n);
    }
    ...
    public UCOAllowedAttributesRuleDataREF(UCOAllowedAttributesRuleDataREF original){
        myName = original.myName;
        object = original.object;
    }

    // Generated from: org.dmd.dms.util.DmoTypeFormatter.dumpNamedREF(DmoTypeFormatter.java:467)
    public void setObject(UCOAllowedAttributesRuleDataDMO o){
         object = o;
         if (object != null)
             myName = (DmcTypeRuleNameSV)o.getObjectNameAttribute();
    }
    ...
    public UCOAllowedAttributesRuleDataREF cloneMe(){
