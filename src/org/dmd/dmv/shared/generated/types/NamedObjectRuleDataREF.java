...
import org.dmd.dmv.shared.generated.dmo.NamedObjectRuleDataDMO; // primitive type
...
public class NamedObjectRuleDataREF extends DmcNamedObjectNontransportableREF<NamedObjectRuleDataDMO> {
    ...
    public NamedObjectRuleDataREF(RuleName n) throws DmcValueException {
         object = null;
    ...
    public NamedObjectRuleDataREF(String n) throws DmcValueException {
         object = null;
         myName = new DmcTypeRuleNameSV(__ruleName);
         myName.set(n);
    }
    ...
    public NamedObjectRuleDataREF(NamedObjectRuleDataREF original){
        myName = original.myName;
        object = original.object;
    }

    // Generated from: org.dmd.dms.util.DmoTypeFormatter.dumpNamedREF(DmoTypeFormatter.java:467)
    public void setObject(NamedObjectRuleDataDMO o){
         object = o;
         if (object != null)
             myName = (DmcTypeRuleNameSV)o.getObjectNameAttribute();
    }
    ...
    public NamedObjectRuleDataREF cloneMe(){
