...
public class DmcTypeNumericRangeRuleDataREFMV extends DmcTypeNumericRangeRuleDataREF implements Serializable {
    ...
    public DmcTypeNumericRangeRuleDataREFMV(DmcAttributeInfo ai){
        super(ai);
    }
    
    @Override
    public DmcTypeNumericRangeRuleDataREFMV getNew(){
        return(new DmcTypeNumericRangeRuleDataREFMV(getAttributeInfo()));
    }
