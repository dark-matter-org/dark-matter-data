...
public class DmcTypeValueLengthRuleDataREFSET extends DmcTypeValueLengthRuleDataREF implements Serializable {
    
     private final static Iterator<ValueLengthRuleDataREF> emptyList =  (new HashSet<ValueLengthRuleDataREF>()).iterator();
    
    
    protected Set<ValueLengthRuleDataREF> value;
    
    public DmcTypeValueLengthRuleDataREFSET(){
        value = null;
    }
    
    public DmcTypeValueLengthRuleDataREFSET(DmcAttributeInfo ai){
        super(ai);
        initValue();
    }
    ...
    void initValue(){
        if (getAttributeInfo().valueType == ValueTypeEnum.HASHSET)
            value = new HashSet<ValueLengthRuleDataREF>();
        else
            value = new TreeSet<ValueLengthRuleDataREF>();
    }
    
    @Override
    public DmcTypeValueLengthRuleDataREFSET getNew(){
        return(new DmcTypeValueLengthRuleDataREFSET(getAttributeInfo()));
    }
    ...
    public DmcAttribute<ValueLengthRuleDataREF> cloneIt(){
        synchronized(this){
            DmcTypeValueLengthRuleDataREFSET rc = getNew();
    ...
    public Iterator<ValueLengthRuleDataREF> getMV(){
        synchronized(this){
            ...
            if (getAttributeInfo().valueType == ValueTypeEnum.HASHSET)
                return( (new HashSet<ValueLengthRuleDataREF>(value)).iterator() );
            else
                return( (new TreeSet<ValueLengthRuleDataREF>(value)).iterator() );
        }
    }
    
    // org.dmd.dms.util.GenUtility.dumpSETType(GenUtility.java:2931)
    public Set<ValueLengthRuleDataREF> getMVCopy(){
        synchronized(this){
            if (getAttributeInfo().valueType == ValueTypeEnum.HASHSET){
                if (value == null)
                    return(new HashSet<ValueLengthRuleDataREF>());
                else
                    return(new HashSet<ValueLengthRuleDataREF>(value));
            }
            else{
                if (value == null)
                    return(new TreeSet<ValueLengthRuleDataREF>(value));
                else
                    return(new TreeSet<ValueLengthRuleDataREF>(value));
            }
        }
