...
public class DmcTypePartCheckerRuleDataREFMV extends DmcTypePartCheckerRuleDataREF implements Serializable {
    
    private final static Iterator<PartCheckerRuleDataREF> emptyList = (new ArrayList<PartCheckerRuleDataREF>()).iterator();
    
    protected ArrayList<PartCheckerRuleDataREF> value;
    
    public DmcTypePartCheckerRuleDataREFMV(){
    
    }
    
    public DmcTypePartCheckerRuleDataREFMV(DmcAttributeInfo ai){
        super(ai);
    }
    
    @Override
    public DmcTypePartCheckerRuleDataREFMV getNew(){
        return(new DmcTypePartCheckerRuleDataREFMV(getAttributeInfo()));
    }
    ...
    public DmcAttribute<PartCheckerRuleDataREF> cloneIt(){
        synchronized(this){
            DmcTypePartCheckerRuleDataREFMV rc = getNew();
    
            if (value == null)
                return(rc);
    
            if (getAttributeInfo().indexSize == 0){
                for(PartCheckerRuleDataREF val: value)
                try {
                    rc.add(val);
    ...
    public PartCheckerRuleDataREF add(Object v) throws DmcValueException {
        synchronized(this){
            PartCheckerRuleDataREF rc = typeCheck(v);
            if (value == null)
                value = new ArrayList<PartCheckerRuleDataREF>();
            value.add(rc);
            return(rc);
        }
    }
    ...
    public PartCheckerRuleDataREF del(Object v){
        synchronized(this){
            ...
            PartCheckerRuleDataREF key = null;
    ...
    public Iterator<PartCheckerRuleDataREF> getMV(){
        synchronized(this){
            ...
            ArrayList<PartCheckerRuleDataREF> clone = new ArrayList<PartCheckerRuleDataREF>(value);
            return(clone.iterator());
        }
    }
    
    // org.dmd.dms.util.GenUtility.dumpMVType(GenUtility.java:2618)
    public ArrayList<PartCheckerRuleDataREF> getMVCopy(){
        synchronized(this){
            if (value == null)
                return(new ArrayList<PartCheckerRuleDataREF>());
            else 
                return(new ArrayList<PartCheckerRuleDataREF>(value));
        }
    }
    ...
    public PartCheckerRuleDataREF getMVnth(int index){
        synchronized(this){
            if (value == null)
                return(null);
    ...
    public PartCheckerRuleDataREF setMVnth(int index, Object v) throws DmcValueException {
        synchronized(this){
            if (getAttributeInfo().indexSize == 0)
            ...
            if (value == null){
                value = new ArrayList<PartCheckerRuleDataREF>(getAttributeInfo().indexSize);
