...
/**
 * The DmcTypeNumericRangeRuleDataREFSTATIC provides static access to functions used to manage values of type NumericRangeRuleDataREF
...
public class DmcTypeNumericRangeRuleDataREFSTATIC {
    ...
    public static DmcTypeNumericRangeRuleDataREFSTATIC instance;
    static DmcTypeNumericRangeRuleDataREFSV typeHelper;
    
    static {
        instance = new DmcTypeNumericRangeRuleDataREFSTATIC();
    }
    ...
    public NumericRangeRuleDataREF typeCheck(Object value) throws DmcValueException {
    	   return(typeHelper.typeCheck(value));
    }
    
    public NumericRangeRuleDataREF cloneValue(NumericRangeRuleDataREF value) throws DmcValueException {
