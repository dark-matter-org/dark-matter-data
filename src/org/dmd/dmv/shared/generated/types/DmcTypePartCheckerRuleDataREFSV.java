...
public class DmcTypePartCheckerRuleDataREFSV extends DmcTypePartCheckerRuleDataREF implements Serializable {
    ...
    public DmcTypePartCheckerRuleDataREFSV(DmcAttributeInfo ai){
        super(ai);
    }
    ...
    public DmcTypePartCheckerRuleDataREFSV getNew(DmcAttributeInfo ai){
        return(new DmcTypePartCheckerRuleDataREFSV(ai));
    }
    
    @Override
    // org.dmd.dms.util.GenUtility.dumpSVType(GenUtility.java:2029)
    public DmcAttribute<PartCheckerRuleDataREF> cloneIt(){
        DmcTypePartCheckerRuleDataREFSV rc = getNew();
        rc.value = value;
        return(rc);
    }
    ...
    public PartCheckerRuleDataREF set(Object v) throws DmcValueException {
