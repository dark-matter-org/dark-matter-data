...
public class ValueLengthRuleDataREF extends DmcNamedObjectNontransportableREF<ValueLengthRuleDataDMO> {
    ...
    public ValueLengthRuleDataREF(ValueLengthRuleDataDMO o){
         object = o;
    ...
    public ValueLengthRuleDataREF(RuleName n) throws DmcValueException {
         object = null;
    ...
    public ValueLengthRuleDataREF(String n) throws DmcValueException {
         object = null;
         myName = new DmcTypeRuleNameSV(__ruleName);
         myName.set(n);
    }
    ...
    public ValueLengthRuleDataREF(ValueLengthRuleDataREF original){
        myName = original.myName;
        object = original.object;
    }

    // Generated from: org.dmd.dms.util.DmoTypeFormatter.dumpNamedREF(DmoTypeFormatter.java:467)
    public void setObject(ValueLengthRuleDataDMO o){
         object = o;
         if (object != null)
             myName = (DmcTypeRuleNameSV)o.getObjectNameAttribute();
    }
