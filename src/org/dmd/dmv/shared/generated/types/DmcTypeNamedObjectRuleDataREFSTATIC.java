...
/**
 * The DmcTypeNamedObjectRuleDataREFSTATIC provides static access to functions used to manage values of type NamedObjectRuleDataREF
...
public class DmcTypeNamedObjectRuleDataREFSTATIC {
    ...
    public static DmcTypeNamedObjectRuleDataREFSTATIC instance;
    static DmcTypeNamedObjectRuleDataREFSV typeHelper;
    
    static {
        instance = new DmcTypeNamedObjectRuleDataREFSTATIC();
    }
    ...
    public NamedObjectRuleDataREF typeCheck(Object value) throws DmcValueException {
    	   return(typeHelper.typeCheck(value));
    }
    
    public NamedObjectRuleDataREF cloneValue(NamedObjectRuleDataREF value) throws DmcValueException {
