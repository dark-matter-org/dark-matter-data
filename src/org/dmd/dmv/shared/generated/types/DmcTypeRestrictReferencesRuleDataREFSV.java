...
public class DmcTypeRestrictReferencesRuleDataREFSV extends DmcTypeRestrictReferencesRuleDataREF implements Serializable {
    ...
    protected RestrictReferencesRuleDataREF value;
    
    public DmcTypeRestrictReferencesRuleDataREFSV(){
    
    }
    
    public DmcTypeRestrictReferencesRuleDataREFSV(DmcAttributeInfo ai){
        super(ai);
    }
    
    public DmcTypeRestrictReferencesRuleDataREFSV getNew(){
        return(new DmcTypeRestrictReferencesRuleDataREFSV(getAttributeInfo()));
    }
    
    public DmcTypeRestrictReferencesRuleDataREFSV getNew(DmcAttributeInfo ai){
        return(new DmcTypeRestrictReferencesRuleDataREFSV(ai));
    }
    ...
    @Override
    public RestrictReferencesRuleDataREF getSV(){
        return(value);
    }
