...
public class NumericRangeRuleDataREFMAPAdapter extends DmcTypeNumericRangeRuleDataREFMAP implements DmcAdapterIF {
    ...
    transient DmcTypeNumericRangeRuleDataREFMAP existingValue;

    public NumericRangeRuleDataREFMAPAdapter(DmcAttributeInfo ai){
    	   super(ai);
    }
    ...
    public void setExisting(DmcAttribute<?> attr) {
    	existingValue = (DmcTypeNumericRangeRuleDataREFMAP) attr;
    	if (existingValue != null)
    		value = existingValue.getMVCopy();
    }
