...
public class ValueLengthRuleDataREFSETAdapter extends DmcTypeValueLengthRuleDataREFSET implements DmcAdapterIF {
    ...
    transient DmcTypeValueLengthRuleDataREFSET existingValue;

    public ValueLengthRuleDataREFSETAdapter(DmcAttributeInfo ai){
    	   super(ai);
    }
    ...
    public void setExisting(DmcAttribute<?> attr) {
    	existingValue = (DmcTypeValueLengthRuleDataREFSET) attr;
    	if (existingValue != null)
    		value = existingValue.getMVCopy();
    }
