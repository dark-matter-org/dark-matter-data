...
import org.dmd.dmv.shared.generated.dmo.AttributeTypeRuleDataDMO; // primitive type
...
public class AttributeTypeRuleDataREF extends DmcNamedObjectNontransportableREF<AttributeTypeRuleDataDMO> {
    ...
    public AttributeTypeRuleDataREF(){
    }

    public AttributeTypeRuleDataREF(AttributeTypeRuleDataDMO o){
         object = o;
         myName = (DmcTypeRuleNameSV)o.getObjectNameAttribute();
    }

    public AttributeTypeRuleDataREF(RuleName n) throws DmcValueException {
         object = null;
         myName = new DmcTypeRuleNameSV(__ruleName);
         myName.set(n);
    }

    public AttributeTypeRuleDataREF(String n) throws DmcValueException {
         object = null;
         myName = new DmcTypeRuleNameSV(__ruleName);
         myName.set(n);
    }

    public AttributeTypeRuleDataREF(AttributeTypeRuleDataREF original){
        myName = original.myName;
        object = original.object;
    }

    public void setObject(AttributeTypeRuleDataDMO o){
         object = o;
         if (object != null)
             myName = (DmcTypeRuleNameSV)o.getObjectNameAttribute();
    }
     ...
     */
    public AttributeTypeRuleDataREF cloneMe(){
