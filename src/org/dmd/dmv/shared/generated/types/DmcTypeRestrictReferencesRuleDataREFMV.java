...
public class DmcTypeRestrictReferencesRuleDataREFMV extends DmcTypeRestrictReferencesRuleDataREF implements Serializable {
    
    private final static Iterator<RestrictReferencesRuleDataREF> emptyList = (new ArrayList<RestrictReferencesRuleDataREF>()).iterator();
    
    protected ArrayList<RestrictReferencesRuleDataREF> value;
    
    public DmcTypeRestrictReferencesRuleDataREFMV(){
    
    }
    
    public DmcTypeRestrictReferencesRuleDataREFMV(DmcAttributeInfo ai){
        super(ai);
    }
    
    @Override
    public DmcTypeRestrictReferencesRuleDataREFMV getNew(){
        return(new DmcTypeRestrictReferencesRuleDataREFMV(getAttributeInfo()));
    }
    ...
    public DmcAttribute<RestrictReferencesRuleDataREF> cloneIt(){
        synchronized(this){
            DmcTypeRestrictReferencesRuleDataREFMV rc = getNew();
    ...
    public RestrictReferencesRuleDataREF add(Object v) throws DmcValueException {
        synchronized(this){
            ...
            if (value == null)
                value = new ArrayList<RestrictReferencesRuleDataREF>();
            value.add(rc);
            return(rc);
        }
    }
    ...
    public RestrictReferencesRuleDataREF del(Object v){
        synchronized(this){
            ...
            RestrictReferencesRuleDataREF key = null;
    ...
    public Iterator<RestrictReferencesRuleDataREF> getMV(){
        synchronized(this){
            ...
            ArrayList<RestrictReferencesRuleDataREF> clone = new ArrayList<RestrictReferencesRuleDataREF>(value);
            return(clone.iterator());
        }
    }
    
    // org.dmd.dms.util.GenUtility.dumpMVType(GenUtility.java:2635)
    public ArrayList<RestrictReferencesRuleDataREF> getMVCopy(){
        synchronized(this){
            if (value == null)
                return(new ArrayList<RestrictReferencesRuleDataREF>());
            else 
                return(new ArrayList<RestrictReferencesRuleDataREF>(value));
        }
    }
    ...
    public RestrictReferencesRuleDataREF getMVnth(int index){
        synchronized(this){
            if (value == null)
                return(null);
    ...
    public RestrictReferencesRuleDataREF setMVnth(int index, Object v) throws DmcValueException {
        synchronized(this){
            if (getAttributeInfo().indexSize == 0)
            ...
            if (value == null){
                value = new ArrayList<RestrictReferencesRuleDataREF>(getAttributeInfo().indexSize);
