...
public class NamedObjectRuleDataDMO  extends RuleDataDMO  implements DmcNamedObjectIF, Serializable  {

    public final static String constructionClassName = "NamedObjectRuleData";


    static {
    }

    public NamedObjectRuleDataDMO() {
        super("NamedObjectRuleData");
    }

    protected NamedObjectRuleDataDMO(String oc) {
        super(oc);
    }

    @Override
    public NamedObjectRuleDataDMO getNew(){
        NamedObjectRuleDataDMO rc = new NamedObjectRuleDataDMO();
        return(rc);
    }

    @Override
    public NamedObjectRuleDataDMO getSlice(DmcSliceInfo info){
        NamedObjectRuleDataDMO rc = new NamedObjectRuleDataDMO();
        populateSlice(rc,info);
        return(rc);
    }

    public NamedObjectRuleDataDMO(DmcTypeModifierMV mods) {
        super("NamedObjectRuleData");
        modrec(true);
        setModifier(mods);
    }

    public NamedObjectRuleDataDMO getModificationRecorder(){
        NamedObjectRuleDataDMO rc = new NamedObjectRuleDataDMO();
    ...
    public boolean equals(Object obj){
        if (obj instanceof NamedObjectRuleDataDMO){
            return( getObjectName().equals( ((NamedObjectRuleDataDMO) obj).getObjectName()) );
        }
        return(false);
    }
