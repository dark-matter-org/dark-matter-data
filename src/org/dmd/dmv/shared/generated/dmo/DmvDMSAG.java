...
import org.dmd.dmv.shared.extended.rulesdmo.AllowedAttributesRule;                       // To support instantiations of AllowedAttributesRule - (DmoCompactSchemaFormatter.java:1196)
import org.dmd.dmv.shared.extended.rulesdmo.CardinalityRule;                             // To support instantiations of CardinalityRule - (DmoCompactSchemaFormatter.java:1196)
import org.dmd.dmv.shared.extended.rulesdmo.CheckAttributesBasedOnValueRule;             // To support instantiations of CheckAttributesBasedOnValueRule - (DmoCompactSchemaFormatter.java:1196)
import org.dmd.dmv.shared.extended.rulesdmo.InitRule;                                    // To support instantiations of InitRule - (DmoCompactSchemaFormatter.java:1196)
import org.dmd.dmv.shared.extended.rulesdmo.NamedObjectRule;                             // To support instantiations of NamedObjectRule - (DmoCompactSchemaFormatter.java:1196)
import org.dmd.dmv.shared.extended.rulesdmo.NumericRangeRule;                            // To support instantiations of NumericRangeRule - (DmoCompactSchemaFormatter.java:1196)
import org.dmd.dmv.shared.extended.rulesdmo.OneOfTheseAttributesRequiredRule;            // To support instantiations of OneOfTheseAttributesRequiredRule - (DmoCompactSchemaFormatter.java:1196)
import org.dmd.dmv.shared.extended.rulesdmo.OnlyOneOfTheseAttributesAllowedRule;         // To support instantiations of OnlyOneOfTheseAttributesAllowedRule - (DmoCompactSchemaFormatter.java:1196)
import org.dmd.dmv.shared.extended.rulesdmo.PartCheckerRule;                             // To support instantiations of PartCheckerRule - (DmoCompactSchemaFormatter.java:1196)
import org.dmd.dmv.shared.extended.rulesdmo.PatternMatchRule;                            // To support instantiations of PatternMatchRule - (DmoCompactSchemaFormatter.java:1196)
import org.dmd.dmv.shared.extended.rulesdmo.ReferencedAttributeTypeRule;                 // To support instantiations of ReferencedAttributeTypeRule - (DmoCompactSchemaFormatter.java:1196)
import org.dmd.dmv.shared.extended.rulesdmo.RelatedNumbersRule;                          // To support instantiations of RelatedNumbersRule - (DmoCompactSchemaFormatter.java:1196)
import org.dmd.dmv.shared.extended.rulesdmo.RestrictReferencesRule;                      // To support instantiations of RestrictReferencesRule - (DmoCompactSchemaFormatter.java:1196)
import org.dmd.dmv.shared.extended.rulesdmo.StringSetRule;                               // To support instantiations of StringSetRule - (DmoCompactSchemaFormatter.java:1196)
import org.dmd.dmv.shared.extended.rulesdmo.UCOAllowedAttributesRule;                    // To support instantiations of UCOAllowedAttributesRule - (DmoCompactSchemaFormatter.java:1196)
import org.dmd.dmv.shared.extended.rulesdmo.ValueLengthRule;                             // To support instantiations of ValueLengthRule - (DmoCompactSchemaFormatter.java:1196)
import org.dmd.dmv.shared.generated.dmo.AllowedAttributesRuleDataDMO;                    // To instantiate AllowedAttributesRuleData rule data - (DmoCompactSchemaFormatter.java:1212)
import org.dmd.dmv.shared.generated.dmo.CheckAttributesBasedOnValueRuleDataDMO;          // To instantiate CheckAttributesBasedOnValueRuleData rule data - (DmoCompactSchemaFormatter.java:1212)
import org.dmd.dmv.shared.generated.dmo.NamedObjectRuleDataDMO;                          // To instantiate NamedObjectRuleData rule data - (DmoCompactSchemaFormatter.java:1212)
...
import org.dmd.dmv.shared.generated.dmo.OneOfTheseAttributesRequiredRuleDataDMO;         // To instantiate OneOfTheseAttributesRequiredRuleData rule data - (DmoCompactSchemaFormatter.java:1212)
import org.dmd.dmv.shared.generated.dmo.PartCheckerRuleDataDMO;                          // To instantiate PartCheckerRuleData rule data - (DmoCompactSchemaFormatter.java:1212)
import org.dmd.dmv.shared.generated.dmo.PatternMatchRuleDataDMO;                         // To instantiate PatternMatchRuleData rule data - (DmoCompactSchemaFormatter.java:1212)
import org.dmd.dmv.shared.generated.dmo.ReferencedAttributeTypeRuleDataDMO;              // To instantiate ReferencedAttributeTypeRuleData rule data - (DmoCompactSchemaFormatter.java:1212)
import org.dmd.dmv.shared.generated.dmo.RelatedNumbersRuleDataDMO;                       // To instantiate RelatedNumbersRuleData rule data - (DmoCompactSchemaFormatter.java:1212)
import org.dmd.dmv.shared.generated.dmo.ValueLengthRuleDataDMO;                          // To instantiate ValueLengthRuleData rule data - (DmoCompactSchemaFormatter.java:1212)
