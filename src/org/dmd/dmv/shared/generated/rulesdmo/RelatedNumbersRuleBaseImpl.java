...
import org.dmd.dmv.shared.generated.dmo.RelatedNumbersRuleDataDMO;         // Rule parameters object - (RuleFormatter.java:507)


// Generated from: org.dmd.dms.util.RuleFormatter.dumpBaseImplementations(RuleFormatter.java:524)
abstract public class RelatedNumbersRuleBaseImpl implements RuleIF, DynamicInitIF,ObjectValidationIF {
    ...
    public void setRuleData(DmcObject obj){
        if (obj instanceof RelatedNumbersRuleDataDMO)
            ruleDMO = (RelatedNumbersRuleDataDMO)obj;
        else
            throw(new IllegalStateException("Object of class " + obj.getClass().getName() + " passed when object of class RelatedNumbersRuleDataDMO required"));
    }
