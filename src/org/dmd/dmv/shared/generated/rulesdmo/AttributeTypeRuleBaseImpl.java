...
import org.dmd.dmv.shared.generated.dmo.AttributeTypeRuleDataDMO;         // Rule parameters object - (RuleFormatter.java:507)


// Generated from: org.dmd.dms.util.RuleFormatter.dumpBaseImplementations(RuleFormatter.java:524)
abstract public class AttributeTypeRuleBaseImpl implements RuleIF, DynamicInitIF,AttributeValidationIF {
    ...
    public void setRuleData(DmcObject obj){
        if (obj instanceof AttributeTypeRuleDataDMO)
            ruleDMO = (AttributeTypeRuleDataDMO)obj;
        else
            throw(new IllegalStateException("Object of class " + obj.getClass().getName() + " passed when object of class AttributeTypeRuleDataDMO required"));
    }
