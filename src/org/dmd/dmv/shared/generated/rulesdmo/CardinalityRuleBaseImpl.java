...
import org.dmd.dmv.shared.generated.dmo.CardinalityRuleDataDMO;         // Rule parameters object - (RuleFormatter.java:508)



// Generated from: org.dmd.dms.util.RuleFormatter.dumpBaseImplementations(RuleFormatter.java:525)
abstract public class CardinalityRuleBaseImpl implements RuleIF, DynamicInitIF,AttributeValidationIF {
    ...
    protected CardinalityRuleDataDMO ruleDMO;
    ...
    public void setRuleData(DmcObject obj){
        if (obj instanceof CardinalityRuleDataDMO)
            ruleDMO = (CardinalityRuleDataDMO)obj;
        else
            throw(new IllegalStateException("Object of class " + obj.getClass().getName() + " passed when object of class CardinalityRuleDataDMO required"));
    }
