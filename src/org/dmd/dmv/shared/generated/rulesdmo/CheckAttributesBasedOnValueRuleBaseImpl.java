...
// Called from: org.dmd.dms.util.RuleFormatter.dumpBaseImplementations(RuleFormatter.java:522)
...
import org.dmd.dmc.rules.ClassRuleKey;                                                  // To allow rule sorting - (RuleFormatter.java:503)
...
import org.dmd.dms.generated.dmo.RuleDataDMO;                                           // To allow access to the rule data DMO - (RuleFormatter.java:498)
import org.dmd.dms.generated.enums.RuleTypeEnum;                                        // Rule type - (RuleFormatter.java:488)
import org.dmd.dms.generated.rulesdmo.ObjectValidationIF;                               // The interface for the ObjectValidation category - (RuleFormatter.java:513)
import org.dmd.dmv.shared.generated.dmo.CheckAttributesBasedOnValueRuleDataDMO;         // Rule parameters object - (RuleFormatter.java:507)


// Generated from: org.dmd.dms.util.RuleFormatter.dumpBaseImplementations(RuleFormatter.java:524)
abstract public class CheckAttributesBasedOnValueRuleBaseImpl implements RuleIF, DynamicInitIF,ObjectValidationIF {
    ...
    protected CheckAttributesBasedOnValueRuleBaseImpl(){
        ruleDMO = null;
        if (categories == null){
    ...
    public void setRuleData(DmcObject obj){
        if (obj instanceof CheckAttributesBasedOnValueRuleDataDMO)
            ruleDMO = (CheckAttributesBasedOnValueRuleDataDMO)obj;
        else
            throw(new IllegalStateException("Object of class " + obj.getClass().getName() + " passed when object of class CheckAttributesBasedOnValueRuleDataDMO required"));
    }

    protected CheckAttributesBasedOnValueRuleBaseImpl(CheckAttributesBasedOnValueRuleDataDMO dmo){
        ruleDMO = dmo;
        if (categories == null){
            categories = new ArrayList<Integer>();
            categories.add(2);
