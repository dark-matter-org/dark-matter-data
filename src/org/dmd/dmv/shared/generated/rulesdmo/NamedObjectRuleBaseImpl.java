...
import org.dmd.dmv.shared.generated.dmo.NamedObjectRuleDataDMO;         // Rule parameters object - (RuleFormatter.java:508)



// Generated from: org.dmd.dms.util.RuleFormatter.dumpBaseImplementations(RuleFormatter.java:525)
abstract public class NamedObjectRuleBaseImpl implements RuleIF, DynamicInitIF,ObjectValidationIF {
    ...
    protected NamedObjectRuleDataDMO ruleDMO;

    protected NamedObjectRuleBaseImpl(){
        ruleDMO = null;
        if (categories == null){
    ...
    public void setRuleData(DmcObject obj){
        if (obj instanceof NamedObjectRuleDataDMO)
            ruleDMO = (NamedObjectRuleDataDMO)obj;
        else
            throw(new IllegalStateException("Object of class " + obj.getClass().getName() + " passed when object of class NamedObjectRuleDataDMO required"));
    }

    protected NamedObjectRuleBaseImpl(NamedObjectRuleDataDMO dmo){
        ruleDMO = dmo;
        if (categories == null){
            categories = new ArrayList<Integer>();
            categories.add(2);
