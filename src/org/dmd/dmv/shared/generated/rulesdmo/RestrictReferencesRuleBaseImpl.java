...
import org.dmd.dmv.shared.generated.dmo.RestrictReferencesRuleDataDMO;         // Rule parameters object - (RuleFormatter.java:508)



// Generated from: org.dmd.dms.util.RuleFormatter.dumpBaseImplementations(RuleFormatter.java:525)
abstract public class RestrictReferencesRuleBaseImpl implements RuleIF, DynamicInitIF,AttributeValidationIF {
    ...
    protected RestrictReferencesRuleDataDMO ruleDMO;

    protected RestrictReferencesRuleBaseImpl(){
        ruleDMO = null;
        if (categories == null){
    ...
    public void setRuleData(DmcObject obj){
        if (obj instanceof RestrictReferencesRuleDataDMO)
            ruleDMO = (RestrictReferencesRuleDataDMO)obj;
        else
            throw(new IllegalStateException("Object of class " + obj.getClass().getName() + " passed when object of class RestrictReferencesRuleDataDMO required"));
    }

    protected RestrictReferencesRuleBaseImpl(RestrictReferencesRuleDataDMO dmo){
        ruleDMO = dmo;
        if (categories == null){
            categories = new ArrayList<Integer>();
            categories.add(3);
