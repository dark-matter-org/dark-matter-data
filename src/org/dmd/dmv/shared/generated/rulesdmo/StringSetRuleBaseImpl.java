...
import org.dmd.dmv.shared.generated.dmo.StringSetRuleDataDMO;         // Rule parameters object - (RuleFormatter.java:508)



// Generated from: org.dmd.dms.util.RuleFormatter.dumpBaseImplementations(RuleFormatter.java:525)
abstract public class StringSetRuleBaseImpl implements RuleIF, DynamicInitIF,AttributeValidationIF {
    ...
    protected StringSetRuleBaseImpl(){
        ruleDMO = null;
        if (categories == null){
    ...
    public void setRuleData(DmcObject obj){
        if (obj instanceof StringSetRuleDataDMO)
            ruleDMO = (StringSetRuleDataDMO)obj;
        else
            throw(new IllegalStateException("Object of class " + obj.getClass().getName() + " passed when object of class StringSetRuleDataDMO required"));
    }

    protected StringSetRuleBaseImpl(StringSetRuleDataDMO dmo){
        ruleDMO = dmo;
        if (categories == null){
            categories = new ArrayList<Integer>();
            categories.add(3);
