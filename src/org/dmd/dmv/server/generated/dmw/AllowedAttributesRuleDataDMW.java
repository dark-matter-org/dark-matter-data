 ...
 */
public class AllowedAttributesRuleDataDMW extends RuleData {
    ...
    public AllowedAttributesRuleDataDMW getModificationRecorder(){
        AllowedAttributesRuleDataDMW rc = new AllowedAttributesRuleDataDMW(new DmcTypeModifierMV(MetaDMSAG.__modify));
        return(rc);
    }
    ...
    public ClassDefinition getApplyToClass(){
        ClassDefinitionREF ref = ((AllowedAttributesRuleDataDMO) core).getApplyToClass();
        if (ref == null)
            return(null);
    ...
    public void setApplyToClass(ClassDefinition value) {
        ((AllowedAttributesRuleDataDMO) core).setApplyToClass(value.getDMO());
    }
    ...
    public void setApplyToClass(Object value) throws DmcValueException {
        ((AllowedAttributesRuleDataDMO) core).setApplyToClass(value);
    }
    ...
    public void remApplyToClass(){
        ((AllowedAttributesRuleDataDMO) core).remApplyToClass();
    }
