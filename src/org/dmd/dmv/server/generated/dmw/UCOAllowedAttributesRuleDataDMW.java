 ...
 */
public class UCOAllowedAttributesRuleDataDMW extends RuleData {
    ...
    public ClassDefinition getApplyToClass(){
        ClassDefinitionREF ref = ((UCOAllowedAttributesRuleDataDMO) core).getApplyToClass();
        if (ref == null)
            return(null);
    ...
    public void setApplyToClass(ClassDefinition value) {
        ((UCOAllowedAttributesRuleDataDMO) core).setApplyToClass(value.getDMO());
    }
    ...
    public void setApplyToClass(Object value) throws DmcValueException {
        ((UCOAllowedAttributesRuleDataDMO) core).setApplyToClass(value);
    }
    ...
    public void remApplyToClass(){
        ((UCOAllowedAttributesRuleDataDMO) core).remApplyToClass();
    }
