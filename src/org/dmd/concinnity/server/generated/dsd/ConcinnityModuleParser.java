...
import java.util.Iterator;                                                              // To iterate over collections - (DSDArtifactFormatter.java:603)
import org.dmd.concinnity.server.extended.Concept;                                      // A definition from the ConcinnityModule Module - (DSDArtifactFormatter.java:973)
import org.dmd.concinnity.server.extended.ConcinnityDefinition;                         // The base definition from the ConcinnityModule Module - (DSDArtifactFormatter.java:965)
import org.dmd.concinnity.server.extended.ConcinnityModule;                             // The kind of DDM we're reading - (DSDArtifactFormatter.java:627)
import org.dmd.concinnity.server.generated.DmconcinnitySchemaAG;                        // The schema recognized by this parser - (DSDArtifactFormatter.java:612)
import org.dmd.concinnity.server.generated.dsd.ConcinnityModuleGlobalInterface;         // Interface to our definition storage - (DSDArtifactFormatter.java:600)
import org.dmd.concinnity.shared.generated.dmo.DmconcinnityDMSAG;                       // To allow loading of rules from the dmconcinnity schema - (DSDArtifactFormatter.java:623)
...
import org.dmd.dms.SchemaDefinition;                                                    // To support dynamic loading of schemas - (DSDArtifactFormatter.java:604)
...
import org.dmd.dms.generated.types.SchemaAndReason;                                     // To allow dynamic schema loading - (DSDArtifactFormatter.java:643)
...
public class ConcinnityModuleParser implements DsdParserInterface, DmcUncheckedOIFHandlerIF {
    ...
    // Generated from: org.dmd.dmg.generators.DSDArtifactFormatter.writeLoadSchemasFunction(DSDArtifactFormatter.java:893)
