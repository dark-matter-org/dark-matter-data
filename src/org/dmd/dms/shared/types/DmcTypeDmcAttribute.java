...
abstract public class DmcTypeDmcAttribute extends DmcAttribute<DmcAttribute<?>> implements Serializable {
	...
	public DmcAttribute<?> typeCheck(Object value) throws DMFeedbackSet {
        ...
        if (value instanceof DmcAttribute<?>){
            ...
            throw(new DMFeedbackSet("Object of class: " + value.getClass().getName() + " passed where object compatible with DmcAttribute<?> expected."));
        }
