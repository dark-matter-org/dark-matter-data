...
public class RuleName extends DmcObjectName implements DmcObjectNameIF, Serializable {
	...
	public RuleName(String n) throws DMFeedbackSet {
		if (n.matches(camelCase))
			name = n;
		else
			throw(new DMFeedbackSet("The String: " + n + " does not conform to the RuleName format."));
	}
	...
	public void setNameString(String n) throws DMFeedbackSet {
		if (n.matches(camelCase))
			...
			throw(new DMFeedbackSet("The String: " + n + " does not conform to RuleName format."));
	}
