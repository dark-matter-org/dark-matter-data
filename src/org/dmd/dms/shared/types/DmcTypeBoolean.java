	...
	public Boolean typeCheck(Object value) throws DMFeedbackSet {
        ...
        if (value instanceof Boolean){
        	...
        	if (v.toLowerCase().equals("true"))
        		...
        		throw(new DMFeedbackSet("Invalid Boolean value: " + v));
        	}
        }
            ...
            throw(new DMFeedbackSet("Object of class: " + value.getClass().getName() + " passed where object compatible with Boolean expected."));
        }
