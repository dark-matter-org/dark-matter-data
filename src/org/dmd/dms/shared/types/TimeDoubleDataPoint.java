...
//	int 	value;
	 ...
	 * @throws DMFeedbackSet
	 */
	public TimeDoubleDataPoint(String v) throws DMFeedbackSet {
		set(v);
	}
	...
	public void set(String val) throws DMFeedbackSet {
		if (val == null){
			throw(new DMFeedbackSet("null value passed to TimeDataPoint.set()"));
		}
		...
		if (space == -1){
			throw(new DMFeedbackSet("Incorrect number of tokens for an TimeDataPoint: " + v));
		}
...
//			value = Integer.parseInt(v.substring(space+1));
			...
			throw(new DMFeedbackSet("Invalid Y value for an TimeDataPoint: " + v.substring(space+1)));
		}
	}
