...
public class DependencyDMO extends org.dmd.dms.shared.generated.dmo.DmsDefinitionDMO implements Serializable  {
    ...
    static {
        ...
        _ImAp.put(MetaCompactSchema.__useInterface.id,MetaCompactSchema.__useInterface);
        ...
        _ImAp.put(MetaCompactSchema.__dependencies.id,MetaCompactSchema.__dependencies);
        ...
        _SmAp.put(MetaCompactSchema.__useInterface.name,MetaCompactSchema.__useInterface);
        ...
        _SmAp.put(MetaCompactSchema.__dependencies.name,MetaCompactSchema.__dependencies);
    ...
    public String getUseInterface(){
        DmcTypeStringSV attr = (DmcTypeStringSV) get(MetaCompactSchema.__useInterface);
        if (attr == null)
            return(null);
    ...
    public void setUseInterface(Object value) throws DMFeedbackSet {
        DmcAttribute<?> attr = get(MetaCompactSchema.__useInterface);
        if (attr == null)
            attr = new DmcTypeStringSV(MetaCompactSchema.__useInterface);
        
        attr.set(value);
        set(MetaCompactSchema.__useInterface,attr);
    }
    ...
    public Iterator<DependencyREF> getDependencies(){
        DmcTypeDependencyREFMV attr = (DmcTypeDependencyREFMV) get(MetaCompactSchema.__dependencies);
        if (attr == null)
            return(null);
     ...
     */
    // org.dmd.dms.tools.generation.meta.AccessFunctionFormatter.dumpMVAccessFunction(AccessFunctionFormatter.java:370)
    public DmcAttribute<?> addDependencies(Object value) throws DMFeedbackSet {
        DmcAttribute<?> attr = get(MetaCompactSchema.__dependencies);
        if (attr == null)
            attr = new DmcTypeDependencyREFMV(MetaCompactSchema.__dependencies);
        
        attr.add(value);
        add(MetaCompactSchema.__dependencies,attr);
        return(attr);
    }
