...
public class DmsModuleDMO extends org.dmd.dms.shared.generated.dmo.DmsDefinitionDMO implements Serializable  {
    ...
    static {
        ...
        _ImAp.put(MetaDMSAG.__dependsOnDmsModule.id,MetaDMSAG.__dependsOnDmsModule);
        ...
        _SmAp.put(MetaDMSAG.__dependsOnDmsModule.name,MetaDMSAG.__dependsOnDmsModule);
    ...
    public Iterator<DmsModuleREF> getDependsOnDmsModule(){
        DmcTypeDmsModuleREFMV attr = (DmcTypeDmsModuleREFMV) get(MetaDMSAG.__dependsOnDmsModule);
        if (attr == null)
            return(null);
    ...
    public DmcAttribute<?> addDependsOnDmsModule(Object value) throws DMFeedbackSet {
        DmcAttribute<?> attr = get(MetaDMSAG.__dependsOnDmsModule);
        if (attr == null)
            attr = new DmcTypeDmsModuleREFMV(MetaDMSAG.__dependsOnDmsModule);
        
        attr.add(value);
        add(MetaDMSAG.__dependsOnDmsModule,attr);
        return(attr);
    }
