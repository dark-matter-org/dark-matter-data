...
public class ConcinnityDMO extends org.dmd.dms.shared.generated.dmo.DSDefinitionDMO implements Serializable  {
    ...
    public ConcinnityDMO(){
        super("Concinnity");
    }

    public ConcinnityDMO(String oc){
        super(oc);
    }
    ...
    @Override
    public ConcinnityDMO getNew(){
        ConcinnityDMO rc = new ConcinnityDMO();
        return(rc);
    }

    @Override
    public ConcinnityDMO getSlice(DmcSliceInfo info){
        ConcinnityDMO rc = new ConcinnityDMO();
