...
public class DependencyImplementationDMO extends org.dmd.dms.shared.generated.dmo.DmsDefinitionDMO implements Serializable  {
    ...
    static {
        ...
        _ImAp.put(MetaCompactSchema.__instantiation.id,MetaCompactSchema.__instantiation);
        _ImAp.put(MetaCompactSchema.__name.id,MetaCompactSchema.__name);
        _ImAp.put(MetaCompactSchema.__runContext.id,MetaCompactSchema.__runContext);
        ...
        _SmAp.put(MetaCompactSchema.__instantiation.name,MetaCompactSchema.__instantiation);
        _SmAp.put(MetaCompactSchema.__name.name,MetaCompactSchema.__name);
        _SmAp.put(MetaCompactSchema.__runContext.name,MetaCompactSchema.__runContext);
    ...
    public String getInstantiation(){
        DmcTypeStringSV attr = (DmcTypeStringSV) get(MetaCompactSchema.__instantiation);
        if (attr == null)
            return(null);
    ...
    public void setInstantiation(Object value) throws DMFeedbackSet {
        DmcAttribute<?> attr = get(MetaCompactSchema.__instantiation);
        if (attr == null)
            attr = new DmcTypeStringSV(MetaCompactSchema.__instantiation);
        
        attr.set(value);
        set(MetaCompactSchema.__instantiation,attr);
    }
    ...
    public RunContextREF getRunContext(){
        DmcTypeRunContextREFSV attr = (DmcTypeRunContextREFSV) get(MetaCompactSchema.__runContext);
        if (attr == null)
            return(null);
     ...
     */
    // org.dmd.dms.tools.meta.AccessFunctionFormatter.dumpSVAccessFunction(AccessFunctionFormatter.java:164)
    public void setRunContext(Object value) throws DMFeedbackSet {
        DmcAttribute<?> attr = get(MetaCompactSchema.__runContext);
        if (attr == null)
            attr = new DmcTypeRunContextREFSV(MetaCompactSchema.__runContext);
        
        attr.set(value);
        set(MetaCompactSchema.__runContext,attr);
    }
