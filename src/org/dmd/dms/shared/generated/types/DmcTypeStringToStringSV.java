...
import org.dmd.dms.shared.types.DmcTypeStringToString;         // DmcType import - (SVTypeFormatter.java:65)
import org.dmd.dms.shared.types.StringToString;                // Base type import - (SVTypeFormatter.java:62)
...
public class DmcTypeStringToStringSV extends DmcTypeStringToString implements Serializable {
    ...
    public DmcTypeStringToStringSV(DmcAttributeInfo ai){
        super(ai);
    }
    ...
    public DmcTypeStringToStringSV getNew(DmcAttributeInfo ai){
        return(new DmcTypeStringToStringSV(ai));
    }
    ...
    public StringToString set(Object v) throws DMFeedbackSet {
