...
import org.dmd.dms.shared.types.DmcTypeIntegerToBoolean;         // DmcType import - (SVTypeFormatter.java:66)
import org.dmd.dms.shared.types.IntegerToBoolean;                // Base type import - (SVTypeFormatter.java:63)
...
public class DmcTypeIntegerToBooleanSV extends DmcTypeIntegerToBoolean implements Serializable {
    ...
    public DmcTypeIntegerToBooleanSV getNew(){
        return(new DmcTypeIntegerToBooleanSV(getAttributeInfo()));
    }
    
    public DmcTypeIntegerToBooleanSV getNew(DmcAttributeInfo ai){
        return(new DmcTypeIntegerToBooleanSV(ai));
    }
    ...
    public IntegerToBoolean set(Object v) throws DMFeedbackSet {
