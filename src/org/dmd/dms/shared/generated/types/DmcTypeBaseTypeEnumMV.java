...
import org.dmd.dms.shared.generated.enums.BaseTypeEnum;         // DmcType import - (MVTypeFormatter.java:64)
 ...
 *    Called from: org.dmd.dms.tools.generation.meta.DerivedTypeFormatter.dumpDerivedTypes(DerivedTypeFormatter.java:58)
 */
@SuppressWarnings("serial")
public class DmcTypeBaseTypeEnumMV extends DmcTypeBaseTypeEnum implements Serializable {
    
    private final static Iterator<BaseTypeEnum> emptyList = (new ArrayList<BaseTypeEnum>()).iterator();
    
    protected ArrayList<BaseTypeEnum> value;
    
    public DmcTypeBaseTypeEnumMV(){
    
    }
    
    public DmcTypeBaseTypeEnumMV(DmcAttributeInfo ai){
        super(ai);
    }
    
    @Override
    public DmcTypeBaseTypeEnumMV getNew(){
        return(new DmcTypeBaseTypeEnumMV(getAttributeInfo()));
    }
    ...
    public DmcAttribute<BaseTypeEnum> cloneIt(){
        synchronized(this){
            DmcTypeBaseTypeEnumMV rc = getNew();
    ...
    public BaseTypeEnum add(Object v) throws DMFeedbackSet {
        synchronized(this){
            BaseTypeEnum rc = typeCheck(v);
            if (value == null)
                value = new ArrayList<BaseTypeEnum>();
            value.add(rc);
            return(rc);
        }
    }
    ...
    public Iterator<BaseTypeEnum> getMV(){
        synchronized(this){
            ...
            ArrayList<BaseTypeEnum> clone = new ArrayList<BaseTypeEnum>(value);
            return(clone.iterator());
        }
    }
    
    // org.dmd.dms.tools.generation.util.MVTypeFormatter.dumpMVType(MVTypeFormatter.java:189)
    public ArrayList<BaseTypeEnum> getMVCopy(){
        synchronized(this){
            if (value == null)
                return(new ArrayList<BaseTypeEnum>());
            else 
                return(new ArrayList<BaseTypeEnum>(value));
        }
    }
    ...
    public BaseTypeEnum getMVnth(int index){
        synchronized(this){
            if (value == null)
                return(null);
    ...
    public BaseTypeEnum setMVnth(int index, Object v) throws DMFeedbackSet {
        synchronized(this){
            if (getAttributeInfo().indexSize == 0)
            ...
            if (value == null){
                value = new ArrayList<BaseTypeEnum>(getAttributeInfo().indexSize);
