...
import org.dmd.dms.shared.generated.enums.ValueTypeEnum;         // DmcType import - (MVTypeFormatter.java:64)
...
public class DmcTypeValueTypeEnumMV extends DmcTypeValueTypeEnum implements Serializable {
    ...
    private final static Iterator<ValueTypeEnum> emptyList = (new ArrayList<ValueTypeEnum>()).iterator();
    
    protected ArrayList<ValueTypeEnum> value;
    
    public DmcTypeValueTypeEnumMV(){
    
    }
    
    public DmcTypeValueTypeEnumMV(DmcAttributeInfo ai){
        super(ai);
    }
    
    @Override
    public DmcTypeValueTypeEnumMV getNew(){
        return(new DmcTypeValueTypeEnumMV(getAttributeInfo()));
    }
    ...
    public DmcAttribute<ValueTypeEnum> cloneIt(){
        synchronized(this){
            DmcTypeValueTypeEnumMV rc = getNew();
    ...
    public ValueTypeEnum add(Object v) throws DMFeedbackSet {
        synchronized(this){
            ...
            if (value == null)
                value = new ArrayList<ValueTypeEnum>();
            value.add(rc);
            return(rc);
        }
    }
    ...
    public ArrayList<ValueTypeEnum> getMVCopy(){
        synchronized(this){
            if (value == null)
                return(new ArrayList<ValueTypeEnum>());
            else 
                return(new ArrayList<ValueTypeEnum>(value));
        }
    }
    ...
    public ValueTypeEnum getMVnth(int index){
        synchronized(this){
            if (value == null)
                return(null);
    ...
    public ValueTypeEnum setMVnth(int index, Object v) throws DMFeedbackSet {
        synchronized(this){
            if (getAttributeInfo().indexSize == 0)
            ...
            if (value == null){
                value = new ArrayList<ValueTypeEnum>(getAttributeInfo().indexSize);
