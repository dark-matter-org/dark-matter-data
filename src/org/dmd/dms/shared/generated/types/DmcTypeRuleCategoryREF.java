...
import org.dmd.dms.shared.generated.dmo.RuleCategoryDMO;         // The type of object we refer to - (TypeFormatter.java:53)
...
abstract public class DmcTypeRuleCategoryREF extends DmcTypeNamedObjectREF<RuleCategoryREF, DefinitionName> implements Serializable {
    ...
    public RuleCategoryREF typeCheck(Object value) throws DMFeedbackSet {
        ...
        if (value instanceof RuleCategoryREF)
            ...
            throw(new DMFeedbackSet("Object of class:" + value.getClass().getName() + " passed where a RuleCategoryREF/DMO or DmcObjectName expected."));
        return(rc);
    }
