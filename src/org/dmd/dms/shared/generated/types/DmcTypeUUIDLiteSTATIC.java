...
import org.dmd.dms.shared.types.UUIDLite;                 // Base type import - (STATICTypeFormatter.java:65)
...
public class DmcTypeUUIDLiteSTATIC {
    ...
    public UUIDLite typeCheck(Object value) throws DMFeedbackSet {
    	   return(typeHelper.typeCheck(value));
    }
    
    public UUIDLite cloneValue(UUIDLite value) throws DMFeedbackSet {
