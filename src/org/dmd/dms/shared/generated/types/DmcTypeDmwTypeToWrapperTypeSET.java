...
import org.dmd.dms.shared.generated.types.DmcTypeDmwTypeToWrapperType;         // DmcType import - (SETTypeFormatter.java:60)
import org.dmd.dms.shared.generated.types.DmwTypeToWrapperType;                // Base type import - (SETTypeFormatter.java:57)
...
public class DmcTypeDmwTypeToWrapperTypeSET extends DmcTypeDmwTypeToWrapperType implements Serializable {
     ...
     private final static Iterator<DmwTypeToWrapperType> emptyList =  (new HashSet<DmwTypeToWrapperType>()).iterator();
    ...
    public Set<DmwTypeToWrapperType> getMVCopy(){
        synchronized(this){
            if (getAttributeInfo().valueType == ValueTypeEnum.HASHSET){
                if (value == null)
                    return(new HashSet<DmwTypeToWrapperType>());
                else
