...
import org.dmd.dms.shared.generated.enums.RuleTypeEnum;         // DmcType import - (MVTypeFormatter.java:64)
...
public class DmcTypeRuleTypeEnumMV extends DmcTypeRuleTypeEnum implements Serializable {
    ...
    private final static Iterator<RuleTypeEnum> emptyList = (new ArrayList<RuleTypeEnum>()).iterator();
    
    protected ArrayList<RuleTypeEnum> value;
    
    public DmcTypeRuleTypeEnumMV(){
    
    }
    
    public DmcTypeRuleTypeEnumMV(DmcAttributeInfo ai){
        super(ai);
    }
    
    @Override
    public DmcTypeRuleTypeEnumMV getNew(){
        return(new DmcTypeRuleTypeEnumMV(getAttributeInfo()));
    }
    ...
    public DmcAttribute<RuleTypeEnum> cloneIt(){
        synchronized(this){
            DmcTypeRuleTypeEnumMV rc = getNew();
    
            if (value == null)
                return(rc);
    
            if (getAttributeInfo().indexSize == 0){
                for(RuleTypeEnum val: value)
                try {
                    rc.add(val);
    ...
    public RuleTypeEnum add(Object v) throws DMFeedbackSet {
        synchronized(this){
            RuleTypeEnum rc = typeCheck(v);
            if (value == null)
                value = new ArrayList<RuleTypeEnum>();
            value.add(rc);
            return(rc);
        }
    }
    ...
    public RuleTypeEnum del(Object v){
        synchronized(this){
            if (value == null)
                return(null);
    
            RuleTypeEnum key = null;
    ...
    public Iterator<RuleTypeEnum> getMV(){
        synchronized(this){
            ...
            ArrayList<RuleTypeEnum> clone = new ArrayList<RuleTypeEnum>(value);
            return(clone.iterator());
        }
    }
    
    // org.dmd.dms.tools.generation.util.MVTypeFormatter.dumpMVType(MVTypeFormatter.java:189)
    public ArrayList<RuleTypeEnum> getMVCopy(){
        synchronized(this){
            if (value == null)
                return(new ArrayList<RuleTypeEnum>());
            else 
                return(new ArrayList<RuleTypeEnum>(value));
        }
    }
    ...
    public RuleTypeEnum getMVnth(int index){
        synchronized(this){
            if (value == null)
                return(null);
    ...
    public RuleTypeEnum setMVnth(int index, Object v) throws DMFeedbackSet {
        synchronized(this){
            if (getAttributeInfo().indexSize == 0)
            ...
            if (value == null){
                value = new ArrayList<RuleTypeEnum>(getAttributeInfo().indexSize);
