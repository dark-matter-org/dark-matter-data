...
import org.dmd.dms.shared.generated.dmo.SchemaDefinitionDMO;         // The type of object we refer to - (TypeFormatter.java:53)
...
abstract public class DmcTypeSchemaDefinitionREF extends DmcTypeNamedObjectREF<SchemaDefinitionREF, DefinitionName> implements Serializable {
    ...
    public SchemaDefinitionREF typeCheck(Object value) throws DMFeedbackSet {
        ...
        if (value instanceof SchemaDefinitionREF)
            ...
            throw(new DMFeedbackSet("Object of class:" + value.getClass().getName() + " passed where a SchemaDefinitionREF/DMO or DmcObjectName expected."));
        return(rc);
    }
