...
import org.dmd.dms.shared.types.DmcTypeStringName;         // DmcType import - (MVTypeFormatter.java:63)
import org.dmd.dms.shared.types.StringName;                // Base type import - (MVTypeFormatter.java:58)
...
public class DmcTypeStringNameMV extends DmcTypeStringName implements Serializable {
    ...
    public StringName add(Object v) throws DMFeedbackSet {
        synchronized(this){
    ...
    public StringName setMVnth(int index, Object v) throws DMFeedbackSet {
        synchronized(this){
            if (getAttributeInfo().indexSize == 0)
