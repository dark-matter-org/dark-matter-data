...
import org.dmd.dms.shared.generated.dmo.DSDefinitionModuleDMO;         // The type of object we refer to - (TypeFormatter.java:53)
...
abstract public class DmcTypeDSDefinitionModuleREF extends DmcTypeNamedObjectREF<DSDefinitionModuleREF, DefinitionName> implements Serializable {
    ...
    public DSDefinitionModuleREF typeCheck(Object value) throws DMFeedbackSet {
        ...
        if (value instanceof DSDefinitionModuleREF)
            ...
            throw(new DMFeedbackSet("Object of class:" + value.getClass().getName() + " passed where a DSDefinitionModuleREF/DMO or DmcObjectName expected."));
        return(rc);
    }
