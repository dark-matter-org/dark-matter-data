...
import org.dmd.dms.shared.types.StringName;                   // Base type import - (STATICTypeFormatter.java:65)
...
public class DmcTypeStringNameSTATIC implements DmcNameBuilderIF {
    ...
    public StringName typeCheck(Object value) throws DMFeedbackSet {
    	   return(typeHelper.typeCheck(value));
    }
    
    public StringName cloneValue(StringName value) throws DMFeedbackSet {
