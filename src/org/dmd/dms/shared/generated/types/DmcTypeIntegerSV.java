...
import org.dmd.dms.shared.types.DmcTypeInteger;         // DmcType import - (SVTypeFormatter.java:65)
...
public class DmcTypeIntegerSV extends DmcTypeInteger implements Serializable {
    ...
    public DmcTypeIntegerSV(){
    
    }
    
    public DmcTypeIntegerSV(DmcAttributeInfo ai){
        super(ai);
    }
    
    public DmcTypeIntegerSV getNew(){
        return(new DmcTypeIntegerSV(getAttributeInfo()));
    }
    
    public DmcTypeIntegerSV getNew(DmcAttributeInfo ai){
        return(new DmcTypeIntegerSV(ai));
    }
