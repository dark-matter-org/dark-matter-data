...
import org.dmd.dms.shared.types.ClassFilter;                // Base type import - (MVTypeFormatter.java:58)
import org.dmd.dms.shared.types.DmcTypeClassFilter;         // DmcType import - (MVTypeFormatter.java:63)
...
public class DmcTypeClassFilterMV extends DmcTypeClassFilter implements Serializable {
    ...
    public DmcTypeClassFilterMV getNew(){
        return(new DmcTypeClassFilterMV(getAttributeInfo()));
    }
    ...
    public ClassFilter add(Object v) throws DMFeedbackSet {
        synchronized(this){
    ...
    public ClassFilter setMVnth(int index, Object v) throws DMFeedbackSet {
        synchronized(this){
            if (getAttributeInfo().indexSize == 0)
            ...
            if (value == null){
                value = new ArrayList<ClassFilter>(getAttributeInfo().indexSize);
