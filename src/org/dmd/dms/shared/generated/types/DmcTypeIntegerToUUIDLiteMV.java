...
import org.dmd.dms.shared.types.DmcTypeIntegerToUUIDLite;         // DmcType import - (MVTypeFormatter.java:64)
import org.dmd.dms.shared.types.IntegerToUUIDLite;                // Base type import - (MVTypeFormatter.java:59)
...
public class DmcTypeIntegerToUUIDLiteMV extends DmcTypeIntegerToUUIDLite implements Serializable {
    ...
    private final static Iterator<IntegerToUUIDLite> emptyList = (new ArrayList<IntegerToUUIDLite>()).iterator();
    
    protected ArrayList<IntegerToUUIDLite> value;
    ...
    public ArrayList<IntegerToUUIDLite> getMVCopy(){
        synchronized(this){
            if (value == null)
                return(new ArrayList<IntegerToUUIDLite>());
            else 
                return(new ArrayList<IntegerToUUIDLite>(value));
        }
    }
    ...
    public IntegerToUUIDLite setMVnth(int index, Object v) throws DMFeedbackSet {
        synchronized(this){
            if (getAttributeInfo().indexSize == 0)
