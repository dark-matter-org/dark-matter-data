...
import org.dmd.dms.shared.generated.enums.OperationalContextEnum;         // DmcType import - (SETTypeFormatter.java:59)
...
public class DmcTypeOperationalContextEnumSET extends DmcTypeOperationalContextEnum implements Serializable {
     ...
     private final static Iterator<OperationalContextEnum> emptyList =  (new HashSet<OperationalContextEnum>()).iterator();
    
    
    protected Set<OperationalContextEnum> value;
    
    public DmcTypeOperationalContextEnumSET(){
        value = null;
    }
    
    public DmcTypeOperationalContextEnumSET(DmcAttributeInfo ai){
        super(ai);
        initValue();
    }
    ...
    public OperationalContextEnum add(Object v) throws DMFeedbackSet {
        synchronized(this){
    ...
    public Set<OperationalContextEnum> getMVCopy(){
        synchronized(this){
            if (getAttributeInfo().valueType == ValueTypeEnum.HASHSET){
                if (value == null)
                    return(new HashSet<OperationalContextEnum>());
                else
