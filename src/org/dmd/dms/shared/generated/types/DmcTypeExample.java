...
abstract public class DmcTypeExample extends DmcAttribute<Example> implements Serializable {
    ...
    protected Example typeCheck(Object value) throws DMFeedbackSet {
        Example rc = null;
        ...
        if (value instanceof Example){
            ...
            throw(new DMFeedbackSet("Object of class: " + value.getClass().getName() + " passed where object compatible with Example expected."));
        }
        return(rc);
    }
