...
import org.dmd.dms.shared.generated.dmo.RuleDefinitionDMO;         // The type of object we refer to - (TypeFormatter.java:53)
...
abstract public class DmcTypeRuleDefinitionREF extends DmcTypeNamedObjectREF<RuleDefinitionREF, DefinitionName> implements Serializable {
    ...
    public RuleDefinitionREF typeCheck(Object value) throws DMFeedbackSet {
        ...
        if (value instanceof RuleDefinitionREF)
            ...
            throw(new DMFeedbackSet("Object of class:" + value.getClass().getName() + " passed where a RuleDefinitionREF/DMO or DmcObjectName expected."));
        return(rc);
    }
