...
import org.dmd.dms.shared.generated.enums.OriginalTypeEnum;         // DmcType import - (STATICTypeFormatter.java:70)



/**
 * The DmcTypeOriginalTypeEnumSTATIC provides static access to functions used to manage values of type OriginalTypeEnum
 ...
 */
public class DmcTypeOriginalTypeEnumSTATIC {
    
    public static DmcTypeOriginalTypeEnumSTATIC instance;
    static DmcTypeOriginalTypeEnumSV typeHelper;
    
    static {
        instance = new DmcTypeOriginalTypeEnumSTATIC();
    }
    
    protected DmcTypeOriginalTypeEnumSTATIC() {
        typeHelper = new DmcTypeOriginalTypeEnumSV();
    }
    
    public OriginalTypeEnum typeCheck(Object value) throws DMFeedbackSet {
    	   return(typeHelper.typeCheck(value));
    }
    
    public OriginalTypeEnum cloneValue(OriginalTypeEnum value) throws DMFeedbackSet {
