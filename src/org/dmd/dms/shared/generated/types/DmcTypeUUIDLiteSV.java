...
import org.dmd.dms.shared.types.DmcTypeUUIDLite;         // DmcType import - (SVTypeFormatter.java:66)
import org.dmd.dms.shared.types.UUIDLite;                // Base type import - (SVTypeFormatter.java:63)
...
public class DmcTypeUUIDLiteSV extends DmcTypeUUIDLite implements Serializable {
    ...
    public DmcTypeUUIDLiteSV getNew(){
        return(new DmcTypeUUIDLiteSV(getAttributeInfo()));
    }
    ...
    public UUIDLite set(Object v) throws DMFeedbackSet {
