...
import org.dmd.dms.shared.types.RuleName;                     // Base type import - (STATICTypeFormatter.java:66)



/**
 * The DmcTypeRuleNameSTATIC provides static access to functions used to manage values of type RuleName
...
public class DmcTypeRuleNameSTATIC implements DmcNameBuilderIF {
    ...
    public static DmcTypeRuleNameSTATIC instance;
    static DmcTypeRuleNameSV typeHelper;
    static String    nameClass = "RuleName";
    static final int attrID    = 153;
    
    static {
        instance = new DmcTypeRuleNameSTATIC();
    }
    
    protected DmcTypeRuleNameSTATIC() {
        typeHelper = new DmcTypeRuleNameSV();
    }
    ...
    public RuleName cloneValue(RuleName value) throws DMFeedbackSet {
