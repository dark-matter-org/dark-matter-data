...
import org.dmd.dms.shared.types.DmcTypeDotName;         // DmcType import - (MVTypeFormatter.java:64)
import org.dmd.dms.shared.types.DotName;                // Base type import - (MVTypeFormatter.java:59)
...
public class DmcTypeDotNameMV extends DmcTypeDotName implements Serializable {
    ...
    private final static Iterator<DotName> emptyList = (new ArrayList<DotName>()).iterator();
    ...
    public DmcTypeDotNameMV getNew(){
        return(new DmcTypeDotNameMV(getAttributeInfo()));
    }
    ...
    public DotName add(Object v) throws DMFeedbackSet {
        synchronized(this){
    ...
    public ArrayList<DotName> getMVCopy(){
        synchronized(this){
            if (value == null)
                return(new ArrayList<DotName>());
            else 
                return(new ArrayList<DotName>(value));
        }
    }
    ...
    public DotName setMVnth(int index, Object v) throws DMFeedbackSet {
        synchronized(this){
            if (getAttributeInfo().indexSize == 0)
            ...
            if (value == null){
                value = new ArrayList<DotName>(getAttributeInfo().indexSize);
