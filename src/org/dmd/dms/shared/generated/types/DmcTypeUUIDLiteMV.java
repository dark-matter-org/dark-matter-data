...
import org.dmd.dms.shared.types.DmcTypeUUIDLite;         // DmcType import - (MVTypeFormatter.java:63)
import org.dmd.dms.shared.types.UUIDLite;                // Base type import - (MVTypeFormatter.java:58)
...
public class DmcTypeUUIDLiteMV extends DmcTypeUUIDLite implements Serializable {
    ...
    public UUIDLite setMVnth(int index, Object v) throws DMFeedbackSet {
        synchronized(this){
            if (getAttributeInfo().indexSize == 0)
