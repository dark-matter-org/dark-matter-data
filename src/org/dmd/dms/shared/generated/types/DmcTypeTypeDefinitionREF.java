...
import org.dmd.dms.shared.generated.dmo.TypeDefinitionDMO;         // The type of object we refer to - (TypeFormatter.java:53)
...
abstract public class DmcTypeTypeDefinitionREF extends DmcTypeNamedObjectREF<TypeDefinitionREF, DefinitionName> implements Serializable {
    ...
    public TypeDefinitionREF typeCheck(Object value) throws DMFeedbackSet {
        ...
        if (value instanceof TypeDefinitionREF)
            ...
            throw(new DMFeedbackSet("Object of class:" + value.getClass().getName() + " passed where a TypeDefinitionREF/DMO or DmcObjectName expected."));
        return(rc);
    }
