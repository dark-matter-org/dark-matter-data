...
/**
 * The DmcTypeDmsModuleREFMV provides storage for a multi-valued DmsModuleREF
 * <P>
...
public class DmcTypeDmsModuleREFMV extends DmcTypeDmsModuleREF implements Serializable {
    
    private final static Iterator<DmsModuleREF> emptyList = (new ArrayList<DmsModuleREF>()).iterator();
    
    protected ArrayList<DmsModuleREF> value;
    
    public DmcTypeDmsModuleREFMV(){
    
    }
    
    public DmcTypeDmsModuleREFMV(DmcAttributeInfo ai){
        super(ai);
    }
    
    @Override
    public DmcTypeDmsModuleREFMV getNew(){
        return(new DmcTypeDmsModuleREFMV(getAttributeInfo()));
    }
    
    @Override
    // org.dmd.dms.tools.generation.util.MVTypeFormatter.dumpMVType(MVTypeFormatter.java:104)
    public DmcAttribute<DmsModuleREF> cloneIt(){
        synchronized(this){
            DmcTypeDmsModuleREFMV rc = getNew();
    
            if (value == null)
                return(rc);
    
            if (getAttributeInfo().indexSize == 0){
                for(DmsModuleREF val: value)
                try {
                    rc.add(val);
    ...
    public DmsModuleREF add(Object v) throws DMFeedbackSet {
        synchronized(this){
            DmsModuleREF rc = typeCheck(v);
            if (value == null)
                value = new ArrayList<DmsModuleREF>();
            value.add(rc);
            return(rc);
        }
    }
    ...
    public DmsModuleREF del(Object v){
        synchronized(this){
            if (value == null)
                return(null);
    
            DmsModuleREF key = null;
            DmsModuleREF rc = null;
            try {
                key = typeCheck(v);
            } catch (DMFeedbackSet e) {
    ...
    public Iterator<DmsModuleREF> getMV(){
        synchronized(this){
            if (value == null)
                return(emptyList);
    
            ArrayList<DmsModuleREF> clone = new ArrayList<DmsModuleREF>(value);
            return(clone.iterator());
        }
    }
    
    // org.dmd.dms.tools.generation.util.MVTypeFormatter.dumpMVType(MVTypeFormatter.java:189)
    public ArrayList<DmsModuleREF> getMVCopy(){
        synchronized(this){
            if (value == null)
                return(new ArrayList<DmsModuleREF>());
            else 
                return(new ArrayList<DmsModuleREF>(value));
        }
    }
    ...
    public DmsModuleREF getMVnth(int index){
        synchronized(this){
            if (value == null)
                return(null);
    ...
    public DmsModuleREF setMVnth(int index, Object v) throws DMFeedbackSet {
        synchronized(this){
            if (getAttributeInfo().indexSize == 0)
            ...
            if (value == null){
                value = new ArrayList<DmsModuleREF>(getAttributeInfo().indexSize);
