...
import org.dmd.dms.shared.generated.dmo.AttributeDefinitionDMO;         // The type of object we refer to - (TypeFormatter.java:53)
...
abstract public class DmcTypeAttributeDefinitionREF extends DmcTypeNamedObjectREF<AttributeDefinitionREF, DefinitionName> implements Serializable {
    ...
    public AttributeDefinitionREF typeCheck(Object value) throws DMFeedbackSet {
        ...
        if (value instanceof AttributeDefinitionREF)
            ...
            throw(new DMFeedbackSet("Object of class:" + value.getClass().getName() + " passed where a AttributeDefinitionREF/DMO or DmcObjectName expected."));
        return(rc);
    }
