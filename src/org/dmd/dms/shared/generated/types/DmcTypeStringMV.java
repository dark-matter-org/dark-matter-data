...
import org.dmd.dms.shared.types.DmcTypeString;         // DmcType import - (MVTypeFormatter.java:64)
...
public class DmcTypeStringMV extends DmcTypeString implements Serializable {
    ...
    private final static Iterator<String> emptyList = (new ArrayList<String>()).iterator();
    ...
    public DmcTypeStringMV getNew(){
        return(new DmcTypeStringMV(getAttributeInfo()));
    }
    ...
    public String setMVnth(int index, Object v) throws DMFeedbackSet {
        synchronized(this){
            if (getAttributeInfo().indexSize == 0)
            ...
            if (value == null){
                value = new ArrayList<String>(getAttributeInfo().indexSize);
