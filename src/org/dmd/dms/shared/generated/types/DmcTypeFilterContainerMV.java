...
import org.dmd.dms.shared.types.DmcTypeFilterContainer;         // DmcType import - (MVTypeFormatter.java:63)
import org.dmd.dms.shared.types.FilterContainer;                // Base type import - (MVTypeFormatter.java:58)
...
public class DmcTypeFilterContainerMV extends DmcTypeFilterContainer implements Serializable {
    ...
    private final static Iterator<FilterContainer> emptyList = (new ArrayList<FilterContainer>()).iterator();
    
    protected ArrayList<FilterContainer> value;
    ...
    public DmcTypeFilterContainerMV getNew(){
        return(new DmcTypeFilterContainerMV(getAttributeInfo()));
    }
    ...
    public FilterContainer add(Object v) throws DMFeedbackSet {
        synchronized(this){
    ...
    public ArrayList<FilterContainer> getMVCopy(){
        synchronized(this){
            if (value == null)
                return(new ArrayList<FilterContainer>());
            else 
                return(new ArrayList<FilterContainer>(value));
        }
    }
    ...
    public FilterContainer setMVnth(int index, Object v) throws DMFeedbackSet {
        synchronized(this){
            if (getAttributeInfo().indexSize == 0)
            ...
            if (value == null){
                value = new ArrayList<FilterContainer>(getAttributeInfo().indexSize);
