...
import org.dmd.dms.shared.generated.types.DmcTypeOptimize;         // DmcType import - (MVTypeFormatter.java:64)
import org.dmd.dms.shared.generated.types.Optimize;                // Base type import - (MVTypeFormatter.java:59)
...
public class DmcTypeOptimizeMV extends DmcTypeOptimize implements Serializable {
    ...
    public Optimize setMVnth(int index, Object v) throws DMFeedbackSet {
        synchronized(this){
            if (getAttributeInfo().indexSize == 0)
