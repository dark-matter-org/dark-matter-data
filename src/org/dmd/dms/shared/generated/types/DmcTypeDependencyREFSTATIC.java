...
/**
 * The DmcTypeDependencyREFSTATIC provides static access to functions used to manage values of type DependencyREF
...
public class DmcTypeDependencyREFSTATIC {
    ...
    public static DmcTypeDependencyREFSTATIC instance;
    static DmcTypeDependencyREFSV typeHelper;
    
    static {
        instance = new DmcTypeDependencyREFSTATIC();
    }
    ...
    public DependencyREF typeCheck(Object value) throws DMFeedbackSet {
    	   return(typeHelper.typeCheck(value));
    }
    
    public DependencyREF cloneValue(DependencyREF value) throws DMFeedbackSet {
