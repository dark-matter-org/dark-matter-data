...
import org.dmd.dms.shared.types.DmcTypeFullyQualifiedName;         // DmcType import - (MVTypeFormatter.java:63)
import org.dmd.dms.shared.types.FullyQualifiedName;                // Base type import - (MVTypeFormatter.java:58)
...
public class DmcTypeFullyQualifiedNameMV extends DmcTypeFullyQualifiedName implements Serializable {
    ...
    private final static Iterator<FullyQualifiedName> emptyList = (new ArrayList<FullyQualifiedName>()).iterator();
    ...
    public DmcTypeFullyQualifiedNameMV getNew(){
        return(new DmcTypeFullyQualifiedNameMV(getAttributeInfo()));
    }
    ...
    public ArrayList<FullyQualifiedName> getMVCopy(){
        synchronized(this){
            if (value == null)
                ...
                return(new ArrayList<FullyQualifiedName>(value));
        }
    }
    ...
    public FullyQualifiedName setMVnth(int index, Object v) throws DMFeedbackSet {
        synchronized(this){
            if (getAttributeInfo().indexSize == 0)
            ...
            if (value == null){
                value = new ArrayList<FullyQualifiedName>(getAttributeInfo().indexSize);
