...
/**
 * The DmcTypeRuleDefinitionREFSTATIC provides static access to functions used to manage values of type RuleDefinitionREF
...
public class DmcTypeRuleDefinitionREFSTATIC {
    ...
    public static DmcTypeRuleDefinitionREFSTATIC instance;
    static DmcTypeRuleDefinitionREFSV typeHelper;
    
    static {
        instance = new DmcTypeRuleDefinitionREFSTATIC();
    }
    ...
    public RuleDefinitionREF typeCheck(Object value) throws DMFeedbackSet {
    	   return(typeHelper.typeCheck(value));
    }
    
    public RuleDefinitionREF cloneValue(RuleDefinitionREF value) throws DMFeedbackSet {
