...
import org.dmd.dms.shared.generated.dmo.RuleDataDMO;               // The type of object we refer to - (TypeFormatter.java:173)
import org.dmd.dms.shared.types.DmcTypeRuleName;                   // The type of our naming attribute - (TypeFormatter.java:175)
import org.dmd.dms.shared.types.RuleName;                          // The base type of our naming attribute - (TypeFormatter.java:176)
...
public class RuleDataREF extends DmcNamedObjectREF<RuleDataDMO> implements Serializable {
    ...
    public void setName(DmcObjectName n) throws DMFeedbackSet {
        if (myName == null);
            myName = new  DmcTypeRuleNameSV(MetaCompactSchema.__name);
        myName.set(n);
    }
