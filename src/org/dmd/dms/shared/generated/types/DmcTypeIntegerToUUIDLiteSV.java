...
import org.dmd.dms.shared.types.DmcTypeIntegerToUUIDLite;         // DmcType import - (SVTypeFormatter.java:65)
import org.dmd.dms.shared.types.IntegerToUUIDLite;                // Base type import - (SVTypeFormatter.java:62)
...
public class DmcTypeIntegerToUUIDLiteSV extends DmcTypeIntegerToUUIDLite implements Serializable {
    ...
    protected IntegerToUUIDLite value;
    ...
    public DmcTypeIntegerToUUIDLiteSV getNew(){
        return(new DmcTypeIntegerToUUIDLiteSV(getAttributeInfo()));
    }
    ...
    public IntegerToUUIDLite getSVCopy(){
        if (value == null)
            return(null);
    ...
    public IntegerToUUIDLite set(Object v) throws DMFeedbackSet {
