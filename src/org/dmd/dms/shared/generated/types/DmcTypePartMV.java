...
import org.dmd.dms.shared.generated.types.DmcTypePart;         // DmcType import - (MVTypeFormatter.java:63)
import org.dmd.dms.shared.generated.types.Part;                // Base type import - (MVTypeFormatter.java:58)
...
public class DmcTypePartMV extends DmcTypePart implements Serializable {
    
    private final static Iterator<Part> emptyList = (new ArrayList<Part>()).iterator();
    ...
    public DmcTypePartMV getNew(){
        return(new DmcTypePartMV(getAttributeInfo()));
    }
    ...
    public Iterator<Part> getMV(){
        synchronized(this){
            ...
            ArrayList<Part> clone = new ArrayList<Part>(value);
    ...
    public ArrayList<Part> getMVCopy(){
        synchronized(this){
            if (value == null)
                ...
                return(new ArrayList<Part>(value));
        }
    }
    ...
    public Part setMVnth(int index, Object v) throws DMFeedbackSet {
        synchronized(this){
            if (getAttributeInfo().indexSize == 0)
            ...
            if (value == null){
                value = new ArrayList<Part>(getAttributeInfo().indexSize);
