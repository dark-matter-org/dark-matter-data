...
import org.dmd.dms.shared.generated.enums.RuleTypeEnum;          // DmcType import - (SETTypeFormatter.java:60)
...
public class DmcTypeRuleTypeEnumSET extends DmcTypeRuleTypeEnum implements Serializable {
     ...
     private final static Iterator<RuleTypeEnum> emptyList =  (new HashSet<RuleTypeEnum>()).iterator();
    
    
    protected Set<RuleTypeEnum> value;
    
    public DmcTypeRuleTypeEnumSET(){
        value = null;
    }
    
    public DmcTypeRuleTypeEnumSET(DmcAttributeInfo ai){
        super(ai);
        initValue();
    }
    ...
    public DmcAttribute<RuleTypeEnum> cloneIt(){
        synchronized(this){
            DmcTypeRuleTypeEnumSET rc = getNew();
    ...
    public Set<RuleTypeEnum> getMVCopy(){
        synchronized(this){
            if (getAttributeInfo().valueType == ValueTypeEnum.HASHSET){
                if (value == null)
                    return(new HashSet<RuleTypeEnum>());
                else
