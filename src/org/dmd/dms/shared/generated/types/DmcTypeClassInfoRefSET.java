...
import org.dmd.dms.shared.types.ClassInfoRef;                    // Base type import - (SETTypeFormatter.java:56)
import org.dmd.dms.shared.types.DmcTypeClassInfoRef;             // DmcType import - (SETTypeFormatter.java:59)
...
public class DmcTypeClassInfoRefSET extends DmcTypeClassInfoRef implements Serializable {
     ...
     private final static Iterator<ClassInfoRef> emptyList =  (new HashSet<ClassInfoRef>()).iterator();
    ...
    public ClassInfoRef add(Object v) throws DMFeedbackSet {
        synchronized(this){
