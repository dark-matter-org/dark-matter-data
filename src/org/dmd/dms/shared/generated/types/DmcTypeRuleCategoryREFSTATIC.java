...
/**
 * The DmcTypeRuleCategoryREFSTATIC provides static access to functions used to manage values of type RuleCategoryREF
...
public class DmcTypeRuleCategoryREFSTATIC {
    ...
    public static DmcTypeRuleCategoryREFSTATIC instance;
    static DmcTypeRuleCategoryREFSV typeHelper;
    
    static {
        instance = new DmcTypeRuleCategoryREFSTATIC();
    }
    ...
    public RuleCategoryREF typeCheck(Object value) throws DMFeedbackSet {
    	   return(typeHelper.typeCheck(value));
    }
    
    public RuleCategoryREF cloneValue(RuleCategoryREF value) throws DMFeedbackSet {
