...
import java.util.Date;                                           // Base type import - (SETTypeFormatter.java:56)
...
import org.dmd.dms.shared.types.DmcTypeDate;                     // DmcType import - (SETTypeFormatter.java:59)
...
public class DmcTypeDateSET extends DmcTypeDate implements Serializable {
     ...
     private final static Iterator<Date> emptyList =  (new HashSet<Date>()).iterator();
    ...
    public Date add(Object v) throws DMFeedbackSet {
        synchronized(this){
            Date rc = typeCheck(v);
            if (value == null)
                initValue();
