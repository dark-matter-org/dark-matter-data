...
import org.dmd.dms.shared.generated.types.DmcTypeDependencyREFMV;         //  - (AdapterFormatter.java:60)
...
public class DependencyREFMVAdapter extends DmcTypeDependencyREFMV implements DmcAdapterIF {
    ...
    public void setExisting(DmcAttribute<?> attr) {
    	existingValue = (DmcTypeDependencyREFMV) attr;
    	if (existingValue != null)
    		value = existingValue.getMVCopy();
    }
