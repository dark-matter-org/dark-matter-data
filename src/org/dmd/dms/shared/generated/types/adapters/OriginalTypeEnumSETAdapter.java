...
import org.dmd.dms.shared.generated.types.DmcTypeOriginalTypeEnumSET;         //  - (AdapterFormatter.java:60)
...
public class OriginalTypeEnumSETAdapter extends DmcTypeOriginalTypeEnumSET implements DmcAdapterIF {

    transient DmcTypeOriginalTypeEnumSET existingValue;

    public OriginalTypeEnumSETAdapter(DmcAttributeInfo ai){
    	   super(ai);
    }
    ...
    public void setExisting(DmcAttribute<?> attr) {
    	existingValue = (DmcTypeOriginalTypeEnumSET) attr;
    	if (existingValue != null)
    		value = existingValue.getMVCopy();
    }
