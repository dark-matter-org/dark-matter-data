...
import org.dmd.dms.shared.generated.types.DmcTypeOptimizeSV;         //  - (AdapterFormatter.java:60)
...
public class OptimizeSVAdapter extends DmcTypeOptimizeSV implements DmcAdapterIF {

    transient DmcTypeOptimizeSV existingValue;

    public OptimizeSVAdapter(DmcAttributeInfo ai){
    	   super(ai);
    }
    ...
    public void setExisting(DmcAttribute<?> attr) {
    	existingValue = (DmcTypeOptimizeSV) attr;
    	if (existingValue != null)
    		value = existingValue.getSVCopy();
    }
