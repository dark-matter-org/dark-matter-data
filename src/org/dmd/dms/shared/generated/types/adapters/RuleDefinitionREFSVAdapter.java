...
import org.dmd.dms.shared.generated.types.DmcTypeRuleDefinitionREFSV;         //  - (AdapterFormatter.java:60)
...
public class RuleDefinitionREFSVAdapter extends DmcTypeRuleDefinitionREFSV implements DmcAdapterIF {

    transient DmcTypeRuleDefinitionREFSV existingValue;

    public RuleDefinitionREFSVAdapter(DmcAttributeInfo ai){
    	   super(ai);
    }
    ...
    public void setExisting(DmcAttribute<?> attr) {
    	existingValue = (DmcTypeRuleDefinitionREFSV) attr;
    	if (existingValue != null)
    		value = existingValue.getSVCopy();
    }
