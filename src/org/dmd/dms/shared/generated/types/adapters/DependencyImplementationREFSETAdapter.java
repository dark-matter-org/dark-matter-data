...
import org.dmd.dms.shared.generated.types.DmcTypeDependencyImplementationREFSET;         //  - (AdapterFormatter.java:60)
...
public class DependencyImplementationREFSETAdapter extends DmcTypeDependencyImplementationREFSET implements DmcAdapterIF {
    ...
    public void setExisting(DmcAttribute<?> attr) {
    	existingValue = (DmcTypeDependencyImplementationREFSET) attr;
    	if (existingValue != null)
    		value = existingValue.getMVCopy();
    }
