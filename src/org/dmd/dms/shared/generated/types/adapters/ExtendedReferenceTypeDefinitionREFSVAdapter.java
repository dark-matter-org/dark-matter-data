...
import org.dmd.dms.shared.generated.types.DmcTypeExtendedReferenceTypeDefinitionREFSV;         //  - (AdapterFormatter.java:60)
...
public class ExtendedReferenceTypeDefinitionREFSVAdapter extends DmcTypeExtendedReferenceTypeDefinitionREFSV implements DmcAdapterIF {
    ...
    public void setExisting(DmcAttribute<?> attr) {
    	existingValue = (DmcTypeExtendedReferenceTypeDefinitionREFSV) attr;
    	if (existingValue != null)
    		value = existingValue.getSVCopy();
    }
