...
import org.dmd.dms.shared.generated.types.DmcTypeShortSV;            //  - (AdapterFormatter.java:60)
...
public class ShortSVAdapter extends DmcTypeShortSV implements DmcAdapterIF {

    transient DmcTypeShortSV existingValue;

    public ShortSVAdapter(DmcAttributeInfo ai){
    	   super(ai);
    }
    ...
    public void setExisting(DmcAttribute<?> attr) {
    	existingValue = (DmcTypeShortSV) attr;
    	if (existingValue != null)
    		value = existingValue.getSVCopy();
    }
