...
import org.dmd.dms.shared.generated.types.DmcTypeRuleParamSV;         //  - (AdapterFormatter.java:60)
...
public class RuleParamSVAdapter extends DmcTypeRuleParamSV implements DmcAdapterIF {

    transient DmcTypeRuleParamSV existingValue;

    public RuleParamSVAdapter(DmcAttributeInfo ai){
    	   super(ai);
    }
    ...
    public void setExisting(DmcAttribute<?> attr) {
    	existingValue = (DmcTypeRuleParamSV) attr;
    	if (existingValue != null)
    		value = existingValue.getSVCopy();
    }
