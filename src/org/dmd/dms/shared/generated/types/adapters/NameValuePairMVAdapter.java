...
import org.dmd.dms.shared.generated.types.DmcTypeNameValuePairMV;         //  - (AdapterFormatter.java:60)
...
public class NameValuePairMVAdapter extends DmcTypeNameValuePairMV implements DmcAdapterIF {

    transient DmcTypeNameValuePairMV existingValue;

    public NameValuePairMVAdapter(DmcAttributeInfo ai){
    	   super(ai);
    }
    ...
    public void setExisting(DmcAttribute<?> attr) {
    	existingValue = (DmcTypeNameValuePairMV) attr;
    	if (existingValue != null)
    		value = existingValue.getMVCopy();
    }
