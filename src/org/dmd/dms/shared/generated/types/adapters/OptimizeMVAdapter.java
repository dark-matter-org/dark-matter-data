...
import org.dmd.dms.shared.generated.types.DmcTypeOptimizeMV;         //  - (AdapterFormatter.java:60)
...
public class OptimizeMVAdapter extends DmcTypeOptimizeMV implements DmcAdapterIF {

    transient DmcTypeOptimizeMV existingValue;

    public OptimizeMVAdapter(DmcAttributeInfo ai){
    	   super(ai);
    }
    ...
    public void setExisting(DmcAttribute<?> attr) {
    	existingValue = (DmcTypeOptimizeMV) attr;
    	if (existingValue != null)
    		value = existingValue.getMVCopy();
    }
