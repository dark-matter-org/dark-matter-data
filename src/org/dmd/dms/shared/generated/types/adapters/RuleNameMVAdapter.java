...
import org.dmd.dms.shared.generated.types.DmcTypeRuleNameMV;         //  - (AdapterFormatter.java:60)
...
public class RuleNameMVAdapter extends DmcTypeRuleNameMV implements DmcAdapterIF {
    ...
    public void setExisting(DmcAttribute<?> attr) {
    	existingValue = (DmcTypeRuleNameMV) attr;
    	if (existingValue != null)
    		value = existingValue.getMVCopy();
    }
