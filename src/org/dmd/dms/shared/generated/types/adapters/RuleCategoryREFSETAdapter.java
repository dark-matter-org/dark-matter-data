...
import org.dmd.dms.shared.generated.types.DmcTypeRuleCategoryREFSET;         //  - (AdapterFormatter.java:60)
...
public class RuleCategoryREFSETAdapter extends DmcTypeRuleCategoryREFSET implements DmcAdapterIF {

    transient DmcTypeRuleCategoryREFSET existingValue;

    public RuleCategoryREFSETAdapter(DmcAttributeInfo ai){
    	   super(ai);
    }
    ...
    public void setExisting(DmcAttribute<?> attr) {
    	existingValue = (DmcTypeRuleCategoryREFSET) attr;
    	if (existingValue != null)
    		value = existingValue.getMVCopy();
    }
