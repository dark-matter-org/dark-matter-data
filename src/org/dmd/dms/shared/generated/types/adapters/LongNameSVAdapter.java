...
import org.dmd.dms.shared.generated.types.DmcTypeLongNameSV;         //  - (AdapterFormatter.java:60)
...
public class LongNameSVAdapter extends DmcTypeLongNameSV implements DmcAdapterIF {
    ...
    public void setExisting(DmcAttribute<?> attr) {
    	existingValue = (DmcTypeLongNameSV) attr;
    	if (existingValue != null)
    		value = existingValue.getSVCopy();
    }
