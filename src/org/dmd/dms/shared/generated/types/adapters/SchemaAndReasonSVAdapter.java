...
import org.dmd.dms.shared.generated.types.DmcTypeSchemaAndReasonSV;         //  - (AdapterFormatter.java:60)
...
public class SchemaAndReasonSVAdapter extends DmcTypeSchemaAndReasonSV implements DmcAdapterIF {

    transient DmcTypeSchemaAndReasonSV existingValue;

    public SchemaAndReasonSVAdapter(DmcAttributeInfo ai){
    	   super(ai);
    }
    ...
    public void setExisting(DmcAttribute<?> attr) {
    	existingValue = (DmcTypeSchemaAndReasonSV) attr;
    	if (existingValue != null)
    		value = existingValue.getSVCopy();
    }
