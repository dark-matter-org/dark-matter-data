...
import org.dmd.dms.shared.generated.types.DmcTypeDependencyImplementationREFSV;         //  - (AdapterFormatter.java:60)
...
public class DependencyImplementationREFSVAdapter extends DmcTypeDependencyImplementationREFSV implements DmcAdapterIF {

    transient DmcTypeDependencyImplementationREFSV existingValue;

    public DependencyImplementationREFSVAdapter(DmcAttributeInfo ai){
    	   super(ai);
    }
    ...
    public void setExisting(DmcAttribute<?> attr) {
    	existingValue = (DmcTypeDependencyImplementationREFSV) attr;
    	if (existingValue != null)
    		value = existingValue.getSVCopy();
    }
