...
import org.dmd.dms.shared.generated.types.DmcTypeConcinnityREFMV;         //  - (AdapterFormatter.java:60)
...
public class ConcinnityREFMVAdapter extends DmcTypeConcinnityREFMV implements DmcAdapterIF {

    transient DmcTypeConcinnityREFMV existingValue;

    public ConcinnityREFMVAdapter(DmcAttributeInfo ai){
    	   super(ai);
    }
    ...
    public void setExisting(DmcAttribute<?> attr) {
    	existingValue = (DmcTypeConcinnityREFMV) attr;
    	if (existingValue != null)
    		value = existingValue.getMVCopy();
    }
