...
import org.dmd.dms.shared.generated.types.DmcTypeDmsModuleREFSET;         //  - (AdapterFormatter.java:60)
...
public class DmsModuleREFSETAdapter extends DmcTypeDmsModuleREFSET implements DmcAdapterIF {
    ...
    public DmsModuleREFSETAdapter(DmcAttributeInfo ai){
    	   super(ai);
    }
    ...
    public void setExisting(DmcAttribute<?> attr) {
    	existingValue = (DmcTypeDmsModuleREFSET) attr;
    	if (existingValue != null)
    		value = existingValue.getMVCopy();
    }
