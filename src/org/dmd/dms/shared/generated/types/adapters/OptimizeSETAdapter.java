...
import org.dmd.dms.shared.generated.types.DmcTypeOptimizeSET;         //  - (AdapterFormatter.java:60)
...
public class OptimizeSETAdapter extends DmcTypeOptimizeSET implements DmcAdapterIF {

    transient DmcTypeOptimizeSET existingValue;

    public OptimizeSETAdapter(DmcAttributeInfo ai){
    	   super(ai);
    }
    ...
    public void setExisting(DmcAttribute<?> attr) {
    	existingValue = (DmcTypeOptimizeSET) attr;
    	if (existingValue != null)
    		value = existingValue.getMVCopy();
    }
