...
import org.dmd.dms.shared.generated.types.DmcTypeByteMV;             //  - (AdapterFormatter.java:60)
...
public class ByteMVAdapter extends DmcTypeByteMV implements DmcAdapterIF {

    transient DmcTypeByteMV existingValue;

    public ByteMVAdapter(DmcAttributeInfo ai){
    	   super(ai);
    }
    ...
    public void setExisting(DmcAttribute<?> attr) {
    	existingValue = (DmcTypeByteMV) attr;
    	if (existingValue != null)
    		value = existingValue.getMVCopy();
    }
