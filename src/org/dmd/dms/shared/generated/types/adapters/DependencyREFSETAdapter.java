...
import org.dmd.dms.shared.generated.types.DmcTypeDependencyREFSET;         //  - (AdapterFormatter.java:60)
...
public class DependencyREFSETAdapter extends DmcTypeDependencyREFSET implements DmcAdapterIF {

    transient DmcTypeDependencyREFSET existingValue;

    public DependencyREFSETAdapter(DmcAttributeInfo ai){
    	   super(ai);
    }
    ...
    public void setExisting(DmcAttribute<?> attr) {
    	existingValue = (DmcTypeDependencyREFSET) attr;
    	if (existingValue != null)
    		value = existingValue.getMVCopy();
    }
