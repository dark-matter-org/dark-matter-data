...
import org.dmd.dms.shared.generated.types.DmcTypeIntegerToStringMAP;         //  - (AdapterFormatter.java:60)
...
// Called from: org.dmd.dms.tools.generation.util.AdapterFormatter.dumpAdapterMAP(AdapterFormatter.java:26)
public class IntegerToStringMAPAdapter extends DmcTypeIntegerToStringMAP implements DmcAdapterIF {
    ...
    public void setExisting(DmcAttribute<?> attr) {
    	existingValue = (DmcTypeIntegerToStringMAP) attr;
    	if (existingValue != null)
    		value = existingValue.getMVCopy();
    }
