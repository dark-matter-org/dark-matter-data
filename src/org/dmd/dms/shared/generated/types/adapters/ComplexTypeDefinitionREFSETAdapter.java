...
import org.dmd.dms.shared.generated.types.DmcTypeComplexTypeDefinitionREFSET;         //  - (AdapterFormatter.java:60)
...
public class ComplexTypeDefinitionREFSETAdapter extends DmcTypeComplexTypeDefinitionREFSET implements DmcAdapterIF {
    ...
    public void setExisting(DmcAttribute<?> attr) {
    	existingValue = (DmcTypeComplexTypeDefinitionREFSET) attr;
    	if (existingValue != null)
    		value = existingValue.getMVCopy();
    }
