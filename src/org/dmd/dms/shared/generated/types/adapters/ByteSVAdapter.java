...
import org.dmd.dms.shared.generated.types.DmcTypeByteSV;             //  - (AdapterFormatter.java:60)
...
public class ByteSVAdapter extends DmcTypeByteSV implements DmcAdapterIF {

    transient DmcTypeByteSV existingValue;

    public ByteSVAdapter(DmcAttributeInfo ai){
    	   super(ai);
    }
    ...
    public void setExisting(DmcAttribute<?> attr) {
    	existingValue = (DmcTypeByteSV) attr;
    	if (existingValue != null)
    		value = existingValue.getSVCopy();
    }
