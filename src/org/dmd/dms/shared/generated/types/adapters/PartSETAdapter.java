...
import org.dmd.dms.shared.generated.types.DmcTypePartSET;            //  - (AdapterFormatter.java:60)
...
public class PartSETAdapter extends DmcTypePartSET implements DmcAdapterIF {

    transient DmcTypePartSET existingValue;

    public PartSETAdapter(DmcAttributeInfo ai){
    	   super(ai);
    }
    ...
    public void setExisting(DmcAttribute<?> attr) {
    	existingValue = (DmcTypePartSET) attr;
    	if (existingValue != null)
    		value = existingValue.getMVCopy();
    }
