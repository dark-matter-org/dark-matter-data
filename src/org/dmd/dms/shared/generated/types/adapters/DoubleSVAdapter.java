...
import org.dmd.dms.shared.generated.types.DmcTypeDoubleSV;           //  - (AdapterFormatter.java:60)
...
public class DoubleSVAdapter extends DmcTypeDoubleSV implements DmcAdapterIF {
    ...
    public void setExisting(DmcAttribute<?> attr) {
    	existingValue = (DmcTypeDoubleSV) attr;
    	if (existingValue != null)
    		value = existingValue.getSVCopy();
    }
