...
import org.dmd.dms.shared.generated.types.DmcTypeShortSET;           //  - (AdapterFormatter.java:60)
...
public class ShortSETAdapter extends DmcTypeShortSET implements DmcAdapterIF {

    transient DmcTypeShortSET existingValue;

    public ShortSETAdapter(DmcAttributeInfo ai){
    	   super(ai);
    }
    ...
    public void setExisting(DmcAttribute<?> attr) {
    	existingValue = (DmcTypeShortSET) attr;
    	if (existingValue != null)
    		value = existingValue.getMVCopy();
    }
