...
import org.dmd.dms.shared.generated.types.DmcTypePartMV;             //  - (AdapterFormatter.java:60)
...
public class PartMVAdapter extends DmcTypePartMV implements DmcAdapterIF {

    transient DmcTypePartMV existingValue;

    public PartMVAdapter(DmcAttributeInfo ai){
    	   super(ai);
    }
    ...
    public void setExisting(DmcAttribute<?> attr) {
    	existingValue = (DmcTypePartMV) attr;
    	if (existingValue != null)
    		value = existingValue.getMVCopy();
    }
