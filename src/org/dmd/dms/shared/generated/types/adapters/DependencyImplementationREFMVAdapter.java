...
import org.dmd.dms.shared.generated.types.DmcTypeDependencyImplementationREFMV;         //  - (AdapterFormatter.java:60)
...
public class DependencyImplementationREFMVAdapter extends DmcTypeDependencyImplementationREFMV implements DmcAdapterIF {

    transient DmcTypeDependencyImplementationREFMV existingValue;

    public DependencyImplementationREFMVAdapter(DmcAttributeInfo ai){
    	   super(ai);
    }
    ...
    public void setExisting(DmcAttribute<?> attr) {
    	existingValue = (DmcTypeDependencyImplementationREFMV) attr;
    	if (existingValue != null)
    		value = existingValue.getMVCopy();
    }
