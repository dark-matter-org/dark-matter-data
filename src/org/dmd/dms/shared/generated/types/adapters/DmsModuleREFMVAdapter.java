...
import org.dmd.dms.shared.generated.types.DmcTypeDmsModuleREFMV;         //  - (AdapterFormatter.java:60)
...
public class DmsModuleREFMVAdapter extends DmcTypeDmsModuleREFMV implements DmcAdapterIF {

    transient DmcTypeDmsModuleREFMV existingValue;

    public DmsModuleREFMVAdapter(DmcAttributeInfo ai){
    	   super(ai);
    }
    ...
    public void setExisting(DmcAttribute<?> attr) {
    	existingValue = (DmcTypeDmsModuleREFMV) attr;
    	if (existingValue != null)
    		value = existingValue.getMVCopy();
    }
