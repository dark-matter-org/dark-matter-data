...
import org.dmd.dms.shared.generated.types.DmcTypeExtendedReferenceTypeDefinitionREFMV;         //  - (AdapterFormatter.java:60)
...
// Called from: org.dmd.dms.tools.util.AdapterFormatter.dumpAdapterMV(AdapterFormatter.java:18)
public class ExtendedReferenceTypeDefinitionREFMVAdapter extends DmcTypeExtendedReferenceTypeDefinitionREFMV implements DmcAdapterIF {

    transient DmcTypeExtendedReferenceTypeDefinitionREFMV existingValue;

    public ExtendedReferenceTypeDefinitionREFMVAdapter(DmcAttributeInfo ai){
    	   super(ai);
    }
    ...
    public void setExisting(DmcAttribute<?> attr) {
    	existingValue = (DmcTypeExtendedReferenceTypeDefinitionREFMV) attr;
    	if (existingValue != null)
    		value = existingValue.getMVCopy();
    }
