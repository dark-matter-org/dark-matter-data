...
public class DmcTypeDependencyREFMV extends DmcTypeDependencyREF implements Serializable {
    
    private final static Iterator<DependencyREF> emptyList = (new ArrayList<DependencyREF>()).iterator();
    
    protected ArrayList<DependencyREF> value;
    
    public DmcTypeDependencyREFMV(){
    
    }
    
    public DmcTypeDependencyREFMV(DmcAttributeInfo ai){
        super(ai);
    }
    
    @Override
    public DmcTypeDependencyREFMV getNew(){
        return(new DmcTypeDependencyREFMV(getAttributeInfo()));
    }
    ...
    public DependencyREF add(Object v) throws DMFeedbackSet {
        synchronized(this){
            DependencyREF rc = typeCheck(v);
            if (value == null)
                value = new ArrayList<DependencyREF>();
            value.add(rc);
            return(rc);
        }
    }
    ...
    public ArrayList<DependencyREF> getMVCopy(){
        synchronized(this){
            if (value == null)
                return(new ArrayList<DependencyREF>());
            else 
                return(new ArrayList<DependencyREF>(value));
        }
    }
    ...
    public DependencyREF setMVnth(int index, Object v) throws DMFeedbackSet {
        synchronized(this){
            if (getAttributeInfo().indexSize == 0)
            ...
            if (value == null){
                value = new ArrayList<DependencyREF>(getAttributeInfo().indexSize);
