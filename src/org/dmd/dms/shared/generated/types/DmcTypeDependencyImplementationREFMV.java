...
public class DmcTypeDependencyImplementationREFMV extends DmcTypeDependencyImplementationREF implements Serializable {
    ...
    private final static Iterator<DependencyImplementationREF> emptyList = (new ArrayList<DependencyImplementationREF>()).iterator();
    
    protected ArrayList<DependencyImplementationREF> value;
    
    public DmcTypeDependencyImplementationREFMV(){
    
    }
    
    public DmcTypeDependencyImplementationREFMV(DmcAttributeInfo ai){
        super(ai);
    }
    
    @Override
    public DmcTypeDependencyImplementationREFMV getNew(){
        return(new DmcTypeDependencyImplementationREFMV(getAttributeInfo()));
    }
    ...
    public DmcAttribute<DependencyImplementationREF> cloneIt(){
        synchronized(this){
            ...
            if (getAttributeInfo().indexSize == 0){
                for(DependencyImplementationREF val: value)
                try {
                    rc.add(val);
    ...
    public DependencyImplementationREF add(Object v) throws DMFeedbackSet {
        synchronized(this){
            DependencyImplementationREF rc = typeCheck(v);
            if (value == null)
                value = new ArrayList<DependencyImplementationREF>();
            value.add(rc);
            return(rc);
        }
    }
    ...
    public ArrayList<DependencyImplementationREF> getMVCopy(){
        synchronized(this){
            if (value == null)
                return(new ArrayList<DependencyImplementationREF>());
            else 
                return(new ArrayList<DependencyImplementationREF>(value));
        }
    }
    ...
    public DependencyImplementationREF setMVnth(int index, Object v) throws DMFeedbackSet {
        synchronized(this){
            if (getAttributeInfo().indexSize == 0)
            ...
            if (value == null){
                value = new ArrayList<DependencyImplementationREF>(getAttributeInfo().indexSize);
    ...
    public boolean contains(Object v){
        synchronized(this){
            ...
            try {
                DependencyImplementationREF val = typeCheck(v);
