...
import org.dmd.dms.generated.types.Field;         // This is the type we're iterating - (GenUtility.java:1928)
...
public class FieldIterableDMW extends DmwMVIterator<Field> {
    ...
    public final static FieldIterableDMW emptyList = new FieldIterableDMW();

    protected FieldIterableDMW(){
        super();
    }

    public FieldIterableDMW(Iterator<Field> it){
        super(it);
    }
