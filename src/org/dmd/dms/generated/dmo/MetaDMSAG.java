...
// Generated from: org.dmd.dms.util.DmoCompactSchemaFormatter.dumpSchema(DmoCompactSchemaFormatter.java:628)
...
// Generated from: org.dmd.dms.util.DmoCompactSchemaFormatter.dumpSchema(DmoCompactSchemaFormatter.java:650)
    ...
    public final static DmcAttributeInfo __nameAndTypeName = new DmcAttributeInfo("meta","nameAndTypeName",176,"DotName",ValueTypeEnum.SINGLE,DataTypeEnum.PERSISTENT);
    ...
    public final static DmcAttributeInfo __optionalPart = new DmcAttributeInfo("meta","optionalPart",114,"Part",ValueTypeEnum.MULTI,DataTypeEnum.PERSISTENT);
    ...
    public final static DmcAttributeInfo __partOfDefinitionModule = new DmcAttributeInfo("meta","partOfDefinitionModule",175,"DSDefinitionModule",ValueTypeEnum.SINGLE,DataTypeEnum.PERSISTENT);
    ...
    public final static DmcAttributeInfo __requiredPart = new DmcAttributeInfo("meta","requiredPart",112,"Part",ValueTypeEnum.MULTI,DataTypeEnum.PERSISTENT);
...
// Generated from: org.dmd.dms.util.DmoCompactSchemaFormatter.dumpSchema(DmoCompactSchemaFormatter.java:663)
...
// Generated from: org.dmd.dms.util.DmoCompactSchemaFormatter.dumpSchema(DmoCompactSchemaFormatter.java:697)
...
// Generated from: org.dmd.dms.util.DmoCompactSchemaFormatter.dumpSchema(DmoCompactSchemaFormatter.java:707)
    ...
    static {
        ...
        _SmAp.put(__nameAndTypeName.id,__nameAndTypeName);
        ...
        __ActionDefinition.addMay(__nameAndTypeName);
        ...
        __AttributeDefinition.addMay(__nameAndTypeName);
        ...
        __ClassDefinition.addMay(__nameAndTypeName);
        ...
        __ComplexTypeDefinition.addMay(__mandatoryFields);
        __ComplexTypeDefinition.addMay(__nameAndTypeName);
        ...
        __DSDefinition.addMay(__nameAndTypeName);
        ...
        __DSDefinitionModule.addMay(__nameAndTypeName);
        ...
        __Dependency.addMay(__nameAndTypeName);
        ...
        __DependencyImplementation.addMay(__nameAndTypeName);
        ...
        __DmsDefinition.addMay(__nameAndTypeName);
        ...
        __EnumDefinition.addMay(__nameAndTypeName);
        ...
        __ExtendedReferenceTypeDefinition.addMay(__mandatoryFields);
        __ExtendedReferenceTypeDefinition.addMay(__nameAndTypeName);
        ...
        __RuleCategory.addMay(__nameAndTypeName);
        ...
        __RuleDefinition.addMay(__nameAndTypeName);
        ...
        __RunContext.addMay(__nameAndTypeName);
        ...
        __SchemaDefinition.addMay(__nameAndTypeName);
        ...
        __SliceDefinition.addMay(__nameAndTypeName);
        ...
        __TypeDefinition.addMay(__nameAndTypeName);
