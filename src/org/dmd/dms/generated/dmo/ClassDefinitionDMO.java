...
import org.dmd.dmc.definitions.DmcDefinitionIF;         // This is a domain specific definition - (MetaGenerator.java:1857)
import org.dmd.dmc.types.*;                             // Basic type access - (MetaGenerator.java:1834)
import org.dmd.dms.generated.enums.*;                   // Has enum attributes - (MetaGenerator.java:1866)
...
public class ClassDefinitionDMO extends org.dmd.dms.generated.dmo.DmsDefinitionDMO implements Serializable, DmcDefinitionIF {
    ...
    static {
        ...
        _ImAp.put(MetaDMSAG.__isDSModule.id,MetaDMSAG.__isDSModule);
        ...
        _SmAp.put(MetaDMSAG.__isDSModule.name,MetaDMSAG.__isDSModule);
     ...
     */
    // org.dmd.dms.meta.MetaGenerator.dumpMVAccessFunction(MetaGenerator.java:2462)
    ...
    public Boolean getIsDSModule(){
        DmcTypeBooleanSV attr = (DmcTypeBooleanSV) get(MetaDMSAG.__isDSModule);
        if (attr == null)
            return(false);
    ...
    public void setIsDSModule(Object value) throws DmcValueException {
        DmcAttribute<?> attr = get(MetaDMSAG.__isDSModule);
        if (attr == null)
            attr = new DmcTypeBooleanSV(MetaDMSAG.__isDSModule);
        
        attr.set(value);
        set(MetaDMSAG.__isDSModule,attr);
    }
