...
public class DmcTypeActionDefinitionREFMV extends DmcTypeActionDefinitionREF implements Serializable {
    ...
    private final static Iterator<ActionDefinitionREF> emptyList = (new ArrayList<ActionDefinitionREF>()).iterator();
    
    protected ArrayList<ActionDefinitionREF> value;
    ...
    public DmcTypeActionDefinitionREFMV getNew(){
        return(new DmcTypeActionDefinitionREFMV(getAttributeInfo()));
    }
    ...
    public DmcAttribute<ActionDefinitionREF> cloneIt(){
        synchronized(this){
            DmcTypeActionDefinitionREFMV rc = getNew();
    ...
    public ArrayList<ActionDefinitionREF> getMVCopy(){
        synchronized(this){
            if (value == null)
                return(new ArrayList<ActionDefinitionREF>());
            else 
                return(new ArrayList<ActionDefinitionREF>(value));
        }
    }
    ...
    public ActionDefinitionREF getMVnth(int index){
        synchronized(this){
            if (value == null)
                return(null);
    ...
    public ActionDefinitionREF setMVnth(int index, Object v) throws DmcValueException {
        synchronized(this){
            if (getAttributeInfo().indexSize == 0)
            ...
            if (value == null){
                value = new ArrayList<ActionDefinitionREF>(getAttributeInfo().indexSize);
