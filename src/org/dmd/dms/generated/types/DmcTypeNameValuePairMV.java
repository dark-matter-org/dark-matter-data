...
import org.dmd.dmc.types.NameValuePair;    // base type import
import org.dmd.dmc.types.DmcTypeNameValuePair;    // DmcType import
/**
...
public class DmcTypeNameValuePairMV extends DmcTypeNameValuePair implements Serializable {
    ...
    public NameValuePair setMVnth(int index, Object v) throws DmcValueException {
        synchronized(this){
            if (getAttributeInfo().indexSize == 0)
