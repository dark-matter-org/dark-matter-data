...
public class DmcTypeDoubleMV extends DmcTypeDouble implements Serializable {
    ...
    private final static Iterator<Double> emptyList = (new ArrayList<Double>()).iterator();
    ...
    public DmcTypeDoubleMV getNew(){
        return(new DmcTypeDoubleMV(getAttributeInfo()));
    }
    ...
    public Double setMVnth(int index, Object v) throws DmcValueException {
        synchronized(this){
            ...
            if (value == null){
                value = new ArrayList<Double>(getAttributeInfo().indexSize);
