...
public class DmcTypeRuleScopeEnumMV extends DmcTypeRuleScopeEnum implements Serializable {
    
    protected ArrayList<RuleScopeEnum> value;
    
    public DmcTypeRuleScopeEnumMV(){
    
    }
    
    public DmcTypeRuleScopeEnumMV(DmcAttributeInfo ai){
        super(ai);
    }
    
    @Override
    public DmcTypeRuleScopeEnumMV getNew(){
        return(new DmcTypeRuleScopeEnumMV(attrInfo));
    }
    ...
    public DmcAttribute<RuleScopeEnum> cloneIt(){
        synchronized(this){
            DmcTypeRuleScopeEnumMV rc = getNew();
    ...
    public RuleScopeEnum add(Object v) throws DmcValueException {
        synchronized(this){
            ...
            if (value == null)
                value = new ArrayList<RuleScopeEnum>();
            value.add(rc);
            return(rc);
        }
    }
    ...
    public Iterator<RuleScopeEnum> getMV(){
        synchronized(this){
            ArrayList<RuleScopeEnum> clone = new ArrayList<RuleScopeEnum>(value);
            return(clone.iterator());
        }
    }
    
    // org.dmd.dms.util.GenUtility.dumpMVType(GenUtility.java:2400)
    public ArrayList<RuleScopeEnum> getMVCopy(){
        synchronized(this){
            ArrayList<RuleScopeEnum> clone = new ArrayList<RuleScopeEnum>(value);
            return(clone);
        }
    ...
    public RuleScopeEnum getMVnth(int index){
        synchronized(this){
            if (value == null)
                return(null);
    ...
    public RuleScopeEnum setMVnth(int index, Object v) throws DmcValueException {
        synchronized(this){
            if (attrInfo.indexSize == 0)
            ...
            if (value == null){
                value = new ArrayList<RuleScopeEnum>(attrInfo.indexSize);
