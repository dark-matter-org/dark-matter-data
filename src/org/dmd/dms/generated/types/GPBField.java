 ...
 * manually.
 * Generated from: org.dmd.dms.meta.MetaGenerator.dumpComplexType(MetaGenerator.java:3097)
 */
public class GPBField implements Serializable {
    ...
    public void resolve(DmcNameResolverWithClashSupportIF resolver, DmcObject object, DmcNameClashResolverIF ncr, DmcAttributeInfo ai) throws DmcValueException, DmcValueExceptionSet {
        ...
        if (!attribute.isResolved()){
            obj = resolver.findNamedObjectMayClash(object, attribute.getObjectName(), ncr, ai);
            if (obj == null)
    ...
    // org.dmd.dms.meta.MetaGenerator.dumpComplexType(MetaGenerator.java:3274)
