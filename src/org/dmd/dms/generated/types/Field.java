...
// Called from: org.dmd.dms.meta.MetaGenerator.dumpComplexType(MetaGenerator.java:3203)
import java.io.Serializable;                                  // Marker interface for serialization - (MetaGenerator.java:3180)
import org.dmd.dmc.DmcAttributeInfo;                          // For fake DmcAttributeInfo - (MetaGenerator.java:3186)
import org.dmd.dmc.DmcContainerIF;                            // Reference resolution - (MetaGenerator.java:3194)
import org.dmd.dmc.DmcInputStreamIF;                          // To support serialization - (MetaGenerator.java:3181)
import org.dmd.dmc.DmcNameClashResolverIF;                    // Ambiguous reference resolution - (MetaGenerator.java:3190)
import org.dmd.dmc.DmcNameResolverIF;                         // Reference resolution - (MetaGenerator.java:3191)
import org.dmd.dmc.DmcNameResolverWithClashSupportIF;         // Ambiguous reference resolution - (MetaGenerator.java:3189)
import org.dmd.dmc.DmcNamedObjectIF;                          // Reference resolution - (MetaGenerator.java:3192)
import org.dmd.dmc.DmcNamedObjectREF;                         // Reference resolution - (MetaGenerator.java:3193)
import org.dmd.dmc.DmcObject;                                 // Ambiguous reference resolution - (MetaGenerator.java:3195)
import org.dmd.dmc.DmcOutputStreamIF;                         // To support serialization - (MetaGenerator.java:3182)
import org.dmd.dmc.DmcValueException;                         // For type checking - (MetaGenerator.java:3199)
import org.dmd.dmc.DmcValueExceptionSet;                      // Ambiguous reference resolution - (MetaGenerator.java:3196)
import org.dmd.dmc.types.IntegerVar;                          // For getNextField() - (MetaGenerator.java:3183)
import org.dmd.dms.generated.enums.DataTypeEnum;              // For fake DmcAttributeInfo - (MetaGenerator.java:3184)
import org.dmd.dms.generated.enums.ValueTypeEnum;             // For fake DmcAttributeInfo - (MetaGenerator.java:3185)
 ...
 * manually.
 * Generated from: org.dmd.dms.meta.MetaGenerator.dumpComplexType(MetaGenerator.java:3210)
 */
public class Field implements Serializable {
    ...
    // org.dmd.dms.meta.MetaGenerator.dumpComplexType(MetaGenerator.java:3387)
