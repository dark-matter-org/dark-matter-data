 ...
 *    Called from: org.dmd.dms.meta.MetaGenerator.dumpDerivedTypes(MetaGenerator.java:521)
 */
@SuppressWarnings("serial")
public class DmcTypeModificationControlEnumSV extends DmcTypeModificationControlEnum implements Serializable {
    
    protected ModificationControlEnum value;
    
    public DmcTypeModificationControlEnumSV(){
    
    }
    
    public DmcTypeModificationControlEnumSV(DmcAttributeInfo ai){
        super(ai);
    }
    
    public DmcTypeModificationControlEnumSV getNew(){
        return(new DmcTypeModificationControlEnumSV(attrInfo));
    }
    
    public DmcTypeModificationControlEnumSV getNew(DmcAttributeInfo ai){
        return(new DmcTypeModificationControlEnumSV(ai));
    }
    
    @Override
    // org.dmd.dms.util.GenUtility.dumpSVType(GenUtility.java:1976)
    public DmcAttribute<ModificationControlEnum> cloneIt(){
        DmcTypeModificationControlEnumSV rc = getNew();
        rc.value = value;
        return(rc);
    }
    
    // org.dmd.dms.util.GenUtility.dumpSVType(GenUtility.java:1987)
    public ModificationControlEnum getSVCopy(){
        if (value == null)
            return(null);
    ...
    public ModificationControlEnum set(Object v) throws DmcValueException {
    ...
    @Override
    public ModificationControlEnum getSV(){
        return(value);
    }
