...
/**
 * The DmcTypeRuleScopeEnumSTATIC provides static access to functions used to manage values of type RuleScopeEnum
...
public class DmcTypeRuleScopeEnumSTATIC {
    ...
    static {
        instance = new DmcTypeRuleScopeEnumSTATIC();
    }
    ...
    public RuleScopeEnum cloneValue(RuleScopeEnum value) throws DmcValueException {
