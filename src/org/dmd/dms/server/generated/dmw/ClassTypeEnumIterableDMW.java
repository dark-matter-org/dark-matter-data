...
import org.dmd.dms.shared.generated.enums.ClassTypeEnum;         // This is the type we're iterating - (DmwFormatter.java:461)
import org.dmd.dmw.DmwMVIterator;                                // The base multi-value iterator - (DmwFormatter.java:458)


/**
 * The ClassTypeEnumIterableDMW wraps an Iterator for a particular type and makes 
 * it Iterable.
 * <P>
 ...
 */
public class ClassTypeEnumIterableDMW extends DmwMVIterator<ClassTypeEnum> {

    public final static ClassTypeEnumIterableDMW emptyList = new ClassTypeEnumIterableDMW();

    protected ClassTypeEnumIterableDMW(){
        super();
    }

    public ClassTypeEnumIterableDMW(Iterator<ClassTypeEnum> it){
        super(it);
    }
