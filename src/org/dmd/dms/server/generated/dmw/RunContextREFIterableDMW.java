...
import org.dmd.dms.shared.generated.types.RunContextREF;         // The base type - (DmwFormatter.java:450)
import org.dmd.dmw.DmwMVIterator;                                // The base multi-value iterator - (DmwFormatter.java:453)


/**
 * The RunContextREFIterableDMW wraps an Iterator for a particular type and makes 
 * it Iterable.
 * <P>
 ...
 */
public class RunContextREFIterableDMW extends DmwMVIterator<RunContextREF> {

    public final static RunContextREFIterableDMW emptyList = new RunContextREFIterableDMW();

    protected RunContextREFIterableDMW(){
        super();
    }

    public RunContextREFIterableDMW(Iterator<RunContextREF> it){
        super(it);
    }
