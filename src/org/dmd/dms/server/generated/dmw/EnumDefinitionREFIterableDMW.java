...
import org.dmd.dms.shared.generated.types.EnumDefinitionREF;         // The base type - (DmwFormatter.java:450)
import org.dmd.dmw.DmwMVIterator;                                    // The base multi-value iterator - (DmwFormatter.java:453)


/**
 * The EnumDefinitionREFIterableDMW wraps an Iterator for a particular type and makes 
 * it Iterable.
 * <P>
 ...
 */
public class EnumDefinitionREFIterableDMW extends DmwMVIterator<EnumDefinitionREF> {

    public final static EnumDefinitionREFIterableDMW emptyList = new EnumDefinitionREFIterableDMW();

    protected EnumDefinitionREFIterableDMW(){
        super();
    }

    public EnumDefinitionREFIterableDMW(Iterator<EnumDefinitionREF> it){
        super(it);
    }
