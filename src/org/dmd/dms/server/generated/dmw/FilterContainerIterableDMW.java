...
import org.dmd.dms.shared.types.FilterContainer;         // This is the type we're iterating - (DmwFormatter.java:461)
...
public class FilterContainerIterableDMW extends DmwMVIterator<FilterContainer> {
    ...
    public final static FilterContainerIterableDMW emptyList = new FilterContainerIterableDMW();
