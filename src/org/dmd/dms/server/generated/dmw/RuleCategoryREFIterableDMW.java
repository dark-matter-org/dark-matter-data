...
import org.dmd.dms.shared.generated.types.RuleCategoryREF;         // The base type - (DmwFormatter.java:450)
import org.dmd.dmw.DmwMVIterator;                                  // The base multi-value iterator - (DmwFormatter.java:453)


/**
 * The RuleCategoryREFIterableDMW wraps an Iterator for a particular type and makes 
 * it Iterable.
 * <P>
 ...
 */
public class RuleCategoryREFIterableDMW extends DmwMVIterator<RuleCategoryREF> {

    public final static RuleCategoryREFIterableDMW emptyList = new RuleCategoryREFIterableDMW();

    protected RuleCategoryREFIterableDMW(){
        super();
    }

    public RuleCategoryREFIterableDMW(Iterator<RuleCategoryREF> it){
        super(it);
    }
