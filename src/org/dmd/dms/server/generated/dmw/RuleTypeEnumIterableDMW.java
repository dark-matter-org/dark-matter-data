...
import org.dmd.dms.shared.generated.enums.RuleTypeEnum;         // This is the type we're iterating - (DmwFormatter.java:461)
import org.dmd.dmw.DmwMVIterator;                               // The base multi-value iterator - (DmwFormatter.java:458)


/**
 * The RuleTypeEnumIterableDMW wraps an Iterator for a particular type and makes 
 * it Iterable.
 * <P>
 ...
 */
public class RuleTypeEnumIterableDMW extends DmwMVIterator<RuleTypeEnum> {

    public final static RuleTypeEnumIterableDMW emptyList = new RuleTypeEnumIterableDMW();

    protected RuleTypeEnumIterableDMW(){
        super();
    }

    public RuleTypeEnumIterableDMW(Iterator<RuleTypeEnum> it){
        super(it);
    }
