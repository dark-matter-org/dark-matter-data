...
import org.dmd.dms.shared.types.StringToString;         // This is the type we're iterating - (DmwFormatter.java:456)
...
public class StringToStringIterableDMW extends DmwMVIterator<StringToString> {
    ...
    public final static StringToStringIterableDMW emptyList = new StringToStringIterableDMW();

    protected StringToStringIterableDMW(){
        super();
    }

    public StringToStringIterableDMW(Iterator<StringToString> it){
        super(it);
    }
