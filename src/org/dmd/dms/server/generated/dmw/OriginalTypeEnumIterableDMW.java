...
import org.dmd.dms.shared.generated.enums.OriginalTypeEnum;         // This is the type we're iterating - (DmwFormatter.java:461)
import org.dmd.dmw.DmwMVIterator;                                   // The base multi-value iterator - (DmwFormatter.java:458)


/**
 * The OriginalTypeEnumIterableDMW wraps an Iterator for a particular type and makes 
 * it Iterable.
 * <P>
 ...
 */
public class OriginalTypeEnumIterableDMW extends DmwMVIterator<OriginalTypeEnum> {

    public final static OriginalTypeEnumIterableDMW emptyList = new OriginalTypeEnumIterableDMW();

    protected OriginalTypeEnumIterableDMW(){
        super();
    }

    public OriginalTypeEnumIterableDMW(Iterator<OriginalTypeEnum> it){
        super(it);
    }
