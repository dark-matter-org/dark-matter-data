...
import org.dmd.dms.shared.generated.types.ConcinnityREF;         // The base type - (DmwFormatter.java:450)
import org.dmd.dmw.DmwMVIterator;                                // The base multi-value iterator - (DmwFormatter.java:453)


/**
 * The ConcinnityREFIterableDMW wraps an Iterator for a particular type and makes 
 * it Iterable.
 * <P>
 ...
 */
public class ConcinnityREFIterableDMW extends DmwMVIterator<ConcinnityREF> {

    public final static ConcinnityREFIterableDMW emptyList = new ConcinnityREFIterableDMW();

    protected ConcinnityREFIterableDMW(){
        super();
    }

    public ConcinnityREFIterableDMW(Iterator<ConcinnityREF> it){
        super(it);
    }
