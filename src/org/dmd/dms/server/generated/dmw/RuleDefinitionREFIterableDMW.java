...
import org.dmd.dms.shared.generated.types.RuleDefinitionREF;         // The base type - (DmwFormatter.java:450)
import org.dmd.dmw.DmwMVIterator;                                    // The base multi-value iterator - (DmwFormatter.java:453)


/**
 * The RuleDefinitionREFIterableDMW wraps an Iterator for a particular type and makes 
 * it Iterable.
 * <P>
 ...
 */
public class RuleDefinitionREFIterableDMW extends DmwMVIterator<RuleDefinitionREF> {

    public final static RuleDefinitionREFIterableDMW emptyList = new RuleDefinitionREFIterableDMW();

    protected RuleDefinitionREFIterableDMW(){
        super();
    }

    public RuleDefinitionREFIterableDMW(Iterator<RuleDefinitionREF> it){
        super(it);
    }
