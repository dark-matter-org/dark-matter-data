...
import org.dmd.dms.shared.generated.types.DmsDefinitionREF;         // The base type - (DmwFormatter.java:450)
import org.dmd.dmw.DmwMVIterator;                                   // The base multi-value iterator - (DmwFormatter.java:453)


/**
 * The DmsDefinitionREFIterableDMW wraps an Iterator for a particular type and makes 
 * it Iterable.
 * <P>
 ...
 */
public class DmsDefinitionREFIterableDMW extends DmwMVIterator<DmsDefinitionREF> {

    public final static DmsDefinitionREFIterableDMW emptyList = new DmsDefinitionREFIterableDMW();

    protected DmsDefinitionREFIterableDMW(){
        super();
    }

    public DmsDefinitionREFIterableDMW(Iterator<DmsDefinitionREF> it){
        super(it);
    }
