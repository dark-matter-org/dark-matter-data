...
import org.dmd.dms.shared.types.TimeDoubleDataPoint;         // This is the type we're iterating - (DmwFormatter.java:461)
...
public class TimeDoubleDataPointIterableDMW extends DmwMVIterator<TimeDoubleDataPoint> {
    ...
    public final static TimeDoubleDataPointIterableDMW emptyList = new TimeDoubleDataPointIterableDMW();
