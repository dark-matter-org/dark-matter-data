...
import org.dmd.dms.shared.types.IntegerToBoolean;         // This is the type we're iterating - (DmwFormatter.java:461)
...
public class IntegerToBooleanIterableDMW extends DmwMVIterator<IntegerToBoolean> {
    ...
    public final static IntegerToBooleanIterableDMW emptyList = new IntegerToBooleanIterableDMW();

    protected IntegerToBooleanIterableDMW(){
        super();
    }

    public IntegerToBooleanIterableDMW(Iterator<IntegerToBoolean> it){
        super(it);
    }
