...
import org.dmd.dms.shared.generated.types.DSDefinitionREF;         // The base type - (DmwFormatter.java:450)
import org.dmd.dmw.DmwMVIterator;                                  // The base multi-value iterator - (DmwFormatter.java:453)


/**
 * The DSDefinitionREFIterableDMW wraps an Iterator for a particular type and makes 
 * it Iterable.
 * <P>
 ...
 */
public class DSDefinitionREFIterableDMW extends DmwMVIterator<DSDefinitionREF> {

    public final static DSDefinitionREFIterableDMW emptyList = new DSDefinitionREFIterableDMW();

    protected DSDefinitionREFIterableDMW(){
        super();
    }

    public DSDefinitionREFIterableDMW(Iterator<DSDefinitionREF> it){
        super(it);
    }
