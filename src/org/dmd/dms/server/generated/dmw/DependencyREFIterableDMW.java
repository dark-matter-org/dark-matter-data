...
import org.dmd.dms.shared.generated.types.DependencyREF;         // The base type - (DmwFormatter.java:450)
import org.dmd.dmw.DmwMVIterator;                                // The base multi-value iterator - (DmwFormatter.java:453)


/**
 * The DependencyREFIterableDMW wraps an Iterator for a particular type and makes 
 * it Iterable.
 * <P>
 ...
 */
public class DependencyREFIterableDMW extends DmwMVIterator<DependencyREF> {

    public final static DependencyREFIterableDMW emptyList = new DependencyREFIterableDMW();

    protected DependencyREFIterableDMW(){
        super();
    }

    public DependencyREFIterableDMW(Iterator<DependencyREF> it){
        super(it);
    }
