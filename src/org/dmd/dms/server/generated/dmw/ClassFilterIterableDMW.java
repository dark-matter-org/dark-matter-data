...
import org.dmd.dms.shared.types.ClassFilter;         // This is the type we're iterating - (DmwFormatter.java:456)
...
public class ClassFilterIterableDMW extends DmwMVIterator<ClassFilter> {
    ...
    public final static ClassFilterIterableDMW emptyList = new ClassFilterIterableDMW();
