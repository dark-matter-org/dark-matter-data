...
import org.dmd.dms.shared.generated.types.TypeDefinitionREF;         // The base type - (DmwFormatter.java:450)
import org.dmd.dmw.DmwMVIterator;                                    // The base multi-value iterator - (DmwFormatter.java:453)


/**
 * The TypeDefinitionREFIterableDMW wraps an Iterator for a particular type and makes 
 * it Iterable.
 * <P>
 ...
 */
public class TypeDefinitionREFIterableDMW extends DmwMVIterator<TypeDefinitionREF> {

    public final static TypeDefinitionREFIterableDMW emptyList = new TypeDefinitionREFIterableDMW();

    protected TypeDefinitionREFIterableDMW(){
        super();
    }

    public TypeDefinitionREFIterableDMW(Iterator<TypeDefinitionREF> it){
        super(it);
    }
