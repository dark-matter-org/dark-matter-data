...
import org.dmd.dms.shared.generated.enums.FilterTypeEnum;         // This is the type we're iterating - (DmwFormatter.java:461)
import org.dmd.dmw.DmwMVIterator;                                 // The base multi-value iterator - (DmwFormatter.java:458)


/**
 * The FilterTypeEnumIterableDMW wraps an Iterator for a particular type and makes 
 * it Iterable.
 * <P>
 ...
 */
public class FilterTypeEnumIterableDMW extends DmwMVIterator<FilterTypeEnum> {

    public final static FilterTypeEnumIterableDMW emptyList = new FilterTypeEnumIterableDMW();

    protected FilterTypeEnumIterableDMW(){
        super();
    }

    public FilterTypeEnumIterableDMW(Iterator<FilterTypeEnum> it){
        super(it);
    }
