...
import org.dmd.dms.shared.types.DefinitionName;         // This is the type we're iterating - (DmwFormatter.java:456)
...
public class DefinitionNameIterableDMW extends DmwMVIterator<DefinitionName> {
    ...
    public final static DefinitionNameIterableDMW emptyList = new DefinitionNameIterableDMW();
