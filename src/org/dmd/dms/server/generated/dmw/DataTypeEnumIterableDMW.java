...
import org.dmd.dms.shared.generated.enums.DataTypeEnum;         // This is the type we're iterating - (DmwFormatter.java:456)
import org.dmd.dmw.DmwMVIterator;                               // The base multi-value iterator - (DmwFormatter.java:453)


/**
 * The DataTypeEnumIterableDMW wraps an Iterator for a particular type and makes 
 * it Iterable.
 * <P>
 ...
 */
public class DataTypeEnumIterableDMW extends DmwMVIterator<DataTypeEnum> {

    public final static DataTypeEnumIterableDMW emptyList = new DataTypeEnumIterableDMW();

    protected DataTypeEnumIterableDMW(){
        super();
    }

    public DataTypeEnumIterableDMW(Iterator<DataTypeEnum> it){
        super(it);
    }
