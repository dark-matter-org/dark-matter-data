...
// Called from: org.dmd.dms.tools.generation.meta.MetaDSDHelper.generateParsingCoordinator(MetaDSDHelper.java:987)
import java.io.IOException;                                                  // If we run it to problems finding configs - (MetaDSDHelper.java:951)
import java.util.ArrayList;                                                  // To handle lists of things - (MetaDSDHelper.java:953)
import java.util.Iterator;                                                   // To iterate over collections - (MetaDSDHelper.java:952)
import java.util.TreeMap;                                                    // To handle loaded configs - (MetaDSDHelper.java:954)
import org.dmd.core.feedback.DMFeedback;                                     // To handle exceptions from value handling - (MetaDSDHelper.java:958)
import org.dmd.core.feedback.DMFeedbackSet;                                  // To handle exceptions from value handling - (MetaDSDHelper.java:959)
import org.dmd.core.feedback.DmcNameClashException;                          // To handle exceptions from parsing objects - (MetaDSDHelper.java:960)
import org.dmd.dms.server.extended.DSDefinition;                             // The common base for all modules - so that we can get error location info - (MetaDSDHelper.java:957)
import org.dmd.dms.server.extended.DmsModule;                                // One of the DDS modules we might load - (MetaDSDHelper.java:977)
import org.dmd.dms.server.generated.dsd.DmsModuleDefinitionManager;          // Maintains all parsed definitions - (MetaDSDHelper.java:968)
import org.dmd.dms.server.generated.dsd.DmsModuleGeneratorInterface;         // The generator we call - (MetaDSDHelper.java:971)
import org.dmd.dms.server.generated.dsd.DmsModuleParser;                     // Required to parse DmsModule definitions - (MetaDSDHelper.java:981)
import org.dmd.dms.shared.generated.types.DmsModuleREF;                      // To access references to DmsModule - (MetaDSDHelper.java:979)
import org.dmd.dms.shared.types.DefinitionName;                              // Allows storage of parsed configs by name - (MetaDSDHelper.java:956)
import org.dmd.dmv.shared.DmvRuleManager;                                    // Allows for application of rules to our definitions - (MetaDSDHelper.java:965)
import org.dmd.util.parsing.ConfigFinder;                                    // Finds configs we may need to parse - (MetaDSDHelper.java:962)
import org.dmd.util.parsing.ConfigLocation;                                  // Handle to a discovered configuration - (MetaDSDHelper.java:963)


// Generated from: org.dmd.dms.tools.generation.meta.MetaDSDHelper.generateParsingCoordinator(MetaDSDHelper.java:991)
/**
...
public class DmsModuleParsingCoordinator {
    ...
    // Called from: org.dmd.dms.tools.generation.meta.MetaDSDHelper.generateParsingCoordinator(MetaDSDHelper.java:998)
...
// Generated from: org.dmd.dms.tools.generation.meta.MetaDSDHelper.generateParsingCoordinator(MetaDSDHelper.java:1000)
    ...
    // Generated from: org.dmd.dms.tools.generation.meta.MetaDSDHelper.generateParsingCoordinator(MetaDSDHelper.java:1053)
    ...
    // Generated from: org.dmd.dms.tools.generation.meta.MetaDSDHelper.generateParsingCoordinator(MetaDSDHelper.java:1079)
    ...
    // Generated from: org.dmd.dms.tools.generation.meta.MetaDSDHelper.generateParsingCoordinator(MetaDSDHelper.java:1111)
    ...
    // Generated from: org.dmd.dms.tools.generation.meta.MetaDSDHelper.generateParsingCoordinator(MetaDSDHelper.java:1128)
    ...
    // Generated from: org.dmd.dms.tools.generation.meta.MetaDSDHelper.generateParsingCoordinator(MetaDSDHelper.java:1139)
    ...
    // Generated from: org.dmd.dms.tools.generation.meta.MetaDSDHelper.generateParsingCoordinator(MetaDSDHelper.java:1169)
    ...
    // Generated from: org.dmd.dms.tools.generation.meta.MetaDSDHelper.generateParsingCoordinator(MetaDSDHelper.java:1183)
