...
import org.dmd.mvw.tools.mvwgenerator.generated.dmo.FieldEditorDefinitionDMO; // primitive type
...
public class FieldEditorDefinitionREF extends DmcNamedObjectNontransportableREF<FieldEditorDefinitionDMO> {
    ...
    public FieldEditorDefinitionREF(){
    }

    public FieldEditorDefinitionREF(FieldEditorDefinitionDMO o){
         object = o;
         myName = (DmcTypeCamelCaseNameSV)o.getObjectNameAttribute();
    }

    public FieldEditorDefinitionREF(CamelCaseName n) throws DmcValueException {
         object = null;
         myName = new DmcTypeCamelCaseNameSV(__editorName);
         myName.set(n);
    }

    public FieldEditorDefinitionREF(String n) throws DmcValueException {
         object = null;
         myName = new DmcTypeCamelCaseNameSV(__editorName);
         myName.set(n);
    }

    public FieldEditorDefinitionREF(FieldEditorDefinitionREF original){
        myName = original.myName;
        object = original.object;
    }

    public void setObject(FieldEditorDefinitionDMO o){
         object = o;
         if (object != null)
             myName = (DmcTypeCamelCaseNameSV)o.getObjectNameAttribute();
    }
     ...
     */
    public FieldEditorDefinitionREF cloneMe(){
