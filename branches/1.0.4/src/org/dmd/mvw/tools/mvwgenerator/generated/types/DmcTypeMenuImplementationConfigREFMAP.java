...
public class DmcTypeMenuImplementationConfigREFMAP extends DmcTypeMenuImplementationConfigREF implements Serializable {
    ...
    private final static Iterator<MenuImplementationConfigREF> emptyList = (new HashMap<CamelCaseName,MenuImplementationConfigREF>()).values().iterator();
    ...
    public CamelCaseName firstKey(){
        if (attrInfo.valueType == ValueTypeEnum.TREEMAPPED){
            if (value == null)
                return(null);
            TreeMap<CamelCaseName,MenuImplementationConfigREF> map = (TreeMap<CamelCaseName,MenuImplementationConfigREF>)value;
            return(map.firstKey());
        }
    ...
    public Map<CamelCaseName,MenuImplementationConfigREF> getMVCopy(){
        synchronized(this){
            ...
            if (attrInfo.valueType == ValueTypeEnum.HASHMAPPED){
                if (value == null)
                    clone = new HashMap<CamelCaseName,MenuImplementationConfigREF>();
                else
                    clone = new HashMap<CamelCaseName,MenuImplementationConfigREF>(value);
            }
            else{
                if (value == null)
                    clone = new TreeMap<CamelCaseName,MenuImplementationConfigREF>();
                else
                    clone = new TreeMap<CamelCaseName,MenuImplementationConfigREF>(value);
            }
            return(clone);
