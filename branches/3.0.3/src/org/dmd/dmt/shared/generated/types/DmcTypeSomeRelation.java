...
// Called from: org.dmd.dms.util.GenUtility.dumpExtendedReferenceTypeDmcType(GenUtility.java:3241)
import org.dmd.dmc.DmcAttributeInfo;                            // Standard attribute interface - (GenUtility.java:3229)
import org.dmd.dmc.DmcInputStreamIF;                            // Serialization support - (GenUtility.java:3226)
import org.dmd.dmc.DmcOutputStreamIF;                           // Serialization support - (GenUtility.java:3227)
import org.dmd.dmc.DmcValueException;                           // Value exceptions - (GenUtility.java:3230)
import org.dmd.dmc.types.DefinitionName;                        // Name type - (GenUtility.java:3235)
import org.dmd.dmc.types.DmcTypeNamedObjectREF;                 // The class we extend - (GenUtility.java:3231)
import org.dmd.dmt.shared.generated.dmo.ObjWithRefsDMO;         // The class we refer to - (GenUtility.java:3233)
 ...
 * Generated from: org.dmd.dms.util.GenUtility.dumpExtendedReferenceTypeDmcType(GenUtility.java:3264)
