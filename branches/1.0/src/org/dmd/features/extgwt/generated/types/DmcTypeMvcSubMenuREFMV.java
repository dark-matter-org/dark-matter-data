...
public class DmcTypeMvcSubMenuREFMV extends DmcTypeMvcSubMenuREF implements Serializable {
    ...
    protected ArrayList<MvcSubMenuREF> value;
    ...
    public Iterator<MvcSubMenuREF> getMV(){
        synchronized(this){
            ArrayList<MvcSubMenuREF> clone = new ArrayList<MvcSubMenuREF>(value);
            return(clone.iterator());
        }
    }
    
    // org.dmd.dms.util.GenUtility.dumpMVType(GenUtility.java:2265)
    public ArrayList<MvcSubMenuREF> getMVCopy(){
        synchronized(this){
            ArrayList<MvcSubMenuREF> clone = new ArrayList<MvcSubMenuREF>(value);
            return(clone);
        }
    ...
    public MvcSubMenuREF getMVnth(int index){
        synchronized(this){
            if (value == null)
                return(null);
    ...
    public MvcSubMenuREF setMVnth(int index, Object v) throws DmcValueException {
        synchronized(this){
            if (attrInfo.indexSize == 0)
            ...
            if (value == null){
                value = new ArrayList<MvcSubMenuREF>(attrInfo.indexSize);
