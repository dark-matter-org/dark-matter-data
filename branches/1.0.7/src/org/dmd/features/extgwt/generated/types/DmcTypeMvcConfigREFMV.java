...
public class DmcTypeMvcConfigREFMV extends DmcTypeMvcConfigREF implements Serializable {
    ...
    protected ArrayList<MvcConfigREF> value;
    ...
    public MvcConfigREF getMVnth(int index){
        synchronized(this){
            if (value == null)
                return(null);
    ...
    public MvcConfigREF setMVnth(int index, Object v) throws DmcValueException {
        synchronized(this){
            if (attrInfo.indexSize == 0)
            ...
            if (value == null){
                value = new ArrayList<MvcConfigREF>(attrInfo.indexSize);
