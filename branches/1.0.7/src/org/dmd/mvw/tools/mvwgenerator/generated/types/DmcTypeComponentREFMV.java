...
/**
 * The DmcTypeComponentREFMV provides storage for a multi-valued ComponentREF
 * <P>
...
public class DmcTypeComponentREFMV extends DmcTypeComponentREF implements Serializable {
    ...
    private final static Iterator<ComponentREF> emptyList = (new ArrayList<ComponentREF>()).iterator();
    
    protected ArrayList<ComponentREF> value;
    
    public DmcTypeComponentREFMV(){
    
    }
    
    public DmcTypeComponentREFMV(DmcAttributeInfo ai){
        super(ai);
    }
    
    @Override
    public DmcTypeComponentREFMV getNew(){
        return(new DmcTypeComponentREFMV(attrInfo));
    }
    ...
    public DmcAttribute<ComponentREF> cloneIt(){
        synchronized(this){
            DmcTypeComponentREFMV rc = getNew();
    ...
    public ComponentREF add(Object v) throws DmcValueException {
        synchronized(this){
            ...
            if (value == null)
                value = new ArrayList<ComponentREF>();
            value.add(rc);
            return(rc);
        }
    }
    ...
    public Iterator<ComponentREF> getMV(){
        synchronized(this){
            ...
            ArrayList<ComponentREF> clone = new ArrayList<ComponentREF>(value);
    ...
    public ComponentREF setMVnth(int index, Object v) throws DmcValueException {
        synchronized(this){
            ...
            if (value == null){
                value = new ArrayList<ComponentREF>(attrInfo.indexSize);
                for(int i=0;i<attrInfo.indexSize;i++)
                    value.add(null);
            }
