...
import org.dmd.dmt.shared.generated.types.DmcTypeNameContainerTestREFSET;

@SuppressWarnings("serial")
// org.dmd.dms.util.AdapterFormatter.dumpAdapter(AdapterFormatter.java:59)
// Called from: org.dmd.dms.util.AdapterFormatter.dumpAdapterSET(AdapterFormatter.java:20)
public class NameContainerTestSETAdapter extends DmcTypeNameContainerTestREFSET implements DmcAdapterIF {
    ...
    public void setExisting(DmcAttribute<?> attr) {
    	existingValue = (DmcTypeNameContainerTestREFSET) attr;
    	if (existingValue != null)
    		value = existingValue.getMVCopy();
    }
