...
import org.dmd.mvw.tools.mvwgenerator.generated.dmo.MenuDMO; // primitive type
...
public class MenuREF extends DmcNamedObjectNontransportableREF<MenuDMO> {
    ...
    public MenuREF(MenuDMO o){
         object = o;
         myName = (DmcTypeCamelCaseNameSV)o.getObjectNameAttribute();
    }

    public MenuREF(CamelCaseName n) throws DmcValueException {
         object = null;
         myName = new DmcTypeCamelCaseNameSV(__elementName);
         myName.set(n);
    }

    public MenuREF(String n) throws DmcValueException {
         object = null;
         myName = new DmcTypeCamelCaseNameSV(__elementName);
         myName.set(n);
    }

    public MenuREF(MenuREF original){
        myName = original.myName;
        object = original.object;
    }

    public void setObject(MenuDMO o){
         object = o;
         if (object != null)
             myName = (DmcTypeCamelCaseNameSV)o.getObjectNameAttribute();
    }
