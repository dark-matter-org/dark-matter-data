...
import org.dmd.dms.generated.rulesdmo.UCOValidationIF;                           // The interface for the UCOValidation category - (RuleFormatter.java:513)
import org.dmd.dmv.shared.generated.dmo.UCOAllowedAttributesRuleDataDMO;         // Rule parameters object - (RuleFormatter.java:507)


// Generated from: org.dmd.dms.util.RuleFormatter.dumpBaseImplementations(RuleFormatter.java:524)
abstract public class UCOAllowedAttributesRuleBaseImpl implements RuleIF, DynamicInitIF,UCOValidationIF {
    ...
    public void setRuleData(DmcObject obj){
        if (obj instanceof UCOAllowedAttributesRuleDataDMO)
            ruleDMO = (UCOAllowedAttributesRuleDataDMO)obj;
        else
            throw(new IllegalStateException("Object of class " + obj.getClass().getName() + " passed when object of class UCOAllowedAttributesRuleDataDMO required"));
    }
