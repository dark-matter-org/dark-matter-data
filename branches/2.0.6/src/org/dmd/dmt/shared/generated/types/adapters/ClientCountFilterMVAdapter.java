...
public class ClientCountFilterMVAdapter extends DmcTypeClientCountFilterREFMV implements DmcAdapterIF {

    transient DmcTypeClientCountFilterREFMV existingValue;

    public ClientCountFilterMVAdapter(DmcAttributeInfo ai){
    	   super(ai);
    }
    ...
    public void setExisting(DmcAttribute<?> attr) {
    	existingValue = (DmcTypeClientCountFilterREFMV) attr;
    	if (existingValue != null)
    		value = existingValue.getMVCopy();
    }
