...
/**
 * The DmcTypeByteSTATIC provides static access to functions used to manage values of type Byte
 ...
 */
public class DmcTypeByteSTATIC {
    
    public static DmcTypeByteSTATIC instance;
    static DmcTypeByteSV typeHelper;
    
    static {
        instance = new DmcTypeByteSTATIC();
    }
    
    protected DmcTypeByteSTATIC() {
        typeHelper = new DmcTypeByteSV();
    }
    ...
    public Byte cloneValue(Byte value) throws DmcValueException {
