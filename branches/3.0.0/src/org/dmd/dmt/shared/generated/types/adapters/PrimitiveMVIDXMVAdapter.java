...
import org.dmd.dmt.shared.generated.types.DmcTypePrimitiveMVIDXREFMV;

@SuppressWarnings("serial")
// org.dmd.dms.util.AdapterFormatter.dumpAdapter(AdapterFormatter.java:59)
// Called from: org.dmd.dms.util.AdapterFormatter.dumpAdapterMV(AdapterFormatter.java:16)
public class PrimitiveMVIDXMVAdapter extends DmcTypePrimitiveMVIDXREFMV implements DmcAdapterIF {
    ...
    public void setExisting(DmcAttribute<?> attr) {
    	existingValue = (DmcTypePrimitiveMVIDXREFMV) attr;
    	if (existingValue != null)
    		value = existingValue.getMVCopy();
    }
