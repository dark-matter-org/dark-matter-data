...
public class DmcTypeWrapperGeneratorREFSV extends DmcTypeWrapperGeneratorREF implements Serializable {
    
    protected WrapperGeneratorREF value;
    
    public DmcTypeWrapperGeneratorREFSV(){
    
    }
    
    public DmcTypeWrapperGeneratorREFSV(DmcAttributeInfo ai){
        super(ai);
    }
    ...
    public DmcTypeWrapperGeneratorREFSV getNew(DmcAttributeInfo ai){
        return(new DmcTypeWrapperGeneratorREFSV(ai));
    }
    ...
    @Override
    public WrapperGeneratorREF getSV(){
        return(value);
    }
