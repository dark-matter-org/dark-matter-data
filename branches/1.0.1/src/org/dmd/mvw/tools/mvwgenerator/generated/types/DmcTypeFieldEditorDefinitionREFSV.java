...
public class DmcTypeFieldEditorDefinitionREFSV extends DmcTypeFieldEditorDefinitionREF implements Serializable {
    
    protected FieldEditorDefinitionREF value;
    
    public DmcTypeFieldEditorDefinitionREFSV(){
    
    }
    
    public DmcTypeFieldEditorDefinitionREFSV(DmcAttributeInfo ai){
        super(ai);
    }
    
    public DmcTypeFieldEditorDefinitionREFSV getNew(){
        return(new DmcTypeFieldEditorDefinitionREFSV(attrInfo));
    }
    
    public DmcTypeFieldEditorDefinitionREFSV getNew(DmcAttributeInfo ai){
        return(new DmcTypeFieldEditorDefinitionREFSV(ai));
    }
    ...
    @Override
    public FieldEditorDefinitionREF getSV(){
        return(value);
    }
