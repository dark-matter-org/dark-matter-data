...
import org.dmd.mvw.tools.mvwgenerator.generated.dmo.SubMenuDMO; // primitive type
...
public class SubMenuREF extends DmcNamedObjectNontransportableREF<SubMenuDMO> {
    ...
    public SubMenuREF(SubMenuDMO o){
         object = o;
         myName = (DmcTypeCamelCaseNameSV)o.getObjectNameAttribute();
    }

    public SubMenuREF(CamelCaseName n) throws DmcValueException {
         object = null;
         myName = new DmcTypeCamelCaseNameSV(__elementName);
         myName.set(n);
    }

    public SubMenuREF(String n) throws DmcValueException {
         object = null;
         myName = new DmcTypeCamelCaseNameSV(__elementName);
         myName.set(n);
    }

    public SubMenuREF(SubMenuREF original){
        myName = original.myName;
        object = original.object;
    }

    public void setObject(SubMenuDMO o){
         object = o;
         if (object != null)
             myName = (DmcTypeCamelCaseNameSV)o.getObjectNameAttribute();
    }
