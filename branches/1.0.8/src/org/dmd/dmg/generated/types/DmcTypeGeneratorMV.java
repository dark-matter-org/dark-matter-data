...
public class DmcTypeGeneratorMV extends DmcTypeGenerator implements Serializable {
    ...
    private final static Iterator<Generator> emptyList = (new ArrayList<Generator>()).iterator();
    
    protected ArrayList<Generator> value;
    ...
    public ArrayList<Generator> getMVCopy(){
        synchronized(this){
            if (value == null)
                ...
                ArrayList<Generator> rc = new  ArrayList<Generator>(value.size());
                if (attrInfo.indexSize == 0){
                    for(Generator val: value)
                        rc.add(val);
                }
    ...
    public Generator getMVnth(int index){
        synchronized(this){
            if (value == null)
                return(null);
