...
public class DmcTypeWrapperGeneratorREFMV extends DmcTypeWrapperGeneratorREF implements Serializable {
    ...
    public DmcTypeWrapperGeneratorREFMV(){
    
    }
    
    public DmcTypeWrapperGeneratorREFMV(DmcAttributeInfo ai){
        super(ai);
    }
    
    @Override
    public DmcTypeWrapperGeneratorREFMV getNew(){
        return(new DmcTypeWrapperGeneratorREFMV(attrInfo));
    }
    ...
    public WrapperGeneratorREF add(Object v) throws DmcValueException {
        synchronized(this){
            ...
            if (value == null)
                value = new ArrayList<WrapperGeneratorREF>();
            value.add(rc);
            return(rc);
        }
    }
    ...
    public ArrayList<WrapperGeneratorREF> getMVCopy(){
        synchronized(this){
            if (value == null)
                ...
                ArrayList<WrapperGeneratorREF> rc = new  ArrayList<WrapperGeneratorREF>(value.size());
                if (attrInfo.indexSize == 0){
                    for(WrapperGeneratorREF val: value)
                        rc.add(val);
                }
    ...
    public WrapperGeneratorREF setMVnth(int index, Object v) throws DmcValueException {
        synchronized(this){
            ...
            if (value == null){
                value = new ArrayList<WrapperGeneratorREF>(attrInfo.indexSize);
                for(int i=0;i<attrInfo.indexSize;i++)
                    value.add(null);
            }
