	...
	public LongName typeCheck(Object value) throws DMFeedbackSet {
		...
		if (value instanceof LongName){
        	...
        	try{
        		...
        		throw(new DMFeedbackSet("Invalid LongName value: " + value.toString()));
        	}
		}
        else{
            throw(new DMFeedbackSet("Object of class: " + value.getClass().getName() + " passed where object compatible with LongName expected."));
        }
