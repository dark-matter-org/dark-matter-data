	...
	public IntegerName typeCheck(Object value) throws DMFeedbackSet {
		...
		if (value instanceof IntegerName){
        	...
        	try{
        		...
        		throw(new DMFeedbackSet("Invalid IntegerName value: " + value.toString()));
        	}
		}
        else{
            throw(new DMFeedbackSet("Object of class: " + value.getClass().getName() + " passed where object compatible with IntegerName expected."));
        }
