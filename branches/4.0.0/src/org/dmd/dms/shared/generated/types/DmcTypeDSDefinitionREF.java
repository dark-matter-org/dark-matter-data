...
import org.dmd.dms.shared.generated.dmo.DSDefinitionDMO;         // The type of object we refer to - (TypeFormatter.java:53)
...
abstract public class DmcTypeDSDefinitionREF extends DmcTypeNamedObjectREF<DSDefinitionREF, DefinitionName> implements Serializable {
    ...
    public DSDefinitionREF typeCheck(Object value) throws DMFeedbackSet {
        ...
        if (value instanceof DSDefinitionREF)
            ...
            throw(new DMFeedbackSet("Object of class:" + value.getClass().getName() + " passed where a DSDefinitionREF/DMO or DmcObjectName expected."));
        return(rc);
    }
