...
public class RuleDefinitionDMO extends org.dmd.dms.shared.generated.dmo.DmsDefinitionDMO implements Serializable  {
    ...
    static {
        ...
        _ImAp.put(MetaCompactSchema.__ruleCategory.id,MetaCompactSchema.__ruleCategory);
        ...
        _ImAp.put(MetaCompactSchema.__dependency.id,MetaCompactSchema.__dependency);
        ...
        _ImAp.put(MetaCompactSchema.__isExtensible.id,MetaCompactSchema.__isExtensible);
        ...
        _SmAp.put(MetaCompactSchema.__ruleCategory.name,MetaCompactSchema.__ruleCategory);
        ...
        _SmAp.put(MetaCompactSchema.__dependency.name,MetaCompactSchema.__dependency);
        ...
        _SmAp.put(MetaCompactSchema.__isExtensible.name,MetaCompactSchema.__isExtensible);
    ...
    public Iterator<RuleCategoryREF> getRuleCategory(){
        DmcTypeRuleCategoryREFMV attr = (DmcTypeRuleCategoryREFMV) get(MetaCompactSchema.__ruleCategory);
        if (attr == null)
            return(null);
    ...
    public DmcAttribute<?> addRuleCategory(Object value) throws DMFeedbackSet {
        DmcAttribute<?> attr = get(MetaCompactSchema.__ruleCategory);
        if (attr == null)
            attr = new DmcTypeRuleCategoryREFMV(MetaCompactSchema.__ruleCategory);
        
        attr.add(value);
        add(MetaCompactSchema.__ruleCategory,attr);
        return(attr);
    }
    ...
    public DependencyREF getDependency(){
        DmcTypeDependencyREFSV attr = (DmcTypeDependencyREFSV) get(MetaCompactSchema.__dependency);
        if (attr == null)
            return(null);
     ...
     */
    // org.dmd.dms.tools.generation.meta.AccessFunctionFormatter.dumpSVAccessFunction(AccessFunctionFormatter.java:164)
    public void setDependency(Object value) throws DMFeedbackSet {
        DmcAttribute<?> attr = get(MetaCompactSchema.__dependency);
        if (attr == null)
            attr = new DmcTypeDependencyREFSV(MetaCompactSchema.__dependency);
        
        attr.set(value);
        set(MetaCompactSchema.__dependency,attr);
    }
    ...
    public Boolean getIsExtensible(){
        DmcTypeBooleanSV attr = (DmcTypeBooleanSV) get(MetaCompactSchema.__isExtensible);
        if (attr == null)
            return(false);
    ...
    public void setIsExtensible(Object value) throws DMFeedbackSet {
        DmcAttribute<?> attr = get(MetaCompactSchema.__isExtensible);
        if (attr == null)
            attr = new DmcTypeBooleanSV(MetaCompactSchema.__isExtensible);
        
        attr.set(value);
        set(MetaCompactSchema.__isExtensible,attr);
    }
