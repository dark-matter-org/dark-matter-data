...
import org.dmd.dms.shared.types.DmcTypeNameContainer;         // DmcType import - (MVTypeFormatter.java:64)
import org.dmd.dms.shared.types.NameContainer;                // Base type import - (MVTypeFormatter.java:59)
...
public class DmcTypeNameContainerMV extends DmcTypeNameContainer implements Serializable {
    ...
    public DmcTypeNameContainerMV(){
    
    }
    
    public DmcTypeNameContainerMV(DmcAttributeInfo ai){
        super(ai);
    }
    ...
    public NameContainer add(Object v) throws DMFeedbackSet {
        synchronized(this){
            NameContainer rc = typeCheck(v);
            if (value == null)
                value = new ArrayList<NameContainer>();
            value.add(rc);
            return(rc);
        }
    }
    ...
    public NameContainer setMVnth(int index, Object v) throws DMFeedbackSet {
        synchronized(this){
            if (getAttributeInfo().indexSize == 0)
