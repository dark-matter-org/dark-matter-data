...
import org.dmd.dms.shared.generated.types.DmcTypeNameValuePairSV;         //  - (AdapterFormatter.java:60)
...
public class NameValuePairSVAdapter extends DmcTypeNameValuePairSV implements DmcAdapterIF {

    transient DmcTypeNameValuePairSV existingValue;

    public NameValuePairSVAdapter(DmcAttributeInfo ai){
    	   super(ai);
    }
    ...
    public void setExisting(DmcAttribute<?> attr) {
    	existingValue = (DmcTypeNameValuePairSV) attr;
    	if (existingValue != null)
    		value = existingValue.getSVCopy();
    }
