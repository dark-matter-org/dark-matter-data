...
import org.dmd.dms.shared.generated.types.DmcTypeRuleDefinitionREFSET;         //  - (AdapterFormatter.java:60)
...
public class RuleDefinitionREFSETAdapter extends DmcTypeRuleDefinitionREFSET implements DmcAdapterIF {
    ...
    public void setExisting(DmcAttribute<?> attr) {
    	existingValue = (DmcTypeRuleDefinitionREFSET) attr;
    	if (existingValue != null)
    		value = existingValue.getMVCopy();
    }
