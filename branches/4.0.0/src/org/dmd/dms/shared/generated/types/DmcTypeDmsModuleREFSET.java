...
/**
 * The DmcTypeDmsModuleREFSET provides storage for a set of DmsModuleREF
 * <P>
 * This code was auto-generated and shouldn't be altered manually!
 * Generated from: org.dmd.dms.tools.util.SETTypeFormatter.dumpSETType(SETTypeFormatter.java:67)
 *    Called from: org.dmd.dms.tools.meta.DerivedTypeFormatter.dumpDerivedTypes(DerivedTypeFormatter.java:69)
 */
@SuppressWarnings("serial")
public class DmcTypeDmsModuleREFSET extends DmcTypeDmsModuleREF implements Serializable {
    
     private final static Iterator<DmsModuleREF> emptyList =  (new HashSet<DmsModuleREF>()).iterator();
    
    
    protected Set<DmsModuleREF> value;
    
    public DmcTypeDmsModuleREFSET(){
        value = null;
    }
    
    public DmcTypeDmsModuleREFSET(DmcAttributeInfo ai){
        super(ai);
        initValue();
    }
    ...
    void initValue(){
        if (getAttributeInfo().valueType == ValueTypeEnum.HASHSET)
            value = new HashSet<DmsModuleREF>();
        else
            value = new TreeSet<DmsModuleREF>();
    }
    
    @Override
    public DmcTypeDmsModuleREFSET getNew(){
        return(new DmcTypeDmsModuleREFSET(getAttributeInfo()));
    }
    ...
    public DmcAttribute<DmsModuleREF> cloneIt(){
        synchronized(this){
            DmcTypeDmsModuleREFSET rc = getNew();
    ...
    public Iterator<DmsModuleREF> getMV(){
        synchronized(this){
            ...
            if (getAttributeInfo().valueType == ValueTypeEnum.HASHSET)
                return( (new HashSet<DmsModuleREF>(value)).iterator() );
            else
                return( (new TreeSet<DmsModuleREF>(value)).iterator() );
        }
    }
    
    // org.dmd.dms.tools.util.SETTypeFormatter.dumpSETType(SETTypeFormatter.java:187)
    public Set<DmsModuleREF> getMVCopy(){
        synchronized(this){
            if (getAttributeInfo().valueType == ValueTypeEnum.HASHSET){
                if (value == null)
                    return(new HashSet<DmsModuleREF>());
                else
                    return(new HashSet<DmsModuleREF>(value));
            }
            else{
                if (value == null)
                    return(new TreeSet<DmsModuleREF>(value));
                else
                    return(new TreeSet<DmsModuleREF>(value));
            }
        }
