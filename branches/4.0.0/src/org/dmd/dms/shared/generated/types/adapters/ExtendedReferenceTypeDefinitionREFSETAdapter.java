...
import org.dmd.dms.shared.generated.types.DmcTypeExtendedReferenceTypeDefinitionREFSET;         //  - (AdapterFormatter.java:60)
...
public class ExtendedReferenceTypeDefinitionREFSETAdapter extends DmcTypeExtendedReferenceTypeDefinitionREFSET implements DmcAdapterIF {
    ...
    public void setExisting(DmcAttribute<?> attr) {
    	existingValue = (DmcTypeExtendedReferenceTypeDefinitionREFSET) attr;
    	if (existingValue != null)
    		value = existingValue.getMVCopy();
    }
