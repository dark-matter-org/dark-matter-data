...
import org.dmd.dms.shared.generated.types.DmcTypeExampleSV;          //  - (AdapterFormatter.java:60)
...
public class ExampleSVAdapter extends DmcTypeExampleSV implements DmcAdapterIF {

    transient DmcTypeExampleSV existingValue;

    public ExampleSVAdapter(DmcAttributeInfo ai){
    	   super(ai);
    }
    ...
    public void setExisting(DmcAttribute<?> attr) {
    	existingValue = (DmcTypeExampleSV) attr;
    	if (existingValue != null)
    		value = existingValue.getSVCopy();
    }
