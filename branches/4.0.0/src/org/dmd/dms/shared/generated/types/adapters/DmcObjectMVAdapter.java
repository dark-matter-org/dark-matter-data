...
import org.dmd.dms.shared.generated.types.DmcTypeDmcObjectMV;         //  - (AdapterFormatter.java:60)
...
public class DmcObjectMVAdapter extends DmcTypeDmcObjectMV implements DmcAdapterIF {
    ...
    public void setExisting(DmcAttribute<?> attr) {
    	existingValue = (DmcTypeDmcObjectMV) attr;
    	if (existingValue != null)
    		value = existingValue.getMVCopy();
    }
