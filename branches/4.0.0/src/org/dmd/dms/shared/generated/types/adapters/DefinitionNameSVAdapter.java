...
import org.dmd.dms.shared.generated.types.DmcTypeDefinitionNameSV;         //  - (AdapterFormatter.java:60)
...
public class DefinitionNameSVAdapter extends DmcTypeDefinitionNameSV implements DmcAdapterIF {

    transient DmcTypeDefinitionNameSV existingValue;

    public DefinitionNameSVAdapter(DmcAttributeInfo ai){
    	   super(ai);
    }
    ...
    public void setExisting(DmcAttribute<?> attr) {
    	existingValue = (DmcTypeDefinitionNameSV) attr;
    	if (existingValue != null)
    		value = existingValue.getSVCopy();
    }
