...
import org.dmd.dms.shared.generated.types.DmcTypeDSDefinitionModuleREFMV;         //  - (AdapterFormatter.java:60)
...
public class DSDefinitionModuleREFMVAdapter extends DmcTypeDSDefinitionModuleREFMV implements DmcAdapterIF {

    transient DmcTypeDSDefinitionModuleREFMV existingValue;

    public DSDefinitionModuleREFMVAdapter(DmcAttributeInfo ai){
    	   super(ai);
    }
    ...
    public void setExisting(DmcAttribute<?> attr) {
    	existingValue = (DmcTypeDSDefinitionModuleREFMV) attr;
    	if (existingValue != null)
    		value = existingValue.getMVCopy();
    }
