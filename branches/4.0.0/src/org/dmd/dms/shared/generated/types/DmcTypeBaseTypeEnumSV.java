...
import org.dmd.dms.shared.generated.enums.BaseTypeEnum;         // DmcType import - (SVTypeFormatter.java:65)
...
public class DmcTypeBaseTypeEnumSV extends DmcTypeBaseTypeEnum implements Serializable {
    ...
    protected BaseTypeEnum value;
    
    public DmcTypeBaseTypeEnumSV(){
    
    }
    
    public DmcTypeBaseTypeEnumSV(DmcAttributeInfo ai){
        super(ai);
    }
    ...
    public DmcTypeBaseTypeEnumSV getNew(DmcAttributeInfo ai){
        return(new DmcTypeBaseTypeEnumSV(ai));
    }
    ...
    public BaseTypeEnum set(Object v) throws DMFeedbackSet {
