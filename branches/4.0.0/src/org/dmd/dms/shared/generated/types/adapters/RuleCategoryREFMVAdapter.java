...
import org.dmd.dms.shared.generated.types.DmcTypeRuleCategoryREFMV;         //  - (AdapterFormatter.java:60)
...
public class RuleCategoryREFMVAdapter extends DmcTypeRuleCategoryREFMV implements DmcAdapterIF {

    transient DmcTypeRuleCategoryREFMV existingValue;

    public RuleCategoryREFMVAdapter(DmcAttributeInfo ai){
    	   super(ai);
    }
    ...
    public void setExisting(DmcAttribute<?> attr) {
    	existingValue = (DmcTypeRuleCategoryREFMV) attr;
    	if (existingValue != null)
    		value = existingValue.getMVCopy();
    }
