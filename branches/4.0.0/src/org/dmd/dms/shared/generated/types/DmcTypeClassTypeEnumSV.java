...
import org.dmd.dms.shared.generated.enums.ClassTypeEnum;         // DmcType import - (SVTypeFormatter.java:65)
...
public class DmcTypeClassTypeEnumSV extends DmcTypeClassTypeEnum implements Serializable {
    ...
    public DmcTypeClassTypeEnumSV getNew(DmcAttributeInfo ai){
        return(new DmcTypeClassTypeEnumSV(ai));
    }
    ...
    public ClassTypeEnum set(Object v) throws DMFeedbackSet {
