...
import org.dmd.dms.shared.generated.types.DmcTypeRunContextREFSET;         //  - (AdapterFormatter.java:60)
...
public class RunContextREFSETAdapter extends DmcTypeRunContextREFSET implements DmcAdapterIF {
    ...
    public void setExisting(DmcAttribute<?> attr) {
    	existingValue = (DmcTypeRunContextREFSET) attr;
    	if (existingValue != null)
    		value = existingValue.getMVCopy();
    }
