...
import org.dmd.dms.shared.generated.types.DmcTypeConcinnityREFSET;         //  - (AdapterFormatter.java:60)
...
public class ConcinnityREFSETAdapter extends DmcTypeConcinnityREFSET implements DmcAdapterIF {

    transient DmcTypeConcinnityREFSET existingValue;

    public ConcinnityREFSETAdapter(DmcAttributeInfo ai){
    	   super(ai);
    }
    ...
    public void setExisting(DmcAttribute<?> attr) {
    	existingValue = (DmcTypeConcinnityREFSET) attr;
    	if (existingValue != null)
    		value = existingValue.getMVCopy();
    }
