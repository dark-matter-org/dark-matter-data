...
import org.dmd.dms.shared.generated.types.DmcTypeRuleDataREFMV;         //  - (AdapterFormatter.java:60)
...
public class RuleDataREFMVAdapter extends DmcTypeRuleDataREFMV implements DmcAdapterIF {

    transient DmcTypeRuleDataREFMV existingValue;

    public RuleDataREFMVAdapter(DmcAttributeInfo ai){
    	   super(ai);
    }
    ...
    public void setExisting(DmcAttribute<?> attr) {
    	existingValue = (DmcTypeRuleDataREFMV) attr;
    	if (existingValue != null)
    		value = existingValue.getMVCopy();
    }
