...
import org.dmd.dms.shared.generated.types.DmcTypeDefinitionNameMV;         //  - (AdapterFormatter.java:60)
...
public class DefinitionNameMVAdapter extends DmcTypeDefinitionNameMV implements DmcAdapterIF {

    transient DmcTypeDefinitionNameMV existingValue;

    public DefinitionNameMVAdapter(DmcAttributeInfo ai){
    	   super(ai);
    }
    ...
    public void setExisting(DmcAttribute<?> attr) {
    	existingValue = (DmcTypeDefinitionNameMV) attr;
    	if (existingValue != null)
    		value = existingValue.getMVCopy();
    }
