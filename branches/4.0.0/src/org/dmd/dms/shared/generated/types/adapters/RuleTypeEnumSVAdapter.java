...
import org.dmd.dms.shared.generated.types.DmcTypeRuleTypeEnumSV;         //  - (AdapterFormatter.java:60)
...
public class RuleTypeEnumSVAdapter extends DmcTypeRuleTypeEnumSV implements DmcAdapterIF {

    transient DmcTypeRuleTypeEnumSV existingValue;

    public RuleTypeEnumSVAdapter(DmcAttributeInfo ai){
    	   super(ai);
    }
    ...
    public void setExisting(DmcAttribute<?> attr) {
    	existingValue = (DmcTypeRuleTypeEnumSV) attr;
    	if (existingValue != null)
    		value = existingValue.getSVCopy();
    }
