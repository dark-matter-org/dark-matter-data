...
import org.dmd.dms.shared.generated.enums.DataTypeEnum;         // DmcType import - (SVTypeFormatter.java:65)
 ...
 *    Called from: org.dmd.dms.tools.meta.DerivedTypeFormatter.dumpDerivedTypes(DerivedTypeFormatter.java:55)
 */
@SuppressWarnings("serial")
public class DmcTypeDataTypeEnumSV extends DmcTypeDataTypeEnum implements Serializable {
    
    protected DataTypeEnum value;
    ...
    public DmcTypeDataTypeEnumSV getNew(){
        return(new DmcTypeDataTypeEnumSV(getAttributeInfo()));
    }
    
    public DmcTypeDataTypeEnumSV getNew(DmcAttributeInfo ai){
        return(new DmcTypeDataTypeEnumSV(ai));
    }
    ...
    public DataTypeEnum set(Object v) throws DMFeedbackSet {
