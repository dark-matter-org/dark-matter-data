...
import org.dmd.dms.shared.types.DmcTypeNameContainer;            // DmcType import - (SETTypeFormatter.java:60)
import org.dmd.dms.shared.types.NameContainer;                   // Base type import - (SETTypeFormatter.java:57)
...
public class DmcTypeNameContainerSET extends DmcTypeNameContainer implements Serializable {
     ...
     private final static Iterator<NameContainer> emptyList =  (new HashSet<NameContainer>()).iterator();
