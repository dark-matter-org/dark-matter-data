...
import org.dmd.dms.shared.types.DmcTypeLabelledIntegerDataPoint;         // DmcType import - (MVTypeFormatter.java:63)
import org.dmd.dms.shared.types.LabelledIntegerDataPoint;                // Base type import - (MVTypeFormatter.java:58)
...
public class DmcTypeLabelledIntegerDataPointMV extends DmcTypeLabelledIntegerDataPoint implements Serializable {
    ...
    public LabelledIntegerDataPoint setMVnth(int index, Object v) throws DMFeedbackSet {
        synchronized(this){
            if (getAttributeInfo().indexSize == 0)
