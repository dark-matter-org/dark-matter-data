...
import org.dmd.dms.shared.generated.types.DmcTypeDependencyREFSV;         //  - (AdapterFormatter.java:60)
...
public class DependencyREFSVAdapter extends DmcTypeDependencyREFSV implements DmcAdapterIF {

    transient DmcTypeDependencyREFSV existingValue;

    public DependencyREFSVAdapter(DmcAttributeInfo ai){
    	   super(ai);
    }
    ...
    public void setExisting(DmcAttribute<?> attr) {
    	existingValue = (DmcTypeDependencyREFSV) attr;
    	if (existingValue != null)
    		value = existingValue.getSVCopy();
    }
