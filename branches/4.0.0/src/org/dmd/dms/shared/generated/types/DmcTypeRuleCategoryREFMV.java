...
public class DmcTypeRuleCategoryREFMV extends DmcTypeRuleCategoryREF implements Serializable {
    
    private final static Iterator<RuleCategoryREF> emptyList = (new ArrayList<RuleCategoryREF>()).iterator();
    
    protected ArrayList<RuleCategoryREF> value;
    
    public DmcTypeRuleCategoryREFMV(){
    
    }
    
    public DmcTypeRuleCategoryREFMV(DmcAttributeInfo ai){
        super(ai);
    }
    
    @Override
    public DmcTypeRuleCategoryREFMV getNew(){
        return(new DmcTypeRuleCategoryREFMV(getAttributeInfo()));
    }
    ...
    public RuleCategoryREF add(Object v) throws DMFeedbackSet {
        synchronized(this){
            ...
            if (value == null)
                value = new ArrayList<RuleCategoryREF>();
            value.add(rc);
            return(rc);
        }
    }
    ...
    public ArrayList<RuleCategoryREF> getMVCopy(){
        synchronized(this){
            if (value == null)
                return(new ArrayList<RuleCategoryREF>());
            else 
                return(new ArrayList<RuleCategoryREF>(value));
        }
    }
    ...
    public RuleCategoryREF setMVnth(int index, Object v) throws DMFeedbackSet {
        synchronized(this){
            if (getAttributeInfo().indexSize == 0)
            ...
            if (value == null){
                value = new ArrayList<RuleCategoryREF>(getAttributeInfo().indexSize);
