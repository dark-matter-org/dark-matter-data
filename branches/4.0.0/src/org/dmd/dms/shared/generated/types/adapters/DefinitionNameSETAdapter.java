...
import org.dmd.dms.shared.generated.types.DmcTypeDefinitionNameSET;         //  - (AdapterFormatter.java:60)
...
public class DefinitionNameSETAdapter extends DmcTypeDefinitionNameSET implements DmcAdapterIF {

    transient DmcTypeDefinitionNameSET existingValue;

    public DefinitionNameSETAdapter(DmcAttributeInfo ai){
    	   super(ai);
    }
    ...
    public void setExisting(DmcAttribute<?> attr) {
    	existingValue = (DmcTypeDefinitionNameSET) attr;
    	if (existingValue != null)
    		value = existingValue.getMVCopy();
    }
