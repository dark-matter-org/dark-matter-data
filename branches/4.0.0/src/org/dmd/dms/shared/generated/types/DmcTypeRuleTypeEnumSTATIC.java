...
import org.dmd.dms.shared.generated.enums.RuleTypeEnum;         // DmcType import - (STATICTypeFormatter.java:70)



/**
 * The DmcTypeRuleTypeEnumSTATIC provides static access to functions used to manage values of type RuleTypeEnum
 ...
 */
public class DmcTypeRuleTypeEnumSTATIC {
    
    public static DmcTypeRuleTypeEnumSTATIC instance;
    static DmcTypeRuleTypeEnumSV typeHelper;
    
    static {
        instance = new DmcTypeRuleTypeEnumSTATIC();
    }
    
    protected DmcTypeRuleTypeEnumSTATIC() {
        typeHelper = new DmcTypeRuleTypeEnumSV();
    }
    
    public RuleTypeEnum typeCheck(Object value) throws DMFeedbackSet {
    	   return(typeHelper.typeCheck(value));
    }
    
    public RuleTypeEnum cloneValue(RuleTypeEnum value) throws DMFeedbackSet {
