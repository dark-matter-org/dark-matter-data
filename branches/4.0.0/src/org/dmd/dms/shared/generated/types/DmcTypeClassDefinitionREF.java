...
import org.dmd.dms.shared.generated.dmo.ClassDefinitionDMO;         // The type of object we refer to - (TypeFormatter.java:53)
...
abstract public class DmcTypeClassDefinitionREF extends DmcTypeNamedObjectREF<ClassDefinitionREF, DefinitionName> implements Serializable {
    ...
    public ClassDefinitionREF typeCheck(Object value) throws DMFeedbackSet {
        ...
        if (value instanceof ClassDefinitionREF)
            ...
            throw(new DMFeedbackSet("Object of class:" + value.getClass().getName() + " passed where a ClassDefinitionREF/DMO or DmcObjectName expected."));
        return(rc);
    }
