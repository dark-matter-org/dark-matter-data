...
import org.dmd.dms.shared.types.ClassFilter;                     // Base type import - (SETTypeFormatter.java:57)
import org.dmd.dms.shared.types.DmcTypeClassFilter;              // DmcType import - (SETTypeFormatter.java:60)
...
public class DmcTypeClassFilterSET extends DmcTypeClassFilter implements Serializable {
     ...
     private final static Iterator<ClassFilter> emptyList =  (new HashSet<ClassFilter>()).iterator();
