...
/**
 * The DmcTypeDmsModuleREFSV provides storage for a single-valued DmsModuleREF
 * <P>
...
public class DmcTypeDmsModuleREFSV extends DmcTypeDmsModuleREF implements Serializable {
    
    protected DmsModuleREF value;
    
    public DmcTypeDmsModuleREFSV(){
    
    }
    
    public DmcTypeDmsModuleREFSV(DmcAttributeInfo ai){
        super(ai);
    }
    
    public DmcTypeDmsModuleREFSV getNew(){
        return(new DmcTypeDmsModuleREFSV(getAttributeInfo()));
    }
    
    public DmcTypeDmsModuleREFSV getNew(DmcAttributeInfo ai){
        return(new DmcTypeDmsModuleREFSV(ai));
    }
    
    @Override
    // org.dmd.dms.tools.util.SVTypeFormatter.dumpSVType(SVTypeFormatter.java:105)
    public DmcAttribute<DmsModuleREF> cloneIt(){
        DmcTypeDmsModuleREFSV rc = getNew();
        rc.value = value;
        return(rc);
    }
    
    // org.dmd.dms.tools.util.SVTypeFormatter.dumpSVType(SVTypeFormatter.java:116)
    public DmsModuleREF getSVCopy(){
        if (value == null)
            return(null);
    ...
    public DmsModuleREF set(Object v) throws DMFeedbackSet {
