...
import org.dmd.dms.shared.types.DmcTypeModifier;         // DmcType import - (SVTypeFormatter.java:66)
import org.dmd.dms.shared.types.Modifier;                // Base type import - (SVTypeFormatter.java:63)
...
public class DmcTypeModifierSV extends DmcTypeModifier implements Serializable {
    
    protected Modifier value;
    ...
    public DmcTypeModifierSV getNew(){
        return(new DmcTypeModifierSV(getAttributeInfo()));
    }
    
    public DmcTypeModifierSV getNew(DmcAttributeInfo ai){
        return(new DmcTypeModifierSV(ai));
    }
    ...
    public Modifier set(Object v) throws DMFeedbackSet {
