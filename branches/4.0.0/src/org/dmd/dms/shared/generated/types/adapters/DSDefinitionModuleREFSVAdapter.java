...
import org.dmd.dms.shared.generated.types.DmcTypeDSDefinitionModuleREFSV;         //  - (AdapterFormatter.java:60)
...
public class DSDefinitionModuleREFSVAdapter extends DmcTypeDSDefinitionModuleREFSV implements DmcAdapterIF {

    transient DmcTypeDSDefinitionModuleREFSV existingValue;

    public DSDefinitionModuleREFSVAdapter(DmcAttributeInfo ai){
    	   super(ai);
    }
    ...
    public void setExisting(DmcAttribute<?> attr) {
    	existingValue = (DmcTypeDSDefinitionModuleREFSV) attr;
    	if (existingValue != null)
    		value = existingValue.getSVCopy();
    }
