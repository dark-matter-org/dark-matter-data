...
import org.dmd.core.DmcObject;                            // Base type import - (SVTypeFormatter.java:62)
...
import org.dmd.dms.shared.types.DmcTypeDmcObject;         // DmcType import - (SVTypeFormatter.java:65)
...
public class DmcTypeDmcObjectSV extends DmcTypeDmcObject implements Serializable {
    ...
    public DmcTypeDmcObjectSV getNew(){
        return(new DmcTypeDmcObjectSV(getAttributeInfo()));
    }
    ...
    public DmcObject set(Object v) throws DMFeedbackSet {
