...
import org.dmd.dms.shared.generated.enums.ModifyTypeEnum;         // DmcType import - (MVTypeFormatter.java:64)
...
public class DmcTypeModifyTypeEnumMV extends DmcTypeModifyTypeEnum implements Serializable {
    ...
    public ModifyTypeEnum setMVnth(int index, Object v) throws DMFeedbackSet {
        synchronized(this){
            if (getAttributeInfo().indexSize == 0)
