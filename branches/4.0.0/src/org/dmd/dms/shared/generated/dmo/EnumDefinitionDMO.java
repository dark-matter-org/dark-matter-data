...
import org.dmd.dms.shared.generated.types.*;         // Enum support - (DmoFormatter.java:86)
...
public class EnumDefinitionDMO extends org.dmd.dms.shared.generated.dmo.DmsDefinitionDMO implements Serializable  {
    ...
    static {
        ...
        _ImAp.put(MetaCompactSchema.__enumValue.id,MetaCompactSchema.__enumValue);
        ...
        _SmAp.put(MetaCompactSchema.__enumValue.name,MetaCompactSchema.__enumValue);
    ...
    public Iterator<EnumValue> getEnumValue(){
        DmcTypeEnumValueMV attr = (DmcTypeEnumValueMV) get(MetaCompactSchema.__enumValue);
        if (attr == null)
            return(null);
    ...
    public DmcAttribute<?> addEnumValue(Object value) throws DMFeedbackSet {
        DmcAttribute<?> attr = get(MetaCompactSchema.__enumValue);
        if (attr == null)
            attr = new DmcTypeEnumValueMV(MetaCompactSchema.__enumValue);
        
        attr.add(value);
        add(MetaCompactSchema.__enumValue,attr);
        return(attr);
    }
