...
public class DmcTypeClassDefinitionREFMV extends DmcTypeClassDefinitionREF implements Serializable {
    ...
    private final static Iterator<ClassDefinitionREF> emptyList = (new ArrayList<ClassDefinitionREF>()).iterator();
    
    protected ArrayList<ClassDefinitionREF> value;
    ...
    public DmcTypeClassDefinitionREFMV getNew(){
        return(new DmcTypeClassDefinitionREFMV(getAttributeInfo()));
    }
    ...
    public ClassDefinitionREF add(Object v) throws DMFeedbackSet {
        synchronized(this){
    ...
    public ArrayList<ClassDefinitionREF> getMVCopy(){
        synchronized(this){
            if (value == null)
                return(new ArrayList<ClassDefinitionREF>());
            else 
                return(new ArrayList<ClassDefinitionREF>(value));
        }
    }
    ...
    public ClassDefinitionREF setMVnth(int index, Object v) throws DMFeedbackSet {
        synchronized(this){
            if (getAttributeInfo().indexSize == 0)
            ...
            if (value == null){
                value = new ArrayList<ClassDefinitionREF>(getAttributeInfo().indexSize);
