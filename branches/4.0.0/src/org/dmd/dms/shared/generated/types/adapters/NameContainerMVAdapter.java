...
import org.dmd.dms.shared.generated.types.DmcTypeNameContainerMV;         //  - (AdapterFormatter.java:60)
...
public class NameContainerMVAdapter extends DmcTypeNameContainerMV implements DmcAdapterIF {
    ...
    public void setExisting(DmcAttribute<?> attr) {
    	existingValue = (DmcTypeNameContainerMV) attr;
    	if (existingValue != null)
    		value = existingValue.getMVCopy();
    }
