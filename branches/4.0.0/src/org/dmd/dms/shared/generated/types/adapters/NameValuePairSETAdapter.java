...
import org.dmd.dms.shared.generated.types.DmcTypeNameValuePairSET;         //  - (AdapterFormatter.java:60)
...
public class NameValuePairSETAdapter extends DmcTypeNameValuePairSET implements DmcAdapterIF {

    transient DmcTypeNameValuePairSET existingValue;

    public NameValuePairSETAdapter(DmcAttributeInfo ai){
    	   super(ai);
    }
    ...
    public void setExisting(DmcAttribute<?> attr) {
    	existingValue = (DmcTypeNameValuePairSET) attr;
    	if (existingValue != null)
    		value = existingValue.getMVCopy();
    }
