...
import org.dmd.dms.shared.types.DmcTypeEnumValue;         // DmcType import - (SVTypeFormatter.java:66)
import org.dmd.dms.shared.types.EnumValue;                // Base type import - (SVTypeFormatter.java:63)
...
public class DmcTypeEnumValueSV extends DmcTypeEnumValue implements Serializable {
    ...
    public DmcTypeEnumValueSV getNew(){
        return(new DmcTypeEnumValueSV(getAttributeInfo()));
    }
    
    public DmcTypeEnumValueSV getNew(DmcAttributeInfo ai){
        return(new DmcTypeEnumValueSV(ai));
    }
    ...
    public EnumValue set(Object v) throws DMFeedbackSet {
