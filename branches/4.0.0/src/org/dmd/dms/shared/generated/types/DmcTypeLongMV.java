...
import org.dmd.dms.shared.types.DmcTypeLong;         // DmcType import - (MVTypeFormatter.java:64)
...
public class DmcTypeLongMV extends DmcTypeLong implements Serializable {
    ...
    private final static Iterator<Long> emptyList = (new ArrayList<Long>()).iterator();
    
    protected ArrayList<Long> value;
    ...
    public DmcTypeLongMV getNew(){
        return(new DmcTypeLongMV(getAttributeInfo()));
    }
    ...
    public ArrayList<Long> getMVCopy(){
        synchronized(this){
            if (value == null)
                ...
                return(new ArrayList<Long>(value));
        }
    }
    ...
    public Long setMVnth(int index, Object v) throws DMFeedbackSet {
        synchronized(this){
            ...
            if (value == null){
                value = new ArrayList<Long>(getAttributeInfo().indexSize);
