...
import org.dmd.dms.shared.generated.types.DmcTypeSchemaAndReasonSET;         //  - (AdapterFormatter.java:60)
...
public class SchemaAndReasonSETAdapter extends DmcTypeSchemaAndReasonSET implements DmcAdapterIF {

    transient DmcTypeSchemaAndReasonSET existingValue;

    public SchemaAndReasonSETAdapter(DmcAttributeInfo ai){
    	   super(ai);
    }
    ...
    public void setExisting(DmcAttribute<?> attr) {
    	existingValue = (DmcTypeSchemaAndReasonSET) attr;
    	if (existingValue != null)
    		value = existingValue.getMVCopy();
    }
