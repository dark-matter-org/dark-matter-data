...
import org.dmd.dms.shared.generated.types.DmcTypeRuleNameSET;         //  - (AdapterFormatter.java:60)
...
public class RuleNameSETAdapter extends DmcTypeRuleNameSET implements DmcAdapterIF {
    ...
    public void setExisting(DmcAttribute<?> attr) {
    	existingValue = (DmcTypeRuleNameSET) attr;
    	if (existingValue != null)
    		value = existingValue.getMVCopy();
    }
