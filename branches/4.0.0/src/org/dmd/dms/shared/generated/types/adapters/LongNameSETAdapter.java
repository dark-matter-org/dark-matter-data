...
import org.dmd.dms.shared.generated.types.DmcTypeLongNameSET;         //  - (AdapterFormatter.java:60)
...
public class LongNameSETAdapter extends DmcTypeLongNameSET implements DmcAdapterIF {
    ...
    public void setExisting(DmcAttribute<?> attr) {
    	existingValue = (DmcTypeLongNameSET) attr;
    	if (existingValue != null)
    		value = existingValue.getMVCopy();
    }
