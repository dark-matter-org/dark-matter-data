...
import org.dmd.dms.shared.generated.types.Part;           // Base type import - (STATICTypeFormatter.java:66)



/**
 * The DmcTypePartSTATIC provides static access to functions used to manage values of type Part
 ...
 */
public class DmcTypePartSTATIC {
    
    public static DmcTypePartSTATIC instance;
    static DmcTypePartSV typeHelper;
    
    static {
        instance = new DmcTypePartSTATIC();
    }
    
    protected DmcTypePartSTATIC() {
        typeHelper = new DmcTypePartSV();
    }
    
    public Part typeCheck(Object value) throws DMFeedbackSet {
    	   return(typeHelper.typeCheck(value));
    }
    
    public Part cloneValue(Part value) throws DMFeedbackSet {
