...
/**
 * The DmcTypeDSDefinitionModuleREFSTATIC provides static access to functions used to manage values of type DSDefinitionModuleREF
 ...
 */
public class DmcTypeDSDefinitionModuleREFSTATIC {
    
    public static DmcTypeDSDefinitionModuleREFSTATIC instance;
    static DmcTypeDSDefinitionModuleREFSV typeHelper;
    
    static {
        instance = new DmcTypeDSDefinitionModuleREFSTATIC();
    }
    
    protected DmcTypeDSDefinitionModuleREFSTATIC() {
        typeHelper = new DmcTypeDSDefinitionModuleREFSV();
    }
    
    public DSDefinitionModuleREF typeCheck(Object value) throws DMFeedbackSet {
    	   return(typeHelper.typeCheck(value));
    }
    
    public DSDefinitionModuleREF cloneValue(DSDefinitionModuleREF value) throws DMFeedbackSet {
