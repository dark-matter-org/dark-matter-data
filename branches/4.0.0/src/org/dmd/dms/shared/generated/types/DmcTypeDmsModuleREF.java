...
import org.dmd.dms.shared.generated.dmo.DmsModuleDMO;          // The type of object we refer to - (TypeFormatter.java:53)
...
abstract public class DmcTypeDmsModuleREF extends DmcTypeNamedObjectREF<DmsModuleREF, DefinitionName> implements Serializable {

    /**
     * Default constructor.
     */
    public DmcTypeDmsModuleREF(){
    }

    /**
     * Default constructor.
     */
    public DmcTypeDmsModuleREF(DmcAttributeInfo ai){
        super(ai);
    }

    /**
     * Checks that we have a DmsModuleREF or DmsModuleDMO.
     */
    public DmsModuleREF typeCheck(Object value) throws DMFeedbackSet {
        DmsModuleREF rc = null;
        if (value instanceof DmsModuleREF)
            rc = (DmsModuleREF)value;
        else if (value instanceof DmsModuleDMO)
            rc = new DmsModuleREF((DmsModuleDMO)value);
            ...
            throw(new DMFeedbackSet("Object of class:" + value.getClass().getName() + " passed where a DmsModuleREF/DMO or DmcObjectName expected."));
        return(rc);
    }

    @Override
    protected DmsModuleREF getNewHelper(){
        return( new DmsModuleREF());
    }
    ...
    protected String getDMOClassName(){
        return( DmsModuleDMO.class.getName());
    }

    @Override
    protected boolean isDMO(Object value){
        if (value instanceof DmsModuleDMO)
            return(true);
        return(false);
    }
     ...
     */
    @Override
    public DmsModuleREF cloneValue(DmsModuleREF val){
        DmsModuleREF rc = new DmsModuleREF(val);
        return(rc);
    }
    ...
    public DmsModuleREF deserializeValue(DmcInputStreamIF dis) throws Exception {
        DmsModuleREF rc = new DmsModuleREF();
