...
import org.dmd.dms.shared.generated.types.DmcTypeConcinnityREFSV;         //  - (AdapterFormatter.java:60)
...
public class ConcinnityREFSVAdapter extends DmcTypeConcinnityREFSV implements DmcAdapterIF {

    transient DmcTypeConcinnityREFSV existingValue;

    public ConcinnityREFSVAdapter(DmcAttributeInfo ai){
    	   super(ai);
    }
    ...
    public void setExisting(DmcAttribute<?> attr) {
    	existingValue = (DmcTypeConcinnityREFSV) attr;
    	if (existingValue != null)
    		value = existingValue.getSVCopy();
    }
