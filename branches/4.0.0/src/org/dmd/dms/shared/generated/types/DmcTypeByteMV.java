...
import org.dmd.dms.shared.types.DmcTypeByte;         // DmcType import - (MVTypeFormatter.java:63)
...
public class DmcTypeByteMV extends DmcTypeByte implements Serializable {
    
    private final static Iterator<Byte> emptyList = (new ArrayList<Byte>()).iterator();
    ...
    public DmcTypeByteMV getNew(){
        return(new DmcTypeByteMV(getAttributeInfo()));
    }
    ...
    public Iterator<Byte> getMV(){
        synchronized(this){
            ...
            ArrayList<Byte> clone = new ArrayList<Byte>(value);
    ...
    public Byte setMVnth(int index, Object v) throws DMFeedbackSet {
        synchronized(this){
            if (getAttributeInfo().indexSize == 0)
            ...
            if (value == null){
                value = new ArrayList<Byte>(getAttributeInfo().indexSize);
