...
import org.dmd.dms.shared.types.ClassInfoRef;                // Base type import - (MVTypeFormatter.java:59)
import org.dmd.dms.shared.types.DmcTypeClassInfoRef;         // DmcType import - (MVTypeFormatter.java:64)
...
public class DmcTypeClassInfoRefMV extends DmcTypeClassInfoRef implements Serializable {
    ...
    public ClassInfoRef setMVnth(int index, Object v) throws DMFeedbackSet {
        synchronized(this){
            if (getAttributeInfo().indexSize == 0)
