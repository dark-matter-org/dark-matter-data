...
import org.dmd.dms.shared.generated.dmo.EnumDefinitionDMO;         // The type of object we refer to - (TypeFormatter.java:53)
...
abstract public class DmcTypeEnumDefinitionREF extends DmcTypeNamedObjectREF<EnumDefinitionREF, DefinitionName> implements Serializable {
    ...
    public EnumDefinitionREF typeCheck(Object value) throws DMFeedbackSet {
        ...
        if (value instanceof EnumDefinitionREF)
            ...
            throw(new DMFeedbackSet("Object of class:" + value.getClass().getName() + " passed where a EnumDefinitionREF/DMO or DmcObjectName expected."));
        return(rc);
    }
