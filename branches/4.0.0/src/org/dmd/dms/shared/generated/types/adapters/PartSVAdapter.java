...
import org.dmd.dms.shared.generated.types.DmcTypePartSV;             //  - (AdapterFormatter.java:60)
...
public class PartSVAdapter extends DmcTypePartSV implements DmcAdapterIF {

    transient DmcTypePartSV existingValue;

    public PartSVAdapter(DmcAttributeInfo ai){
    	   super(ai);
    }
    ...
    public void setExisting(DmcAttribute<?> attr) {
    	existingValue = (DmcTypePartSV) attr;
    	if (existingValue != null)
    		value = existingValue.getSVCopy();
    }
