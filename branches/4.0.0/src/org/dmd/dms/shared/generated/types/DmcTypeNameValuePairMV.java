...
import org.dmd.dms.shared.generated.types.DmcTypeNameValuePair;         // DmcType import - (MVTypeFormatter.java:63)
import org.dmd.dms.shared.generated.types.NameValuePair;                // Base type import - (MVTypeFormatter.java:58)
...
public class DmcTypeNameValuePairMV extends DmcTypeNameValuePair implements Serializable {
    
    private final static Iterator<NameValuePair> emptyList = (new ArrayList<NameValuePair>()).iterator();
    
    protected ArrayList<NameValuePair> value;
    
    public DmcTypeNameValuePairMV(){
    
    }
    
    public DmcTypeNameValuePairMV(DmcAttributeInfo ai){
        super(ai);
    }
    
    @Override
    public DmcTypeNameValuePairMV getNew(){
        return(new DmcTypeNameValuePairMV(getAttributeInfo()));
    }
    ...
    public DmcAttribute<NameValuePair> cloneIt(){
        synchronized(this){
            DmcTypeNameValuePairMV rc = getNew();
    ...
    public Iterator<NameValuePair> getMV(){
        synchronized(this){
            ...
            ArrayList<NameValuePair> clone = new ArrayList<NameValuePair>(value);
            return(clone.iterator());
        }
    }
    
    // org.dmd.dms.tools.util.MVTypeFormatter.dumpMVType(MVTypeFormatter.java:188)
    public ArrayList<NameValuePair> getMVCopy(){
        synchronized(this){
            if (value == null)
                return(new ArrayList<NameValuePair>());
            else 
                return(new ArrayList<NameValuePair>(value));
        }
    }
    ...
    public NameValuePair getMVnth(int index){
        synchronized(this){
            if (value == null)
                return(null);
    ...
    public NameValuePair setMVnth(int index, Object v) throws DMFeedbackSet {
        synchronized(this){
            if (getAttributeInfo().indexSize == 0)
            ...
            if (value == null){
                value = new ArrayList<NameValuePair>(getAttributeInfo().indexSize);
