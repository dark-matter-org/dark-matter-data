...
import org.dmd.dms.shared.generated.types.DmcTypeExample;         // DmcType import - (SVTypeFormatter.java:66)
import org.dmd.dms.shared.generated.types.Example;                // Base type import - (SVTypeFormatter.java:63)
...
public class DmcTypeExampleSV extends DmcTypeExample implements Serializable {
    
    protected Example value;
    
    public DmcTypeExampleSV(){
    
    }
    
    public DmcTypeExampleSV(DmcAttributeInfo ai){
        super(ai);
    }
    
    public DmcTypeExampleSV getNew(){
        return(new DmcTypeExampleSV(getAttributeInfo()));
    }
    
    public DmcTypeExampleSV getNew(DmcAttributeInfo ai){
        return(new DmcTypeExampleSV(ai));
    }
    
    @Override
    // org.dmd.dms.tools.generation.util.SVTypeFormatter.dumpSVType(SVTypeFormatter.java:106)
    public DmcAttribute<Example> cloneIt(){
        DmcTypeExampleSV rc = getNew();
        rc.value = value;
        return(rc);
    }
    
    // org.dmd.dms.tools.generation.util.SVTypeFormatter.dumpSVType(SVTypeFormatter.java:117)
    public Example getSVCopy(){
        if (value == null)
            return(null);
    ...
    public Example set(Object v) throws DMFeedbackSet {
