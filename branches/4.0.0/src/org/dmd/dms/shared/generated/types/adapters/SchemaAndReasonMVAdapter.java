...
import org.dmd.dms.shared.generated.types.DmcTypeSchemaAndReasonMV;         //  - (AdapterFormatter.java:60)
...
public class SchemaAndReasonMVAdapter extends DmcTypeSchemaAndReasonMV implements DmcAdapterIF {

    transient DmcTypeSchemaAndReasonMV existingValue;

    public SchemaAndReasonMVAdapter(DmcAttributeInfo ai){
    	   super(ai);
    }
    ...
    public void setExisting(DmcAttribute<?> attr) {
    	existingValue = (DmcTypeSchemaAndReasonMV) attr;
    	if (existingValue != null)
    		value = existingValue.getMVCopy();
    }
