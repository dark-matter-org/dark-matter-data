...
import org.dmd.dms.shared.generated.dmo.DmsModuleDMO;              // The type of object we refer to - (TypeFormatter.java:173)
...
public class DmsModuleREF extends DmcNamedObjectREF<DmsModuleDMO> implements Serializable {
     ...
     * Copy constructor.
     */
    public DmsModuleREF(DmsModuleREF original){
     ...
     * Wrapper constructor.
     */
    public DmsModuleREF(DmsModuleDMO dmo){
     ...
     */
    @Override
    public void setObject(DmsModuleDMO o){
        object = o;
    }
