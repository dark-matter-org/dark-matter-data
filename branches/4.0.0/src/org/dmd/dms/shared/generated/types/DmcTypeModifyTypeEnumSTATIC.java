...
import org.dmd.dms.shared.generated.enums.ModifyTypeEnum;         // DmcType import - (STATICTypeFormatter.java:70)



/**
 * The DmcTypeModifyTypeEnumSTATIC provides static access to functions used to manage values of type ModifyTypeEnum
...
public class DmcTypeModifyTypeEnumSTATIC {
    ...
    public ModifyTypeEnum typeCheck(Object value) throws DMFeedbackSet {
    	   return(typeHelper.typeCheck(value));
    }
    
    public ModifyTypeEnum cloneValue(ModifyTypeEnum value) throws DMFeedbackSet {
