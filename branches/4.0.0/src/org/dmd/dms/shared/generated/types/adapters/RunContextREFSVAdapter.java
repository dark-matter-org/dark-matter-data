...
import org.dmd.dms.shared.generated.types.DmcTypeRunContextREFSV;         //  - (AdapterFormatter.java:60)
...
public class RunContextREFSVAdapter extends DmcTypeRunContextREFSV implements DmcAdapterIF {

    transient DmcTypeRunContextREFSV existingValue;

    public RunContextREFSVAdapter(DmcAttributeInfo ai){
    	   super(ai);
    }
    ...
    public void setExisting(DmcAttribute<?> attr) {
    	existingValue = (DmcTypeRunContextREFSV) attr;
    	if (existingValue != null)
    		value = existingValue.getSVCopy();
    }
