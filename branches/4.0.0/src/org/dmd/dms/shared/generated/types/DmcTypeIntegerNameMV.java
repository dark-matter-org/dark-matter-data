...
import org.dmd.dms.shared.types.DmcTypeIntegerName;         // DmcType import - (MVTypeFormatter.java:63)
import org.dmd.dms.shared.types.IntegerName;                // Base type import - (MVTypeFormatter.java:58)
...
public class DmcTypeIntegerNameMV extends DmcTypeIntegerName implements Serializable {
    ...
    private final static Iterator<IntegerName> emptyList = (new ArrayList<IntegerName>()).iterator();
    
    protected ArrayList<IntegerName> value;
    ...
    public DmcTypeIntegerNameMV getNew(){
        return(new DmcTypeIntegerNameMV(getAttributeInfo()));
    }
    ...
    public IntegerName add(Object v) throws DMFeedbackSet {
        synchronized(this){
    ...
    public ArrayList<IntegerName> getMVCopy(){
        synchronized(this){
            if (value == null)
                return(new ArrayList<IntegerName>());
            else 
                return(new ArrayList<IntegerName>(value));
        }
    }
    ...
    public IntegerName setMVnth(int index, Object v) throws DMFeedbackSet {
        synchronized(this){
            if (getAttributeInfo().indexSize == 0)
            ...
            if (value == null){
                value = new ArrayList<IntegerName>(getAttributeInfo().indexSize);
