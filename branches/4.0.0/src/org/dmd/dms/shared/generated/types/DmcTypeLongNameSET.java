...
import org.dmd.dms.shared.types.DmcTypeLongName;                 // DmcType import - (SETTypeFormatter.java:59)
import org.dmd.dms.shared.types.LongName;                        // Base type import - (SETTypeFormatter.java:56)
...
public class DmcTypeLongNameSET extends DmcTypeLongName implements Serializable {
     ...
     private final static Iterator<LongName> emptyList =  (new HashSet<LongName>()).iterator();
    ...
    public LongName add(Object v) throws DMFeedbackSet {
        synchronized(this){
