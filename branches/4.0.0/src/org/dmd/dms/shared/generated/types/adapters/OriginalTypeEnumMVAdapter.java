...
import org.dmd.dms.shared.generated.types.DmcTypeOriginalTypeEnumMV;         //  - (AdapterFormatter.java:60)
...
public class OriginalTypeEnumMVAdapter extends DmcTypeOriginalTypeEnumMV implements DmcAdapterIF {

    transient DmcTypeOriginalTypeEnumMV existingValue;

    public OriginalTypeEnumMVAdapter(DmcAttributeInfo ai){
    	   super(ai);
    }
    ...
    public void setExisting(DmcAttribute<?> attr) {
    	existingValue = (DmcTypeOriginalTypeEnumMV) attr;
    	if (existingValue != null)
    		value = existingValue.getMVCopy();
    }
