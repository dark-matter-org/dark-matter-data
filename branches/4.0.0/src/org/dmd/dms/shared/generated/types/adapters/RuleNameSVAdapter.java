...
import org.dmd.dms.shared.generated.types.DmcTypeRuleNameSV;         //  - (AdapterFormatter.java:60)
...
public class RuleNameSVAdapter extends DmcTypeRuleNameSV implements DmcAdapterIF {

    transient DmcTypeRuleNameSV existingValue;

    public RuleNameSVAdapter(DmcAttributeInfo ai){
    	   super(ai);
    }
    ...
    public void setExisting(DmcAttribute<?> attr) {
    	existingValue = (DmcTypeRuleNameSV) attr;
    	if (existingValue != null)
    		value = existingValue.getSVCopy();
    }
