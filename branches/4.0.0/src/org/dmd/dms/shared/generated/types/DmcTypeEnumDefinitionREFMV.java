...
public class DmcTypeEnumDefinitionREFMV extends DmcTypeEnumDefinitionREF implements Serializable {
    ...
    private final static Iterator<EnumDefinitionREF> emptyList = (new ArrayList<EnumDefinitionREF>()).iterator();
    
    protected ArrayList<EnumDefinitionREF> value;
    ...
    public DmcTypeEnumDefinitionREFMV getNew(){
        return(new DmcTypeEnumDefinitionREFMV(getAttributeInfo()));
    }
    ...
    public EnumDefinitionREF add(Object v) throws DMFeedbackSet {
        synchronized(this){
    ...
    public ArrayList<EnumDefinitionREF> getMVCopy(){
        synchronized(this){
            if (value == null)
                return(new ArrayList<EnumDefinitionREF>());
            else 
                return(new ArrayList<EnumDefinitionREF>(value));
        }
    }
    ...
    public EnumDefinitionREF setMVnth(int index, Object v) throws DMFeedbackSet {
        synchronized(this){
            if (getAttributeInfo().indexSize == 0)
            ...
            if (value == null){
                value = new ArrayList<EnumDefinitionREF>(getAttributeInfo().indexSize);
