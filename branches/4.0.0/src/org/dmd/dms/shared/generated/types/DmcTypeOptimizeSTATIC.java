...
import org.dmd.dms.shared.generated.types.Optimize;         // Base type import - (STATICTypeFormatter.java:65)



/**
 * The DmcTypeOptimizeSTATIC provides static access to functions used to manage values of type Optimize
...
public class DmcTypeOptimizeSTATIC {
    ...
    public static DmcTypeOptimizeSTATIC instance;
    static DmcTypeOptimizeSV typeHelper;
    
    static {
        instance = new DmcTypeOptimizeSTATIC();
    }
    ...
    public Optimize typeCheck(Object value) throws DMFeedbackSet {
    	   return(typeHelper.typeCheck(value));
    }
    
    public Optimize cloneValue(Optimize value) throws DMFeedbackSet {
