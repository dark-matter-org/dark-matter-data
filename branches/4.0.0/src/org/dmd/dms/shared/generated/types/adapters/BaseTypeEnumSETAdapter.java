...
import org.dmd.dms.shared.generated.types.DmcTypeBaseTypeEnumSET;         //  - (AdapterFormatter.java:60)
...
public class BaseTypeEnumSETAdapter extends DmcTypeBaseTypeEnumSET implements DmcAdapterIF {
    ...
    public void setExisting(DmcAttribute<?> attr) {
    	existingValue = (DmcTypeBaseTypeEnumSET) attr;
    	if (existingValue != null)
    		value = existingValue.getMVCopy();
    }
