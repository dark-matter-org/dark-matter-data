...
import org.dmd.dms.shared.generated.types.DmcTypeBaseTypeEnumSV;         //  - (AdapterFormatter.java:60)
...
public class BaseTypeEnumSVAdapter extends DmcTypeBaseTypeEnumSV implements DmcAdapterIF {

    transient DmcTypeBaseTypeEnumSV existingValue;

    public BaseTypeEnumSVAdapter(DmcAttributeInfo ai){
    	   super(ai);
    }
    ...
    public void setExisting(DmcAttribute<?> attr) {
    	existingValue = (DmcTypeBaseTypeEnumSV) attr;
    	if (existingValue != null)
    		value = existingValue.getSVCopy();
    }
