...
import org.dmd.dms.shared.generated.types.DmcTypeClassTypeEnumSV;         //  - (AdapterFormatter.java:60)
...
public class ClassTypeEnumSVAdapter extends DmcTypeClassTypeEnumSV implements DmcAdapterIF {
    ...
    public void setExisting(DmcAttribute<?> attr) {
    	existingValue = (DmcTypeClassTypeEnumSV) attr;
    	if (existingValue != null)
    		value = existingValue.getSVCopy();
    }
