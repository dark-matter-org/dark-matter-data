...
import org.dmd.dms.shared.generated.enums.DebugEnum;         // DmcType import - (MVTypeFormatter.java:64)
...
public class DmcTypeDebugEnumMV extends DmcTypeDebugEnum implements Serializable {
    ...
    private final static Iterator<DebugEnum> emptyList = (new ArrayList<DebugEnum>()).iterator();
    
    protected ArrayList<DebugEnum> value;
    ...
    public DmcTypeDebugEnumMV getNew(){
        return(new DmcTypeDebugEnumMV(getAttributeInfo()));
    }
    ...
    public ArrayList<DebugEnum> getMVCopy(){
        synchronized(this){
            if (value == null)
                return(new ArrayList<DebugEnum>());
            else 
                return(new ArrayList<DebugEnum>(value));
        }
    }
    ...
    public DebugEnum setMVnth(int index, Object v) throws DMFeedbackSet {
        synchronized(this){
            if (getAttributeInfo().indexSize == 0)
            ...
            if (value == null){
                value = new ArrayList<DebugEnum>(getAttributeInfo().indexSize);
