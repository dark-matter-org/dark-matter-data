...
import org.dmd.dms.shared.generated.types.DmcTypeByteSET;            //  - (AdapterFormatter.java:60)
...
public class ByteSETAdapter extends DmcTypeByteSET implements DmcAdapterIF {

    transient DmcTypeByteSET existingValue;

    public ByteSETAdapter(DmcAttributeInfo ai){
    	   super(ai);
    }
    ...
    public void setExisting(DmcAttribute<?> attr) {
    	existingValue = (DmcTypeByteSET) attr;
    	if (existingValue != null)
    		value = existingValue.getMVCopy();
    }
