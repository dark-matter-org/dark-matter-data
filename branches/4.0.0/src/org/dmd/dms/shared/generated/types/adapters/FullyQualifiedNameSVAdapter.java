...
import org.dmd.dms.shared.generated.types.DmcTypeFullyQualifiedNameSV;         //  - (AdapterFormatter.java:60)
...
public class FullyQualifiedNameSVAdapter extends DmcTypeFullyQualifiedNameSV implements DmcAdapterIF {
    ...
    public void setExisting(DmcAttribute<?> attr) {
    	existingValue = (DmcTypeFullyQualifiedNameSV) attr;
    	if (existingValue != null)
    		value = existingValue.getSVCopy();
    }
