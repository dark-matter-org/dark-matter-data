...
import org.dmd.dms.shared.generated.types.DmcTypeShortMV;            //  - (AdapterFormatter.java:60)
...
public class ShortMVAdapter extends DmcTypeShortMV implements DmcAdapterIF {

    transient DmcTypeShortMV existingValue;

    public ShortMVAdapter(DmcAttributeInfo ai){
    	   super(ai);
    }
    ...
    public void setExisting(DmcAttribute<?> attr) {
    	existingValue = (DmcTypeShortMV) attr;
    	if (existingValue != null)
    		value = existingValue.getMVCopy();
    }
