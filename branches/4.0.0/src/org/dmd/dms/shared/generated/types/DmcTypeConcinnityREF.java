...
import org.dmd.dms.shared.generated.dmo.ConcinnityDMO;         // The type of object we refer to - (TypeFormatter.java:53)
...
abstract public class DmcTypeConcinnityREF extends DmcTypeNamedObjectREF<ConcinnityREF, DefinitionName> implements Serializable {
    ...
    public ConcinnityREF typeCheck(Object value) throws DMFeedbackSet {
        ...
        if (value instanceof ConcinnityREF)
            ...
            throw(new DMFeedbackSet("Object of class:" + value.getClass().getName() + " passed where a ConcinnityREF/DMO or DmcObjectName expected."));
        return(rc);
    }
