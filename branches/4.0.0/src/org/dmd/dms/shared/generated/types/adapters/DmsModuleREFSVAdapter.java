...
import org.dmd.dms.shared.generated.types.DmcTypeDmsModuleREFSV;         //  - (AdapterFormatter.java:60)
...
public class DmsModuleREFSVAdapter extends DmcTypeDmsModuleREFSV implements DmcAdapterIF {

    transient DmcTypeDmsModuleREFSV existingValue;

    public DmsModuleREFSVAdapter(DmcAttributeInfo ai){
    	   super(ai);
    }
    ...
    public void setExisting(DmcAttribute<?> attr) {
    	existingValue = (DmcTypeDmsModuleREFSV) attr;
    	if (existingValue != null)
    		value = existingValue.getSVCopy();
    }
