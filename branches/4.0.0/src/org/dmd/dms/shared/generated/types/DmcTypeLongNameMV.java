...
import org.dmd.dms.shared.types.DmcTypeLongName;         // DmcType import - (MVTypeFormatter.java:64)
import org.dmd.dms.shared.types.LongName;                // Base type import - (MVTypeFormatter.java:59)
...
public class DmcTypeLongNameMV extends DmcTypeLongName implements Serializable {
    ...
    public LongName setMVnth(int index, Object v) throws DMFeedbackSet {
        synchronized(this){
            if (getAttributeInfo().indexSize == 0)
