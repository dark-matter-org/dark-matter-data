...
import org.dmd.dms.shared.generated.types.DmcTypeIntegerSET;         //  - (AdapterFormatter.java:60)
...
public class IntegerSETAdapter extends DmcTypeIntegerSET implements DmcAdapterIF {
    ...
    public void setExisting(DmcAttribute<?> attr) {
    	existingValue = (DmcTypeIntegerSET) attr;
    	if (existingValue != null)
    		value = existingValue.getMVCopy();
    }
