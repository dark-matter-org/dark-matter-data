...
import org.dmd.dms.shared.generated.types.DmcTypeNameContainerSET;         //  - (AdapterFormatter.java:60)
...
public class NameContainerSETAdapter extends DmcTypeNameContainerSET implements DmcAdapterIF {
    ...
    public void setExisting(DmcAttribute<?> attr) {
    	existingValue = (DmcTypeNameContainerSET) attr;
    	if (existingValue != null)
    		value = existingValue.getMVCopy();
    }
