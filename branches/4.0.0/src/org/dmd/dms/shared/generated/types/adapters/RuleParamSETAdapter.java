...
import org.dmd.dms.shared.generated.types.DmcTypeRuleParamSET;         //  - (AdapterFormatter.java:60)
...
public class RuleParamSETAdapter extends DmcTypeRuleParamSET implements DmcAdapterIF {

    transient DmcTypeRuleParamSET existingValue;

    public RuleParamSETAdapter(DmcAttributeInfo ai){
    	   super(ai);
    }
    ...
    public void setExisting(DmcAttribute<?> attr) {
    	existingValue = (DmcTypeRuleParamSET) attr;
    	if (existingValue != null)
    		value = existingValue.getMVCopy();
    }
