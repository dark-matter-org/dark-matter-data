...
import org.dmd.dms.shared.generated.types.DmcTypeComplexTypeDefinitionREFMV;         //  - (AdapterFormatter.java:60)
...
public class ComplexTypeDefinitionREFMVAdapter extends DmcTypeComplexTypeDefinitionREFMV implements DmcAdapterIF {
    ...
    public void setExisting(DmcAttribute<?> attr) {
    	existingValue = (DmcTypeComplexTypeDefinitionREFMV) attr;
    	if (existingValue != null)
    		value = existingValue.getMVCopy();
    }
