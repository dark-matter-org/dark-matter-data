...
public class DmcTypeExtendedReferenceTypeDefinitionREFMV extends DmcTypeExtendedReferenceTypeDefinitionREF implements Serializable {
    ...
    private final static Iterator<ExtendedReferenceTypeDefinitionREF> emptyList = (new ArrayList<ExtendedReferenceTypeDefinitionREF>()).iterator();
    
    protected ArrayList<ExtendedReferenceTypeDefinitionREF> value;
    
    public DmcTypeExtendedReferenceTypeDefinitionREFMV(){
    
    }
    
    public DmcTypeExtendedReferenceTypeDefinitionREFMV(DmcAttributeInfo ai){
        super(ai);
    }
    
    @Override
    public DmcTypeExtendedReferenceTypeDefinitionREFMV getNew(){
        return(new DmcTypeExtendedReferenceTypeDefinitionREFMV(getAttributeInfo()));
    }
    ...
    public ExtendedReferenceTypeDefinitionREF add(Object v) throws DMFeedbackSet {
        synchronized(this){
            ...
            if (value == null)
                value = new ArrayList<ExtendedReferenceTypeDefinitionREF>();
            value.add(rc);
            return(rc);
        }
    }
    ...
    public ArrayList<ExtendedReferenceTypeDefinitionREF> getMVCopy(){
        synchronized(this){
            if (value == null)
                return(new ArrayList<ExtendedReferenceTypeDefinitionREF>());
            else 
                return(new ArrayList<ExtendedReferenceTypeDefinitionREF>(value));
        }
    }
    ...
    public ExtendedReferenceTypeDefinitionREF setMVnth(int index, Object v) throws DMFeedbackSet {
        synchronized(this){
            if (getAttributeInfo().indexSize == 0)
            ...
            if (value == null){
                value = new ArrayList<ExtendedReferenceTypeDefinitionREF>(getAttributeInfo().indexSize);
