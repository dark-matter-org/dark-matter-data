...
import org.dmd.dms.shared.generated.types.DmcTypeLabelledIntegerDataPointMV;         //  - (AdapterFormatter.java:60)
...
public class LabelledIntegerDataPointMVAdapter extends DmcTypeLabelledIntegerDataPointMV implements DmcAdapterIF {
    ...
    public void setExisting(DmcAttribute<?> attr) {
    	existingValue = (DmcTypeLabelledIntegerDataPointMV) attr;
    	if (existingValue != null)
    		value = existingValue.getMVCopy();
    }
