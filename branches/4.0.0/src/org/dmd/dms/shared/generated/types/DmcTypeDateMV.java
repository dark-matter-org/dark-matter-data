...
import java.util.Date;                               // Base type import - (MVTypeFormatter.java:58)
...
import org.dmd.dms.shared.types.DmcTypeDate;         // DmcType import - (MVTypeFormatter.java:63)
...
public class DmcTypeDateMV extends DmcTypeDate implements Serializable {
    ...
    public Date setMVnth(int index, Object v) throws DMFeedbackSet {
        synchronized(this){
            if (getAttributeInfo().indexSize == 0)
