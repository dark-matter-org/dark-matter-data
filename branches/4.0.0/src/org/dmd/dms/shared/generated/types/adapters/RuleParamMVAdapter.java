...
import org.dmd.dms.shared.generated.types.DmcTypeRuleParamMV;         //  - (AdapterFormatter.java:60)
...
public class RuleParamMVAdapter extends DmcTypeRuleParamMV implements DmcAdapterIF {

    transient DmcTypeRuleParamMV existingValue;

    public RuleParamMVAdapter(DmcAttributeInfo ai){
    	   super(ai);
    }
    ...
    public void setExisting(DmcAttribute<?> attr) {
    	existingValue = (DmcTypeRuleParamMV) attr;
    	if (existingValue != null)
    		value = existingValue.getMVCopy();
    }
