...
import org.dmd.dms.shared.types.DmcTypeFloat;         // DmcType import - (MVTypeFormatter.java:64)
...
public class DmcTypeFloatMV extends DmcTypeFloat implements Serializable {
    ...
    private final static Iterator<Float> emptyList = (new ArrayList<Float>()).iterator();
    ...
    public DmcTypeFloatMV getNew(){
        return(new DmcTypeFloatMV(getAttributeInfo()));
    }
    ...
    public Float setMVnth(int index, Object v) throws DMFeedbackSet {
        synchronized(this){
            if (getAttributeInfo().indexSize == 0)
            ...
            if (value == null){
                value = new ArrayList<Float>(getAttributeInfo().indexSize);
