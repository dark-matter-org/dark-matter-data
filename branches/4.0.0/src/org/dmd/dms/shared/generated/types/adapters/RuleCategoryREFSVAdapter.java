...
import org.dmd.dms.shared.generated.types.DmcTypeRuleCategoryREFSV;         //  - (AdapterFormatter.java:60)
...
public class RuleCategoryREFSVAdapter extends DmcTypeRuleCategoryREFSV implements DmcAdapterIF {

    transient DmcTypeRuleCategoryREFSV existingValue;

    public RuleCategoryREFSVAdapter(DmcAttributeInfo ai){
    	   super(ai);
    }
    ...
    public void setExisting(DmcAttribute<?> attr) {
    	existingValue = (DmcTypeRuleCategoryREFSV) attr;
    	if (existingValue != null)
    		value = existingValue.getSVCopy();
    }
