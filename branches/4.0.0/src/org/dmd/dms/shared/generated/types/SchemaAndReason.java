...
public class SchemaAndReason implements Serializable {
     ...
     */
    public SchemaAndReason(String f1, String f2) throws DMFeedbackSet {
     ...
     */
    public SchemaAndReason(String initialInput) throws DMFeedbackSet {
    ...
    void initialize(String initialInput) throws DMFeedbackSet {
        ...
        if (nvp.size() < requiredParts)
            throw(new DMFeedbackSet("Missing required values for complex type: SchemaAndReason"));
