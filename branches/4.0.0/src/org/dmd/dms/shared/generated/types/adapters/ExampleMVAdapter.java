...
import org.dmd.dms.shared.generated.types.DmcTypeExampleMV;          //  - (AdapterFormatter.java:60)
...
public class ExampleMVAdapter extends DmcTypeExampleMV implements DmcAdapterIF {

    transient DmcTypeExampleMV existingValue;

    public ExampleMVAdapter(DmcAttributeInfo ai){
    	   super(ai);
    }
    ...
    public void setExisting(DmcAttribute<?> attr) {
    	existingValue = (DmcTypeExampleMV) attr;
    	if (existingValue != null)
    		value = existingValue.getMVCopy();
    }
