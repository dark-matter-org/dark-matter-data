...
import org.dmd.dms.shared.generated.types.DmcTypeIntegerSV;          //  - (AdapterFormatter.java:60)
...
public class IntegerSVAdapter extends DmcTypeIntegerSV implements DmcAdapterIF {
    ...
    public void setExisting(DmcAttribute<?> attr) {
    	existingValue = (DmcTypeIntegerSV) attr;
    	if (existingValue != null)
    		value = existingValue.getSVCopy();
    }
