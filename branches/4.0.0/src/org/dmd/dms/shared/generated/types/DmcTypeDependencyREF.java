...
import org.dmd.dms.shared.generated.dmo.DependencyDMO;         // The type of object we refer to - (TypeFormatter.java:53)
...
abstract public class DmcTypeDependencyREF extends DmcTypeNamedObjectREF<DependencyREF, DefinitionName> implements Serializable {
    ...
    public DependencyREF typeCheck(Object value) throws DMFeedbackSet {
        ...
        if (value instanceof DependencyREF)
            ...
            throw(new DMFeedbackSet("Object of class:" + value.getClass().getName() + " passed where a DependencyREF/DMO or DmcObjectName expected."));
        return(rc);
    }
