...
import org.dmd.core.DmcObject;                                   // Base type import - (SETTypeFormatter.java:56)
...
import org.dmd.dms.shared.types.DmcTypeDmcObject;                // DmcType import - (SETTypeFormatter.java:59)
...
public class DmcTypeDmcObjectSET extends DmcTypeDmcObject implements Serializable {
     ...
     private final static Iterator<DmcObject> emptyList =  (new HashSet<DmcObject>()).iterator();
