...
import org.dmd.dms.shared.types.IntegerName;         // This is the type we're iterating - (DmwFormatter.java:456)
...
public class IntegerNameIterableDMW extends DmwMVIterator<IntegerName> {
    ...
    public final static IntegerNameIterableDMW emptyList = new IntegerNameIterableDMW();
