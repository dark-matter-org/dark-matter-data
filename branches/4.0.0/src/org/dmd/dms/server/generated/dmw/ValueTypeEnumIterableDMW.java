...
import org.dmd.dms.shared.generated.enums.ValueTypeEnum;         // This is the type we're iterating - (DmwFormatter.java:456)
import org.dmd.dmw.DmwMVIterator;                                // The base multi-value iterator - (DmwFormatter.java:453)


/**
 * The ValueTypeEnumIterableDMW wraps an Iterator for a particular type and makes 
 * it Iterable.
 * <P>
 ...
 */
public class ValueTypeEnumIterableDMW extends DmwMVIterator<ValueTypeEnum> {

    public final static ValueTypeEnumIterableDMW emptyList = new ValueTypeEnumIterableDMW();

    protected ValueTypeEnumIterableDMW(){
        super();
    }

    public ValueTypeEnumIterableDMW(Iterator<ValueTypeEnum> it){
        super(it);
    }
