...
import org.dmd.dms.shared.generated.types.DmsModuleREF;         // The base type - (DmwFormatter.java:450)
import org.dmd.dmw.DmwMVIterator;                               // The base multi-value iterator - (DmwFormatter.java:453)


/**
 * The DmsModuleREFIterableDMW wraps an Iterator for a particular type and makes 
 * it Iterable.
 * <P>
 ...
 */
public class DmsModuleREFIterableDMW extends DmwMVIterator<DmsModuleREF> {

    public final static DmsModuleREFIterableDMW emptyList = new DmsModuleREFIterableDMW();

    protected DmsModuleREFIterableDMW(){
        super();
    }

    public DmsModuleREFIterableDMW(Iterator<DmsModuleREF> it){
        super(it);
    }
