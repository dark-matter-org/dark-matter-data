...
import org.dmd.dms.shared.generated.types.RuleDataREF;         // The base type - (DmwFormatter.java:450)
import org.dmd.dmw.DmwMVIterator;                              // The base multi-value iterator - (DmwFormatter.java:453)


/**
 * The RuleDataREFIterableDMW wraps an Iterator for a particular type and makes 
 * it Iterable.
 * <P>
 ...
 */
public class RuleDataREFIterableDMW extends DmwMVIterator<RuleDataREF> {

    public final static RuleDataREFIterableDMW emptyList = new RuleDataREFIterableDMW();

    protected RuleDataREFIterableDMW(){
        super();
    }

    public RuleDataREFIterableDMW(Iterator<RuleDataREF> it){
        super(it);
    }
