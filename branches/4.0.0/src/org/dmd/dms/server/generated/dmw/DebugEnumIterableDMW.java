...
import org.dmd.dms.shared.generated.enums.DebugEnum;         // This is the type we're iterating - (DmwFormatter.java:461)
import org.dmd.dmw.DmwMVIterator;                            // The base multi-value iterator - (DmwFormatter.java:458)


/**
 * The DebugEnumIterableDMW wraps an Iterator for a particular type and makes 
 * it Iterable.
 * <P>
 ...
 */
public class DebugEnumIterableDMW extends DmwMVIterator<DebugEnum> {

    public final static DebugEnumIterableDMW emptyList = new DebugEnumIterableDMW();

    protected DebugEnumIterableDMW(){
        super();
    }

    public DebugEnumIterableDMW(Iterator<DebugEnum> it){
        super(it);
    }
