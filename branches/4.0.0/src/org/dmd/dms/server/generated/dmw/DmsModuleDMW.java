...
public class DmsModuleDMW extends org.dmd.dms.server.extended.DmsDefinition implements DmcNamedObjectIF, DmsModuleScopedInterface  {
    ...
    // Called from: org.dmd.dms.tools.meta.MetaDSDHelper.dumpAdditionalWrapperDefinitions(MetaDSDHelper.java:991)
    ...
    public DmsModuleIterableDMW getDependsOnDmsModule(){
        DmcTypeDmsModuleREFMV attr = (DmcTypeDmsModuleREFMV) mycore.get(MetaCompactSchema.__dependsOnDmsModule);
        if (attr == null)
    ...
    public int getDependsOnDmsModuleSize(){
        DmcAttribute<?> attr = mycore.get(MetaCompactSchema.__dependsOnDmsModule);
        if (attr == null)
            return(0);
        return(attr.getMVSize());
    }
    ...
    // Called from: org.dmd.dms.tools.meta.MetaDSDHelper.dumpAdditionalWrapperFunctions(MetaDSDHelper.java:1019)
    /**
