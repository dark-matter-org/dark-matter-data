...
import org.dmd.dms.shared.generated.types.SchemaDefinitionREF;         // The base type - (DmwFormatter.java:450)
import org.dmd.dmw.DmwMVIterator;                                      // The base multi-value iterator - (DmwFormatter.java:453)


/**
 * The SchemaDefinitionREFIterableDMW wraps an Iterator for a particular type and makes 
 * it Iterable.
 * <P>
 ...
 */
public class SchemaDefinitionREFIterableDMW extends DmwMVIterator<SchemaDefinitionREF> {

    public final static SchemaDefinitionREFIterableDMW emptyList = new SchemaDefinitionREFIterableDMW();

    protected SchemaDefinitionREFIterableDMW(){
        super();
    }

    public SchemaDefinitionREFIterableDMW(Iterator<SchemaDefinitionREF> it){
        super(it);
    }
