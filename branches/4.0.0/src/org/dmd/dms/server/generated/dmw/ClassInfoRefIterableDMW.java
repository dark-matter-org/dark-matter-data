...
import org.dmd.dms.shared.types.ClassInfoRef;         // This is the type we're iterating - (DmwFormatter.java:456)
...
public class ClassInfoRefIterableDMW extends DmwMVIterator<ClassInfoRef> {
    ...
    public final static ClassInfoRefIterableDMW emptyList = new ClassInfoRefIterableDMW();
