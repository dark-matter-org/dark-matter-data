...
import org.dmd.dms.shared.generated.types.SliceDefinitionREF;         // The base type - (DmwFormatter.java:450)
import org.dmd.dmw.DmwMVIterator;                                     // The base multi-value iterator - (DmwFormatter.java:453)


/**
 * The SliceDefinitionREFIterableDMW wraps an Iterator for a particular type and makes 
 * it Iterable.
 * <P>
 ...
 */
public class SliceDefinitionREFIterableDMW extends DmwMVIterator<SliceDefinitionREF> {

    public final static SliceDefinitionREFIterableDMW emptyList = new SliceDefinitionREFIterableDMW();

    protected SliceDefinitionREFIterableDMW(){
        super();
    }

    public SliceDefinitionREFIterableDMW(Iterator<SliceDefinitionREF> it){
        super(it);
    }
