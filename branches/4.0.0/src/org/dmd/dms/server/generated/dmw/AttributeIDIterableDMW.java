...
import org.dmd.dms.shared.types.AttributeID;         // This is the type we're iterating - (DmwFormatter.java:461)
...
public class AttributeIDIterableDMW extends DmwMVIterator<AttributeID> {
    ...
    public final static AttributeIDIterableDMW emptyList = new AttributeIDIterableDMW();
