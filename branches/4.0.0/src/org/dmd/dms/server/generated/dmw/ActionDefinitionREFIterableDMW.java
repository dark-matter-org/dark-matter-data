...
import org.dmd.dms.shared.generated.types.ActionDefinitionREF;         // The base type - (DmwFormatter.java:450)
import org.dmd.dmw.DmwMVIterator;                                      // The base multi-value iterator - (DmwFormatter.java:453)


/**
 * The ActionDefinitionREFIterableDMW wraps an Iterator for a particular type and makes 
 * it Iterable.
 * <P>
 ...
 */
public class ActionDefinitionREFIterableDMW extends DmwMVIterator<ActionDefinitionREF> {

    public final static ActionDefinitionREFIterableDMW emptyList = new ActionDefinitionREFIterableDMW();

    protected ActionDefinitionREFIterableDMW(){
        super();
    }

    public ActionDefinitionREFIterableDMW(Iterator<ActionDefinitionREF> it){
        super(it);
    }
