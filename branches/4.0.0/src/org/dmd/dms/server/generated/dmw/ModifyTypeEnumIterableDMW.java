...
import org.dmd.dms.shared.generated.enums.ModifyTypeEnum;         // This is the type we're iterating - (DmwFormatter.java:461)
import org.dmd.dmw.DmwMVIterator;                                 // The base multi-value iterator - (DmwFormatter.java:458)


/**
 * The ModifyTypeEnumIterableDMW wraps an Iterator for a particular type and makes 
 * it Iterable.
 * <P>
 ...
 */
public class ModifyTypeEnumIterableDMW extends DmwMVIterator<ModifyTypeEnum> {

    public final static ModifyTypeEnumIterableDMW emptyList = new ModifyTypeEnumIterableDMW();

    protected ModifyTypeEnumIterableDMW(){
        super();
    }

    public ModifyTypeEnumIterableDMW(Iterator<ModifyTypeEnum> it){
        super(it);
    }
