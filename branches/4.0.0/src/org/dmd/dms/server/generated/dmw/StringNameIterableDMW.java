...
import org.dmd.dms.shared.types.StringName;         // This is the type we're iterating - (DmwFormatter.java:456)
...
public class StringNameIterableDMW extends DmwMVIterator<StringName> {
    ...
    public final static StringNameIterableDMW emptyList = new StringNameIterableDMW();
