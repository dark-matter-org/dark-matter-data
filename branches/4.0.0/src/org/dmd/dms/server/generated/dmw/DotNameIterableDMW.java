...
import org.dmd.dms.shared.types.DotName;         // This is the type we're iterating - (DmwFormatter.java:456)
...
public class DotNameIterableDMW extends DmwMVIterator<DotName> {
    ...
    public final static DotNameIterableDMW emptyList = new DotNameIterableDMW();
