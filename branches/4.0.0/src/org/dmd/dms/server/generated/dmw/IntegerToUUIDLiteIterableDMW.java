...
import org.dmd.dms.shared.types.IntegerToUUIDLite;         // This is the type we're iterating - (DmwFormatter.java:461)
...
public class IntegerToUUIDLiteIterableDMW extends DmwMVIterator<IntegerToUUIDLite> {
    ...
    public final static IntegerToUUIDLiteIterableDMW emptyList = new IntegerToUUIDLiteIterableDMW();

    protected IntegerToUUIDLiteIterableDMW(){
        super();
    }

    public IntegerToUUIDLiteIterableDMW(Iterator<IntegerToUUIDLite> it){
        super(it);
    }
