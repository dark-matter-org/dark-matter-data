...
import org.dmd.dmp.shared.generated.types.DmcTypeLogoutResponseREFSV;         //  - (AdapterFormatter.java:60)
...
public class LogoutResponseSVAdapter extends DmcTypeLogoutResponseREFSV implements DmcAdapterIF {

    transient DmcTypeLogoutResponseREFSV existingValue;

    public LogoutResponseSVAdapter(DmcAttributeInfo ai){
    	   super(ai);
    }
    ...
    public void setExisting(DmcAttribute<?> attr) {
    	existingValue = (DmcTypeLogoutResponseREFSV) attr;
    	if (existingValue != null)
    		value = existingValue.getSVCopy();
    }
