...
import org.dmd.dmp.shared.generated.types.DmcTypeDenotifyResponseREFSV;         //  - (AdapterFormatter.java:60)
...
public class DenotifyResponseSVAdapter extends DmcTypeDenotifyResponseREFSV implements DmcAdapterIF {
    ...
    public void setExisting(DmcAttribute<?> attr) {
    	existingValue = (DmcTypeDenotifyResponseREFSV) attr;
    	if (existingValue != null)
    		value = existingValue.getSVCopy();
    }
