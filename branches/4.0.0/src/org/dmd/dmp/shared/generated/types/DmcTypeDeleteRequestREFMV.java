...
import org.dmd.dmp.shared.generated.dmo.DeleteRequestDMO;         // DmcType import - (MVTypeFormatter.java:63)
...
public class DmcTypeDeleteRequestREFMV extends DmcTypeDeleteRequestREF implements Serializable {
    ...
    private final static Iterator<DeleteRequestDMO> emptyList = (new ArrayList<DeleteRequestDMO>()).iterator();
    
    protected ArrayList<DeleteRequestDMO> value;
    ...
    public DmcTypeDeleteRequestREFMV getNew(){
        return(new DmcTypeDeleteRequestREFMV(getAttributeInfo()));
    }
    ...
    public DeleteRequestDMO add(Object v) throws DMFeedbackSet {
        synchronized(this){
    ...
    public ArrayList<DeleteRequestDMO> getMVCopy(){
        synchronized(this){
            if (value == null)
                return(new ArrayList<DeleteRequestDMO>());
            else 
                return(new ArrayList<DeleteRequestDMO>(value));
        }
    }
    ...
    public DeleteRequestDMO setMVnth(int index, Object v) throws DMFeedbackSet {
        synchronized(this){
            if (getAttributeInfo().indexSize == 0)
            ...
            if (value == null){
                value = new ArrayList<DeleteRequestDMO>(getAttributeInfo().indexSize);
