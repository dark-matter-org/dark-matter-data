...
import org.dmd.dmp.shared.generated.types.DmcTypeDMPEventREFSET;         //  - (AdapterFormatter.java:60)
...
public class DMPEventSETAdapter extends DmcTypeDMPEventREFSET implements DmcAdapterIF {
    ...
    public void setExisting(DmcAttribute<?> attr) {
    	existingValue = (DmcTypeDMPEventREFSET) attr;
    	if (existingValue != null)
    		value = existingValue.getMVCopy();
    }
