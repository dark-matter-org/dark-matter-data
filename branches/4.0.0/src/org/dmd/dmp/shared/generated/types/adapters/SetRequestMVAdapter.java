...
import org.dmd.dmp.shared.generated.types.DmcTypeSetRequestREFMV;         //  - (AdapterFormatter.java:60)
...
public class SetRequestMVAdapter extends DmcTypeSetRequestREFMV implements DmcAdapterIF {
    ...
    public void setExisting(DmcAttribute<?> attr) {
    	existingValue = (DmcTypeSetRequestREFMV) attr;
    	if (existingValue != null)
    		value = existingValue.getMVCopy();
    }
