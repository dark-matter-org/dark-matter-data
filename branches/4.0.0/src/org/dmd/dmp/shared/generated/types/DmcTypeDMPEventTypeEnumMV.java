...
import org.dmd.dmp.shared.generated.enums.DMPEventTypeEnum;         // DmcType import - (MVTypeFormatter.java:63)
...
public class DmcTypeDMPEventTypeEnumMV extends DmcTypeDMPEventTypeEnum implements Serializable {
    ...
    public DmcTypeDMPEventTypeEnumMV getNew(){
        return(new DmcTypeDMPEventTypeEnumMV(getAttributeInfo()));
    }
    ...
    public DMPEventTypeEnum add(Object v) throws DMFeedbackSet {
        synchronized(this){
    ...
    public DMPEventTypeEnum setMVnth(int index, Object v) throws DMFeedbackSet {
        synchronized(this){
            if (getAttributeInfo().indexSize == 0)
            ...
            if (value == null){
                value = new ArrayList<DMPEventTypeEnum>(getAttributeInfo().indexSize);
