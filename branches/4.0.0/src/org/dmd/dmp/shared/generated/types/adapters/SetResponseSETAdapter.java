...
import org.dmd.dmp.shared.generated.types.DmcTypeSetResponseREFSET;         //  - (AdapterFormatter.java:60)
...
public class SetResponseSETAdapter extends DmcTypeSetResponseREFSET implements DmcAdapterIF {
    ...
    public void setExisting(DmcAttribute<?> attr) {
    	existingValue = (DmcTypeSetResponseREFSET) attr;
    	if (existingValue != null)
    		value = existingValue.getMVCopy();
    }
