...
import org.dmd.dmp.shared.generated.types.DmcTypeDenotifyResponseREFMV;         //  - (AdapterFormatter.java:60)
...
public class DenotifyResponseMVAdapter extends DmcTypeDenotifyResponseREFMV implements DmcAdapterIF {

    transient DmcTypeDenotifyResponseREFMV existingValue;

    public DenotifyResponseMVAdapter(DmcAttributeInfo ai){
    	   super(ai);
    }
    ...
    public void setExisting(DmcAttribute<?> attr) {
    	existingValue = (DmcTypeDenotifyResponseREFMV) attr;
    	if (existingValue != null)
    		value = existingValue.getMVCopy();
    }
