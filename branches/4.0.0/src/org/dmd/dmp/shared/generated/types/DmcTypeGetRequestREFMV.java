...
import org.dmd.dmp.shared.generated.dmo.GetRequestDMO;         // DmcType import - (MVTypeFormatter.java:63)
...
public class DmcTypeGetRequestREFMV extends DmcTypeGetRequestREF implements Serializable {
    ...
    public GetRequestDMO setMVnth(int index, Object v) throws DMFeedbackSet {
        synchronized(this){
            if (getAttributeInfo().indexSize == 0)
