...
import org.dmd.dmp.shared.generated.types.DmcTypeDenotifyRequestREFSET;         //  - (AdapterFormatter.java:60)
...
public class DenotifyRequestSETAdapter extends DmcTypeDenotifyRequestREFSET implements DmcAdapterIF {
    ...
    public void setExisting(DmcAttribute<?> attr) {
    	existingValue = (DmcTypeDenotifyRequestREFSET) attr;
    	if (existingValue != null)
    		value = existingValue.getMVCopy();
    }
