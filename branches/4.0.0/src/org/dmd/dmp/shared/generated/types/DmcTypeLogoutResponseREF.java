...
import org.dmd.dmp.shared.generated.dmo.LogoutResponseDMO;         //  - (DmoTypeFormatter.java:194)
...
abstract public class DmcTypeLogoutResponseREF extends DmcAttribute<LogoutResponseDMO> implements Serializable {
    ...
    protected LogoutResponseDMO typeCheck(Object value) throws DMFeedbackSet {
        if (value instanceof LogoutResponseDMO)
            return((LogoutResponseDMO)value);
        
        throw(new DMFeedbackSet("Object of class: " + value.getClass().getName() + " passed where object compatible with LogoutResponseDMO expected."));
    }

    @Override
    public void serializeValue(DmcOutputStreamIF dos, LogoutResponseDMO value) throws Exception {
        value.serializeIt(dos);
    }

    @Override
    public LogoutResponseDMO deserializeValue(DmcInputStreamIF dis) throws Exception {
        LogoutResponseDMO rc = (LogoutResponseDMO)dis.getDMOInstance(dis);
        rc.deserializeIt(dis);
        return(rc);
    }

    @Override
    public LogoutResponseDMO cloneValue(LogoutResponseDMO value){
        return((LogoutResponseDMO)value.cloneIt());
    }
