...
import org.dmd.dmp.shared.generated.types.DmcTypeNotifyRequestREFSV;         //  - (AdapterFormatter.java:60)
...
public class NotifyRequestSVAdapter extends DmcTypeNotifyRequestREFSV implements DmcAdapterIF {

    transient DmcTypeNotifyRequestREFSV existingValue;

    public NotifyRequestSVAdapter(DmcAttributeInfo ai){
    	   super(ai);
    }
    ...
    public void setExisting(DmcAttribute<?> attr) {
    	existingValue = (DmcTypeNotifyRequestREFSV) attr;
    	if (existingValue != null)
    		value = existingValue.getSVCopy();
    }
