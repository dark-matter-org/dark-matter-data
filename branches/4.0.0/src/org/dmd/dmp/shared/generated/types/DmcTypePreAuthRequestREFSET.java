...
import org.dmd.dmp.shared.generated.dmo.PreAuthRequestDMO;         // DmcType import - (SETTypeFormatter.java:59)
...
public class DmcTypePreAuthRequestREFSET extends DmcTypePreAuthRequestREF implements Serializable {
    ...
    public DmcTypePreAuthRequestREFSET getNew(){
        return(new DmcTypePreAuthRequestREFSET(getAttributeInfo()));
    }
