...
import org.dmd.dmp.shared.generated.types.DmcTypeLoginRequestREFSV;         //  - (AdapterFormatter.java:60)
...
public class LoginRequestSVAdapter extends DmcTypeLoginRequestREFSV implements DmcAdapterIF {

    transient DmcTypeLoginRequestREFSV existingValue;

    public LoginRequestSVAdapter(DmcAttributeInfo ai){
    	   super(ai);
    }
    ...
    public void setExisting(DmcAttribute<?> attr) {
    	existingValue = (DmcTypeLoginRequestREFSV) attr;
    	if (existingValue != null)
    		value = existingValue.getSVCopy();
    }
