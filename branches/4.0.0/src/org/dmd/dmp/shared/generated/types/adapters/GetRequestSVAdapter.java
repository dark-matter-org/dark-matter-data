...
import org.dmd.dmp.shared.generated.types.DmcTypeGetRequestREFSV;         //  - (AdapterFormatter.java:60)
...
public class GetRequestSVAdapter extends DmcTypeGetRequestREFSV implements DmcAdapterIF {

    transient DmcTypeGetRequestREFSV existingValue;

    public GetRequestSVAdapter(DmcAttributeInfo ai){
    	   super(ai);
    }
    ...
    public void setExisting(DmcAttribute<?> attr) {
    	existingValue = (DmcTypeGetRequestREFSV) attr;
    	if (existingValue != null)
    		value = existingValue.getSVCopy();
    }
