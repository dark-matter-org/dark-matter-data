...
import org.dmd.dmp.shared.generated.types.DmcTypePreAuthRequestREFSET;         //  - (AdapterFormatter.java:60)
...
public class PreAuthRequestSETAdapter extends DmcTypePreAuthRequestREFSET implements DmcAdapterIF {

    transient DmcTypePreAuthRequestREFSET existingValue;

    public PreAuthRequestSETAdapter(DmcAttributeInfo ai){
    	   super(ai);
    }
    ...
    public void setExisting(DmcAttribute<?> attr) {
    	existingValue = (DmcTypePreAuthRequestREFSET) attr;
    	if (existingValue != null)
    		value = existingValue.getMVCopy();
    }
