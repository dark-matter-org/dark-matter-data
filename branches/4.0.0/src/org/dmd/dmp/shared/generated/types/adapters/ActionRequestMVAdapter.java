...
import org.dmd.dmp.shared.generated.types.DmcTypeActionRequestREFMV;         //  - (AdapterFormatter.java:60)
...
public class ActionRequestMVAdapter extends DmcTypeActionRequestREFMV implements DmcAdapterIF {

    transient DmcTypeActionRequestREFMV existingValue;

    public ActionRequestMVAdapter(DmcAttributeInfo ai){
    	   super(ai);
    }
    ...
    public void setExisting(DmcAttribute<?> attr) {
    	existingValue = (DmcTypeActionRequestREFMV) attr;
    	if (existingValue != null)
    		value = existingValue.getMVCopy();
    }
