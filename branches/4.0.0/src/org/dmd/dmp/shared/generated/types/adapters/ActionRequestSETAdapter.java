...
import org.dmd.dmp.shared.generated.types.DmcTypeActionRequestREFSET;         //  - (AdapterFormatter.java:60)
...
public class ActionRequestSETAdapter extends DmcTypeActionRequestREFSET implements DmcAdapterIF {
    ...
    public void setExisting(DmcAttribute<?> attr) {
    	existingValue = (DmcTypeActionRequestREFSET) attr;
    	if (existingValue != null)
    		value = existingValue.getMVCopy();
    }
