...
import org.dmd.dmp.shared.generated.types.DmcTypeResponseCategoryEnumSV;         //  - (AdapterFormatter.java:60)
...
public class ResponseCategoryEnumSVAdapter extends DmcTypeResponseCategoryEnumSV implements DmcAdapterIF {
    ...
    public void setExisting(DmcAttribute<?> attr) {
    	existingValue = (DmcTypeResponseCategoryEnumSV) attr;
    	if (existingValue != null)
    		value = existingValue.getSVCopy();
    }
