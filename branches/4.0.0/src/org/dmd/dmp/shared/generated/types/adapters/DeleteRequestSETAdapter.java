...
import org.dmd.dmp.shared.generated.types.DmcTypeDeleteRequestREFSET;         //  - (AdapterFormatter.java:60)
...
public class DeleteRequestSETAdapter extends DmcTypeDeleteRequestREFSET implements DmcAdapterIF {
    ...
    public void setExisting(DmcAttribute<?> attr) {
    	existingValue = (DmcTypeDeleteRequestREFSET) attr;
    	if (existingValue != null)
    		value = existingValue.getMVCopy();
    }
