...
import org.dmd.dmp.shared.generated.dmo.DeleteRequestDMO;         //  - (DmoTypeFormatter.java:194)
...
abstract public class DmcTypeDeleteRequestREF extends DmcAttribute<DeleteRequestDMO> implements Serializable {
    ...
    protected DeleteRequestDMO typeCheck(Object value) throws DMFeedbackSet {
        if (value instanceof DeleteRequestDMO)
            return((DeleteRequestDMO)value);
        
        throw(new DMFeedbackSet("Object of class: " + value.getClass().getName() + " passed where object compatible with DeleteRequestDMO expected."));
    }
    ...
    public DeleteRequestDMO deserializeValue(DmcInputStreamIF dis) throws Exception {
        DeleteRequestDMO rc = (DeleteRequestDMO)dis.getDMOInstance(dis);
