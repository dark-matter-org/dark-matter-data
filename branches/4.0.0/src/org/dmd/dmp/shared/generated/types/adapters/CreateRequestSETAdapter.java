...
import org.dmd.dmp.shared.generated.types.DmcTypeCreateRequestREFSET;         //  - (AdapterFormatter.java:60)
...
public class CreateRequestSETAdapter extends DmcTypeCreateRequestREFSET implements DmcAdapterIF {
    ...
    public void setExisting(DmcAttribute<?> attr) {
    	existingValue = (DmcTypeCreateRequestREFSET) attr;
    	if (existingValue != null)
    		value = existingValue.getMVCopy();
    }
