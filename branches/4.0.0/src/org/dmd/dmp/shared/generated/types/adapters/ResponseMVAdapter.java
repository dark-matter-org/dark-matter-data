...
import org.dmd.dmp.shared.generated.types.DmcTypeResponseREFMV;         //  - (AdapterFormatter.java:60)
...
public class ResponseMVAdapter extends DmcTypeResponseREFMV implements DmcAdapterIF {

    transient DmcTypeResponseREFMV existingValue;

    public ResponseMVAdapter(DmcAttributeInfo ai){
    	   super(ai);
    }
    ...
    public void setExisting(DmcAttribute<?> attr) {
    	existingValue = (DmcTypeResponseREFMV) attr;
    	if (existingValue != null)
    		value = existingValue.getMVCopy();
    }
