...
import org.dmd.dmp.shared.generated.types.DmcTypeDeleteResponseREFSET;         //  - (AdapterFormatter.java:60)
...
public class DeleteResponseSETAdapter extends DmcTypeDeleteResponseREFSET implements DmcAdapterIF {
    ...
    public void setExisting(DmcAttribute<?> attr) {
    	existingValue = (DmcTypeDeleteResponseREFSET) attr;
    	if (existingValue != null)
    		value = existingValue.getMVCopy();
    }
