...
import org.dmd.dmp.shared.generated.types.DmcTypeDenotifyResponseREFSET;         //  - (AdapterFormatter.java:60)
...
public class DenotifyResponseSETAdapter extends DmcTypeDenotifyResponseREFSET implements DmcAdapterIF {
    ...
    public void setExisting(DmcAttribute<?> attr) {
    	existingValue = (DmcTypeDenotifyResponseREFSET) attr;
    	if (existingValue != null)
    		value = existingValue.getMVCopy();
    }
