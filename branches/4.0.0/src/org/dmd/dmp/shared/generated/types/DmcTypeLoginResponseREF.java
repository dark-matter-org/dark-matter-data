...
import org.dmd.dmp.shared.generated.dmo.LoginResponseDMO;         //  - (DmoTypeFormatter.java:194)
...
abstract public class DmcTypeLoginResponseREF extends DmcAttribute<LoginResponseDMO> implements Serializable {
    ...
    protected LoginResponseDMO typeCheck(Object value) throws DMFeedbackSet {
        if (value instanceof LoginResponseDMO)
            return((LoginResponseDMO)value);
        
        throw(new DMFeedbackSet("Object of class: " + value.getClass().getName() + " passed where object compatible with LoginResponseDMO expected."));
    }
