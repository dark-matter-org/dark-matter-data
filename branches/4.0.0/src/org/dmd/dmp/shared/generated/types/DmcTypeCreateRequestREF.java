...
import org.dmd.dmp.shared.generated.dmo.CreateRequestDMO;         //  - (DmoTypeFormatter.java:194)
...
abstract public class DmcTypeCreateRequestREF extends DmcAttribute<CreateRequestDMO> implements Serializable {
    ...
    protected CreateRequestDMO typeCheck(Object value) throws DMFeedbackSet {
        if (value instanceof CreateRequestDMO)
            return((CreateRequestDMO)value);
        
        throw(new DMFeedbackSet("Object of class: " + value.getClass().getName() + " passed where object compatible with CreateRequestDMO expected."));
    }

    @Override
    public void serializeValue(DmcOutputStreamIF dos, CreateRequestDMO value) throws Exception {
        value.serializeIt(dos);
    }

    @Override
    public CreateRequestDMO deserializeValue(DmcInputStreamIF dis) throws Exception {
        CreateRequestDMO rc = (CreateRequestDMO)dis.getDMOInstance(dis);
        rc.deserializeIt(dis);
        return(rc);
    }

    @Override
    public CreateRequestDMO cloneValue(CreateRequestDMO value){
        return((CreateRequestDMO)value.cloneIt());
    }
