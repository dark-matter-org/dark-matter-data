...
import org.dmd.dmp.shared.generated.enums.ResponseFormatEnum;         // DmcType import - (SVTypeFormatter.java:65)
...
public class DmcTypeResponseFormatEnumSV extends DmcTypeResponseFormatEnum implements Serializable {
    ...
    protected ResponseFormatEnum value;
    ...
    public DmcTypeResponseFormatEnumSV getNew(DmcAttributeInfo ai){
        return(new DmcTypeResponseFormatEnumSV(ai));
    }
    ...
    public ResponseFormatEnum set(Object v) throws DMFeedbackSet {
