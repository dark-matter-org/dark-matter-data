...
import org.dmd.dmp.shared.generated.dmo.DenotifyRequestDMO;         // DmcType import - (SETTypeFormatter.java:59)
...
public class DmcTypeDenotifyRequestREFSET extends DmcTypeDenotifyRequestREF implements Serializable {
     ...
     private final static Iterator<DenotifyRequestDMO> emptyList =  (new HashSet<DenotifyRequestDMO>()).iterator();
    ...
    public Set<DenotifyRequestDMO> getMVCopy(){
        synchronized(this){
            if (getAttributeInfo().valueType == ValueTypeEnum.HASHSET){
                if (value == null)
                    return(new HashSet<DenotifyRequestDMO>());
                else
