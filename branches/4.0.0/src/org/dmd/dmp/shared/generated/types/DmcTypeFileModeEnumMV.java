...
import org.dmd.dmp.shared.generated.enums.FileModeEnum;         // DmcType import - (MVTypeFormatter.java:63)
...
public class DmcTypeFileModeEnumMV extends DmcTypeFileModeEnum implements Serializable {
    ...
    private final static Iterator<FileModeEnum> emptyList = (new ArrayList<FileModeEnum>()).iterator();
    ...
    public ArrayList<FileModeEnum> getMVCopy(){
        synchronized(this){
            if (value == null)
                return(new ArrayList<FileModeEnum>());
            else 
                return(new ArrayList<FileModeEnum>(value));
        }
    }
    ...
    public FileModeEnum setMVnth(int index, Object v) throws DMFeedbackSet {
        synchronized(this){
            if (getAttributeInfo().indexSize == 0)
            ...
            if (value == null){
                value = new ArrayList<FileModeEnum>(getAttributeInfo().indexSize);
