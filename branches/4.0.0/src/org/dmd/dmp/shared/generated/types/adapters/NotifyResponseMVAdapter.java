...
import org.dmd.dmp.shared.generated.types.DmcTypeNotifyResponseREFMV;         //  - (AdapterFormatter.java:60)
...
public class NotifyResponseMVAdapter extends DmcTypeNotifyResponseREFMV implements DmcAdapterIF {

    transient DmcTypeNotifyResponseREFMV existingValue;

    public NotifyResponseMVAdapter(DmcAttributeInfo ai){
    	   super(ai);
    }
    ...
    public void setExisting(DmcAttribute<?> attr) {
    	existingValue = (DmcTypeNotifyResponseREFMV) attr;
    	if (existingValue != null)
    		value = existingValue.getMVCopy();
    }
