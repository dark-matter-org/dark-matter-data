...
import org.dmd.dmp.shared.generated.dmo.ActionRequestDMO;         //  - (DmoTypeFormatter.java:194)
...
abstract public class DmcTypeActionRequestREF extends DmcAttribute<ActionRequestDMO> implements Serializable {
    ...
    protected ActionRequestDMO typeCheck(Object value) throws DMFeedbackSet {
        if (value instanceof ActionRequestDMO)
            return((ActionRequestDMO)value);
        
        throw(new DMFeedbackSet("Object of class: " + value.getClass().getName() + " passed where object compatible with ActionRequestDMO expected."));
    }

    @Override
    public void serializeValue(DmcOutputStreamIF dos, ActionRequestDMO value) throws Exception {
    ...
    @Override
    public ActionRequestDMO cloneValue(ActionRequestDMO value){
        return((ActionRequestDMO)value.cloneIt());
    }
