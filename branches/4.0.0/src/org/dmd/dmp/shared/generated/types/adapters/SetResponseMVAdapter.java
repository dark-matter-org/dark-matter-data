...
import org.dmd.dmp.shared.generated.types.DmcTypeSetResponseREFMV;         //  - (AdapterFormatter.java:60)
...
public class SetResponseMVAdapter extends DmcTypeSetResponseREFMV implements DmcAdapterIF {

    transient DmcTypeSetResponseREFMV existingValue;

    public SetResponseMVAdapter(DmcAttributeInfo ai){
    	   super(ai);
    }
    ...
    public void setExisting(DmcAttribute<?> attr) {
    	existingValue = (DmcTypeSetResponseREFMV) attr;
    	if (existingValue != null)
    		value = existingValue.getMVCopy();
    }
