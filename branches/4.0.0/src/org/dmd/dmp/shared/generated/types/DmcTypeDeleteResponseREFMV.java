...
import org.dmd.dmp.shared.generated.dmo.DeleteResponseDMO;         // DmcType import - (MVTypeFormatter.java:63)
...
public class DmcTypeDeleteResponseREFMV extends DmcTypeDeleteResponseREF implements Serializable {
    ...
    public DmcTypeDeleteResponseREFMV getNew(){
        return(new DmcTypeDeleteResponseREFMV(getAttributeInfo()));
    }
    ...
    public DeleteResponseDMO setMVnth(int index, Object v) throws DMFeedbackSet {
        synchronized(this){
            if (getAttributeInfo().indexSize == 0)
            ...
            if (value == null){
                value = new ArrayList<DeleteResponseDMO>(getAttributeInfo().indexSize);
