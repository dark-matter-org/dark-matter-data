...
import org.dmd.dmp.shared.generated.dmo.NotifyRequestDMO;         //  - (DmoTypeFormatter.java:194)
...
abstract public class DmcTypeNotifyRequestREF extends DmcAttribute<NotifyRequestDMO> implements Serializable {
    ...
    protected NotifyRequestDMO typeCheck(Object value) throws DMFeedbackSet {
        if (value instanceof NotifyRequestDMO)
            return((NotifyRequestDMO)value);
        
        throw(new DMFeedbackSet("Object of class: " + value.getClass().getName() + " passed where object compatible with NotifyRequestDMO expected."));
    }

    @Override
    public void serializeValue(DmcOutputStreamIF dos, NotifyRequestDMO value) throws Exception {
        value.serializeIt(dos);
    }

    @Override
    public NotifyRequestDMO deserializeValue(DmcInputStreamIF dis) throws Exception {
        NotifyRequestDMO rc = (NotifyRequestDMO)dis.getDMOInstance(dis);
        rc.deserializeIt(dis);
        return(rc);
    }

    @Override
    public NotifyRequestDMO cloneValue(NotifyRequestDMO value){
        return((NotifyRequestDMO)value.cloneIt());
    }
