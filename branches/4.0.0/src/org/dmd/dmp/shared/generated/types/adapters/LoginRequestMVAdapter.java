...
import org.dmd.dmp.shared.generated.types.DmcTypeLoginRequestREFMV;         //  - (AdapterFormatter.java:60)
...
public class LoginRequestMVAdapter extends DmcTypeLoginRequestREFMV implements DmcAdapterIF {
    ...
    public void setExisting(DmcAttribute<?> attr) {
    	existingValue = (DmcTypeLoginRequestREFMV) attr;
    	if (existingValue != null)
    		value = existingValue.getMVCopy();
    }
