...
import org.dmd.dmp.shared.generated.types.DmcTypeLoginResponseREFSET;         //  - (AdapterFormatter.java:60)
...
public class LoginResponseSETAdapter extends DmcTypeLoginResponseREFSET implements DmcAdapterIF {
    ...
    public void setExisting(DmcAttribute<?> attr) {
    	existingValue = (DmcTypeLoginResponseREFSET) attr;
    	if (existingValue != null)
    		value = existingValue.getMVCopy();
    }
