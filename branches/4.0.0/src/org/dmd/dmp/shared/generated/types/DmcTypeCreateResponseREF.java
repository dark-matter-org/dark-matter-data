...
import org.dmd.dmp.shared.generated.dmo.CreateResponseDMO;         //  - (DmoTypeFormatter.java:194)
...
abstract public class DmcTypeCreateResponseREF extends DmcAttribute<CreateResponseDMO> implements Serializable {
    ...
    protected CreateResponseDMO typeCheck(Object value) throws DMFeedbackSet {
        if (value instanceof CreateResponseDMO)
            return((CreateResponseDMO)value);
        
        throw(new DMFeedbackSet("Object of class: " + value.getClass().getName() + " passed where object compatible with CreateResponseDMO expected."));
    }
