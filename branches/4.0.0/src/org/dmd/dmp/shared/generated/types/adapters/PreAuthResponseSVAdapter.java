...
import org.dmd.dmp.shared.generated.types.DmcTypePreAuthResponseREFSV;         //  - (AdapterFormatter.java:60)
...
public class PreAuthResponseSVAdapter extends DmcTypePreAuthResponseREFSV implements DmcAdapterIF {

    transient DmcTypePreAuthResponseREFSV existingValue;

    public PreAuthResponseSVAdapter(DmcAttributeInfo ai){
    	   super(ai);
    }
    ...
    public void setExisting(DmcAttribute<?> attr) {
    	existingValue = (DmcTypePreAuthResponseREFSV) attr;
    	if (existingValue != null)
    		value = existingValue.getSVCopy();
    }
