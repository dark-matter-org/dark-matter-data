...
import org.dmd.dmp.shared.generated.types.DmcTypeCreateResponseREFSET;         //  - (AdapterFormatter.java:60)
...
public class CreateResponseSETAdapter extends DmcTypeCreateResponseREFSET implements DmcAdapterIF {

    transient DmcTypeCreateResponseREFSET existingValue;

    public CreateResponseSETAdapter(DmcAttributeInfo ai){
    	   super(ai);
    }
    ...
    public void setExisting(DmcAttribute<?> attr) {
    	existingValue = (DmcTypeCreateResponseREFSET) attr;
    	if (existingValue != null)
    		value = existingValue.getMVCopy();
    }
