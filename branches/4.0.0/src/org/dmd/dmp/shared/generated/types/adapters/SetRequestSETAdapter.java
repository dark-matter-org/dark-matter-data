...
import org.dmd.dmp.shared.generated.types.DmcTypeSetRequestREFSET;         //  - (AdapterFormatter.java:60)
...
public class SetRequestSETAdapter extends DmcTypeSetRequestREFSET implements DmcAdapterIF {

    transient DmcTypeSetRequestREFSET existingValue;

    public SetRequestSETAdapter(DmcAttributeInfo ai){
    	   super(ai);
    }
    ...
    public void setExisting(DmcAttribute<?> attr) {
    	existingValue = (DmcTypeSetRequestREFSET) attr;
    	if (existingValue != null)
    		value = existingValue.getMVCopy();
    }
