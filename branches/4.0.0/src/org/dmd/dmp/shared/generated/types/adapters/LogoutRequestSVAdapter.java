...
import org.dmd.dmp.shared.generated.types.DmcTypeLogoutRequestREFSV;         //  - (AdapterFormatter.java:60)
...
public class LogoutRequestSVAdapter extends DmcTypeLogoutRequestREFSV implements DmcAdapterIF {
    ...
    public void setExisting(DmcAttribute<?> attr) {
    	existingValue = (DmcTypeLogoutRequestREFSV) attr;
    	if (existingValue != null)
    		value = existingValue.getSVCopy();
    }
