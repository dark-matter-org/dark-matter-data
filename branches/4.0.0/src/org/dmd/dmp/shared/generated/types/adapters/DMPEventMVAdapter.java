...
import org.dmd.dmp.shared.generated.types.DmcTypeDMPEventREFMV;         //  - (AdapterFormatter.java:60)
...
public class DMPEventMVAdapter extends DmcTypeDMPEventREFMV implements DmcAdapterIF {
    ...
    public void setExisting(DmcAttribute<?> attr) {
    	existingValue = (DmcTypeDMPEventREFMV) attr;
    	if (existingValue != null)
    		value = existingValue.getMVCopy();
    }
