...
import org.dmd.dmp.shared.generated.dmo.PreAuthRequestDMO;         //  - (DmoTypeFormatter.java:194)
...
abstract public class DmcTypePreAuthRequestREF extends DmcAttribute<PreAuthRequestDMO> implements Serializable {

    public DmcTypePreAuthRequestREF(){
    }

    public DmcTypePreAuthRequestREF(DmcAttributeInfo ai){
        super(ai);
    }

    protected PreAuthRequestDMO typeCheck(Object value) throws DMFeedbackSet {
        if (value instanceof PreAuthRequestDMO)
            return((PreAuthRequestDMO)value);
        
        throw(new DMFeedbackSet("Object of class: " + value.getClass().getName() + " passed where object compatible with PreAuthRequestDMO expected."));
    }

    @Override
    public void serializeValue(DmcOutputStreamIF dos, PreAuthRequestDMO value) throws Exception {
        value.serializeIt(dos);
    }

    @Override
    public PreAuthRequestDMO deserializeValue(DmcInputStreamIF dis) throws Exception {
        PreAuthRequestDMO rc = (PreAuthRequestDMO)dis.getDMOInstance(dis);
        rc.deserializeIt(dis);
        return(rc);
    }

    @Override
    public PreAuthRequestDMO cloneValue(PreAuthRequestDMO value){
        return((PreAuthRequestDMO)value.cloneIt());
    }
