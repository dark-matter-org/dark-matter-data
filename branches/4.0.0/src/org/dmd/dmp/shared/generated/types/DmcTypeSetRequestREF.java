...
import org.dmd.dmp.shared.generated.dmo.SetRequestDMO;         //  - (DmoTypeFormatter.java:194)
...
abstract public class DmcTypeSetRequestREF extends DmcAttribute<SetRequestDMO> implements Serializable {
    ...
    protected SetRequestDMO typeCheck(Object value) throws DMFeedbackSet {
        if (value instanceof SetRequestDMO)
            return((SetRequestDMO)value);
        
        throw(new DMFeedbackSet("Object of class: " + value.getClass().getName() + " passed where object compatible with SetRequestDMO expected."));
    }
