...
import org.dmd.dmp.shared.generated.types.DmcTypeLoginResponseREFMV;         //  - (AdapterFormatter.java:60)
...
public class LoginResponseMVAdapter extends DmcTypeLoginResponseREFMV implements DmcAdapterIF {

    transient DmcTypeLoginResponseREFMV existingValue;

    public LoginResponseMVAdapter(DmcAttributeInfo ai){
    	   super(ai);
    }
    ...
    public void setExisting(DmcAttribute<?> attr) {
    	existingValue = (DmcTypeLoginResponseREFMV) attr;
    	if (existingValue != null)
    		value = existingValue.getMVCopy();
    }
