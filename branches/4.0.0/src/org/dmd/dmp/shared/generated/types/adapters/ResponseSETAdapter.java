...
import org.dmd.dmp.shared.generated.types.DmcTypeResponseREFSET;         //  - (AdapterFormatter.java:60)
...
public class ResponseSETAdapter extends DmcTypeResponseREFSET implements DmcAdapterIF {

    transient DmcTypeResponseREFSET existingValue;

    public ResponseSETAdapter(DmcAttributeInfo ai){
    	   super(ai);
    }
    ...
    public void setExisting(DmcAttribute<?> attr) {
    	existingValue = (DmcTypeResponseREFSET) attr;
    	if (existingValue != null)
    		value = existingValue.getMVCopy();
    }
