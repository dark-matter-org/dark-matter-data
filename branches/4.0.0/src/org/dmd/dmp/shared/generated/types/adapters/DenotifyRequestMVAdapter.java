...
import org.dmd.dmp.shared.generated.types.DmcTypeDenotifyRequestREFMV;         //  - (AdapterFormatter.java:60)
...
public class DenotifyRequestMVAdapter extends DmcTypeDenotifyRequestREFMV implements DmcAdapterIF {
    ...
    public void setExisting(DmcAttribute<?> attr) {
    	existingValue = (DmcTypeDenotifyRequestREFMV) attr;
    	if (existingValue != null)
    		value = existingValue.getMVCopy();
    }
