...
import org.dmd.dmp.shared.generated.dmo.LoginResponseDMO;         // DmcType import - (SVTypeFormatter.java:65)
...
public class DmcTypeLoginResponseREFSV extends DmcTypeLoginResponseREF implements Serializable {
    ...
    protected LoginResponseDMO value;
    ...
    public DmcTypeLoginResponseREFSV getNew(){
        return(new DmcTypeLoginResponseREFSV(getAttributeInfo()));
    }
    ...
    public LoginResponseDMO getSVCopy(){
        if (value == null)
            return(null);
    ...
    public LoginResponseDMO set(Object v) throws DMFeedbackSet {
