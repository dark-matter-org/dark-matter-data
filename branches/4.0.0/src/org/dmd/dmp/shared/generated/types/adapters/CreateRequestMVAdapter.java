...
import org.dmd.dmp.shared.generated.types.DmcTypeCreateRequestREFMV;         //  - (AdapterFormatter.java:60)
...
public class CreateRequestMVAdapter extends DmcTypeCreateRequestREFMV implements DmcAdapterIF {

    transient DmcTypeCreateRequestREFMV existingValue;

    public CreateRequestMVAdapter(DmcAttributeInfo ai){
    	   super(ai);
    }
    ...
    public void setExisting(DmcAttribute<?> attr) {
    	existingValue = (DmcTypeCreateRequestREFMV) attr;
    	if (existingValue != null)
    		value = existingValue.getMVCopy();
    }
