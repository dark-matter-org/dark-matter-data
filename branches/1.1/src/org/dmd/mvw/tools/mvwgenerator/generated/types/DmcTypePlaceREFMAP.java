...
public class DmcTypePlaceREFMAP extends DmcTypePlaceREF implements Serializable {
    ...
    public DmcTypePlaceREFMAP(){
        value = null;
    }
    
    public DmcTypePlaceREFMAP(DmcAttributeInfo ai){
        super(ai);
        initValue();
    }
    ...
    void initValue(){
        if (attrInfo.valueType == ValueTypeEnum.HASHMAPPED)
            value = new HashMap<CamelCaseName,PlaceREF>();
        else
            value = new TreeMap<CamelCaseName,PlaceREF>();
    }
    ...
    public CamelCaseName firstKey(){
        if (attrInfo.valueType == ValueTypeEnum.TREEMAPPED){
            if (value == null)
                return(null);
            TreeMap<CamelCaseName,PlaceREF> map = (TreeMap<CamelCaseName,PlaceREF>)value;
            return(map.firstKey());
        }
    ...
    @Override
    public DmcTypePlaceREFMAP getNew(){
        return(new DmcTypePlaceREFMAP(attrInfo));
    }
    ...
    public PlaceREF add(Object v) throws DmcValueException {
        synchronized(this){
            ...
            PlaceREF oldval = value.put(key,newval);
