...
// Called from: org.dmd.dms.util.GenUtility.dumpExtendedReferenceTypeDmcType(GenUtility.java:3193)
import org.dmd.dmc.DmcAttributeInfo;                            // Standard attribute interface - (GenUtility.java:3181)
import org.dmd.dmc.DmcInputStreamIF;                            // Serialization support - (GenUtility.java:3178)
import org.dmd.dmc.DmcOutputStreamIF;                           // Serialization support - (GenUtility.java:3179)
import org.dmd.dmc.DmcValueException;                           // Value exceptions - (GenUtility.java:3182)
import org.dmd.dmc.types.DmcTypeNamedObjectREF;                 // The class we extend - (GenUtility.java:3183)
import org.dmd.dmc.types.StringName;                            // Name type - (GenUtility.java:3187)
import org.dmd.dmt.shared.generated.dmo.ObjWithRefsDMO;         // The class we refer to - (GenUtility.java:3185)
 ...
 * Generated from: org.dmd.dms.util.GenUtility.dumpExtendedReferenceTypeDmcType(GenUtility.java:3216)
