...
import org.dmd.mvw.tools.mvwgenerator.generated.dmo.MenuItemDMO; // primitive type
...
public class MenuItemREF extends DmcNamedObjectNontransportableREF<MenuItemDMO> {
    ...
    public MenuItemREF(MenuItemDMO o){
         object = o;
         myName = (DmcTypeCamelCaseNameSV)o.getObjectNameAttribute();
    }

    public MenuItemREF(CamelCaseName n) throws DmcValueException {
         object = null;
         myName = new DmcTypeCamelCaseNameSV(__elementName);
         myName.set(n);
    }

    public MenuItemREF(String n) throws DmcValueException {
         object = null;
         myName = new DmcTypeCamelCaseNameSV(__elementName);
         myName.set(n);
    }

    public MenuItemREF(MenuItemREF original){
        myName = original.myName;
        object = original.object;
    }

    public void setObject(MenuItemDMO o){
         object = o;
         if (object != null)
             myName = (DmcTypeCamelCaseNameSV)o.getObjectNameAttribute();
    }
