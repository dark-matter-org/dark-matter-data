...
public class DmcTypeAttributeDefinitionREFMV extends DmcTypeAttributeDefinitionREF implements Serializable {
    ...
    private final static Iterator<AttributeDefinitionREF> emptyList = (new ArrayList<AttributeDefinitionREF>()).iterator();
    
    protected ArrayList<AttributeDefinitionREF> value;
    ...
    public DmcTypeAttributeDefinitionREFMV getNew(){
        return(new DmcTypeAttributeDefinitionREFMV(getAttributeInfo()));
    }
    ...
    public AttributeDefinitionREF del(Object v){
        synchronized(this){
            ...
            AttributeDefinitionREF key = null;
    ...
    public ArrayList<AttributeDefinitionREF> getMVCopy(){
        synchronized(this){
            if (value == null)
                return(new ArrayList<AttributeDefinitionREF>());
            else 
                return(new ArrayList<AttributeDefinitionREF>(value));
        }
    }
    ...
    public AttributeDefinitionREF getMVnth(int index){
        synchronized(this){
            if (value == null)
                return(null);
    ...
    public AttributeDefinitionREF setMVnth(int index, Object v) throws DmcValueException {
        synchronized(this){
            if (getAttributeInfo().indexSize == 0)
            ...
            if (value == null){
                value = new ArrayList<AttributeDefinitionREF>(getAttributeInfo().indexSize);
