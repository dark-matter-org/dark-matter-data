...
public class DmcTypeSliceDefinitionREFMV extends DmcTypeSliceDefinitionREF implements Serializable {
    ...
    private final static Iterator<SliceDefinitionREF> emptyList = (new ArrayList<SliceDefinitionREF>()).iterator();
    
    protected ArrayList<SliceDefinitionREF> value;
    ...
    public DmcTypeSliceDefinitionREFMV getNew(){
        return(new DmcTypeSliceDefinitionREFMV(getAttributeInfo()));
    }
    ...
    public ArrayList<SliceDefinitionREF> getMVCopy(){
        synchronized(this){
            if (value == null)
                return(new ArrayList<SliceDefinitionREF>());
            else 
                return(new ArrayList<SliceDefinitionREF>(value));
        }
    }
    ...
    public SliceDefinitionREF setMVnth(int index, Object v) throws DmcValueException {
        synchronized(this){
            ...
            if (value == null){
                value = new ArrayList<SliceDefinitionREF>(getAttributeInfo().indexSize);
