...
public class DmcTypeSchemaDefinitionREFMV extends DmcTypeSchemaDefinitionREF implements Serializable {
    ...
    private final static Iterator<SchemaDefinitionREF> emptyList = (new ArrayList<SchemaDefinitionREF>()).iterator();
    
    protected ArrayList<SchemaDefinitionREF> value;
    ...
    public DmcTypeSchemaDefinitionREFMV getNew(){
        return(new DmcTypeSchemaDefinitionREFMV(getAttributeInfo()));
    }
    ...
    public ArrayList<SchemaDefinitionREF> getMVCopy(){
        synchronized(this){
            if (value == null)
                return(new ArrayList<SchemaDefinitionREF>());
            else 
                return(new ArrayList<SchemaDefinitionREF>(value));
        }
    }
    ...
    public SchemaDefinitionREF setMVnth(int index, Object v) throws DmcValueException {
        synchronized(this){
            ...
            if (value == null){
                value = new ArrayList<SchemaDefinitionREF>(getAttributeInfo().indexSize);
