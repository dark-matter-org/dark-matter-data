...
// Called from: org.dmd.dms.meta.MetaGenerator.dumpComplexType(MetaGenerator.java:3184)
import java.io.Serializable;                                  // Marker interface for serialization - (MetaGenerator.java:3161)
import org.dmd.dmc.DmcAttributeInfo;                          // For fake DmcAttributeInfo - (MetaGenerator.java:3167)
import org.dmd.dmc.DmcContainerIF;                            // Reference resolution - (MetaGenerator.java:3175)
import org.dmd.dmc.DmcInputStreamIF;                          // To support serialization - (MetaGenerator.java:3162)
import org.dmd.dmc.DmcNameClashResolverIF;                    // Ambiguous reference resolution - (MetaGenerator.java:3171)
import org.dmd.dmc.DmcNameResolverIF;                         // Reference resolution - (MetaGenerator.java:3172)
import org.dmd.dmc.DmcNameResolverWithClashSupportIF;         // Ambiguous reference resolution - (MetaGenerator.java:3170)
import org.dmd.dmc.DmcNamedObjectIF;                          // Reference resolution - (MetaGenerator.java:3173)
import org.dmd.dmc.DmcNamedObjectREF;                         // Reference resolution - (MetaGenerator.java:3174)
import org.dmd.dmc.DmcObject;                                 // Ambiguous reference resolution - (MetaGenerator.java:3176)
import org.dmd.dmc.DmcOutputStreamIF;                         // To support serialization - (MetaGenerator.java:3163)
import org.dmd.dmc.DmcValueException;                         // For type checking - (MetaGenerator.java:3180)
import org.dmd.dmc.DmcValueExceptionSet;                      // Ambiguous reference resolution - (MetaGenerator.java:3177)
import org.dmd.dmc.types.IntegerVar;                          // For getNextField() - (MetaGenerator.java:3164)
import org.dmd.dms.generated.enums.DataTypeEnum;              // For fake DmcAttributeInfo - (MetaGenerator.java:3165)
import org.dmd.dms.generated.enums.ValueTypeEnum;             // For fake DmcAttributeInfo - (MetaGenerator.java:3166)
 ...
 * manually.
 * Generated from: org.dmd.dms.meta.MetaGenerator.dumpComplexType(MetaGenerator.java:3191)
 */
public class Field implements Serializable {
    ...
    // org.dmd.dms.meta.MetaGenerator.dumpComplexType(MetaGenerator.java:3368)
