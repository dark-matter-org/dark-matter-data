...
import org.dmd.dmp.server.extended.PreAuthResponse;                 // Required for getModificationRecorder() - (BaseDMWGenerator.java:1000)
import org.dmd.dmp.server.extended.Response;                        // Derived class - (BaseDMWGenerator.java:1172)
import org.dmd.dmp.shared.generated.dmo.PreAuthResponseDMO;         // Class not auxiliary or abstract - (BaseDMWGenerator.java:1176)
