...
public class DmcTypePatternMatchRuleDataREFSV extends DmcTypePatternMatchRuleDataREF implements Serializable {
    ...
    public DmcTypePatternMatchRuleDataREFSV(DmcAttributeInfo ai){
        super(ai);
    }
    
    public DmcTypePatternMatchRuleDataREFSV getNew(){
        return(new DmcTypePatternMatchRuleDataREFSV(getAttributeInfo()));
    }
    
    public DmcTypePatternMatchRuleDataREFSV getNew(DmcAttributeInfo ai){
        return(new DmcTypePatternMatchRuleDataREFSV(ai));
    }
