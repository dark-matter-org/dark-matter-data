...
import org.dmd.dmc.rules.AttributeRuleKey;                               // To allow rule sorting - (RuleFormatter.java:501)
...
import org.dmd.dms.generated.rulesdmo.AttributeValidationIF;             // The interface for the AttributeValidation category - (RuleFormatter.java:513)
import org.dmd.dmv.shared.generated.dmo.NumericRangeRuleDataDMO;         // Rule parameters object - (RuleFormatter.java:507)



// Generated from: org.dmd.dms.util.RuleFormatter.dumpBaseImplementations(RuleFormatter.java:524)
abstract public class NumericRangeRuleBaseImpl implements RuleIF, DynamicInitIF,AttributeValidationIF {
    ...
    protected NumericRangeRuleDataDMO ruleDMO;

    protected NumericRangeRuleBaseImpl(){
        ruleDMO = null;
        if (categories == null){
    ...
    public void setRuleData(DmcObject obj){
        if (obj instanceof NumericRangeRuleDataDMO)
            ruleDMO = (NumericRangeRuleDataDMO)obj;
        else
            throw(new IllegalStateException("Object of class " + obj.getClass().getName() + " passed when object of class NumericRangeRuleDataDMO required"));
    }

    protected NumericRangeRuleBaseImpl(NumericRangeRuleDataDMO dmo){
        ruleDMO = dmo;
        if (categories == null){
            categories = new ArrayList<Integer>();
            categories.add(3);
