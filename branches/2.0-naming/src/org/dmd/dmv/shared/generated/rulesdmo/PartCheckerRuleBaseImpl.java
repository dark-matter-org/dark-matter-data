...
import org.dmd.dmv.shared.generated.dmo.PartCheckerRuleDataDMO;         // Rule parameters object - (RuleFormatter.java:507)



// Generated from: org.dmd.dms.util.RuleFormatter.dumpBaseImplementations(RuleFormatter.java:524)
abstract public class PartCheckerRuleBaseImpl implements RuleIF, DynamicInitIF,ObjectValidationIF {
    ...
    protected PartCheckerRuleDataDMO ruleDMO;

    protected PartCheckerRuleBaseImpl(){
        ruleDMO = null;
        if (categories == null){
    ...
    public void setRuleData(DmcObject obj){
        if (obj instanceof PartCheckerRuleDataDMO)
            ruleDMO = (PartCheckerRuleDataDMO)obj;
        else
            throw(new IllegalStateException("Object of class " + obj.getClass().getName() + " passed when object of class PartCheckerRuleDataDMO required"));
    }

    protected PartCheckerRuleBaseImpl(PartCheckerRuleDataDMO dmo){
        ruleDMO = dmo;
        if (categories == null){
            categories = new ArrayList<Integer>();
            categories.add(2);
