...
public class Classifier {
     ...
     */
    public Classifier(Dictionary d, boolean useDefaults) {
        dict = d;
        separators = new Dictionary();
     ...
     */
    public TokenArrayList classify(String s, boolean returnSeps){
    ...
    /**
     * Retiurns the basic type of a piece of text that isn't a separator or keyword.
