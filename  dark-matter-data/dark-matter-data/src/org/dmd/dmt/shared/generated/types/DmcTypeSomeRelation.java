...
// Called from: org.dmd.dms.util.GenUtility.dumpExtendedReferenceTypeDmcType(GenUtility.java:3097)
import org.dmd.dmc.DmcAttributeInfo;                            // Standard attribute interface - (GenUtility.java:3085)
import org.dmd.dmc.DmcInputStreamIF;                            // Serialization support - (GenUtility.java:3082)
import org.dmd.dmc.DmcOutputStreamIF;                           // Serialization support - (GenUtility.java:3083)
import org.dmd.dmc.DmcValueException;                           // Value exceptions - (GenUtility.java:3086)
import org.dmd.dmc.types.DmcTypeNamedObjectREF;                 // The class we extend - (GenUtility.java:3087)
import org.dmd.dmc.types.StringName;                            // Name type - (GenUtility.java:3091)
import org.dmd.dmt.shared.generated.dmo.ObjWithRefsDMO;         // The class we refer to - (GenUtility.java:3089)
 ...
 * Generated from: org.dmd.dms.util.GenUtility.dumpExtendedReferenceTypeDmcType(GenUtility.java:3120)
