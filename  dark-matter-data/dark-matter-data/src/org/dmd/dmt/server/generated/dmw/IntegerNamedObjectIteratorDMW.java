 ...
 */
public class IntegerNamedObjectIteratorDMW extends DmwContainerIterator<IntegerNamedObjectDMW,IntegerNamedObjectREF> {

    public final static IntegerNamedObjectIteratorDMW emptyList = new IntegerNamedObjectIteratorDMW();

    protected IntegerNamedObjectIteratorDMW(){
        super();
    }

    public IntegerNamedObjectIteratorDMW(Iterator<IntegerNamedObjectREF> it){
        super(it);
    }
