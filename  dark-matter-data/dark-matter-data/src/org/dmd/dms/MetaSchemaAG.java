...
public class MetaSchemaAG extends SchemaDefinition {
    ...
    public static AttributeDefinition _typeClass;
    ...
    public static AttributeDefinition _codeName;
    public static AttributeDefinition _codePackage;
    ...
    public MetaSchemaAG(){
        ...
        if (_metaSchema == null){
            ...
            // Generated from: org.dmd.dms.meta.MetaGenerator.dumpMetaSchema(MetaGenerator.java:457)
            ...
            // Generated from: org.dmd.dms.meta.MetaGenerator.dumpMetaSchema(MetaGenerator.java:467)
            ...
            // Generated from: org.dmd.dms.meta.MetaGenerator.dumpMetaSchema(MetaGenerator.java:477)
            ...
            _ActionDefinitionReference   = new TypeDefinition("ActionDefinitionReference", org.dmd.dms.generated.types.DmcTypeActionDefinitionREF.class);
            _AttributeDefinitionReference= new TypeDefinition("AttributeDefinitionReference", org.dmd.dms.generated.types.DmcTypeAttributeDefinitionREF.class);
            _ClassDefinitionReference    = new TypeDefinition("ClassDefinitionReference", org.dmd.dms.generated.types.DmcTypeClassDefinitionREF.class);
            _DmsDefinitionReference      = new TypeDefinition("DmsDefinitionReference", org.dmd.dms.generated.types.DmcTypeDmsDefinitionREF.class);
            _EnumDefinitionReference     = new TypeDefinition("EnumDefinitionReference", org.dmd.dms.generated.types.DmcTypeEnumDefinitionREF.class);
            _SchemaDefinitionReference   = new TypeDefinition("SchemaDefinitionReference", org.dmd.dms.generated.types.DmcTypeSchemaDefinitionREF.class);
            _TypeDefinitionReference     = new TypeDefinition("TypeDefinitionReference", org.dmd.dms.generated.types.DmcTypeTypeDefinitionREF.class);
            ...
            // Generated from: org.dmd.dms.meta.MetaGenerator.dumpMetaSchema(MetaGenerator.java:492)
            _name                        = new AttributeDefinition("name", _String);
            _valuePackage                = new AttributeDefinition("valuePackage", _String);
            _typeClass                   = new AttributeDefinition("typeClass", _String);
            ...
            _reposName                   = new AttributeDefinition("reposName", _String);
            ...
            _codeName                    = new AttributeDefinition("codeName", _String);
            _codePackage                 = new AttributeDefinition("codePackage", _String);
            ...
            // Generated from: org.dmd.dms.meta.MetaGenerator.dumpMetaSchema(MetaGenerator.java:529)
            ...
            _ActionDefinitionReference   .setTypeClass("org.dmd.dms.generated.types.DmcTypeActionDefinitionREF");
            ...
            _AttributeDefinitionReference.setTypeClass("org.dmd.dms.generated.types.DmcTypeAttributeDefinitionREF");
            ...
            _Boolean                     .setTypeClass("org.dmd.dmc.types.DmcTypeBoolean");
            ...
            _ClassDefinitionReference    .setTypeClass("org.dmd.dms.generated.types.DmcTypeClassDefinitionREF");
            ...
            _ClassTypeEnumReference      .setTypeClass("org.dmd.dms.generated.types.DmcTypeClassTypeEnum");
            ...
            _DataTypeEnumReference       .setTypeClass("org.dmd.dms.generated.types.DmcTypeDataTypeEnum");
            ...
            _DebugEnumReference          .setTypeClass("org.dmd.dms.generated.types.DmcTypeDebugEnum");
            ...
            _DmsDefinitionReference      .setTypeClass("org.dmd.dms.generated.types.DmcTypeDmsDefinitionREF");
            ...
            _Double                      .setTypeClass("org.dmd.dmc.types.DmcTypeDouble");
            ...
            _EnumDefinitionReference     .setTypeClass("org.dmd.dms.generated.types.DmcTypeEnumDefinitionREF");
            _EnumDefinitionReference     .setDefinedIn(this);

            _EnumValue                   .addObjectClass(_TypeDefinition);
            _EnumValue                   .setName("EnumValue");
            _EnumValue                   .setTypeClass("org.dmd.dms.types.DmcTypeEnumValue");
            ...
            _FilterTypeEnumReference     .setTypeClass("org.dmd.dms.generated.types.DmcTypeFilterTypeEnum");
            ...
            _Float                       .setTypeClass("org.dmd.dmc.types.DmcTypeFloat");
            ...
            _Integer                     .setTypeClass("org.dmd.dmc.types.DmcTypeInteger");
            _Integer                     .setDefinedIn(this);

            _Long                        .addObjectClass(_TypeDefinition);
            _Long                        .setName("Long");
            _Long                        .setPrimitiveType("long");
            _Long                        .setTypeClass("org.dmd.dmc.types.DmcTypeLong");
            ...
            _ModifyTypeEnumReference     .setTypeClass("org.dmd.dms.generated.types.DmcTypeModifyTypeEnum");
            ...
            _SchemaDefinitionReference   .setTypeClass("org.dmd.dms.generated.types.DmcTypeSchemaDefinitionREF");
            ...
            _String                      .setTypeClass("org.dmd.dmc.types.DmcTypeString");
            ...
            _TypeDefinitionReference     .setTypeClass("org.dmd.dms.generated.types.DmcTypeTypeDefinitionREF");
            ...
            _codeName                    .addObjectClass(_AttributeDefinition);
            _codeName                    .setDataType(DataTypeEnum.TRANSIENT);
            _codeName                    .setDescription("The name used to represent this item when it is generated as Java code. For class definitions, this would be the class name, for attribute definitions, this would be the name used in get/set functions. If a value isn't provided for this attribute, the name attribute is used.");
            _codeName                    .setName("codeName");
            _codeName                    .setType(_String);
            _codeName                    .setDefinedIn(this);

            _codePackage                 .addObjectClass(_AttributeDefinition);
            _codePackage                 .setDataType(DataTypeEnum.TRANSIENT);
            _codePackage                 .setDescription("The package to be used when a Java class is generated from a schema definition. Note: the autogenerated code will be place in the generated subdirectory beneath this package. For example, if you specify com.foo.bar as the codePackage. Your code will be generated in com.foo.bar.generated.");
            _codePackage                 .setName("codePackage");
            _codePackage                 .setType(_String);
            _codePackage                 .setDefinedIn(this);
            ...
            _namingAttribute             .setDataType(DataTypeEnum.TRANSIENT);
            _namingAttribute             .setDescription("This attribute indicates the attribute that is used to name an object instance. When a hierarchic name is composed for an object, the class name plus the value of the naming attribute (type:value) is used to create the name of an object.");
            ...
            _reposName                   .addObjectClass(_AttributeDefinition);
            _reposName                   .setDataType(DataTypeEnum.TRANSIENT);
            _reposName                   .setDescription("This attribute indicates the name of an attribute or class when it is stored in a repository and added to that repository's schema. Generally speaking, we will always use the standard ef prefix for all attribute and class names. Like all other name values, this one must be globally unique.");
            _reposName                   .setName("reposName");
            _reposName                   .setType(_String);
            ...
            _typeClass                   .addObjectClass(_AttributeDefinition);
            _typeClass                   .setDataType(DataTypeEnum.TRANSIENT);
            _typeClass                   .setDescription("This is the fully qualified name of the class derived from DmcAttribute that provides management of a particular type of attribute value. For instance, the type class that handles String attributes  is org.dmd.dmc.types.DmcTypeString");
            _typeClass                   .setName("typeClass");
            _typeClass                   .setType(_String);
            _typeClass                   .setDefinedIn(this);
            ...
            _AttributeDefinition         .addMay(_reposName);
            ...
            _ClassDefinition             .setCodePackage("org.dmd.dms");
            ...
            _ClassDefinition             .addMay(_reposName);
            ...
            _DmsDefinition               .setCodePackage("org.dmd.dms");
            ...
            _TypeDefinition              .addMust(_typeClass);
            _TypeDefinition              .setName("TypeDefinition");
            _TypeDefinition              .setDefinedIn(this);

        // Add the definitions to the schema object
        // Generated from: org.dmd.dms.meta.MetaGenerator.dumpMetaSchema(MetaGenerator.java:541)
            ...
            this.addAttributeDefList(_typeClass);
            ...
            this.addAttributeDefList(_reposName);
            ...
            this.addAttributeDefList(_codeName);
            this.addAttributeDefList(_codePackage);
