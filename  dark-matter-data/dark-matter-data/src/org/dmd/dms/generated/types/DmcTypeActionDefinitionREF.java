...
abstract public class DmcTypeActionDefinitionREF extends DmcTypeNamedObjectREF<ActionDefinitionREF, StringName> {
    ...
    public ActionDefinitionREF typeCheck(Object value) throws DmcValueException {
        ...
        if (value instanceof ActionDefinitionREF)
            ...
            throw(new DmcValueException("Object of class:" + value.getClass().getName() + " passed where a ActionDefinitionREF/DMO or DmcObjectNameIF expected."));
        return(rc);
    }
