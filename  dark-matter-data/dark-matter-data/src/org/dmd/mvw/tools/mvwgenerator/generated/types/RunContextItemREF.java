...
import org.dmd.mvw.tools.mvwgenerator.generated.dmo.RunContextItemDMO; // primitive type
...
public class RunContextItemREF extends DmcNamedObjectNontransportableREF<RunContextItemDMO> {
    ...
    public final static DmcAttributeInfo __itemName = new DmcAttributeInfo("itemName",827,"CamelCaseName",ValueTypeEnum.SINGLE,false);
    
    DmcTypeCamelCaseNameSV myName;    
    
    public RunContextItemREF(){
    }

    public RunContextItemREF(RunContextItemDMO o){
         object = o;
    ...
    public RunContextItemREF(RunContextItemREF original){
        myName = original.myName;
        object = original.object;
    }

    public void setObject(RunContextItemDMO o){
         object = o;
         myName = (DmcTypeCamelCaseNameSV)o.getObjectNameAttribute();
    }
     ...
     */
    public RunContextItemREF cloneMe(){
