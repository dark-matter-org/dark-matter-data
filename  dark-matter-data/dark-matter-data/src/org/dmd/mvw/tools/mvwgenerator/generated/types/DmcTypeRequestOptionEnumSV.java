...
public class DmcTypeRequestOptionEnumSV extends DmcTypeRequestOptionEnum implements Serializable {
    ...
    RequestOptionEnum value;
    
    public DmcTypeRequestOptionEnumSV(){
    
    }
    
    public DmcTypeRequestOptionEnumSV(DmcAttributeInfo ai){
        super(ai);
    }
    
    public DmcTypeRequestOptionEnumSV getNew(){
        return(new DmcTypeRequestOptionEnumSV(attrInfo));
    }
    
    public DmcTypeRequestOptionEnumSV getNew(DmcAttributeInfo ai){
        return(new DmcTypeRequestOptionEnumSV(ai));
    }
    ...
    @Override
    public RequestOptionEnum getSV(){
        return(value);
    }
