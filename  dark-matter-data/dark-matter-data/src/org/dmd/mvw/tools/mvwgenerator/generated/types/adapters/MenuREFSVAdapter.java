...
import org.dmd.mvw.tools.mvwgenerator.generated.types.DmcTypeMenuREFSV;

@SuppressWarnings("serial")
// org.dmd.dms.util.AdapterFormatter.dumpAdapter(AdapterFormatter.java:50)
// Called from: org.dmd.dms.util.AdapterFormatter.dumpAdapterSV(AdapterFormatter.java:12)
public class MenuREFSVAdapter extends DmcTypeMenuREFSV implements DmcAdapterIF {

    DmcTypeMenuREFSV existingValue;
    ...
    public void setExisting(DmcAttribute<?> attr) {
    	existingValue = (DmcTypeMenuREFSV) attr;
    	if (existingValue != null)
    		value = existingValue.getSVCopy();
    }
