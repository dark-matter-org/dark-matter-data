...
public class MultipleDMOSelectedEventDMO  extends BroadcastEventDMO  implements DmcNamedObjectIF, Serializable  {

    public final static String constructionClassName = "MultipleDMOSelectedEvent";
    ...
    public MultipleDMOSelectedEventDMO() {
        super("MultipleDMOSelectedEvent");
    }

    protected MultipleDMOSelectedEventDMO(String oc) {
        super(oc);
    }
    ...
    @Override
    public MultipleDMOSelectedEventDMO getNew(){
        MultipleDMOSelectedEventDMO rc = new MultipleDMOSelectedEventDMO();
        return(rc);
    }

    @Override
    public MultipleDMOSelectedEventDMO getSlice(DmcSliceInfo info){
        MultipleDMOSelectedEventDMO rc = new MultipleDMOSelectedEventDMO();
        populateSlice(rc,info);
        return(rc);
    }

    public MultipleDMOSelectedEventDMO(DmcTypeModifierMV mods) {
        super("MultipleDMOSelectedEvent");
        modrec(true);
        setModifier(mods);
    }
    ...
    public boolean equals(Object obj){
        if (obj instanceof MultipleDMOSelectedEventDMO){
            return( getObjectName().equals( ((MultipleDMOSelectedEventDMO) obj).getObjectName()) );
        }
        return(false);
    }
