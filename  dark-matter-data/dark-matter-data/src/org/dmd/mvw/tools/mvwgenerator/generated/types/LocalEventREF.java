...
import org.dmd.mvw.tools.mvwgenerator.generated.dmo.LocalEventDMO; // primitive type
...
public class LocalEventREF extends DmcNamedObjectNontransportableREF<LocalEventDMO> {
    ...
    public LocalEventREF(){
    }

    public LocalEventREF(LocalEventDMO o){
         object = o;
         myName = (DmcTypeCamelCaseNameSV)o.getObjectNameAttribute();
    }

    public LocalEventREF(CamelCaseName n) throws DmcValueException {
         object = null;
         myName = new DmcTypeCamelCaseNameSV();
         myName.set(n);
    }

    public LocalEventREF(String n) throws DmcValueException {
         object = null;
         myName = new DmcTypeCamelCaseNameSV();
         myName.set(n);
    }

    public LocalEventREF(LocalEventREF original){
        myName = original.myName;
        object = original.object;
    }

    public void setObject(LocalEventDMO o){
         object = o;
         myName = (DmcTypeCamelCaseNameSV)o.getObjectNameAttribute();
    }
