...
import org.dmd.mvw.tools.mvwgenerator.generated.dmo.MvwEventDMO; // primitive type
...
public class MvwEventREF extends DmcNamedObjectNontransportableREF<MvwEventDMO> {
    ...
    public MvwEventREF(MvwEventDMO o){
         object = o;
         myName = (DmcTypeCamelCaseNameSV)o.getObjectNameAttribute();
    }

    public MvwEventREF(CamelCaseName n) throws DmcValueException {
         object = null;
         myName = new DmcTypeCamelCaseNameSV();
         myName.set(n);
    }

    public MvwEventREF(String n) throws DmcValueException {
         object = null;
         myName = new DmcTypeCamelCaseNameSV();
         myName.set(n);
    }

    public MvwEventREF(MvwEventREF original){
        myName = original.myName;
        object = original.object;
    }

    public void setObject(MvwEventDMO o){
         object = o;
         myName = (DmcTypeCamelCaseNameSV)o.getObjectNameAttribute();
    }
