...
import org.dmd.mvw.tools.mvwgenerator.generated.types.DmcTypeSubMenuREFSV;

@SuppressWarnings("serial")
// org.dmd.dms.util.AdapterFormatter.dumpAdapter(AdapterFormatter.java:50)
// Called from: org.dmd.dms.util.AdapterFormatter.dumpAdapterSV(AdapterFormatter.java:12)
public class SubMenuREFSVAdapter extends DmcTypeSubMenuREFSV implements DmcAdapterIF {

    DmcTypeSubMenuREFSV existingValue;
    ...
    public void setExisting(DmcAttribute<?> attr) {
    	existingValue = (DmcTypeSubMenuREFSV) attr;
    	if (existingValue != null)
    		value = existingValue.getSVCopy();
    }
