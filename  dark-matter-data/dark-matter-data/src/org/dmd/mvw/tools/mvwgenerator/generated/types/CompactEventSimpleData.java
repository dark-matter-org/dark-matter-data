...
public class CompactEventSimpleData implements Serializable {
     ...
     * Default constructor.
     */
    public CompactEventSimpleData(){
    }

    /**
     * Copy constructor.
     */
    public CompactEventSimpleData(CompactEventSimpleData original){
        name = original.name;
     ...
     */
    public CompactEventSimpleData(String f1, String f2) throws DmcValueException {
     ...
     */
    public CompactEventSimpleData(String input) throws DmcValueException {
        IntegerVar seppos = new IntegerVar(-1);
        name = DmcTypeStringSTATIC.instance.typeCheck(getNextField(input,seppos,"name",false));
        userData = DmcTypeStringSTATIC.instance.typeCheck(getNextField(input,seppos,"userData",true));
    }
    ...
    public String toString(){
        return(name.toString() + " " + userData.toString());
    }
    ...
    String getNextField(String input, IntegerVar seppos, String fn, boolean last) throws DmcValueException {
    	   ...
    	   if ( (start+1) >= input.length())
    		   throw (new DmcValueException("Missing value for field: " + fn + " in complex type: CompactEventSimpleData"));
