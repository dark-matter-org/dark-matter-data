...
public enum GetFunctionOptionEnum implements DmcEnumIF
{
    ...
    CREATED(7,"Indicates that you want notification of create events associated with the get request."),

    DELETED(8,"Indicates that you want notification of delete events associated with the get request."),

    MODIFIED(9,"Indicates that you want notification of modification events associated with the get request.");
