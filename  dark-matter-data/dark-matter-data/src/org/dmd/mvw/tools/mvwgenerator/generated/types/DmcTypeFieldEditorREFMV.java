...
/**
 * The DmcTypeFieldEditorREFMV provides storage for a multi-valued FieldEditorREF
 * <P>
...
public class DmcTypeFieldEditorREFMV extends DmcTypeFieldEditorREF implements Serializable {
    
    ArrayList<FieldEditorREF> value;
    
    public DmcTypeFieldEditorREFMV(){
    
    }
    
    public DmcTypeFieldEditorREFMV(DmcAttributeInfo ai){
        super(ai);
    }
    
    @Override
    public DmcTypeFieldEditorREFMV getNew(){
        return(new DmcTypeFieldEditorREFMV(attrInfo));
    }
    ...
    public DmcAttribute<FieldEditorREF> cloneIt(){
        synchronized(this){
            DmcTypeFieldEditorREFMV rc = getNew();
            if (attrInfo.indexSize == 0){
                for(FieldEditorREF val: value)
                try {
                    rc.add(val);
    ...
    public FieldEditorREF add(Object v) throws DmcValueException {
        synchronized(this){
            ...
            if (value == null)
                value = new ArrayList<FieldEditorREF>();
            value.add(rc);
            return(rc);
        }
    }
    ...
    public Iterator<FieldEditorREF> getMV(){
        synchronized(this){
            ArrayList<FieldEditorREF> clone = new ArrayList<FieldEditorREF>(value);
            return(clone.iterator());
        }
    }
    
    // org.dmd.dms.util.GenUtility.dumpMVType(GenUtility.java:2149)
    public ArrayList<FieldEditorREF> getMVCopy(){
        synchronized(this){
            ArrayList<FieldEditorREF> clone = new ArrayList<FieldEditorREF>(value);
            return(clone);
        }
    ...
    public FieldEditorREF getMVnth(int index){
        synchronized(this){
    ...
    public FieldEditorREF setMVnth(int index, Object v) throws DmcValueException {
        synchronized(this){
            if (attrInfo.indexSize == 0)
            ...
            if (value == null){
                value = new ArrayList<FieldEditorREF>(attrInfo.indexSize);
