...
import org.dmd.mvw.tools.mvwgenerator.generated.dmo.DefaultPlaceDMO; // primitive type
...
public class DefaultPlaceREF extends DmcNamedObjectNontransportableREF<DefaultPlaceDMO> {

    public final static DmcAttributeInfo __placeName = new DmcAttributeInfo("placeName",853,"CamelCaseName",ValueTypeEnum.SINGLE,DataTypeEnum.PERSISTENT,false);
    
    DmcTypeCamelCaseNameSV myName;    
    
    public DefaultPlaceREF(){
    }

    public DefaultPlaceREF(DefaultPlaceDMO o){
         object = o;
         myName = (DmcTypeCamelCaseNameSV)o.getObjectNameAttribute();
    }

    public DefaultPlaceREF(CamelCaseName n) throws DmcValueException {
         object = null;
         myName = new DmcTypeCamelCaseNameSV(__placeName);
         myName.set(n);
    }

    public DefaultPlaceREF(String n) throws DmcValueException {
         object = null;
         myName = new DmcTypeCamelCaseNameSV(__placeName);
         myName.set(n);
    }

    public DefaultPlaceREF(DefaultPlaceREF original){
        myName = original.myName;
        object = original.object;
    }

    public void setObject(DefaultPlaceDMO o){
         object = o;
         myName = (DmcTypeCamelCaseNameSV)o.getObjectNameAttribute();
    }
     ...
     */
    public DefaultPlaceREF cloneMe(){
