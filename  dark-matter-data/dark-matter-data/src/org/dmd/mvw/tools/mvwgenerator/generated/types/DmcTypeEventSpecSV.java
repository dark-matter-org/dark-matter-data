...
public class DmcTypeEventSpecSV extends DmcTypeEventSpec implements Serializable {
    ...
    public DmcTypeEventSpecSV(DmcAttributeInfo ai){
        super(ai);
    }
    
    public DmcTypeEventSpecSV getNew(){
        return(new DmcTypeEventSpecSV(attrInfo));
    }
    
    public DmcTypeEventSpecSV getNew(DmcAttributeInfo ai){
        return(new DmcTypeEventSpecSV(ai));
    }
    
    @Override
    public DmcAttribute<EventSpec> cloneIt(){
        DmcTypeEventSpecSV rc = getNew();
        rc.value = value;
        return(rc);
    }
    
    @Override
    public EventSpec set(Object v) throws DmcValueException {
