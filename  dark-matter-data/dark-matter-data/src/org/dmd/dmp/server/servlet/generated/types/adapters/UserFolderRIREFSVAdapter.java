...
import org.dmd.dmp.server.servlet.generated.types.DmcTypeUserFolderRIREFSV;

@SuppressWarnings("serial")
// org.dmd.dms.util.AdapterFormatter.dumpAdapter(AdapterFormatter.java:50)
// Called from: org.dmd.dms.util.AdapterFormatter.dumpAdapterSV(AdapterFormatter.java:12)
public class UserFolderRIREFSVAdapter extends DmcTypeUserFolderRIREFSV implements DmcAdapterIF {

    DmcTypeUserFolderRIREFSV existingValue;
    ...
    public void setExisting(DmcAttribute<?> attr) {
    	existingValue = (DmcTypeUserFolderRIREFSV) attr;
    	if (existingValue != null)
    		value = existingValue.getSVCopy();
    }
