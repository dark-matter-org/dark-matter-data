...
public class DmcTypeSessionFolderRIREFSV extends DmcTypeSessionFolderRIREF implements Serializable {
    ...
    SessionFolderRIREF value;
    
    public DmcTypeSessionFolderRIREFSV(){
    
    }
    
    public DmcTypeSessionFolderRIREFSV(DmcAttributeInfo ai){
        super(ai);
    }
    
    public DmcTypeSessionFolderRIREFSV getNew(){
        return(new DmcTypeSessionFolderRIREFSV(attrInfo));
    }
    
    public DmcTypeSessionFolderRIREFSV getNew(DmcAttributeInfo ai){
        return(new DmcTypeSessionFolderRIREFSV(ai));
    }
    ...
    @Override
    public SessionFolderRIREF getSV(){
        return(value);
    }
