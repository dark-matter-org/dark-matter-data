...
public class DmcTypeDeleteRequestREF extends DmcTypeNamedObjectREF<DeleteRequestREF, IntegerName> {
     ...
     */
    public DmcTypeDeleteRequestREF cloneMe(){
        DmcTypeDeleteRequestREF rc = new DmcTypeDeleteRequestREF();
        if (mv == null){
            rc.sv = sv.cloneMe();
        }
        else{
            rc.mv = new ArrayList<DeleteRequestREF>();
            for(DeleteRequestREF val : mv){
     ...
     */
    public DmcTypeDeleteRequestREF getOneOfMe(){
        DmcTypeDeleteRequestREF rc = new DmcTypeDeleteRequestREF();
        return(rc);
    }
     ...
     */
    public DeleteRequestREF cloneValue(DeleteRequestREF val){
        DeleteRequestREF rc = new DeleteRequestREF(val);
        return(rc);
    }
