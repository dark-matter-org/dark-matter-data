...
// public class DmcTypeLogoutRequestREFMV extends DmcTypeLogoutRequestREF<LogoutRequestREF,IntegerName> {
public class DmcTypeLogoutRequestREFMV extends DmcTypeLogoutRequestREF {
    
    ArrayList<LogoutRequestREF> value;
    ...
    public DmcTypeLogoutRequestREFMV(DmcAttributeInfo ai){
        super(ai);
        value = new ArrayList<LogoutRequestREF>();
    }
    ...
    public LogoutRequestREF getMVnth(int i){
        return(value.get(i));
    }
