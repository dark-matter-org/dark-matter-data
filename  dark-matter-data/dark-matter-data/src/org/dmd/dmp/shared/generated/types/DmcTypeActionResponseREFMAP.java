...
public class DmcTypeActionResponseREFMAP extends DmcTypeActionResponseREF implements Serializable {
    ...
    public ActionResponseREF add(Object v) throws DmcValueException {
        ActionResponseREF newval = typeCheck(v);
        if (value == null)
            initValue();
        IntegerName key = (IntegerName)((DmcMappedAttributeIF)newval).getKey();
        ActionResponseREF oldval = value.put(key,newval);
