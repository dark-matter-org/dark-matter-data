...
public class DmcTypeGetResponseREF extends DmcTypeNamedObjectREF<GetResponseREF, IntegerName> {
     ...
     */
    public DmcTypeGetResponseREF cloneMe(){
        DmcTypeGetResponseREF rc = new DmcTypeGetResponseREF();
        if (mv == null){
            rc.sv = sv.cloneMe();
        }
        else{
            rc.mv = new ArrayList<GetResponseREF>();
            for(GetResponseREF val : mv){
     ...
     */
    public GetResponseREF cloneValue(GetResponseREF val){
        GetResponseREF rc = new GetResponseREF(val);
        return(rc);
    }
