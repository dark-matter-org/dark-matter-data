...
/**
 * This is the generated DmcAttribute derivative for values of type EventTypeEnum
 * <P>
...
public class DmcTypeEventTypeEnum extends DmcAttribute<EventTypeEnum> {

    public DmcTypeEventTypeEnum(){
    }

    public DmcTypeEventTypeEnum(DmcAttributeInfo ai){
        super(ai);
    }
    ...
    protected EventTypeEnum typeCheck(Object value) throws DmcValueException {
        ...
        if (value instanceof EventTypeEnum){
            ...
            throw(new DmcValueException("Object of class: " + value.getClass().getName() + " passed where object compatible with EventTypeEnum expected."));
        }
        return(rc);
    }
     ...
     */
    public DmcTypeEventTypeEnum getOneOfMe(){
        DmcTypeEventTypeEnum rc = new DmcTypeEventTypeEnum();
        return(rc);
    }
