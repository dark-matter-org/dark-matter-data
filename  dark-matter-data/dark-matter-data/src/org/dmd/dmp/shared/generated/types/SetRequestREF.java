...
public class SetRequestREF extends DmcNamedObjectNontransportableREF<SetRequestDMO> {
    ...
    public SetRequestREF(){
    }

    public SetRequestREF(SetRequestDMO o){
         object = o;
         myName = (DmcTypeIntegerNameSV)o.getObjectNameAttribute();
    }

    public SetRequestREF(String n) throws DmcValueException {
         object = null;
         myName = new DmcTypeIntegerNameSV();
         myName.set(n);
    }

    public SetRequestREF(SetRequestREF original){
        myName = original.myName;
        object = original.object;
    }

    public void setObject(SetRequestDMO o){
         object = o;
         myName = (DmcTypeIntegerNameSV)o.getObjectNameAttribute();
    }
