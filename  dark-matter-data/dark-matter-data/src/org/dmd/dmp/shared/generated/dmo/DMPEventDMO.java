...
public class DMPEventDMO  extends DMPMessageDMO  implements DmcNamedObjectIF,de.novanic.eventservice.client.event.Event  {
    ...
    public DMPEventDMO(String oc, Map<Integer,DmcAttributeInfo> im, Map<String,DmcAttributeInfo> sm){
        super(oc,im,sm);
    }

    public DMPEventDMO(DMPEventDMO original) {
        super(constructionClassName);
        System.out.println("Full object cloning not implemented...");
    }

    @Override
    public DMPEventDMO getOneOfMe() {
        DMPEventDMO rc = new DMPEventDMO(constructionClassName);
        return(rc);
    }
