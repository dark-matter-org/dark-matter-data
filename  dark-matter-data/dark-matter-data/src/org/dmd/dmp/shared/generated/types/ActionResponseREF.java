...
public class ActionResponseREF extends DmcNamedObjectNontransportableREF<ActionResponseDMO> {
    ...
    public ActionResponseREF(){
    }

    public ActionResponseREF(ActionResponseDMO o){
         object = o;
         myName = (DmcTypeIntegerNameSV)o.getObjectNameAttribute();
    }

    public ActionResponseREF(String n) throws DmcValueException {
         object = null;
         myName = new DmcTypeIntegerNameSV();
         myName.set(n);
    }

    public ActionResponseREF(ActionResponseREF original){
        myName = original.myName;
        object = original.object;
    }

    public void setObject(ActionResponseDMO o){
         object = o;
         myName = (DmcTypeIntegerNameSV)o.getObjectNameAttribute();
    }
     ...
     */
    public ActionResponseREF cloneMe(){
