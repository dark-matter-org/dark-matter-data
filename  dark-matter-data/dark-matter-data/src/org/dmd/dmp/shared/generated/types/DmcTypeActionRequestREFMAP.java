...
// public class DmcTypeActionRequestREFMAP extends DmcTypeActionRequestREF<ActionRequestREF,IntegerName> {
public class DmcTypeActionRequestREFMAP extends DmcTypeActionRequestREF implements Serializable {
    
    Map<IntegerName,ActionRequestREF> value;
    
    public DmcTypeActionRequestREFMAP(){
        value = null;
    }
    
    public DmcTypeActionRequestREFMAP(DmcAttributeInfo ai){
        super(ai);
        initValue();
    }
    ...
    void initValue(){
        if (attrInfo.valueType == ValueTypeEnum.HASHMAPPED)
            value = new HashMap<IntegerName,ActionRequestREF>();
        else
    ...
    public DmcAttribute<ActionRequestREF> cloneIt(){
        DmcTypeActionRequestREFMAP rc = getNew();
        for(ActionRequestREF val: value.values())
        try {
            rc.add(val);
    ...
    public ActionRequestREF add(Object v) throws DmcValueException {
        ...
        ActionRequestREF oldval = value.put(key,newval);
    ...
    @Override
    public ActionRequestREF del(Object key){
    ...
    public Map<IntegerName,ActionRequestREF> getMVCopy(){
        Map<IntegerName,ActionRequestREF> clone = null;
        if (attrInfo.valueType == ValueTypeEnum.HASHMAPPED)
            clone = new HashMap<IntegerName,ActionRequestREF>(value);
        else
