...
public class DeleteResponseREF extends DmcNamedObjectNontransportableREF<DeleteResponseDMO> {
    ...
    public DeleteResponseREF(){
    }

    public DeleteResponseREF(DeleteResponseDMO o){
         object = o;
         myName = (DmcTypeIntegerNameSV)o.getObjectNameAttribute();
    }

    public DeleteResponseREF(String n) throws DmcValueException {
         object = null;
         myName = new DmcTypeIntegerNameSV();
         myName.set(n);
    }

    public DeleteResponseREF(DeleteResponseREF original){
        myName = original.myName;
        object = original.object;
    }

    public void setObject(DeleteResponseDMO o){
         object = o;
         myName = (DmcTypeIntegerNameSV)o.getObjectNameAttribute();
    }
     ...
     */
    public DeleteResponseREF cloneMe(){
    ...
    public void deserializeIt(DmcInputStreamIF dis) throws Exception {
        myName = (DmcTypeIntegerNameSV) dis.getAttributeInstance(__requestID.id);
