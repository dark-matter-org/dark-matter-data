...
public class LoginResponseREF extends DmcNamedObjectNontransportableREF<LoginResponseDMO> {
    ...
    public LoginResponseREF(){
    }

    public LoginResponseREF(LoginResponseDMO o){
         object = o;
         myName = (DmcTypeIntegerNameSV)o.getObjectNameAttribute();
    }

    public LoginResponseREF(String n) throws DmcValueException {
         object = null;
         myName = new DmcTypeIntegerNameSV();
         myName.set(n);
    }

    public LoginResponseREF(LoginResponseREF original){
        myName = original.myName;
        object = original.object;
    }

    public void setObject(LoginResponseDMO o){
         object = o;
         myName = (DmcTypeIntegerNameSV)o.getObjectNameAttribute();
    }
     ...
     */
    public LoginResponseREF cloneMe(){
