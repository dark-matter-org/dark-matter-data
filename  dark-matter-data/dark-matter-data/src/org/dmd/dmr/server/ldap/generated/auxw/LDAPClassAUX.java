 ...
 * Generated from: org.dmd.dmg.generators.DMWGenerator.getAuxClassHeader(DMWGenerator.java:1042)
 */
public class LDAPClassAUX {
    ...
    static private void removeAuxIfRequired(DmwWrapper corew){
        ...
        if (corew.getDmcObject().get(_reposName) != null)
            anyLeft = true;
        if (corew.getDmcObject().get(_namingAttribute) != null)
            anyLeft = true;
    ...
    static public DmcAttribute remNamingAttribute(DmwWrapper corew){
        if (corew == null)
            return(null);
        DmcAttribute rc = corew.getDmcObject().rem(_namingAttribute);
        removeAuxIfRequired(corew);
        return(rc);
    }
