...
public class DmcTypeMvcEventREFMAP extends DmcTypeMvcEventREF implements Serializable {
    
    Map<StringName,MvcEventREF> value;
    
    public DmcTypeMvcEventREFMAP(){
        value = null;
    }
    
    public DmcTypeMvcEventREFMAP(DmcAttributeInfo ai){
        super(ai);
        initValue();
    }
    ...
    void initValue(){
        if (attrInfo.valueType == ValueTypeEnum.HASHMAPPED)
            value = new HashMap<StringName,MvcEventREF>();
        else
            value = new TreeMap<StringName,MvcEventREF>();
    }
    
    @Override
    public DmcTypeMvcEventREFMAP getNew(){
        return(new DmcTypeMvcEventREFMAP(attrInfo));
    }
    
    @Override
    public DmcAttribute<MvcEventREF> cloneIt(){
        DmcTypeMvcEventREFMAP rc = getNew();
        for(MvcEventREF val: value.values())
        try {
            rc.add(val);
    ...
    public MvcEventREF add(Object v) throws DmcValueException {
        ...
        MvcEventREF oldval = value.put(key,newval);
