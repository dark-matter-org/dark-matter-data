...
import org.dmd.features.extgwt.generated.dmo.MvcServerEventDMO; // primitive type
...
public class MvcServerEventREF extends DmcNamedObjectNontransportableREF<MvcServerEventDMO> {
    ...
    public MvcServerEventREF(){
    }

    public MvcServerEventREF(MvcServerEventDMO o){
         object = o;
         myName = (DmcTypeStringNameSV)o.getObjectNameAttribute();
    }

    public MvcServerEventREF(StringName n) throws DmcValueException {
         object = null;
         myName = new DmcTypeStringNameSV(__name);
         myName.set(n);
    }

    public MvcServerEventREF(String n) throws DmcValueException {
         object = null;
         myName = new DmcTypeStringNameSV(__name);
         myName.set(n);
    }

    public MvcServerEventREF(MvcServerEventREF original){
        myName = original.myName;
        object = original.object;
    }

    public void setObject(MvcServerEventDMO o){
         object = o;
         myName = (DmcTypeStringNameSV)o.getObjectNameAttribute();
    }
     ...
     */
    public MvcServerEventREF cloneMe(){
