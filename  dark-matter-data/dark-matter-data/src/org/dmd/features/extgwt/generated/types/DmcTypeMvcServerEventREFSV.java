...
public class DmcTypeMvcServerEventREFSV extends DmcTypeMvcServerEventREF implements Serializable {
    ...
    public DmcTypeMvcServerEventREFSV getNew(DmcAttributeInfo ai){
        return(new DmcTypeMvcServerEventREFSV(ai));
    }
