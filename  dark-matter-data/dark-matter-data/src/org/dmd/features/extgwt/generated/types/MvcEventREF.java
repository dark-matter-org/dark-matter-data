...
import org.dmd.features.extgwt.generated.dmo.MvcEventDMO; // primitive type
...
public class MvcEventREF extends DmcNamedObjectNontransportableREF<MvcEventDMO> {
    ...
    public MvcEventREF(MvcEventDMO o){
         object = o;
         myName = (DmcTypeStringNameSV)o.getObjectNameAttribute();
    }

    public MvcEventREF(StringName n) throws DmcValueException {
         object = null;
         myName = new DmcTypeStringNameSV(__name);
         myName.set(n);
    }

    public MvcEventREF(String n) throws DmcValueException {
         object = null;
         myName = new DmcTypeStringNameSV(__name);
         myName.set(n);
    }
