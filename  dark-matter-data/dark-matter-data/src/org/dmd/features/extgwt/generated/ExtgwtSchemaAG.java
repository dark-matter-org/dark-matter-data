...
public class ExtgwtSchemaAG extends SchemaDefinition {
    ...
    private ExtgwtSchemaAG() throws DmcValueException {
        SchemaDefinitionDMO me = (SchemaDefinitionDMO) this.getDmcObject();
        me.setName("extgwt");
        me.setSchemaPackage("org.dmd.features.extgwt");
        me.setDmwPackage("org.dmd.features.extgwt");
        me.setFile("F:/AASoftDev/workspace/dark-matter-data/src/org/dmd/features/extgwt/schema/v0dot1/extgwt.dms");
        ...
        _MvcDefinitionOBJ.setFile("F:/AASoftDev/workspace/dark-matter-data/src/org/dmd/features/extgwt/schema/v0dot1/classes.dmd");
        ...
        _MvcConfigOBJ.setFile("F:/AASoftDev/workspace/dark-matter-data/src/org/dmd/features/extgwt/schema/v0dot1/classes.dmd");
        ...
        _MvcEventOBJ.setFile("F:/AASoftDev/workspace/dark-matter-data/src/org/dmd/features/extgwt/schema/v0dot1/classes.dmd");
        ...
        _MvcApplicationOBJ.setFile("F:/AASoftDev/workspace/dark-matter-data/src/org/dmd/features/extgwt/schema/v0dot1/classes.dmd");
        _MvcApplicationOBJ.setIsNamedBy("name");
        _MvcApplicationOBJ.setLineNumber("64");
        ...
        _MvcControllerOBJ.setFile("F:/AASoftDev/workspace/dark-matter-data/src/org/dmd/features/extgwt/schema/v0dot1/classes.dmd");
        _MvcControllerOBJ.setIsNamedBy("name");
        _MvcControllerOBJ.setLineNumber("90");
        ...
        _MvcViewOBJ.setFile("F:/AASoftDev/workspace/dark-matter-data/src/org/dmd/features/extgwt/schema/v0dot1/classes.dmd");
        _MvcViewOBJ.setIsNamedBy("name");
        _MvcViewOBJ.setLineNumber("105");
        ...
        _MvcRegistryItemOBJ.setFile("F:/AASoftDev/workspace/dark-matter-data/src/org/dmd/features/extgwt/schema/v0dot1/classes.dmd");
        _MvcRegistryItemOBJ.setIsNamedBy("name");
        _MvcRegistryItemOBJ.setLineNumber("119");
        ...
        _dependsOnMVCOBJ.setFile("F:/AASoftDev/workspace/dark-matter-data/src/org/dmd/features/extgwt/schema/v0dot1/attributes.dmd");
        ...
        _definesEventOBJ.setDescription("This attributes holds a list of EventType names that are defined by MvcControllers. A particular event must be defined only once; but it can be emitted and handled by many different components.");
        _definesEventOBJ.setFile("F:/AASoftDev/workspace/dark-matter-data/src/org/dmd/features/extgwt/schema/v0dot1/attributes.dmd");
        ...
        _handlesEventOBJ.setDescription("This attributes holds a list of EventType names that are handled by MvcControllers or MvcViews. A global list of these names is created and used to generate the AppEvents class.");
        _handlesEventOBJ.setFile("F:/AASoftDev/workspace/dark-matter-data/src/org/dmd/features/extgwt/schema/v0dot1/attributes.dmd");
        ...
        _dispatchesEventOBJ.setFile("F:/AASoftDev/workspace/dark-matter-data/src/org/dmd/features/extgwt/schema/v0dot1/attributes.dmd");
        ...
        _definedByOBJ.setFile("F:/AASoftDev/workspace/dark-matter-data/src/org/dmd/features/extgwt/schema/v0dot1/attributes.dmd");
        ...
        _emittedByOBJ.setFile("F:/AASoftDev/workspace/dark-matter-data/src/org/dmd/features/extgwt/schema/v0dot1/attributes.dmd");
        ...
        _handledByOBJ.setFile("F:/AASoftDev/workspace/dark-matter-data/src/org/dmd/features/extgwt/schema/v0dot1/attributes.dmd");
        ...
        _controllersOBJ.setFile("F:/AASoftDev/workspace/dark-matter-data/src/org/dmd/features/extgwt/schema/v0dot1/attributes.dmd");
        ...
        _userDataTypeOBJ.setFile("F:/AASoftDev/workspace/dark-matter-data/src/org/dmd/features/extgwt/schema/v0dot1/attributes.dmd");
        ...
        _createsRegistryItemOBJ.setFile("F:/AASoftDev/workspace/dark-matter-data/src/org/dmd/features/extgwt/schema/v0dot1/attributes.dmd");
        _createsRegistryItemOBJ.setIsMultiValued("true");
        _createsRegistryItemOBJ.setLineNumber("85");
        ...
        _usesRegistryItemOBJ.setFile("F:/AASoftDev/workspace/dark-matter-data/src/org/dmd/features/extgwt/schema/v0dot1/attributes.dmd");
        _usesRegistryItemOBJ.setIsMultiValued("true");
        _usesRegistryItemOBJ.setLineNumber("91");
        ...
        _prefixOBJ.setFile("F:/AASoftDev/workspace/dark-matter-data/src/org/dmd/features/extgwt/schema/v0dot1/attributes.dmd");
        _prefixOBJ.setLineNumber("97");
        ...
        _controlsViewOBJ.setFile("F:/AASoftDev/workspace/dark-matter-data/src/org/dmd/features/extgwt/schema/v0dot1/attributes.dmd");
        _controlsViewOBJ.setIsMultiValued("true");
        _controlsViewOBJ.setLineNumber("103");
        ...
        _definedInMVCConfigOBJ.setFile("F:/AASoftDev/workspace/dark-matter-data/src/org/dmd/features/extgwt/schema/v0dot1/attributes.dmd");
        _definedInMVCConfigOBJ.setLineNumber("110");
        ...
        _isHistoryEventOBJ.setFile("F:/AASoftDev/workspace/dark-matter-data/src/org/dmd/features/extgwt/schema/v0dot1/attributes.dmd");
        _isHistoryEventOBJ.setLineNumber("116");
        ...
        _parentControllerOBJ.setFile("F:/AASoftDev/workspace/dark-matter-data/src/org/dmd/features/extgwt/schema/v0dot1/attributes.dmd");
        _parentControllerOBJ.setLineNumber("123");
        ...
        _firesEventOBJ.setFile("F:/AASoftDev/workspace/dark-matter-data/src/org/dmd/features/extgwt/schema/v0dot1/attributes.dmd");
        _firesEventOBJ.setLineNumber("130");
        ...
        _userDataCollectionOBJ.setFile("F:/AASoftDev/workspace/dark-matter-data/src/org/dmd/features/extgwt/schema/v0dot1/attributes.dmd");
        _userDataCollectionOBJ.setLineNumber("136");
        ...
        _userDataGenericSpecOBJ.setFile("F:/AASoftDev/workspace/dark-matter-data/src/org/dmd/features/extgwt/schema/v0dot1/attributes.dmd");
        _userDataGenericSpecOBJ.setLineNumber("143");
    ...
    public static ExtgwtSchemaAG getInstance() throws DmcValueException{
    	   if (instance == null)
