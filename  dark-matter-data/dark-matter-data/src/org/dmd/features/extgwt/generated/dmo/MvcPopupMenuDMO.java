...
public class MvcPopupMenuDMO  extends MvcMenuDMO  implements DmcNamedObjectIF, Serializable  {
    ...
    @Override
    public MvcPopupMenuDMO getSlice(DmcSliceInfo info){
        MvcPopupMenuDMO rc = new MvcPopupMenuDMO();
    ...
    public String getUseForModelClass(){
        DmcTypeStringSV attr = (DmcTypeStringSV) get(ExtgwtDMSAG.__useForModelClass);
        if (attr == null)
            return(null);
    ...
    public void setUseForModelClass(String value) {
        DmcAttribute<?> attr = get(ExtgwtDMSAG.__useForModelClass);
        if (attr == null)
            attr = new DmcTypeStringSV(ExtgwtDMSAG.__useForModelClass);
        
        try{
            attr.set(value);
            set(ExtgwtDMSAG.__useForModelClass,attr);
        }
        catch(DmcValueException ex){
            throw(new IllegalStateException("The type specific set() method shouldn't throw exceptions!",ex));
        }
    ...
    public void remUseForModelClass(){
         rem(ExtgwtDMSAG.__useForModelClass);
    }
