...
public class DmcTypeMvcMultiViewREF extends DmcTypeNamedObjectREF<MvcMultiViewREF> {
     ...
     */
    public DmcTypeMvcMultiViewREF cloneMe(){
        DmcTypeMvcMultiViewREF rc = new DmcTypeMvcMultiViewREF();
        if (mv == null){
            rc.sv = sv.cloneMe();
        }
        else{
            rc.mv = new ArrayList<MvcMultiViewREF>();
            for(MvcMultiViewREF val : mv){
     ...
     */
    public DmcTypeMvcMultiViewREF getOneOfMe(){
        DmcTypeMvcMultiViewREF rc = new DmcTypeMvcMultiViewREF();
        return(rc);
    }
     ...
     */
    public MvcMultiViewREF cloneValue(MvcMultiViewREF val){
        MvcMultiViewREF rc = new MvcMultiViewREF(val);
        return(rc);
    }
