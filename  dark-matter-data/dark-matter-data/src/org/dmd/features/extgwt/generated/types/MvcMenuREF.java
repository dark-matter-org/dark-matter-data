...
import org.dmd.features.extgwt.generated.dmo.MvcMenuDMO; // primitive type
...
public class MvcMenuREF extends DmcNamedObjectNontransportableREF<MvcMenuDMO> {
    ...
    public MvcMenuREF(MvcMenuDMO o){
         object = o;
         myName = (DmcTypeStringNameSV)o.getObjectNameAttribute();
    }

    public MvcMenuREF(StringName n) throws DmcValueException {
         object = null;
         myName = new DmcTypeStringNameSV(__name);
         myName.set(n);
    }

    public MvcMenuREF(String n) throws DmcValueException {
         object = null;
         myName = new DmcTypeStringNameSV(__name);
         myName.set(n);
    }
