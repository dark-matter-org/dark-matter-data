...
import org.dmd.features.extgwt.generated.dmo.MvcActionDMO; // primitive type
...
public class MvcActionREF extends DmcNamedObjectNontransportableREF<MvcActionDMO> {
    ...
    public MvcActionREF(MvcActionDMO o){
         object = o;
         myName = (DmcTypeStringNameSV)o.getObjectNameAttribute();
    }

    public MvcActionREF(StringName n) throws DmcValueException {
         object = null;
         myName = new DmcTypeStringNameSV(__name);
         myName.set(n);
    }

    public MvcActionREF(String n) throws DmcValueException {
         object = null;
         myName = new DmcTypeStringNameSV(__name);
         myName.set(n);
    }
