...
import org.dmd.features.extgwt.generated.dmo.MvcToolBarDMO; // primitive type
...
public class MvcToolBarREF extends DmcNamedObjectNontransportableREF<MvcToolBarDMO> {
    ...
    public MvcToolBarREF(MvcToolBarDMO o){
         object = o;
         myName = (DmcTypeStringNameSV)o.getObjectNameAttribute();
    }

    public MvcToolBarREF(StringName n) throws DmcValueException {
         object = null;
         myName = new DmcTypeStringNameSV(__name);
         myName.set(n);
    }

    public MvcToolBarREF(String n) throws DmcValueException {
         object = null;
         myName = new DmcTypeStringNameSV(__name);
         myName.set(n);
    }
