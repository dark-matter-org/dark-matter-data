...
public class DmcTypeMvcViewREFMV extends DmcTypeMvcViewREF implements Serializable {
    ...
    protected ArrayList<MvcViewREF> value;
    ...
    public ArrayList<MvcViewREF> getMVCopy(){
        synchronized(this){
            ArrayList<MvcViewREF> clone = new ArrayList<MvcViewREF>(value);
            return(clone);
        }
    ...
    public MvcViewREF getMVnth(int index){
        synchronized(this){
            if (value == null)
                return(null);
    ...
    public MvcViewREF setMVnth(int index, Object v) throws DmcValueException {
        synchronized(this){
            if (attrInfo.indexSize == 0)
            ...
            if (value == null){
                value = new ArrayList<MvcViewREF>(attrInfo.indexSize);
