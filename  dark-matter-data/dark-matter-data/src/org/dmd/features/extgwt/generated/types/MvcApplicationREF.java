...
import org.dmd.features.extgwt.generated.dmo.MvcApplicationDMO; // primitive type
...
public class MvcApplicationREF extends DmcNamedObjectNontransportableREF<MvcApplicationDMO> {
    ...
    public MvcApplicationREF(MvcApplicationDMO o){
         object = o;
         myName = (DmcTypeStringNameSV)o.getObjectNameAttribute();
    }

    public MvcApplicationREF(StringName n) throws DmcValueException {
         object = null;
         myName = new DmcTypeStringNameSV(__name);
         myName.set(n);
    }

    public MvcApplicationREF(String n) throws DmcValueException {
         object = null;
         myName = new DmcTypeStringNameSV(__name);
         myName.set(n);
    }
